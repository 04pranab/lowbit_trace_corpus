...
BUILD_DIR="$SCRIPT_DIR/bin_gem5_o3"
OUT_DIR="$SCRIPT_DIR/gem5_stats_o3"
...
# O3CPU: gem5's detailed out-of-order CPU model.
#
# O3 is kept as a separate backend from MinorCPU because it is
# substantially more expensive and some RISC-V workloads can expose
# limitations in gem5's O3/RISC-V implementation.
#
# Use O3 for detailed architectural experiments and comparison against
# MinorCPU. Do not assume that a timeout means the benchmark itself is
# invalid. Record failed/timeout runs separately.
