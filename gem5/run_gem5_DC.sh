...
BUILD_DIR="$SCRIPT_DIR/bin_gem5_atomcpu"
OUT_DIR="$SCRIPT_DIR/gem5_stats_atomcpu"
...
GEM5_CPU_TYPE="${GEM5_CPU_TYPE:-DerivO3CPU}"
...
echo "Parse with: python3 $SCRIPT_DIR/parse_gem5_stats_to_csv.py $OUT_DIR $SCRIPT_DIR/lowbit_traces_gem5_derivcpu.csv"