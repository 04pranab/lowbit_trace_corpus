#!/usr/bin/env python3
"""
Parse LowBit Trace Corpus *.perf.txt files (Orange Pi RISC-V hardware backend) into an ML-ready CSV.
...
OUTPUT_CSV = Path(sys.argv[2]) if len(sys.argv) > 2 else SCRIPT_DIR / "lowbit_traces_orange_pi.csv"
