/*
 * LowBit -- 1082_grid_b22_drifting_threshold_periodic_reset__c32_hilbert_curve_traversal.c
 * Branch: drifting_threshold_periodic_reset | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1082_grid_b22_drifting_threshold_periodic_reset__c32_hilbert_curve_traversal.c\n");
