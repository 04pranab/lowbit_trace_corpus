/*
 * LowBit -- 0716_grid_b15_manual_unroll4_sparse__c16_block_sparse.c
 * Branch: manual_unroll4_sparse | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0716_grid_b15_manual_unroll4_sparse__c16_block_sparse.c\n");
