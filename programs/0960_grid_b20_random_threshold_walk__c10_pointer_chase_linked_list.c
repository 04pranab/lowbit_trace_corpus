/*
 * LowBit -- 0960_grid_b20_random_threshold_walk__c10_pointer_chase_linked_list.c
 * Branch: random_threshold_walk | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0960_grid_b20_random_threshold_walk__c10_pointer_chase_linked_list.c\n");
