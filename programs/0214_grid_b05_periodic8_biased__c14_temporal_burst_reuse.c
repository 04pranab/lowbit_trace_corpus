/*
 * LowBit -- 0214_grid_b05_periodic8_biased__c14_temporal_burst_reuse.c
 * Branch: periodic8_biased | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0214_grid_b05_periodic8_biased__c14_temporal_burst_reuse.c\n");
