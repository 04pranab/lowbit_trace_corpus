/*
 * LowBit -- 0263_grid_b06_pseudo_random_50__c13_two_stream_interleaved.c
 * Branch: pseudo_random_50 | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0263_grid_b06_pseudo_random_50__c13_two_stream_interleaved.c\n");
