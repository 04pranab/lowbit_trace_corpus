/*
 * LowBit -- 0652_grid_b14_four_way_skewed__c02_sequential_wraparound_large.c
 * Branch: four_way_skewed | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0652_grid_b14_four_way_skewed__c02_sequential_wraparound_large.c\n");
