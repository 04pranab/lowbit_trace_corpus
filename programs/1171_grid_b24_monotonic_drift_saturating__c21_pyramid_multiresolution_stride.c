/*
 * LowBit -- 1171_grid_b24_monotonic_drift_saturating__c21_pyramid_multiresolution_stride.c
 * Branch: monotonic_drift_saturating | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1171_grid_b24_monotonic_drift_saturating__c21_pyramid_multiresolution_stride.c\n");
