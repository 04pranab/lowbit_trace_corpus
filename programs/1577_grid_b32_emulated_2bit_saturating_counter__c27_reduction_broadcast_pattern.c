/*
 * LowBit -- 1577_grid_b32_emulated_2bit_saturating_counter__c27_reduction_broadcast_pattern.c
 * Branch: emulated_2bit_saturating_counter | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1577_grid_b32_emulated_2bit_saturating_counter__c27_reduction_broadcast_pattern.c\n");
