/*
 * LowBit -- 0878_grid_b18_indirect_fn_dispatch__c28_morton_zorder_traversal.c
 * Branch: indirect_fn_dispatch | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0878_grid_b18_indirect_fn_dispatch__c28_morton_zorder_traversal.c\n");
