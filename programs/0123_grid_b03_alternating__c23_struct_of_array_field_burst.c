/*
 * LowBit -- 0123_grid_b03_alternating__c23_struct_of_array_field_burst.c
 * Branch: alternating | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0123_grid_b03_alternating__c23_struct_of_array_field_burst.c\n");
