/*
 * LowBit -- 1884_grid_b38_decaying_hazard_probability__c34_variable_length_burst_reuse.c
 * Branch: decaying_hazard_probability | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1884_grid_b38_decaying_hazard_probability__c34_variable_length_burst_reuse.c\n");
