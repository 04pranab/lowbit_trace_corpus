/*
 * LowBit -- 1866_grid_b38_decaying_hazard_probability__c16_block_sparse.c
 * Branch: decaying_hazard_probability | Cache: block_sparse
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1866_grid_b38_decaying_hazard_probability__c16_block_sparse.c\n");
