/*
 * LowBit -- 0184_grid_b04_periodic3__c34_variable_length_burst_reuse.c
 * Branch: periodic3 | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0184_grid_b04_periodic3__c34_variable_length_burst_reuse.c\n");
