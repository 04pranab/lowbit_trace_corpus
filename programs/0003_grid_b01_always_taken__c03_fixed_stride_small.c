/*
 * LowBit -- 0003_grid_b01_always_taken__c03_fixed_stride_small.c
 * Branch: always_taken | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0003_grid_b01_always_taken__c03_fixed_stride_small.c\n");
