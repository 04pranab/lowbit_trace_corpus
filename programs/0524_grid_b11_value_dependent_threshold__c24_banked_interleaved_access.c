/*
 * LowBit -- 0524_grid_b11_value_dependent_threshold__c24_banked_interleaved_access.c
 * Branch: value_dependent_threshold | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0524_grid_b11_value_dependent_threshold__c24_banked_interleaved_access.c\n");
