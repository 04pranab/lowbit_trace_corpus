/*
 * LowBit -- 1877_grid_b38_decaying_hazard_probability__c27_reduction_broadcast_pattern.c
 * Branch: decaying_hazard_probability | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1877_grid_b38_decaying_hazard_probability__c27_reduction_broadcast_pattern.c\n");
