/*
 * LowBit -- 0340_grid_b07_nested_dependent__c40_causal_attention_triangular.c
 * Branch: nested_dependent | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0340_grid_b07_nested_dependent__c40_causal_attention_triangular.c\n");
