/*
 * LowBit -- 0693_grid_b14_four_way_skewed__c43_whole_buffer_rotation.c
 * Branch: four_way_skewed | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0693_grid_b14_four_way_skewed__c43_whole_buffer_rotation.c\n");
