/*
 * LowBit -- 0949_grid_b19_data_dependent_break_trip__c49_binary_heap_parent_child.c
 * Branch: data_dependent_break_trip | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0949_grid_b19_data_dependent_break_trip__c49_binary_heap_parent_child.c\n");
