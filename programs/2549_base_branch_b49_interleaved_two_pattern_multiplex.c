/*
 * LowBit -- 2549_base_branch_b49_interleaved_two_pattern_multiplex.c
 * Branch: interleaved_two_pattern_multiplex | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2549_base_branch_b49_interleaved_two_pattern_multiplex.c\n");
