/*
 * LowBit -- 2116_grid_b43_moving_average_threshold__c16_block_sparse.c
 * Branch: moving_average_threshold | Cache: block_sparse
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2116_grid_b43_moving_average_threshold__c16_block_sparse.c\n");
