/*
 * LowBit -- 0460_grid_b10_correlated_history__c10_pointer_chase_linked_list.c
 * Branch: correlated_history | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0460_grid_b10_correlated_history__c10_pointer_chase_linked_list.c\n");
