/*
 * LowBit -- 1176_grid_b24_monotonic_drift_saturating__c26_geometric_stride_growth.c
 * Branch: monotonic_drift_saturating | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1176_grid_b24_monotonic_drift_saturating__c26_geometric_stride_growth.c\n");
