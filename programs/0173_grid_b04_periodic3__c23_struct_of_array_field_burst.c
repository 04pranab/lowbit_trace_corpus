/*
 * LowBit -- 0173_grid_b04_periodic3__c23_struct_of_array_field_burst.c
 * Branch: periodic3 | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0173_grid_b04_periodic3__c23_struct_of_array_field_burst.c\n");
