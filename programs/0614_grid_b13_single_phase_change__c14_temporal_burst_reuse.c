/*
 * LowBit -- 0614_grid_b13_single_phase_change__c14_temporal_burst_reuse.c
 * Branch: single_phase_change | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0614_grid_b13_single_phase_change__c14_temporal_burst_reuse.c\n");
