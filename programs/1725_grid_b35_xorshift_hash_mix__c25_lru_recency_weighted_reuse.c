/*
 * LowBit -- 1725_grid_b35_xorshift_hash_mix__c25_lru_recency_weighted_reuse.c
 * Branch: xorshift_hash_mix | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1725_grid_b35_xorshift_hash_mix__c25_lru_recency_weighted_reuse.c\n");
