/*
 * LowBit -- 2518_base_branch_b18_indirect_fn_dispatch.c
 * Branch: indirect_fn_dispatch | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=2518_base_branch_b18_indirect_fn_dispatch.c\n");
