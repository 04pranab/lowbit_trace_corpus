/*
 * LowBit -- 1167_grid_b24_monotonic_drift_saturating__c17_zipf_like_hot_buckets.c
 * Branch: monotonic_drift_saturating | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1167_grid_b24_monotonic_drift_saturating__c17_zipf_like_hot_buckets.c\n");
