/*
 * LowBit -- 1600_grid_b32_emulated_2bit_saturating_counter__c50_streaming_with_periodic_flush.c
 * Branch: emulated_2bit_saturating_counter | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1600_grid_b32_emulated_2bit_saturating_counter__c50_streaming_with_periodic_flush.c\n");
