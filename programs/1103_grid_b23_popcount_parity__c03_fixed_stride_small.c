/*
 * LowBit -- 1103_grid_b23_popcount_parity__c03_fixed_stride_small.c
 * Branch: popcount_parity | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1103_grid_b23_popcount_parity__c03_fixed_stride_small.c\n");
