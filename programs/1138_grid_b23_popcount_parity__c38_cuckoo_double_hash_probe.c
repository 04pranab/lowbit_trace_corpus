/*
 * LowBit -- 1138_grid_b23_popcount_parity__c38_cuckoo_double_hash_probe.c
 * Branch: popcount_parity | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1138_grid_b23_popcount_parity__c38_cuckoo_double_hash_probe.c\n");
