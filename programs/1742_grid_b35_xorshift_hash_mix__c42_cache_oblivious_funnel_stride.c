/*
 * LowBit -- 1742_grid_b35_xorshift_hash_mix__c42_cache_oblivious_funnel_stride.c
 * Branch: xorshift_hash_mix | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1742_grid_b35_xorshift_hash_mix__c42_cache_oblivious_funnel_stride.c\n");
