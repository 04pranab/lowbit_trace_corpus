/*
 * LowBit -- 0247_grid_b05_periodic8_biased__c47_false_sharing_line_cycle.c
 * Branch: periodic8_biased | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0247_grid_b05_periodic8_biased__c47_false_sharing_line_cycle.c\n");
