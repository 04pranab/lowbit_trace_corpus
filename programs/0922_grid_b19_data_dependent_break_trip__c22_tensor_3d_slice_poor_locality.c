/*
 * LowBit -- 0922_grid_b19_data_dependent_break_trip__c22_tensor_3d_slice_poor_locality.c
 * Branch: data_dependent_break_trip | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0922_grid_b19_data_dependent_break_trip__c22_tensor_3d_slice_poor_locality.c\n");
