/*
 * LowBit -- 1190_grid_b24_monotonic_drift_saturating__c40_causal_attention_triangular.c
 * Branch: monotonic_drift_saturating | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1190_grid_b24_monotonic_drift_saturating__c40_causal_attention_triangular.c\n");
