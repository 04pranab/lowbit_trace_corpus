/*
 * LowBit -- 2559_base_cache_c09_matrix_tiled_blocked.c
 * Branch: synthetic_always_taken | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=2559_base_cache_c09_matrix_tiled_blocked.c\n");
