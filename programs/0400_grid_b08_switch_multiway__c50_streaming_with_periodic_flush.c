/*
 * LowBit -- 0400_grid_b08_switch_multiway__c50_streaming_with_periodic_flush.c
 * Branch: switch_multiway | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0400_grid_b08_switch_multiway__c50_streaming_with_periodic_flush.c\n");
