/*
 * LowBit -- 2493_grid_b50_hysteresis_debounce__c43_whole_buffer_rotation.c
 * Branch: hysteresis_debounce | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2493_grid_b50_hysteresis_debounce__c43_whole_buffer_rotation.c\n");
