/*
 * LowBit -- 0870_grid_b18_indirect_fn_dispatch__c20_hot_cold_phase_alternation.c
 * Branch: indirect_fn_dispatch | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0870_grid_b18_indirect_fn_dispatch__c20_hot_cold_phase_alternation.c\n");
