/*
 * LowBit -- 0004_grid_b01_always_taken__c04_fixed_stride_large.c
 * Branch: always_taken | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0004_grid_b01_always_taken__c04_fixed_stride_large.c\n");
