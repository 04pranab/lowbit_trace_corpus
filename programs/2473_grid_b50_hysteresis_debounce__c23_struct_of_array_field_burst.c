/*
 * LowBit -- 2473_grid_b50_hysteresis_debounce__c23_struct_of_array_field_burst.c
 * Branch: hysteresis_debounce | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2473_grid_b50_hysteresis_debounce__c23_struct_of_array_field_burst.c\n");
