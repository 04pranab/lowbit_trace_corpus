/*
 * LowBit -- 0860_grid_b18_indirect_fn_dispatch__c10_pointer_chase_linked_list.c
 * Branch: indirect_fn_dispatch | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0860_grid_b18_indirect_fn_dispatch__c10_pointer_chase_linked_list.c\n");
