/*
 * LowBit -- 2170_grid_b44_exception_then_recovery_burst__c20_hot_cold_phase_alternation.c
 * Branch: exception_then_recovery_burst | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2170_grid_b44_exception_then_recovery_burst__c20_hot_cold_phase_alternation.c\n");
