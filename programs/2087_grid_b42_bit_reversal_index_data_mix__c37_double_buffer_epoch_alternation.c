/*
 * LowBit -- 2087_grid_b42_bit_reversal_index_data_mix__c37_double_buffer_epoch_alternation.c
 * Branch: bit_reversal_index_data_mix | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2087_grid_b42_bit_reversal_index_data_mix__c37_double_buffer_epoch_alternation.c\n");
