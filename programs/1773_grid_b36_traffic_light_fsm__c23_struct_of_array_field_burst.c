/*
 * LowBit -- 1773_grid_b36_traffic_light_fsm__c23_struct_of_array_field_burst.c
 * Branch: traffic_light_fsm | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1773_grid_b36_traffic_light_fsm__c23_struct_of_array_field_burst.c\n");
