/*
 * LowBit -- 1406_grid_b29_bursty_streak_pattern__c06_random_full_working_set.c
 * Branch: bursty_streak_pattern | Cache: random_full_working_set
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1406_grid_b29_bursty_streak_pattern__c06_random_full_working_set.c\n");
