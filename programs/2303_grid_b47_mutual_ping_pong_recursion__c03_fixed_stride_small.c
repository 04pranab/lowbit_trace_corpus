/*
 * LowBit -- 2303_grid_b47_mutual_ping_pong_recursion__c03_fixed_stride_small.c
 * Branch: mutual_ping_pong_recursion | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2303_grid_b47_mutual_ping_pong_recursion__c03_fixed_stride_small.c\n");
