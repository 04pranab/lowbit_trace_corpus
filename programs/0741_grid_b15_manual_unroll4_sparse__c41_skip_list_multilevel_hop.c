/*
 * LowBit -- 0741_grid_b15_manual_unroll4_sparse__c41_skip_list_multilevel_hop.c
 * Branch: manual_unroll4_sparse | Cache: skip_list_multilevel_hop
...
int main(void) {
    ...
    printf("program=0741_grid_b15_manual_unroll4_sparse__c41_skip_list_multilevel_hop.c\n");
