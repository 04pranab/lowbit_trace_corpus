/*
 * LowBit -- 1705_grid_b35_xorshift_hash_mix__c05_random_small_working_set.c
 * Branch: xorshift_hash_mix | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1705_grid_b35_xorshift_hash_mix__c05_random_small_working_set.c\n");
