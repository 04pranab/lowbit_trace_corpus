/*
 * LowBit -- 1973_grid_b40_collatz_value_transform__c23_struct_of_array_field_burst.c
 * Branch: collatz_value_transform | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1973_grid_b40_collatz_value_transform__c23_struct_of_array_field_burst.c\n");
