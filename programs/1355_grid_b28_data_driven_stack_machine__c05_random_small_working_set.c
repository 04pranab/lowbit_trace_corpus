/*
 * LowBit -- 1355_grid_b28_data_driven_stack_machine__c05_random_small_working_set.c
 * Branch: data_driven_stack_machine | Cache: random_small_working_set
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1355_grid_b28_data_driven_stack_machine__c05_random_small_working_set.c\n");
