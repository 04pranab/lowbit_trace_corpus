/*
 * LowBit -- 0050_grid_b01_always_taken__c50_streaming_with_periodic_flush.c
 * Branch: always_taken | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0050_grid_b01_always_taken__c50_streaming_with_periodic_flush.c\n");
