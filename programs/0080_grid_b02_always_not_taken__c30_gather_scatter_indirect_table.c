/*
 * LowBit -- 0080_grid_b02_always_not_taken__c30_gather_scatter_indirect_table.c
 * Branch: always_not_taken | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0080_grid_b02_always_not_taken__c30_gather_scatter_indirect_table.c\n");
