/*
 * LowBit -- 2038_grid_b41_markov_chain_3state__c38_cuckoo_double_hash_probe.c
 * Branch: markov_chain_3state | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2038_grid_b41_markov_chain_3state__c38_cuckoo_double_hash_probe.c\n");
