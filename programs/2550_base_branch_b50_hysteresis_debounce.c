/*
 * LowBit -- 2550_base_branch_b50_hysteresis_debounce.c
 * Branch: hysteresis_debounce | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2550_base_branch_b50_hysteresis_debounce.c\n");
