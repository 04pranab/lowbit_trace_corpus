/*
 * LowBit -- 0462_grid_b10_correlated_history__c12_prime_stride_anti_alias.c
 * Branch: correlated_history | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0462_grid_b10_correlated_history__c12_prime_stride_anti_alias.c\n");
