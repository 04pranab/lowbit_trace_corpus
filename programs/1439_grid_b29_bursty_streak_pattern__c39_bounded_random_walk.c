/*
 * LowBit -- 1439_grid_b29_bursty_streak_pattern__c39_bounded_random_walk.c
 * Branch: bursty_streak_pattern | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1439_grid_b29_bursty_streak_pattern__c39_bounded_random_walk.c\n");
