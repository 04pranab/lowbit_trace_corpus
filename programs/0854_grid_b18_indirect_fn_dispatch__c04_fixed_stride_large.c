/*
 * LowBit -- 0854_grid_b18_indirect_fn_dispatch__c04_fixed_stride_large.c
 * Branch: indirect_fn_dispatch | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0854_grid_b18_indirect_fn_dispatch__c04_fixed_stride_large.c\n");
