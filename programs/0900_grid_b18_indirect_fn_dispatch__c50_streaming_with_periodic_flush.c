/*
 * LowBit -- 0900_grid_b18_indirect_fn_dispatch__c50_streaming_with_periodic_flush.c
 * Branch: indirect_fn_dispatch | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0900_grid_b18_indirect_fn_dispatch__c50_streaming_with_periodic_flush.c\n");
