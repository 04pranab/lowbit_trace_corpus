/*
 * LowBit -- 1251_grid_b26_warmup_then_steady__c01_sequential_unit_stride.c
 * Branch: warmup_then_steady | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1251_grid_b26_warmup_then_steady__c01_sequential_unit_stride.c\n");
