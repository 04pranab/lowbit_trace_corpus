/*
 * LowBit -- 2311_grid_b47_mutual_ping_pong_recursion__c11_sliding_window.c
 * Branch: mutual_ping_pong_recursion | Cache: sliding_window
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2311_grid_b47_mutual_ping_pong_recursion__c11_sliding_window.c\n");
