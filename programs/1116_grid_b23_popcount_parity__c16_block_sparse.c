/*
 * LowBit -- 1116_grid_b23_popcount_parity__c16_block_sparse.c
 * Branch: popcount_parity | Cache: block_sparse
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1116_grid_b23_popcount_parity__c16_block_sparse.c\n");
