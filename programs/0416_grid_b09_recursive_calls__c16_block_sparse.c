/*
 * LowBit -- 0416_grid_b09_recursive_calls__c16_block_sparse.c
 * Branch: recursive_calls | Cache: block_sparse
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0416_grid_b09_recursive_calls__c16_block_sparse.c\n");
