/*
 * LowBit -- 0426_grid_b09_recursive_calls__c26_geometric_stride_growth.c
 * Branch: recursive_calls | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0426_grid_b09_recursive_calls__c26_geometric_stride_growth.c\n");
