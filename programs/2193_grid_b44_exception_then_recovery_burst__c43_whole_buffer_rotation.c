/*
 * LowBit -- 2193_grid_b44_exception_then_recovery_burst__c43_whole_buffer_rotation.c
 * Branch: exception_then_recovery_burst | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2193_grid_b44_exception_then_recovery_burst__c43_whole_buffer_rotation.c\n");
