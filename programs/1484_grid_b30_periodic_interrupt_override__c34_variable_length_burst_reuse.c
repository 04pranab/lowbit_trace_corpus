/*
 * LowBit -- 1484_grid_b30_periodic_interrupt_override__c34_variable_length_burst_reuse.c
 * Branch: periodic_interrupt_override | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=1484_grid_b30_periodic_interrupt_override__c34_variable_length_burst_reuse.c\n");
