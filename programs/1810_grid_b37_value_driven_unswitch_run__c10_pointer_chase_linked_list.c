/*
 * LowBit -- 1810_grid_b37_value_driven_unswitch_run__c10_pointer_chase_linked_list.c
 * Branch: value_driven_unswitch_run | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1810_grid_b37_value_driven_unswitch_run__c10_pointer_chase_linked_list.c\n");
