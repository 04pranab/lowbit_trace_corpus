/*
 * LowBit -- 1615_grid_b33_uniform_random_block_runs__c15_reverse_sequential.c
 * Branch: uniform_random_block_runs | Cache: reverse_sequential
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = (uint32_t)(SIZE - 1u - (i % SIZE));
        uint32_t v = buf[idx];
        int taken;
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1615_grid_b33_uniform_random_block_runs__c15_reverse_sequential.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=reverse_sequential\n");
