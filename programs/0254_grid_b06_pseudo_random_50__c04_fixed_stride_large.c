/*
 * LowBit -- 0254_grid_b06_pseudo_random_50__c04_fixed_stride_large.c
 * Branch: pseudo_random_50 | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0254_grid_b06_pseudo_random_50__c04_fixed_stride_large.c\n");
