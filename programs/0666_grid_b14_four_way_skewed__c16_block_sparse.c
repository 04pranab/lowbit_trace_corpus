/*
 * LowBit -- 0666_grid_b14_four_way_skewed__c16_block_sparse.c
 * Branch: four_way_skewed | Cache: block_sparse
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0666_grid_b14_four_way_skewed__c16_block_sparse.c\n");
