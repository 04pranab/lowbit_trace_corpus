/*
 * LowBit -- 2345_grid_b47_mutual_ping_pong_recursion__c45_read_hot_write_cold_split.c
 * Branch: mutual_ping_pong_recursion | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2345_grid_b47_mutual_ping_pong_recursion__c45_read_hot_write_cold_split.c\n");
