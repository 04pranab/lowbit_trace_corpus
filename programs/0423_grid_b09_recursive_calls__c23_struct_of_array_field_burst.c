/*
 * LowBit -- 0423_grid_b09_recursive_calls__c23_struct_of_array_field_burst.c
 * Branch: recursive_calls | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0423_grid_b09_recursive_calls__c23_struct_of_array_field_burst.c\n");
