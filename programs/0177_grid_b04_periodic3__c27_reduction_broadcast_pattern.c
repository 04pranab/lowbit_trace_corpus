/*
 * LowBit -- 0177_grid_b04_periodic3__c27_reduction_broadcast_pattern.c
 * Branch: periodic3 | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0177_grid_b04_periodic3__c27_reduction_broadcast_pattern.c\n");
