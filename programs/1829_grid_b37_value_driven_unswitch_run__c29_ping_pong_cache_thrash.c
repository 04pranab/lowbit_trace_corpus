/*
 * LowBit -- 1829_grid_b37_value_driven_unswitch_run__c29_ping_pong_cache_thrash.c
 * Branch: value_driven_unswitch_run | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1829_grid_b37_value_driven_unswitch_run__c29_ping_pong_cache_thrash.c\n");
