/*
 * LowBit -- 1965_grid_b40_collatz_value_transform__c15_reverse_sequential.c
 * Branch: collatz_value_transform | Cache: reverse_sequential
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1965_grid_b40_collatz_value_transform__c15_reverse_sequential.c\n");
