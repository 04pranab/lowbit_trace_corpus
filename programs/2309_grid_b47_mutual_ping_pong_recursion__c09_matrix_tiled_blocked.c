/*
 * LowBit -- 2309_grid_b47_mutual_ping_pong_recursion__c09_matrix_tiled_blocked.c
 * Branch: mutual_ping_pong_recursion | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2309_grid_b47_mutual_ping_pong_recursion__c09_matrix_tiled_blocked.c\n");
