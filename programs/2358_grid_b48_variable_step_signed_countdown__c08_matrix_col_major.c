/*
 * LowBit -- 2358_grid_b48_variable_step_signed_countdown__c08_matrix_col_major.c
 * Branch: variable_step_signed_countdown | Cache: matrix_col_major
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2358_grid_b48_variable_step_signed_countdown__c08_matrix_col_major.c\n");
