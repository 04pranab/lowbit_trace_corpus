/*
 * LowBit -- 1820_grid_b37_value_driven_unswitch_run__c20_hot_cold_phase_alternation.c
 * Branch: value_driven_unswitch_run | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1820_grid_b37_value_driven_unswitch_run__c20_hot_cold_phase_alternation.c\n");
