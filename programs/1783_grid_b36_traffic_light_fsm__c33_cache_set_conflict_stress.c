/*
 * LowBit -- 1783_grid_b36_traffic_light_fsm__c33_cache_set_conflict_stress.c
 * Branch: traffic_light_fsm | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1783_grid_b36_traffic_light_fsm__c33_cache_set_conflict_stress.c\n");
