/*
 * LowBit -- 1681_grid_b34_data_driven_countdown__c31_fibonacci_stride.c
 * Branch: data_driven_countdown | Cache: fibonacci_stride
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1681_grid_b34_data_driven_countdown__c31_fibonacci_stride.c\n");
