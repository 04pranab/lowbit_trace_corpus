/*
 * LowBit -- 2189_grid_b44_exception_then_recovery_burst__c39_bounded_random_walk.c
 * Branch: exception_then_recovery_burst | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2189_grid_b44_exception_then_recovery_burst__c39_bounded_random_walk.c\n");
