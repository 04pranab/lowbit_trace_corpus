/*
 * LowBit -- 2157_grid_b44_exception_then_recovery_burst__c07_matrix_row_major.c
 * Branch: exception_then_recovery_burst | Cache: matrix_row_major
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2157_grid_b44_exception_then_recovery_burst__c07_matrix_row_major.c\n");
