/*
 * LowBit -- 0418_grid_b09_recursive_calls__c18_producer_consumer_two_pointer.c
 * Branch: recursive_calls | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0418_grid_b09_recursive_calls__c18_producer_consumer_two_pointer.c\n");
