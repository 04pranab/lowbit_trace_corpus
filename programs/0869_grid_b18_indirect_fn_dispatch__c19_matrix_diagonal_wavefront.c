/*
 * LowBit -- 0869_grid_b18_indirect_fn_dispatch__c19_matrix_diagonal_wavefront.c
 * Branch: indirect_fn_dispatch | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0869_grid_b18_indirect_fn_dispatch__c19_matrix_diagonal_wavefront.c\n");
