/*
 * LowBit -- 1386_grid_b28_data_driven_stack_machine__c36_im2col_overlapping_patch_gather.c
 * Branch: data_driven_stack_machine | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1386_grid_b28_data_driven_stack_machine__c36_im2col_overlapping_patch_gather.c\n");
