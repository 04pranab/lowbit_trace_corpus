/*
 * LowBit -- 1516_grid_b31_prime_period13__c16_block_sparse.c
 * Branch: prime_period13 | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=1516_grid_b31_prime_period13__c16_block_sparse.c\n");
