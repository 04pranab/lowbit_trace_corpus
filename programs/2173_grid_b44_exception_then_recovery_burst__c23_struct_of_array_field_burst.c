/*
 * LowBit -- 2173_grid_b44_exception_then_recovery_burst__c23_struct_of_array_field_burst.c
 * Branch: exception_then_recovery_burst | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2173_grid_b44_exception_then_recovery_burst__c23_struct_of_array_field_burst.c\n");
