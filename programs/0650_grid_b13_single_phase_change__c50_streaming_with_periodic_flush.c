/*
 * LowBit -- 0650_grid_b13_single_phase_change__c50_streaming_with_periodic_flush.c
 * Branch: single_phase_change | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0650_grid_b13_single_phase_change__c50_streaming_with_periodic_flush.c\n");
