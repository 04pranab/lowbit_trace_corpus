/*
 * LowBit -- 2364_grid_b48_variable_step_signed_countdown__c14_temporal_burst_reuse.c
 * Branch: variable_step_signed_countdown | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2364_grid_b48_variable_step_signed_countdown__c14_temporal_burst_reuse.c\n");
