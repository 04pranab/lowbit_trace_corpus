/*
 * LowBit -- 2149_grid_b43_moving_average_threshold__c49_binary_heap_parent_child.c
 * Branch: moving_average_threshold | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2149_grid_b43_moving_average_threshold__c49_binary_heap_parent_child.c\n");
