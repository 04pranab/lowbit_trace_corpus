/*
 * LowBit -- 0192_grid_b04_periodic3__c42_cache_oblivious_funnel_stride.c
 * Branch: periodic3 | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0192_grid_b04_periodic3__c42_cache_oblivious_funnel_stride.c\n");
