/*
 * LowBit -- 1066_grid_b22_drifting_threshold_periodic_reset__c16_block_sparse.c
 * Branch: drifting_threshold_periodic_reset | Cache: block_sparse
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1066_grid_b22_drifting_threshold_periodic_reset__c16_block_sparse.c\n");
