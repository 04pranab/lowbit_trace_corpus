/*
 * LowBit -- 0197_grid_b04_periodic3__c47_false_sharing_line_cycle.c
 * Branch: periodic3 | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0197_grid_b04_periodic3__c47_false_sharing_line_cycle.c\n");
