/*
 * LowBit -- 0845_grid_b17_correlated_two_branch_xor__c45_read_hot_write_cold_split.c
 * Branch: correlated_two_branch_xor | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0845_grid_b17_correlated_two_branch_xor__c45_read_hot_write_cold_split.c\n");
