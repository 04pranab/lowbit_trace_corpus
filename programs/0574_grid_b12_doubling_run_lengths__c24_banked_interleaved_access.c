/*
 * LowBit -- 0574_grid_b12_doubling_run_lengths__c24_banked_interleaved_access.c
 * Branch: doubling_run_lengths | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0574_grid_b12_doubling_run_lengths__c24_banked_interleaved_access.c\n");
