/*
 * LowBit -- 0409_grid_b09_recursive_calls__c09_matrix_tiled_blocked.c
 * Branch: recursive_calls | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0409_grid_b09_recursive_calls__c09_matrix_tiled_blocked.c\n");
