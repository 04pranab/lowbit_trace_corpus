/*
 * LowBit -- 0694_grid_b14_four_way_skewed__c44_naive_gemm_row_col_alternation.c
 * Branch: four_way_skewed | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0694_grid_b14_four_way_skewed__c44_naive_gemm_row_col_alternation.c\n");
