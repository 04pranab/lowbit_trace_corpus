/*
 * LowBit -- 2062_grid_b42_bit_reversal_index_data_mix__c12_prime_stride_anti_alias.c
 * Branch: bit_reversal_index_data_mix | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2062_grid_b42_bit_reversal_index_data_mix__c12_prime_stride_anti_alias.c\n");
