/*
 * LowBit -- 0500_grid_b10_correlated_history__c50_streaming_with_periodic_flush.c
 * Branch: correlated_history | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0500_grid_b10_correlated_history__c50_streaming_with_periodic_flush.c\n");
