/*
 * LowBit -- 0230_grid_b05_periodic8_biased__c30_gather_scatter_indirect_table.c
 * Branch: periodic8_biased | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0230_grid_b05_periodic8_biased__c30_gather_scatter_indirect_table.c\n");
