/*
 * LowBit -- 0615_grid_b13_single_phase_change__c15_reverse_sequential.c
 * Branch: single_phase_change | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0615_grid_b13_single_phase_change__c15_reverse_sequential.c\n");
