/*
 * LowBit -- 0496_grid_b10_correlated_history__c46_cantor_gap_sparse.c
 * Branch: correlated_history | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0496_grid_b10_correlated_history__c46_cantor_gap_sparse.c\n");
