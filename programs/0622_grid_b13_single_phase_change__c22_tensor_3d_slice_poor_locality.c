/*
 * LowBit -- 0622_grid_b13_single_phase_change__c22_tensor_3d_slice_poor_locality.c
 * Branch: single_phase_change | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0622_grid_b13_single_phase_change__c22_tensor_3d_slice_poor_locality.c\n");
