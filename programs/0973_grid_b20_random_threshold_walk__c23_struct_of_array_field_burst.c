/*
 * LowBit -- 0973_grid_b20_random_threshold_walk__c23_struct_of_array_field_burst.c
 * Branch: random_threshold_walk | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0973_grid_b20_random_threshold_walk__c23_struct_of_array_field_burst.c\n");
