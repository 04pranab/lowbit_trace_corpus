/*
 * LowBit -- 2223_grid_b45_two_counters_race__c23_struct_of_array_field_burst.c
 * Branch: two_counters_race | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2223_grid_b45_two_counters_race__c23_struct_of_array_field_burst.c\n");
