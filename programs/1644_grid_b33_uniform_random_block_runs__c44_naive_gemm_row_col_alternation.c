/*
 * LowBit -- 1644_grid_b33_uniform_random_block_runs__c44_naive_gemm_row_col_alternation.c
 * Branch: uniform_random_block_runs | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1644_grid_b33_uniform_random_block_runs__c44_naive_gemm_row_col_alternation.c\n");
