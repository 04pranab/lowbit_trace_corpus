/*
 * LowBit -- 2487_grid_b50_hysteresis_debounce__c37_double_buffer_epoch_alternation.c
 * Branch: hysteresis_debounce | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2487_grid_b50_hysteresis_debounce__c37_double_buffer_epoch_alternation.c\n");
