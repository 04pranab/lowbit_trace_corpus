/*
 * LowBit -- 1268_grid_b26_warmup_then_steady__c18_producer_consumer_two_pointer.c
 * Branch: warmup_then_steady | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1268_grid_b26_warmup_then_steady__c18_producer_consumer_two_pointer.c\n");
