/*
 * LowBit -- 0160_grid_b04_periodic3__c10_pointer_chase_linked_list.c
 * Branch: periodic3 | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0160_grid_b04_periodic3__c10_pointer_chase_linked_list.c\n");
