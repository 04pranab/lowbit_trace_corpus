/*
 * LowBit -- 1729_grid_b35_xorshift_hash_mix__c29_ping_pong_cache_thrash.c
 * Branch: xorshift_hash_mix | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1729_grid_b35_xorshift_hash_mix__c29_ping_pong_cache_thrash.c\n");
