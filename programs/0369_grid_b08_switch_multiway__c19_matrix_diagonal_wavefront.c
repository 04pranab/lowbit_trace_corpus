/*
 * LowBit -- 0369_grid_b08_switch_multiway__c19_matrix_diagonal_wavefront.c
 * Branch: switch_multiway | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0369_grid_b08_switch_multiway__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=switch_multiway\n");
