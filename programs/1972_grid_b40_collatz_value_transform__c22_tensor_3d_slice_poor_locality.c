/*
 * LowBit -- 1972_grid_b40_collatz_value_transform__c22_tensor_3d_slice_poor_locality.c
 * Branch: collatz_value_transform | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1972_grid_b40_collatz_value_transform__c22_tensor_3d_slice_poor_locality.c\n");
