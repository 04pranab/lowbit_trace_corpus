/*
 * LowBit -- 0204_grid_b05_periodic8_biased__c04_fixed_stride_large.c
 * Branch: periodic8_biased | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0204_grid_b05_periodic8_biased__c04_fixed_stride_large.c\n");
