/*
 * LowBit -- 0891_grid_b18_indirect_fn_dispatch__c41_skip_list_multilevel_hop.c
 * Branch: indirect_fn_dispatch | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0891_grid_b18_indirect_fn_dispatch__c41_skip_list_multilevel_hop.c\n");
