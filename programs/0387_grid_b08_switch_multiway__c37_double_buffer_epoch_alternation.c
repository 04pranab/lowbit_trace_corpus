/*
 * LowBit -- 0387_grid_b08_switch_multiway__c37_double_buffer_epoch_alternation.c
 * Branch: switch_multiway | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0387_grid_b08_switch_multiway__c37_double_buffer_epoch_alternation.c\n");
