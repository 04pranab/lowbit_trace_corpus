/*
 * LowBit -- 2042_grid_b41_markov_chain_3state__c42_cache_oblivious_funnel_stride.c
 * Branch: markov_chain_3state | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2042_grid_b41_markov_chain_3state__c42_cache_oblivious_funnel_stride.c\n");
