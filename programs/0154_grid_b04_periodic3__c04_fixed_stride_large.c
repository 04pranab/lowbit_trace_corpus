/*
 * LowBit -- 0154_grid_b04_periodic3__c04_fixed_stride_large.c
 * Branch: periodic3 | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0154_grid_b04_periodic3__c04_fixed_stride_large.c\n");
