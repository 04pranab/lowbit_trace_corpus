/*
 * LowBit -- 1585_grid_b32_emulated_2bit_saturating_counter__c35_checkerboard_red_black.c
 * Branch: emulated_2bit_saturating_counter | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1585_grid_b32_emulated_2bit_saturating_counter__c35_checkerboard_red_black.c\n");
