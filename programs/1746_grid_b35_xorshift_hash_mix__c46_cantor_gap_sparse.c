/*
 * LowBit -- 1746_grid_b35_xorshift_hash_mix__c46_cantor_gap_sparse.c
 * Branch: xorshift_hash_mix | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1746_grid_b35_xorshift_hash_mix__c46_cantor_gap_sparse.c\n");
