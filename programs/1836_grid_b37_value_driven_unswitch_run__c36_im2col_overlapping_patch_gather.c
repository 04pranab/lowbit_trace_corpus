/*
 * LowBit -- 1836_grid_b37_value_driven_unswitch_run__c36_im2col_overlapping_patch_gather.c
 * Branch: value_driven_unswitch_run | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1836_grid_b37_value_driven_unswitch_run__c36_im2col_overlapping_patch_gather.c\n");
