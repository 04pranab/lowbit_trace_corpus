/*
 * LowBit -- 1025_grid_b21_loop_carried_running_state__c25_lru_recency_weighted_reuse.c
 * Branch: loop_carried_running_state | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=1025_grid_b21_loop_carried_running_state__c25_lru_recency_weighted_reuse.c\n");
