/*
 * LowBit -- 1063_grid_b22_drifting_threshold_periodic_reset__c13_two_stream_interleaved.c
 * Branch: drifting_threshold_periodic_reset | Cache: two_stream_interleaved
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1063_grid_b22_drifting_threshold_periodic_reset__c13_two_stream_interleaved.c\n");
