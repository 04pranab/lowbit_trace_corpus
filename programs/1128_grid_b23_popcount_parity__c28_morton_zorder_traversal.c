/*
 * LowBit -- 1128_grid_b23_popcount_parity__c28_morton_zorder_traversal.c
 * Branch: popcount_parity | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1128_grid_b23_popcount_parity__c28_morton_zorder_traversal.c\n");
