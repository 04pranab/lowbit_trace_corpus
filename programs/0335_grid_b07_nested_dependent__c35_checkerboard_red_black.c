/*
 * LowBit -- 0335_grid_b07_nested_dependent__c35_checkerboard_red_black.c
 * Branch: nested_dependent | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0335_grid_b07_nested_dependent__c35_checkerboard_red_black.c\n");
