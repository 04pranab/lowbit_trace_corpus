/*
 * LowBit -- 0063_grid_b02_always_not_taken__c13_two_stream_interleaved.c
 * Branch: always_not_taken | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0063_grid_b02_always_not_taken__c13_two_stream_interleaved.c\n");
