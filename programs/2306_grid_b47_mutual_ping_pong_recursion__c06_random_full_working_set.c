/*
 * LowBit -- 2306_grid_b47_mutual_ping_pong_recursion__c06_random_full_working_set.c
 * Branch: mutual_ping_pong_recursion | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2306_grid_b47_mutual_ping_pong_recursion__c06_random_full_working_set.c\n");
