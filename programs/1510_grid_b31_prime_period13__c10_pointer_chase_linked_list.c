/*
 * LowBit -- 1510_grid_b31_prime_period13__c10_pointer_chase_linked_list.c
 * Branch: prime_period13 | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=1510_grid_b31_prime_period13__c10_pointer_chase_linked_list.c\n");
