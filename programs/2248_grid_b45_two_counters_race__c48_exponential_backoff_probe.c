/*
 * LowBit -- 2248_grid_b45_two_counters_race__c48_exponential_backoff_probe.c
 * Branch: two_counters_race | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2248_grid_b45_two_counters_race__c48_exponential_backoff_probe.c\n");
