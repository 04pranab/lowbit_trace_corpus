/*
 * LowBit -- 1166_grid_b24_monotonic_drift_saturating__c16_block_sparse.c
 * Branch: monotonic_drift_saturating | Cache: block_sparse
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1166_grid_b24_monotonic_drift_saturating__c16_block_sparse.c\n");
