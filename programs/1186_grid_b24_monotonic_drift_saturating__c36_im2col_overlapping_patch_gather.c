/*
 * LowBit -- 1186_grid_b24_monotonic_drift_saturating__c36_im2col_overlapping_patch_gather.c
 * Branch: monotonic_drift_saturating | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1186_grid_b24_monotonic_drift_saturating__c36_im2col_overlapping_patch_gather.c\n");
