/*
 * LowBit -- 0266_grid_b06_pseudo_random_50__c16_block_sparse.c
 * Branch: pseudo_random_50 | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0266_grid_b06_pseudo_random_50__c16_block_sparse.c\n");
