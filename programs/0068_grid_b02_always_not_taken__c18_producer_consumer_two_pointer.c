/*
 * LowBit -- 0068_grid_b02_always_not_taken__c18_producer_consumer_two_pointer.c
 * Branch: always_not_taken | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0068_grid_b02_always_not_taken__c18_producer_consumer_two_pointer.c\n");
