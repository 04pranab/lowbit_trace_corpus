/*
 * LowBit -- 0609_grid_b13_single_phase_change__c09_matrix_tiled_blocked.c
 * Branch: single_phase_change | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0609_grid_b13_single_phase_change__c09_matrix_tiled_blocked.c\n");
