/*
 * LowBit -- 0489_grid_b10_correlated_history__c39_bounded_random_walk.c
 * Branch: correlated_history | Cache: bounded_random_walk
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0489_grid_b10_correlated_history__c39_bounded_random_walk.c\n");
