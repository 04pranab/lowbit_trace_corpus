/*
 * LowBit -- 0623_grid_b13_single_phase_change__c23_struct_of_array_field_burst.c
 * Branch: single_phase_change | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0623_grid_b13_single_phase_change__c23_struct_of_array_field_burst.c\n");
