/*
 * LowBit -- 0284_grid_b06_pseudo_random_50__c34_variable_length_burst_reuse.c
 * Branch: pseudo_random_50 | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0284_grid_b06_pseudo_random_50__c34_variable_length_burst_reuse.c\n");
