/*
 * LowBit -- 2005_grid_b41_markov_chain_3state__c05_random_small_working_set.c
 * Branch: markov_chain_3state | Cache: random_small_working_set
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2005_grid_b41_markov_chain_3state__c05_random_small_working_set.c\n");
