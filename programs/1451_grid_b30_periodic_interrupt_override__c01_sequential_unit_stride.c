/*
 * LowBit -- 1451_grid_b30_periodic_interrupt_override__c01_sequential_unit_stride.c
 * Branch: periodic_interrupt_override | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=1451_grid_b30_periodic_interrupt_override__c01_sequential_unit_stride.c\n");
