/*
 * LowBit -- 1979_grid_b40_collatz_value_transform__c29_ping_pong_cache_thrash.c
 * Branch: collatz_value_transform | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1979_grid_b40_collatz_value_transform__c29_ping_pong_cache_thrash.c\n");
