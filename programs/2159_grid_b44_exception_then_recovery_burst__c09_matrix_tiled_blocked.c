/*
 * LowBit -- 2159_grid_b44_exception_then_recovery_burst__c09_matrix_tiled_blocked.c
 * Branch: exception_then_recovery_burst | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2159_grid_b44_exception_then_recovery_burst__c09_matrix_tiled_blocked.c\n");
