/*
 * LowBit -- 0185_grid_b04_periodic3__c35_checkerboard_red_black.c
 * Branch: periodic3 | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0185_grid_b04_periodic3__c35_checkerboard_red_black.c\n");
