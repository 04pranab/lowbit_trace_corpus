/*
 * LowBit -- 2068_grid_b42_bit_reversal_index_data_mix__c18_producer_consumer_two_pointer.c
 * Branch: bit_reversal_index_data_mix | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2068_grid_b42_bit_reversal_index_data_mix__c18_producer_consumer_two_pointer.c\n");
