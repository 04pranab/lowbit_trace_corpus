/*
 * LowBit -- 1532_grid_b31_prime_period13__c32_hilbert_curve_traversal.c
 * Branch: prime_period13 | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=1532_grid_b31_prime_period13__c32_hilbert_curve_traversal.c\n");
