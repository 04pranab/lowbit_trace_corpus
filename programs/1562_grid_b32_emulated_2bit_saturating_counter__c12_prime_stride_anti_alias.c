/*
 * LowBit -- 1562_grid_b32_emulated_2bit_saturating_counter__c12_prime_stride_anti_alias.c
 * Branch: emulated_2bit_saturating_counter | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1562_grid_b32_emulated_2bit_saturating_counter__c12_prime_stride_anti_alias.c\n");
