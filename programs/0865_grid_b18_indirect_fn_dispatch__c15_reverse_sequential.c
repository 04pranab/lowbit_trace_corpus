/*
 * LowBit -- 0865_grid_b18_indirect_fn_dispatch__c15_reverse_sequential.c
 * Branch: indirect_fn_dispatch | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0865_grid_b18_indirect_fn_dispatch__c15_reverse_sequential.c\n");
