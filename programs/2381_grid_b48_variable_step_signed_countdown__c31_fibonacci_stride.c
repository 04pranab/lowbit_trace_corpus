/*
 * LowBit -- 2381_grid_b48_variable_step_signed_countdown__c31_fibonacci_stride.c
 * Branch: variable_step_signed_countdown | Cache: fibonacci_stride
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2381_grid_b48_variable_step_signed_countdown__c31_fibonacci_stride.c\n");
