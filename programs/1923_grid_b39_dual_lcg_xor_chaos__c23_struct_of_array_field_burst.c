/*
 * LowBit -- 1923_grid_b39_dual_lcg_xor_chaos__c23_struct_of_array_field_burst.c
 * Branch: dual_lcg_xor_chaos | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1923_grid_b39_dual_lcg_xor_chaos__c23_struct_of_array_field_burst.c\n");
