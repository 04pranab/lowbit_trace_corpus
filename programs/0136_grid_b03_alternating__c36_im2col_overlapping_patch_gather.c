/*
 * LowBit -- 0136_grid_b03_alternating__c36_im2col_overlapping_patch_gather.c
 * Branch: alternating | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0136_grid_b03_alternating__c36_im2col_overlapping_patch_gather.c\n");
