/*
 * LowBit -- 0271_grid_b06_pseudo_random_50__c21_pyramid_multiresolution_stride.c
 * Branch: pseudo_random_50 | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0271_grid_b06_pseudo_random_50__c21_pyramid_multiresolution_stride.c\n");
