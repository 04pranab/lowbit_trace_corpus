/*
 * LowBit -- 0337_grid_b07_nested_dependent__c37_double_buffer_epoch_alternation.c
 * Branch: nested_dependent | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0337_grid_b07_nested_dependent__c37_double_buffer_epoch_alternation.c\n");
