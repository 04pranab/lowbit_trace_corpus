/*
 * LowBit -- 2449_grid_b49_interleaved_two_pattern_multiplex__c49_binary_heap_parent_child.c
 * Branch: interleaved_two_pattern_multiplex | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=2449_grid_b49_interleaved_two_pattern_multiplex__c49_binary_heap_parent_child.c\n");
