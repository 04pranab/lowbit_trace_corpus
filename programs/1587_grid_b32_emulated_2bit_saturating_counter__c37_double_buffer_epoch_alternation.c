/*
 * LowBit -- 1587_grid_b32_emulated_2bit_saturating_counter__c37_double_buffer_epoch_alternation.c
 * Branch: emulated_2bit_saturating_counter | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1587_grid_b32_emulated_2bit_saturating_counter__c37_double_buffer_epoch_alternation.c\n");
