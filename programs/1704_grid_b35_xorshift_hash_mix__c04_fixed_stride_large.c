/*
 * LowBit -- 1704_grid_b35_xorshift_hash_mix__c04_fixed_stride_large.c
 * Branch: xorshift_hash_mix | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1704_grid_b35_xorshift_hash_mix__c04_fixed_stride_large.c\n");
