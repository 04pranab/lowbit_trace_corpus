/*
 * LowBit -- 2540_base_branch_b40_collatz_value_transform.c
 * Branch: collatz_value_transform | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=2540_base_branch_b40_collatz_value_transform.c\n");
