/*
 * LowBit -- 0517_grid_b11_value_dependent_threshold__c17_zipf_like_hot_buckets.c
 * Branch: value_dependent_threshold | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0517_grid_b11_value_dependent_threshold__c17_zipf_like_hot_buckets.c\n");
