/*
 * LowBit -- 1531_grid_b31_prime_period13__c31_fibonacci_stride.c
 * Branch: prime_period13 | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=1531_grid_b31_prime_period13__c31_fibonacci_stride.c\n");
