/*
 * LowBit -- 0389_grid_b08_switch_multiway__c39_bounded_random_walk.c
 * Branch: switch_multiway | Cache: bounded_random_walk
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0389_grid_b08_switch_multiway__c39_bounded_random_walk.c\n");
