/*
 * LowBit -- 2356_grid_b48_variable_step_signed_countdown__c06_random_full_working_set.c
 * Branch: variable_step_signed_countdown | Cache: random_full_working_set
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2356_grid_b48_variable_step_signed_countdown__c06_random_full_working_set.c\n");
