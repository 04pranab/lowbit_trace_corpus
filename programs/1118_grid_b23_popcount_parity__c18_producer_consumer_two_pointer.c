/*
 * LowBit -- 1118_grid_b23_popcount_parity__c18_producer_consumer_two_pointer.c
 * Branch: popcount_parity | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1118_grid_b23_popcount_parity__c18_producer_consumer_two_pointer.c\n");
