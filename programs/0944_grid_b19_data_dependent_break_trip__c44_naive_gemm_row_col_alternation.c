/*
 * LowBit -- 0944_grid_b19_data_dependent_break_trip__c44_naive_gemm_row_col_alternation.c
 * Branch: data_dependent_break_trip | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0944_grid_b19_data_dependent_break_trip__c44_naive_gemm_row_col_alternation.c\n");
