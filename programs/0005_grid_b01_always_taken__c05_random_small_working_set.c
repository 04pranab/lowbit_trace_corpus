/*
 * LowBit -- 0005_grid_b01_always_taken__c05_random_small_working_set.c
 * Branch: always_taken | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0005_grid_b01_always_taken__c05_random_small_working_set.c\n");
