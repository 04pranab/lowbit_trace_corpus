/*
 * LowBit -- 1253_grid_b26_warmup_then_steady__c03_fixed_stride_small.c
 * Branch: warmup_then_steady | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1253_grid_b26_warmup_then_steady__c03_fixed_stride_small.c\n");
