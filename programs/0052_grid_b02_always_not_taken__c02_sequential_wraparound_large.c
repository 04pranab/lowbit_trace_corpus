/*
 * LowBit -- 0052_grid_b02_always_not_taken__c02_sequential_wraparound_large.c
 * Branch: always_not_taken | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0052_grid_b02_always_not_taken__c02_sequential_wraparound_large.c\n");
