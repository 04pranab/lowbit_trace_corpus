/*
 * LowBit -- 1410_grid_b29_bursty_streak_pattern__c10_pointer_chase_linked_list.c
 * Branch: bursty_streak_pattern | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1410_grid_b29_bursty_streak_pattern__c10_pointer_chase_linked_list.c\n");
