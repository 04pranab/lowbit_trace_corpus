/*
 * LowBit -- 0804_grid_b17_correlated_two_branch_xor__c04_fixed_stride_large.c
 * Branch: correlated_two_branch_xor | Cache: fixed_stride_large
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0804_grid_b17_correlated_two_branch_xor__c04_fixed_stride_large.c\n");
