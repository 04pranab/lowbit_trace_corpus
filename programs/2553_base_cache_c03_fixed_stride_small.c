/*
 * LowBit -- 2553_base_cache_c03_fixed_stride_small.c
 * Branch: synthetic_always_taken | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=2553_base_cache_c03_fixed_stride_small.c\n");
