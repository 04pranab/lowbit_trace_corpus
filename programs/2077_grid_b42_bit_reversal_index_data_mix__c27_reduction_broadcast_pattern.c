/*
 * LowBit -- 2077_grid_b42_bit_reversal_index_data_mix__c27_reduction_broadcast_pattern.c
 * Branch: bit_reversal_index_data_mix | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2077_grid_b42_bit_reversal_index_data_mix__c27_reduction_broadcast_pattern.c\n");
