/*
 * LowBit -- 0472_grid_b10_correlated_history__c22_tensor_3d_slice_poor_locality.c
 * Branch: correlated_history | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0472_grid_b10_correlated_history__c22_tensor_3d_slice_poor_locality.c\n");
