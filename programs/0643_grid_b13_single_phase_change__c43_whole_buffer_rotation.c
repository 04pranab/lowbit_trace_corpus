/*
 * LowBit -- 0643_grid_b13_single_phase_change__c43_whole_buffer_rotation.c
 * Branch: single_phase_change | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0643_grid_b13_single_phase_change__c43_whole_buffer_rotation.c\n");
