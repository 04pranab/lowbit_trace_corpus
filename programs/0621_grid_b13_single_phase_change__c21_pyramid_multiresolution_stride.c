/*
 * LowBit -- 0621_grid_b13_single_phase_change__c21_pyramid_multiresolution_stride.c
 * Branch: single_phase_change | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0621_grid_b13_single_phase_change__c21_pyramid_multiresolution_stride.c\n");
