/*
 * LowBit -- 1868_grid_b38_decaying_hazard_probability__c18_producer_consumer_two_pointer.c
 * Branch: decaying_hazard_probability | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1868_grid_b38_decaying_hazard_probability__c18_producer_consumer_two_pointer.c\n");
