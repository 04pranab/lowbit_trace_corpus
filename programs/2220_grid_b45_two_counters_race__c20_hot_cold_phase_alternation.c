/*
 * LowBit -- 2220_grid_b45_two_counters_race__c20_hot_cold_phase_alternation.c
 * Branch: two_counters_race | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2220_grid_b45_two_counters_race__c20_hot_cold_phase_alternation.c\n");
