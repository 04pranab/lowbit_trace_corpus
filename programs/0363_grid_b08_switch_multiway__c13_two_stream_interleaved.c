/*
 * LowBit -- 0363_grid_b08_switch_multiway__c13_two_stream_interleaved.c
 * Branch: switch_multiway | Cache: two_stream_interleaved
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0363_grid_b08_switch_multiway__c13_two_stream_interleaved.c\n");
