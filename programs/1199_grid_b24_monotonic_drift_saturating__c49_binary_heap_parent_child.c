/*
 * LowBit -- 1199_grid_b24_monotonic_drift_saturating__c49_binary_heap_parent_child.c
 * Branch: monotonic_drift_saturating | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1199_grid_b24_monotonic_drift_saturating__c49_binary_heap_parent_child.c\n");
