/*
 * LowBit -- 0984_grid_b20_random_threshold_walk__c34_variable_length_burst_reuse.c
 * Branch: random_threshold_walk | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0984_grid_b20_random_threshold_walk__c34_variable_length_burst_reuse.c\n");
