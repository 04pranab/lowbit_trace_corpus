/*
 * LowBit -- 1845_grid_b37_value_driven_unswitch_run__c45_read_hot_write_cold_split.c
 * Branch: value_driven_unswitch_run | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1845_grid_b37_value_driven_unswitch_run__c45_read_hot_write_cold_split.c\n");
