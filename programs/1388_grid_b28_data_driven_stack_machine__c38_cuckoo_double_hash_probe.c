/*
 * LowBit -- 1388_grid_b28_data_driven_stack_machine__c38_cuckoo_double_hash_probe.c
 * Branch: data_driven_stack_machine | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1388_grid_b28_data_driven_stack_machine__c38_cuckoo_double_hash_probe.c\n");
