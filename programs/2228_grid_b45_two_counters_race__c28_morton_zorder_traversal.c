/*
 * LowBit -- 2228_grid_b45_two_counters_race__c28_morton_zorder_traversal.c
 * Branch: two_counters_race | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2228_grid_b45_two_counters_race__c28_morton_zorder_traversal.c\n");
