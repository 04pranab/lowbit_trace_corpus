/*
 * LowBit -- 1760_grid_b36_traffic_light_fsm__c10_pointer_chase_linked_list.c
 * Branch: traffic_light_fsm | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1760_grid_b36_traffic_light_fsm__c10_pointer_chase_linked_list.c\n");
