/*
 * LowBit -- 2135_grid_b43_moving_average_threshold__c35_checkerboard_red_black.c
 * Branch: moving_average_threshold | Cache: checkerboard_red_black
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2135_grid_b43_moving_average_threshold__c35_checkerboard_red_black.c\n");
