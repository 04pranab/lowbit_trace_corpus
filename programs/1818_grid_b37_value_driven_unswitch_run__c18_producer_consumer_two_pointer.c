/*
 * LowBit -- 1818_grid_b37_value_driven_unswitch_run__c18_producer_consumer_two_pointer.c
 * Branch: value_driven_unswitch_run | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1818_grid_b37_value_driven_unswitch_run__c18_producer_consumer_two_pointer.c\n");
