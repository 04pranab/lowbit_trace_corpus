/*
 * LowBit -- 1358_grid_b28_data_driven_stack_machine__c08_matrix_col_major.c
 * Branch: data_driven_stack_machine | Cache: matrix_col_major
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1358_grid_b28_data_driven_stack_machine__c08_matrix_col_major.c\n");
