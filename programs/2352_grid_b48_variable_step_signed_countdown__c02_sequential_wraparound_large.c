/*
 * LowBit -- 2352_grid_b48_variable_step_signed_countdown__c02_sequential_wraparound_large.c
 * Branch: variable_step_signed_countdown | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2352_grid_b48_variable_step_signed_countdown__c02_sequential_wraparound_large.c\n");
