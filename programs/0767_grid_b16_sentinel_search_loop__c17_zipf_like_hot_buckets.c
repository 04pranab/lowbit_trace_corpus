/*
 * LowBit -- 0767_grid_b16_sentinel_search_loop__c17_zipf_like_hot_buckets.c
 * Branch: sentinel_search_loop | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0767_grid_b16_sentinel_search_loop__c17_zipf_like_hot_buckets.c\n");
