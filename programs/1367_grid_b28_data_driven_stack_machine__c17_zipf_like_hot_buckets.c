/*
 * LowBit -- 1367_grid_b28_data_driven_stack_machine__c17_zipf_like_hot_buckets.c
 * Branch: data_driven_stack_machine | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1367_grid_b28_data_driven_stack_machine__c17_zipf_like_hot_buckets.c\n");
