/*
 * LowBit -- 2061_grid_b42_bit_reversal_index_data_mix__c11_sliding_window.c
 * Branch: bit_reversal_index_data_mix | Cache: sliding_window
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2061_grid_b42_bit_reversal_index_data_mix__c11_sliding_window.c\n");
