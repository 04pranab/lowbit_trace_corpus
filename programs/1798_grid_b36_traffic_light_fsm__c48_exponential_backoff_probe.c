/*
 * LowBit -- 1798_grid_b36_traffic_light_fsm__c48_exponential_backoff_probe.c
 * Branch: traffic_light_fsm | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1798_grid_b36_traffic_light_fsm__c48_exponential_backoff_probe.c\n");
