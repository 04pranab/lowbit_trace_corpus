/*
 * LowBit -- 2475_grid_b50_hysteresis_debounce__c25_lru_recency_weighted_reuse.c
 * Branch: hysteresis_debounce | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2475_grid_b50_hysteresis_debounce__c25_lru_recency_weighted_reuse.c\n");
