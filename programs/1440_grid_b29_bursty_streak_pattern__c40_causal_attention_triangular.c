/*
 * LowBit -- 1440_grid_b29_bursty_streak_pattern__c40_causal_attention_triangular.c
 * Branch: bursty_streak_pattern | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1440_grid_b29_bursty_streak_pattern__c40_causal_attention_triangular.c\n");
