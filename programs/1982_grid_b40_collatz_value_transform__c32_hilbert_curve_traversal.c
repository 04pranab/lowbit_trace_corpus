/*
 * LowBit -- 1982_grid_b40_collatz_value_transform__c32_hilbert_curve_traversal.c
 * Branch: collatz_value_transform | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1982_grid_b40_collatz_value_transform__c32_hilbert_curve_traversal.c\n");
