/*
 * LowBit -- 0534_grid_b11_value_dependent_threshold__c34_variable_length_burst_reuse.c
 * Branch: value_dependent_threshold | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0534_grid_b11_value_dependent_threshold__c34_variable_length_burst_reuse.c\n");
