/*
 * LowBit -- 2047_grid_b41_markov_chain_3state__c47_false_sharing_line_cycle.c
 * Branch: markov_chain_3state | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2047_grid_b41_markov_chain_3state__c47_false_sharing_line_cycle.c\n");
