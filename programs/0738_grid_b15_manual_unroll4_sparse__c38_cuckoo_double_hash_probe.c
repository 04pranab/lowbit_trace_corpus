/*
 * LowBit -- 0738_grid_b15_manual_unroll4_sparse__c38_cuckoo_double_hash_probe.c
 * Branch: manual_unroll4_sparse | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0738_grid_b15_manual_unroll4_sparse__c38_cuckoo_double_hash_probe.c\n");
