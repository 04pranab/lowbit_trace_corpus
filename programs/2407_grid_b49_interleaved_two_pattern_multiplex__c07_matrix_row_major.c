/*
 * LowBit -- 2407_grid_b49_interleaved_two_pattern_multiplex__c07_matrix_row_major.c
 * Branch: interleaved_two_pattern_multiplex | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=2407_grid_b49_interleaved_two_pattern_multiplex__c07_matrix_row_major.c\n");
