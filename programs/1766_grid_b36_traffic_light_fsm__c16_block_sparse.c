/*
 * LowBit -- 1766_grid_b36_traffic_light_fsm__c16_block_sparse.c
 * Branch: traffic_light_fsm | Cache: block_sparse
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1766_grid_b36_traffic_light_fsm__c16_block_sparse.c\n");
