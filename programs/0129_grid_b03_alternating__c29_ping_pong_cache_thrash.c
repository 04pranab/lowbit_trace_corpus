/*
 * LowBit -- 0129_grid_b03_alternating__c29_ping_pong_cache_thrash.c
 * Branch: alternating | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0129_grid_b03_alternating__c29_ping_pong_cache_thrash.c\n");
