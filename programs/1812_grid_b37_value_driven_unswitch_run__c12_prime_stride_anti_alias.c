/*
 * LowBit -- 1812_grid_b37_value_driven_unswitch_run__c12_prime_stride_anti_alias.c
 * Branch: value_driven_unswitch_run | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1812_grid_b37_value_driven_unswitch_run__c12_prime_stride_anti_alias.c\n");
