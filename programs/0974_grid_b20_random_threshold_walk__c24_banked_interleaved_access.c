/*
 * LowBit -- 0974_grid_b20_random_threshold_walk__c24_banked_interleaved_access.c
 * Branch: random_threshold_walk | Cache: banked_interleaved_access
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0974_grid_b20_random_threshold_walk__c24_banked_interleaved_access.c\n");
