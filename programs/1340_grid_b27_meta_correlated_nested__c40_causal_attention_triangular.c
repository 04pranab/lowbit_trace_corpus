/*
 * LowBit -- 1340_grid_b27_meta_correlated_nested__c40_causal_attention_triangular.c
 * Branch: meta_correlated_nested | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1340_grid_b27_meta_correlated_nested__c40_causal_attention_triangular.c\n");
