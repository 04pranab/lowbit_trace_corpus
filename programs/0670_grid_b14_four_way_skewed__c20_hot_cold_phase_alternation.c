/*
 * LowBit -- 0670_grid_b14_four_way_skewed__c20_hot_cold_phase_alternation.c
 * Branch: four_way_skewed | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0670_grid_b14_four_way_skewed__c20_hot_cold_phase_alternation.c\n");
