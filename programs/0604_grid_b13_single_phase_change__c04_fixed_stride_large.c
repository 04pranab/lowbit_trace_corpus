/*
 * LowBit -- 0604_grid_b13_single_phase_change__c04_fixed_stride_large.c
 * Branch: single_phase_change | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0604_grid_b13_single_phase_change__c04_fixed_stride_large.c\n");
