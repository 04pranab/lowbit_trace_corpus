/*
 * LowBit -- 1621_grid_b33_uniform_random_block_runs__c21_pyramid_multiresolution_stride.c
 * Branch: uniform_random_block_runs | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1621_grid_b33_uniform_random_block_runs__c21_pyramid_multiresolution_stride.c\n");
