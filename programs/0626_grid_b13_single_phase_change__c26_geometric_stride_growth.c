/*
 * LowBit -- 0626_grid_b13_single_phase_change__c26_geometric_stride_growth.c
 * Branch: single_phase_change | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0626_grid_b13_single_phase_change__c26_geometric_stride_growth.c\n");
