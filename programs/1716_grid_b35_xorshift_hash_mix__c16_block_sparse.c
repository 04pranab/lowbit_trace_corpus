/*
 * LowBit -- 1716_grid_b35_xorshift_hash_mix__c16_block_sparse.c
 * Branch: xorshift_hash_mix | Cache: block_sparse
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1716_grid_b35_xorshift_hash_mix__c16_block_sparse.c\n");
