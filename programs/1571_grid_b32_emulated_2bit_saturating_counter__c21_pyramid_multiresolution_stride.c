/*
 * LowBit -- 1571_grid_b32_emulated_2bit_saturating_counter__c21_pyramid_multiresolution_stride.c
 * Branch: emulated_2bit_saturating_counter | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1571_grid_b32_emulated_2bit_saturating_counter__c21_pyramid_multiresolution_stride.c\n");
