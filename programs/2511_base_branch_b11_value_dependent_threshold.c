/*
 * LowBit -- 2511_base_branch_b11_value_dependent_threshold.c
 * Branch: value_dependent_threshold | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2511_base_branch_b11_value_dependent_threshold.c\n");
