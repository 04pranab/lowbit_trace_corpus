/*
 * LowBit -- 0924_grid_b19_data_dependent_break_trip__c24_banked_interleaved_access.c
 * Branch: data_dependent_break_trip | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0924_grid_b19_data_dependent_break_trip__c24_banked_interleaved_access.c\n");
