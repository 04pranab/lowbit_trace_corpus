/*
 * LowBit -- 1921_grid_b39_dual_lcg_xor_chaos__c21_pyramid_multiresolution_stride.c
 * Branch: dual_lcg_xor_chaos | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1921_grid_b39_dual_lcg_xor_chaos__c21_pyramid_multiresolution_stride.c\n");
