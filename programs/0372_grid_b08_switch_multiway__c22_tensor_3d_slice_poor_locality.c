/*
 * LowBit -- 0372_grid_b08_switch_multiway__c22_tensor_3d_slice_poor_locality.c
 * Branch: switch_multiway | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0372_grid_b08_switch_multiway__c22_tensor_3d_slice_poor_locality.c\n");
