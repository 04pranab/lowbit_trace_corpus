/*
 * LowBit -- 1693_grid_b34_data_driven_countdown__c43_whole_buffer_rotation.c
 * Branch: data_driven_countdown | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1693_grid_b34_data_driven_countdown__c43_whole_buffer_rotation.c\n");
