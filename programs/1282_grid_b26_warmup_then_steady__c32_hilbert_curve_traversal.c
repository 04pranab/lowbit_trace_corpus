/*
 * LowBit -- 1282_grid_b26_warmup_then_steady__c32_hilbert_curve_traversal.c
 * Branch: warmup_then_steady | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1282_grid_b26_warmup_then_steady__c32_hilbert_curve_traversal.c\n");
