/*
 * LowBit -- 0827_grid_b17_correlated_two_branch_xor__c27_reduction_broadcast_pattern.c
 * Branch: correlated_two_branch_xor | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0827_grid_b17_correlated_two_branch_xor__c27_reduction_broadcast_pattern.c\n");
