/*
 * LowBit -- 1266_grid_b26_warmup_then_steady__c16_block_sparse.c
 * Branch: warmup_then_steady | Cache: block_sparse
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1266_grid_b26_warmup_then_steady__c16_block_sparse.c\n");
