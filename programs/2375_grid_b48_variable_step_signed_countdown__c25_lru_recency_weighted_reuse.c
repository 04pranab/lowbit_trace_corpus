/*
 * LowBit -- 2375_grid_b48_variable_step_signed_countdown__c25_lru_recency_weighted_reuse.c
 * Branch: variable_step_signed_countdown | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2375_grid_b48_variable_step_signed_countdown__c25_lru_recency_weighted_reuse.c\n");
