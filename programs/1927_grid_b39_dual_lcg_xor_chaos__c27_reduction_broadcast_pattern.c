/*
 * LowBit -- 1927_grid_b39_dual_lcg_xor_chaos__c27_reduction_broadcast_pattern.c
 * Branch: dual_lcg_xor_chaos | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1927_grid_b39_dual_lcg_xor_chaos__c27_reduction_broadcast_pattern.c\n");
