/*
 * LowBit -- 1556_grid_b32_emulated_2bit_saturating_counter__c06_random_full_working_set.c
 * Branch: emulated_2bit_saturating_counter | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1556_grid_b32_emulated_2bit_saturating_counter__c06_random_full_working_set.c\n");
