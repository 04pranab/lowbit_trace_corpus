/*
 * LowBit -- 1179_grid_b24_monotonic_drift_saturating__c29_ping_pong_cache_thrash.c
 * Branch: monotonic_drift_saturating | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1179_grid_b24_monotonic_drift_saturating__c29_ping_pong_cache_thrash.c\n");
