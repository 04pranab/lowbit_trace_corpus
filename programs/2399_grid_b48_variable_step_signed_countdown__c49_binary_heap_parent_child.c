/*
 * LowBit -- 2399_grid_b48_variable_step_signed_countdown__c49_binary_heap_parent_child.c
 * Branch: variable_step_signed_countdown | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2399_grid_b48_variable_step_signed_countdown__c49_binary_heap_parent_child.c\n");
