/*
 * LowBit -- 0926_grid_b19_data_dependent_break_trip__c26_geometric_stride_growth.c
 * Branch: data_dependent_break_trip | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0926_grid_b19_data_dependent_break_trip__c26_geometric_stride_growth.c\n");
