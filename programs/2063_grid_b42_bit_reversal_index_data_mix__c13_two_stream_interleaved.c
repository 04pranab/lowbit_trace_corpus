/*
 * LowBit -- 2063_grid_b42_bit_reversal_index_data_mix__c13_two_stream_interleaved.c
 * Branch: bit_reversal_index_data_mix | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2063_grid_b42_bit_reversal_index_data_mix__c13_two_stream_interleaved.c\n");
