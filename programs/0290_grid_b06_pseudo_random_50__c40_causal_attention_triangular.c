/*
 * LowBit -- 0290_grid_b06_pseudo_random_50__c40_causal_attention_triangular.c
 * Branch: pseudo_random_50 | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0290_grid_b06_pseudo_random_50__c40_causal_attention_triangular.c\n");
