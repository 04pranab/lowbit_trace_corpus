/*
 * LowBit -- 0777_grid_b16_sentinel_search_loop__c27_reduction_broadcast_pattern.c
 * Branch: sentinel_search_loop | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0777_grid_b16_sentinel_search_loop__c27_reduction_broadcast_pattern.c\n");
