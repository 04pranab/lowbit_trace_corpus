/*
 * LowBit -- 1808_grid_b37_value_driven_unswitch_run__c08_matrix_col_major.c
 * Branch: value_driven_unswitch_run | Cache: matrix_col_major
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1808_grid_b37_value_driven_unswitch_run__c08_matrix_col_major.c\n");
