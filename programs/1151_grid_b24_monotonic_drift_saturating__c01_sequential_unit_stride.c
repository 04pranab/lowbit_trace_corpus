/*
 * LowBit -- 1151_grid_b24_monotonic_drift_saturating__c01_sequential_unit_stride.c
 * Branch: monotonic_drift_saturating | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1151_grid_b24_monotonic_drift_saturating__c01_sequential_unit_stride.c\n");
