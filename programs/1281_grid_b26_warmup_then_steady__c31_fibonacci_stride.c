/*
 * LowBit -- 1281_grid_b26_warmup_then_steady__c31_fibonacci_stride.c
 * Branch: warmup_then_steady | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1281_grid_b26_warmup_then_steady__c31_fibonacci_stride.c\n");
