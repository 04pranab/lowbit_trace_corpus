/*
 * LowBit -- 2125_grid_b43_moving_average_threshold__c25_lru_recency_weighted_reuse.c
 * Branch: moving_average_threshold | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2125_grid_b43_moving_average_threshold__c25_lru_recency_weighted_reuse.c\n");
