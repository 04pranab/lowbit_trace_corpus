/*
 * LowBit -- 2110_grid_b43_moving_average_threshold__c10_pointer_chase_linked_list.c
 * Branch: moving_average_threshold | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2110_grid_b43_moving_average_threshold__c10_pointer_chase_linked_list.c\n");
