/*
 * LowBit -- 0969_grid_b20_random_threshold_walk__c19_matrix_diagonal_wavefront.c
 * Branch: random_threshold_walk | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0969_grid_b20_random_threshold_walk__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=random_threshold_walk\n");
