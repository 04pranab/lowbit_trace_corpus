/*
 * LowBit -- 0393_grid_b08_switch_multiway__c43_whole_buffer_rotation.c
 * Branch: switch_multiway | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0393_grid_b08_switch_multiway__c43_whole_buffer_rotation.c\n");
