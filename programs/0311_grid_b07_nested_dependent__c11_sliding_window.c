/*
 * LowBit -- 0311_grid_b07_nested_dependent__c11_sliding_window.c
 * Branch: nested_dependent | Cache: sliding_window
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0311_grid_b07_nested_dependent__c11_sliding_window.c\n");
