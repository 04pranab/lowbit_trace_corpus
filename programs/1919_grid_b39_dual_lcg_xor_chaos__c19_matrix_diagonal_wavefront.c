/*
 * LowBit -- 1919_grid_b39_dual_lcg_xor_chaos__c19_matrix_diagonal_wavefront.c
 * Branch: dual_lcg_xor_chaos | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static uint32_t s1_39 = 0x11111111u, s2_39 = 0x22222222u;
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1919_grid_b39_dual_lcg_xor_chaos__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=dual_lcg_xor_chaos\n");
