/*
 * LowBit -- 2512_base_branch_b12_doubling_run_lengths.c
 * Branch: doubling_run_lengths | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=2512_base_branch_b12_doubling_run_lengths.c\n");
    printf("branch_pattern=doubling_run_lengths\n");
    printf("cache_pattern=synthetic_sequential_scan\n");
    printf("predictor_stress_type=phase-changing/non-stationary\n");
    printf("expected_dominant_miss_type=n/a (synthetic baseline)\n");
