/*
 * LowBit -- 0705_grid_b15_manual_unroll4_sparse__c05_random_small_working_set.c
 * Branch: manual_unroll4_sparse | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0705_grid_b15_manual_unroll4_sparse__c05_random_small_working_set.c\n");
