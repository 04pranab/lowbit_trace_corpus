/*
 * LowBit -- 0647_grid_b13_single_phase_change__c47_false_sharing_line_cycle.c
 * Branch: single_phase_change | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0647_grid_b13_single_phase_change__c47_false_sharing_line_cycle.c\n");
