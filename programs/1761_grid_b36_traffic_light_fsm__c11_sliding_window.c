/*
 * LowBit -- 1761_grid_b36_traffic_light_fsm__c11_sliding_window.c
 * Branch: traffic_light_fsm | Cache: sliding_window
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1761_grid_b36_traffic_light_fsm__c11_sliding_window.c\n");
