/*
 * LowBit -- 1294_grid_b26_warmup_then_steady__c44_naive_gemm_row_col_alternation.c
 * Branch: warmup_then_steady | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1294_grid_b26_warmup_then_steady__c44_naive_gemm_row_col_alternation.c\n");
