/*
 * LowBit -- 0457_grid_b10_correlated_history__c07_matrix_row_major.c
 * Branch: correlated_history | Cache: matrix_row_major
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0457_grid_b10_correlated_history__c07_matrix_row_major.c\n");
