/*
 * LowBit -- 0125_grid_b03_alternating__c25_lru_recency_weighted_reuse.c
 * Branch: alternating | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0125_grid_b03_alternating__c25_lru_recency_weighted_reuse.c\n");
