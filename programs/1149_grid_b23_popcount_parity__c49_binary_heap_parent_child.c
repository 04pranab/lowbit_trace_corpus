/*
 * LowBit -- 1149_grid_b23_popcount_parity__c49_binary_heap_parent_child.c
 * Branch: popcount_parity | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1149_grid_b23_popcount_parity__c49_binary_heap_parent_child.c\n");
