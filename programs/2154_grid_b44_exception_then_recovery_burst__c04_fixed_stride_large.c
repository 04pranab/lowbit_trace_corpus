/*
 * LowBit -- 2154_grid_b44_exception_then_recovery_burst__c04_fixed_stride_large.c
 * Branch: exception_then_recovery_burst | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2154_grid_b44_exception_then_recovery_burst__c04_fixed_stride_large.c\n");
