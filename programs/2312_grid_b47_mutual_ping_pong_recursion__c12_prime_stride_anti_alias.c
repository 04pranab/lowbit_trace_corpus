/*
 * LowBit -- 2312_grid_b47_mutual_ping_pong_recursion__c12_prime_stride_anti_alias.c
 * Branch: mutual_ping_pong_recursion | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2312_grid_b47_mutual_ping_pong_recursion__c12_prime_stride_anti_alias.c\n");
