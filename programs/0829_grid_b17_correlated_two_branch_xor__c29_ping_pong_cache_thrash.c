/*
 * LowBit -- 0829_grid_b17_correlated_two_branch_xor__c29_ping_pong_cache_thrash.c
 * Branch: correlated_two_branch_xor | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0829_grid_b17_correlated_two_branch_xor__c29_ping_pong_cache_thrash.c\n");
