/*
 * LowBit -- 1679_grid_b34_data_driven_countdown__c29_ping_pong_cache_thrash.c
 * Branch: data_driven_countdown | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1679_grid_b34_data_driven_countdown__c29_ping_pong_cache_thrash.c\n");
