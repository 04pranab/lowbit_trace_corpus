/*
 * LowBit -- 0630_grid_b13_single_phase_change__c30_gather_scatter_indirect_table.c
 * Branch: single_phase_change | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0630_grid_b13_single_phase_change__c30_gather_scatter_indirect_table.c\n");
