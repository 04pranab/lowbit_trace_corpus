/*
 * LowBit -- 0936_grid_b19_data_dependent_break_trip__c36_im2col_overlapping_patch_gather.c
 * Branch: data_dependent_break_trip | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0936_grid_b19_data_dependent_break_trip__c36_im2col_overlapping_patch_gather.c\n");
