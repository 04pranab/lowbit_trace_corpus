/*
 * LowBit -- 0456_grid_b10_correlated_history__c06_random_full_working_set.c
 * Branch: correlated_history | Cache: random_full_working_set
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0456_grid_b10_correlated_history__c06_random_full_working_set.c\n");
