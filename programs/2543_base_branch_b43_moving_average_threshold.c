/*
 * LowBit -- 2543_base_branch_b43_moving_average_threshold.c
 * Branch: moving_average_threshold | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2543_base_branch_b43_moving_average_threshold.c\n");
