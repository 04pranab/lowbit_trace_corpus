/*
 * LowBit -- 0082_grid_b02_always_not_taken__c32_hilbert_curve_traversal.c
 * Branch: always_not_taken | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0082_grid_b02_always_not_taken__c32_hilbert_curve_traversal.c\n");
