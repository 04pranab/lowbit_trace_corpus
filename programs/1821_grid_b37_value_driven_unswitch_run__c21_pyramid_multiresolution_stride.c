/*
 * LowBit -- 1821_grid_b37_value_driven_unswitch_run__c21_pyramid_multiresolution_stride.c
 * Branch: value_driven_unswitch_run | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1821_grid_b37_value_driven_unswitch_run__c21_pyramid_multiresolution_stride.c\n");
