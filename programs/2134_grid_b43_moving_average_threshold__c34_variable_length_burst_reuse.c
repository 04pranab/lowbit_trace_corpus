/*
 * LowBit -- 2134_grid_b43_moving_average_threshold__c34_variable_length_burst_reuse.c
 * Branch: moving_average_threshold | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2134_grid_b43_moving_average_threshold__c34_variable_length_burst_reuse.c\n");
