/*
 * LowBit -- 0122_grid_b03_alternating__c22_tensor_3d_slice_poor_locality.c
 * Branch: alternating | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0122_grid_b03_alternating__c22_tensor_3d_slice_poor_locality.c\n");
