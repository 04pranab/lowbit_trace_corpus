/*
 * LowBit -- 0195_grid_b04_periodic3__c45_read_hot_write_cold_split.c
 * Branch: periodic3 | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0195_grid_b04_periodic3__c45_read_hot_write_cold_split.c\n");
