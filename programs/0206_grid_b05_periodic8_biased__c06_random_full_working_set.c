/*
 * LowBit -- 0206_grid_b05_periodic8_biased__c06_random_full_working_set.c
 * Branch: periodic8_biased | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0206_grid_b05_periodic8_biased__c06_random_full_working_set.c\n");
