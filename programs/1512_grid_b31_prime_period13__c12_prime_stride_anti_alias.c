/*
 * LowBit -- 1512_grid_b31_prime_period13__c12_prime_stride_anti_alias.c
 * Branch: prime_period13 | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=1512_grid_b31_prime_period13__c12_prime_stride_anti_alias.c\n");
