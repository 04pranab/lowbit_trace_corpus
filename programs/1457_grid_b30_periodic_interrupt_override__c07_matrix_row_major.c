/*
 * LowBit -- 1457_grid_b30_periodic_interrupt_override__c07_matrix_row_major.c
 * Branch: periodic_interrupt_override | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=1457_grid_b30_periodic_interrupt_override__c07_matrix_row_major.c\n");
