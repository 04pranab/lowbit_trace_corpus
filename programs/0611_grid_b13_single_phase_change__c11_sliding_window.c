/*
 * LowBit -- 0611_grid_b13_single_phase_change__c11_sliding_window.c
 * Branch: single_phase_change | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0611_grid_b13_single_phase_change__c11_sliding_window.c\n");
