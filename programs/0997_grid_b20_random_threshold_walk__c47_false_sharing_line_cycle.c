/*
 * LowBit -- 0997_grid_b20_random_threshold_walk__c47_false_sharing_line_cycle.c
 * Branch: random_threshold_walk | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0997_grid_b20_random_threshold_walk__c47_false_sharing_line_cycle.c\n");
