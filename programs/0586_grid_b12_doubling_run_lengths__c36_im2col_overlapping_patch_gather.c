/*
 * LowBit -- 0586_grid_b12_doubling_run_lengths__c36_im2col_overlapping_patch_gather.c
 * Branch: doubling_run_lengths | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0586_grid_b12_doubling_run_lengths__c36_im2col_overlapping_patch_gather.c\n");
