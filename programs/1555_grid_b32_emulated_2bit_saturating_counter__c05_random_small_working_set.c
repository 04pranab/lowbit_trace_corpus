/*
 * LowBit -- 1555_grid_b32_emulated_2bit_saturating_counter__c05_random_small_working_set.c
 * Branch: emulated_2bit_saturating_counter | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1555_grid_b32_emulated_2bit_saturating_counter__c05_random_small_working_set.c\n");
