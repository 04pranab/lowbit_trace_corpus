/*
 * LowBit -- 0872_grid_b18_indirect_fn_dispatch__c22_tensor_3d_slice_poor_locality.c
 * Branch: indirect_fn_dispatch | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0872_grid_b18_indirect_fn_dispatch__c22_tensor_3d_slice_poor_locality.c\n");
