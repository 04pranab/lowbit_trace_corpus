/*
 * LowBit -- 0285_grid_b06_pseudo_random_50__c35_checkerboard_red_black.c
 * Branch: pseudo_random_50 | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0285_grid_b06_pseudo_random_50__c35_checkerboard_red_black.c\n");
