/*
 * LowBit -- 1383_grid_b28_data_driven_stack_machine__c33_cache_set_conflict_stress.c
 * Branch: data_driven_stack_machine | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1383_grid_b28_data_driven_stack_machine__c33_cache_set_conflict_stress.c\n");
