/*
 * LowBit -- 0776_grid_b16_sentinel_search_loop__c26_geometric_stride_growth.c
 * Branch: sentinel_search_loop | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0776_grid_b16_sentinel_search_loop__c26_geometric_stride_growth.c\n");
