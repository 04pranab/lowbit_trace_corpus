/*
 * LowBit -- 2026_grid_b41_markov_chain_3state__c26_geometric_stride_growth.c
 * Branch: markov_chain_3state | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2026_grid_b41_markov_chain_3state__c26_geometric_stride_growth.c\n");
