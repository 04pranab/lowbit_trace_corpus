/*
 * LowBit -- 0264_grid_b06_pseudo_random_50__c14_temporal_burst_reuse.c
 * Branch: pseudo_random_50 | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0264_grid_b06_pseudo_random_50__c14_temporal_burst_reuse.c\n");
