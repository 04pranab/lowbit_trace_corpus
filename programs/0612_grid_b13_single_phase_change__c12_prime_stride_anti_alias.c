/*
 * LowBit -- 0612_grid_b13_single_phase_change__c12_prime_stride_anti_alias.c
 * Branch: single_phase_change | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0612_grid_b13_single_phase_change__c12_prime_stride_anti_alias.c\n");
