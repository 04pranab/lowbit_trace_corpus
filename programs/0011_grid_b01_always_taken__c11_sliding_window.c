/*
 * LowBit -- 0011_grid_b01_always_taken__c11_sliding_window.c
 * Branch: always_taken | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0011_grid_b01_always_taken__c11_sliding_window.c\n");
