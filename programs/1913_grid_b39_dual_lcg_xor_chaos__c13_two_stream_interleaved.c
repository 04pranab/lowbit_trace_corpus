/*
 * LowBit -- 1913_grid_b39_dual_lcg_xor_chaos__c13_two_stream_interleaved.c
 * Branch: dual_lcg_xor_chaos | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1913_grid_b39_dual_lcg_xor_chaos__c13_two_stream_interleaved.c\n");
