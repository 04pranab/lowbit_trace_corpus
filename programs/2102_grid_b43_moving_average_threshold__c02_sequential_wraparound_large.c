/*
 * LowBit -- 2102_grid_b43_moving_average_threshold__c02_sequential_wraparound_large.c
 * Branch: moving_average_threshold | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2102_grid_b43_moving_average_threshold__c02_sequential_wraparound_large.c\n");
