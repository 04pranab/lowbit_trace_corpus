/*
 * LowBit -- 0330_grid_b07_nested_dependent__c30_gather_scatter_indirect_table.c
 * Branch: nested_dependent | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0330_grid_b07_nested_dependent__c30_gather_scatter_indirect_table.c\n");
