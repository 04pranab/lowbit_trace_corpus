/*
 * LowBit -- 0317_grid_b07_nested_dependent__c17_zipf_like_hot_buckets.c
 * Branch: nested_dependent | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0317_grid_b07_nested_dependent__c17_zipf_like_hot_buckets.c\n");
