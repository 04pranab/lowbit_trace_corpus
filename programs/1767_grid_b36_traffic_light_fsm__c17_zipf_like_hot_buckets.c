/*
 * LowBit -- 1767_grid_b36_traffic_light_fsm__c17_zipf_like_hot_buckets.c
 * Branch: traffic_light_fsm | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1767_grid_b36_traffic_light_fsm__c17_zipf_like_hot_buckets.c\n");
