/*
 * LowBit -- 2020_grid_b41_markov_chain_3state__c20_hot_cold_phase_alternation.c
 * Branch: markov_chain_3state | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2020_grid_b41_markov_chain_3state__c20_hot_cold_phase_alternation.c\n");
