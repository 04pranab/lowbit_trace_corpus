/*
 * LowBit -- 1947_grid_b39_dual_lcg_xor_chaos__c47_false_sharing_line_cycle.c
 * Branch: dual_lcg_xor_chaos | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1947_grid_b39_dual_lcg_xor_chaos__c47_false_sharing_line_cycle.c\n");
