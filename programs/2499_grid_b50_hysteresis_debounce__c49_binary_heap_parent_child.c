/*
 * LowBit -- 2499_grid_b50_hysteresis_debounce__c49_binary_heap_parent_child.c
 * Branch: hysteresis_debounce | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2499_grid_b50_hysteresis_debounce__c49_binary_heap_parent_child.c\n");
