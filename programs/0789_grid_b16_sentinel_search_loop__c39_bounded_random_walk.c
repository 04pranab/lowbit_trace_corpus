/*
 * LowBit -- 0789_grid_b16_sentinel_search_loop__c39_bounded_random_walk.c
 * Branch: sentinel_search_loop | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0789_grid_b16_sentinel_search_loop__c39_bounded_random_walk.c\n");
