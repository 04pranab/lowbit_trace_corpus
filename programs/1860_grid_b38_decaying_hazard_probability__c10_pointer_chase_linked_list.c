/*
 * LowBit -- 1860_grid_b38_decaying_hazard_probability__c10_pointer_chase_linked_list.c
 * Branch: decaying_hazard_probability | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1860_grid_b38_decaying_hazard_probability__c10_pointer_chase_linked_list.c\n");
