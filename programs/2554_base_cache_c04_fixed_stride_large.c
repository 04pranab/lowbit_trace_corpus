/*
 * LowBit -- 2554_base_cache_c04_fixed_stride_large.c
 * Branch: synthetic_always_taken | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=2554_base_cache_c04_fixed_stride_large.c\n");
