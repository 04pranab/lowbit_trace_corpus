/*
 * LowBit -- 0710_grid_b15_manual_unroll4_sparse__c10_pointer_chase_linked_list.c
 * Branch: manual_unroll4_sparse | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0710_grid_b15_manual_unroll4_sparse__c10_pointer_chase_linked_list.c\n");
