/*
 * LowBit -- 0007_grid_b01_always_taken__c07_matrix_row_major.c
 * Branch: always_taken | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0007_grid_b01_always_taken__c07_matrix_row_major.c\n");
