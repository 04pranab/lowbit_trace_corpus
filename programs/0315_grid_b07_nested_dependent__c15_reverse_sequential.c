/*
 * LowBit -- 0315_grid_b07_nested_dependent__c15_reverse_sequential.c
 * Branch: nested_dependent | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0315_grid_b07_nested_dependent__c15_reverse_sequential.c\n");
