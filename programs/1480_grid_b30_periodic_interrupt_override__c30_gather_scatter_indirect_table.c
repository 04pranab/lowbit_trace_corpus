/*
 * LowBit -- 1480_grid_b30_periodic_interrupt_override__c30_gather_scatter_indirect_table.c
 * Branch: periodic_interrupt_override | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=1480_grid_b30_periodic_interrupt_override__c30_gather_scatter_indirect_table.c\n");
