/*
 * LowBit -- 1121_grid_b23_popcount_parity__c21_pyramid_multiresolution_stride.c
 * Branch: popcount_parity | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1121_grid_b23_popcount_parity__c21_pyramid_multiresolution_stride.c\n");
