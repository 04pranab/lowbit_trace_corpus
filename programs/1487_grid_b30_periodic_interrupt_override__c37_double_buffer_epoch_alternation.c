/*
 * LowBit -- 1487_grid_b30_periodic_interrupt_override__c37_double_buffer_epoch_alternation.c
 * Branch: periodic_interrupt_override | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=1487_grid_b30_periodic_interrupt_override__c37_double_buffer_epoch_alternation.c\n");
