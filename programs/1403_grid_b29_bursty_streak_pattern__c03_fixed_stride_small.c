/*
 * LowBit -- 1403_grid_b29_bursty_streak_pattern__c03_fixed_stride_small.c
 * Branch: bursty_streak_pattern | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1403_grid_b29_bursty_streak_pattern__c03_fixed_stride_small.c\n");
