/*
 * LowBit -- 2597_base_cache_c47_false_sharing_line_cycle.c
 * Branch: synthetic_always_taken | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=2597_base_cache_c47_false_sharing_line_cycle.c\n");
