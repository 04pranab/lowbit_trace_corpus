/*
 * LowBit -- 0414_grid_b09_recursive_calls__c14_temporal_burst_reuse.c
 * Branch: recursive_calls | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0414_grid_b09_recursive_calls__c14_temporal_burst_reuse.c\n");
