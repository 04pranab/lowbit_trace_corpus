/*
 * LowBit -- 1588_grid_b32_emulated_2bit_saturating_counter__c38_cuckoo_double_hash_probe.c
 * Branch: emulated_2bit_saturating_counter | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1588_grid_b32_emulated_2bit_saturating_counter__c38_cuckoo_double_hash_probe.c\n");
