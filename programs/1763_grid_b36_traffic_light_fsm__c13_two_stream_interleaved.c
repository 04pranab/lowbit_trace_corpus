/*
 * LowBit -- 1763_grid_b36_traffic_light_fsm__c13_two_stream_interleaved.c
 * Branch: traffic_light_fsm | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1763_grid_b36_traffic_light_fsm__c13_two_stream_interleaved.c\n");
