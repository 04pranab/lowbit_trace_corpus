/*
 * LowBit -- 0676_grid_b14_four_way_skewed__c26_geometric_stride_growth.c
 * Branch: four_way_skewed | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0676_grid_b14_four_way_skewed__c26_geometric_stride_growth.c\n");
