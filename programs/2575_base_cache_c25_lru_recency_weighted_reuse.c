/*
 * LowBit -- 2575_base_cache_c25_lru_recency_weighted_reuse.c
 * Branch: synthetic_always_taken | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=2575_base_cache_c25_lru_recency_weighted_reuse.c\n");
