/*
 * LowBit -- 0601_grid_b13_single_phase_change__c01_sequential_unit_stride.c
 * Branch: single_phase_change | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0601_grid_b13_single_phase_change__c01_sequential_unit_stride.c\n");
