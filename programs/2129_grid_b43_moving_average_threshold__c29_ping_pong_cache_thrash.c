/*
 * LowBit -- 2129_grid_b43_moving_average_threshold__c29_ping_pong_cache_thrash.c
 * Branch: moving_average_threshold | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2129_grid_b43_moving_average_threshold__c29_ping_pong_cache_thrash.c\n");
