/*
 * LowBit -- 1721_grid_b35_xorshift_hash_mix__c21_pyramid_multiresolution_stride.c
 * Branch: xorshift_hash_mix | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1721_grid_b35_xorshift_hash_mix__c21_pyramid_multiresolution_stride.c\n");
