/*
 * LowBit -- 1058_grid_b22_drifting_threshold_periodic_reset__c08_matrix_col_major.c
 * Branch: drifting_threshold_periodic_reset | Cache: matrix_col_major
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1058_grid_b22_drifting_threshold_periodic_reset__c08_matrix_col_major.c\n");
