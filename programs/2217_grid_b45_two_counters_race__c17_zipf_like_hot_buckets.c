/*
 * LowBit -- 2217_grid_b45_two_counters_race__c17_zipf_like_hot_buckets.c
 * Branch: two_counters_race | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2217_grid_b45_two_counters_race__c17_zipf_like_hot_buckets.c\n");
