/*
 * LowBit -- 1881_grid_b38_decaying_hazard_probability__c31_fibonacci_stride.c
 * Branch: decaying_hazard_probability | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1881_grid_b38_decaying_hazard_probability__c31_fibonacci_stride.c\n");
