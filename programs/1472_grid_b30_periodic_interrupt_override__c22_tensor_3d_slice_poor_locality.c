/*
 * LowBit -- 1472_grid_b30_periodic_interrupt_override__c22_tensor_3d_slice_poor_locality.c
 * Branch: periodic_interrupt_override | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=1472_grid_b30_periodic_interrupt_override__c22_tensor_3d_slice_poor_locality.c\n");
