/*
 * LowBit -- 2160_grid_b44_exception_then_recovery_burst__c10_pointer_chase_linked_list.c
 * Branch: exception_then_recovery_burst | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2160_grid_b44_exception_then_recovery_burst__c10_pointer_chase_linked_list.c\n");
