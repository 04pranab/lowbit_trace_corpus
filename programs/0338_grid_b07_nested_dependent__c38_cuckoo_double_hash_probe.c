/*
 * LowBit -- 0338_grid_b07_nested_dependent__c38_cuckoo_double_hash_probe.c
 * Branch: nested_dependent | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0338_grid_b07_nested_dependent__c38_cuckoo_double_hash_probe.c\n");
