/*
 * LowBit -- 2121_grid_b43_moving_average_threshold__c21_pyramid_multiresolution_stride.c
 * Branch: moving_average_threshold | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2121_grid_b43_moving_average_threshold__c21_pyramid_multiresolution_stride.c\n");
