/*
 * LowBit -- 1610_grid_b33_uniform_random_block_runs__c10_pointer_chase_linked_list.c
 * Branch: uniform_random_block_runs | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1610_grid_b33_uniform_random_block_runs__c10_pointer_chase_linked_list.c\n");
