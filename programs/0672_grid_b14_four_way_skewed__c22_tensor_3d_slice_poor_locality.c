/*
 * LowBit -- 0672_grid_b14_four_way_skewed__c22_tensor_3d_slice_poor_locality.c
 * Branch: four_way_skewed | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0672_grid_b14_four_way_skewed__c22_tensor_3d_slice_poor_locality.c\n");
