/*
 * LowBit -- 1999_grid_b40_collatz_value_transform__c49_binary_heap_parent_child.c
 * Branch: collatz_value_transform | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1999_grid_b40_collatz_value_transform__c49_binary_heap_parent_child.c\n");
