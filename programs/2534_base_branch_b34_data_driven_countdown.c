/*
 * LowBit -- 2534_base_branch_b34_data_driven_countdown.c
 * Branch: data_driven_countdown | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=2534_base_branch_b34_data_driven_countdown.c\n");
