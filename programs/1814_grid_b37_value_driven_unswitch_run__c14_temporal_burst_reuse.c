/*
 * LowBit -- 1814_grid_b37_value_driven_unswitch_run__c14_temporal_burst_reuse.c
 * Branch: value_driven_unswitch_run | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1814_grid_b37_value_driven_unswitch_run__c14_temporal_burst_reuse.c\n");
