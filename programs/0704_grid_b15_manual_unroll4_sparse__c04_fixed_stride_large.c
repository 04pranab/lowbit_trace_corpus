/*
 * LowBit -- 0704_grid_b15_manual_unroll4_sparse__c04_fixed_stride_large.c
 * Branch: manual_unroll4_sparse | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0704_grid_b15_manual_unroll4_sparse__c04_fixed_stride_large.c\n");
