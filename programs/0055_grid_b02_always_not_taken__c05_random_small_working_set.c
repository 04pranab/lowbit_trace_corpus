/*
 * LowBit -- 0055_grid_b02_always_not_taken__c05_random_small_working_set.c
 * Branch: always_not_taken | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0055_grid_b02_always_not_taken__c05_random_small_working_set.c\n");
