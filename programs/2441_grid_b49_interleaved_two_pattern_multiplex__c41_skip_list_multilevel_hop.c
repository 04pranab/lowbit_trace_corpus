/*
 * LowBit -- 2441_grid_b49_interleaved_two_pattern_multiplex__c41_skip_list_multilevel_hop.c
 * Branch: interleaved_two_pattern_multiplex | Cache: skip_list_multilevel_hop
...
int main(void) {
    ...
    printf("program=2441_grid_b49_interleaved_two_pattern_multiplex__c41_skip_list_multilevel_hop.c\n");
