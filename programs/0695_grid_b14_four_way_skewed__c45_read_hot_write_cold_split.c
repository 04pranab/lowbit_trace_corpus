/*
 * LowBit -- 0695_grid_b14_four_way_skewed__c45_read_hot_write_cold_split.c
 * Branch: four_way_skewed | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0695_grid_b14_four_way_skewed__c45_read_hot_write_cold_split.c\n");
