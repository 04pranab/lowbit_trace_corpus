/*
 * LowBit -- 2021_grid_b41_markov_chain_3state__c21_pyramid_multiresolution_stride.c
 * Branch: markov_chain_3state | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2021_grid_b41_markov_chain_3state__c21_pyramid_multiresolution_stride.c\n");
