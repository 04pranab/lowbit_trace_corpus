/*
 * LowBit -- 0107_grid_b03_alternating__c07_matrix_row_major.c
 * Branch: alternating | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0107_grid_b03_alternating__c07_matrix_row_major.c\n");
