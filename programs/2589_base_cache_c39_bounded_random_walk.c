/*
 * LowBit -- 2589_base_cache_c39_bounded_random_walk.c
 * Branch: synthetic_always_taken | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=2589_base_cache_c39_bounded_random_walk.c\n");
