/*
 * LowBit -- 1413_grid_b29_bursty_streak_pattern__c13_two_stream_interleaved.c
 * Branch: bursty_streak_pattern | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1413_grid_b29_bursty_streak_pattern__c13_two_stream_interleaved.c\n");
