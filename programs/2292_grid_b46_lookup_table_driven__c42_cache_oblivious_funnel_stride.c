/*
 * LowBit -- 2292_grid_b46_lookup_table_driven__c42_cache_oblivious_funnel_stride.c
 * Branch: lookup_table_driven | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t depth42_ = (uint32_t)(i % 20u);
     uint32_t k42_ = 1u;
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2292_grid_b46_lookup_table_driven__c42_cache_oblivious_funnel_stride.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=cache_oblivious_funnel_stride\n");
