/*
 * LowBit -- 2011_grid_b41_markov_chain_3state__c11_sliding_window.c
 * Branch: markov_chain_3state | Cache: sliding_window
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2011_grid_b41_markov_chain_3state__c11_sliding_window.c\n");
