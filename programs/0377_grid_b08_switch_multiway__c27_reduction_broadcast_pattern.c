/*
 * LowBit -- 0377_grid_b08_switch_multiway__c27_reduction_broadcast_pattern.c
 * Branch: switch_multiway | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0377_grid_b08_switch_multiway__c27_reduction_broadcast_pattern.c\n");
