/*
 * LowBit -- 0375_grid_b08_switch_multiway__c25_lru_recency_weighted_reuse.c
 * Branch: switch_multiway | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0375_grid_b08_switch_multiway__c25_lru_recency_weighted_reuse.c\n");
