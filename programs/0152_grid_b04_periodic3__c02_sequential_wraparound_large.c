/*
 * LowBit -- 0152_grid_b04_periodic3__c02_sequential_wraparound_large.c
 * Branch: periodic3 | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0152_grid_b04_periodic3__c02_sequential_wraparound_large.c\n");
