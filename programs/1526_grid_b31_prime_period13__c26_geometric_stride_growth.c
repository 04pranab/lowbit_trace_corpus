/*
 * LowBit -- 1526_grid_b31_prime_period13__c26_geometric_stride_growth.c
 * Branch: prime_period13 | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=1526_grid_b31_prime_period13__c26_geometric_stride_growth.c\n");
