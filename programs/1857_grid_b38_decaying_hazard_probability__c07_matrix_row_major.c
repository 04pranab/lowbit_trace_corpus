/*
 * LowBit -- 1857_grid_b38_decaying_hazard_probability__c07_matrix_row_major.c
 * Branch: decaying_hazard_probability | Cache: matrix_row_major
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1857_grid_b38_decaying_hazard_probability__c07_matrix_row_major.c\n");
