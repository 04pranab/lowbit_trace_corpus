/*
 * LowBit -- 1914_grid_b39_dual_lcg_xor_chaos__c14_temporal_burst_reuse.c
 * Branch: dual_lcg_xor_chaos | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1914_grid_b39_dual_lcg_xor_chaos__c14_temporal_burst_reuse.c\n");
