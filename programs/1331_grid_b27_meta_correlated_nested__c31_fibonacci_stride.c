/*
 * LowBit -- 1331_grid_b27_meta_correlated_nested__c31_fibonacci_stride.c
 * Branch: meta_correlated_nested | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1331_grid_b27_meta_correlated_nested__c31_fibonacci_stride.c\n");
