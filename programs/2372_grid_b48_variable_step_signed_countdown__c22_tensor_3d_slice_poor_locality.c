/*
 * LowBit -- 2372_grid_b48_variable_step_signed_countdown__c22_tensor_3d_slice_poor_locality.c
 * Branch: variable_step_signed_countdown | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2372_grid_b48_variable_step_signed_countdown__c22_tensor_3d_slice_poor_locality.c\n");
