/*
 * LowBit -- 2351_grid_b48_variable_step_signed_countdown__c01_sequential_unit_stride.c
 * Branch: variable_step_signed_countdown | Cache: sequential_unit_stride
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2351_grid_b48_variable_step_signed_countdown__c01_sequential_unit_stride.c\n");
