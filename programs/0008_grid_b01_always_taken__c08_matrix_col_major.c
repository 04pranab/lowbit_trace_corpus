/*
 * LowBit -- 0008_grid_b01_always_taken__c08_matrix_col_major.c
 * Branch: always_taken | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0008_grid_b01_always_taken__c08_matrix_col_major.c\n");
