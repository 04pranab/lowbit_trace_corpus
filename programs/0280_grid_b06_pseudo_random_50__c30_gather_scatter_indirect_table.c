/*
 * LowBit -- 0280_grid_b06_pseudo_random_50__c30_gather_scatter_indirect_table.c
 * Branch: pseudo_random_50 | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0280_grid_b06_pseudo_random_50__c30_gather_scatter_indirect_table.c\n");
