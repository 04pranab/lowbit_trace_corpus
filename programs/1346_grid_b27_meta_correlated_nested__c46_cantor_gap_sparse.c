/*
 * LowBit -- 1346_grid_b27_meta_correlated_nested__c46_cantor_gap_sparse.c
 * Branch: meta_correlated_nested | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1346_grid_b27_meta_correlated_nested__c46_cantor_gap_sparse.c\n");
