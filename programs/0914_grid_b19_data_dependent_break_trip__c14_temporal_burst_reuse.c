/*
 * LowBit -- 0914_grid_b19_data_dependent_break_trip__c14_temporal_burst_reuse.c
 * Branch: data_dependent_break_trip | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0914_grid_b19_data_dependent_break_trip__c14_temporal_burst_reuse.c\n");
