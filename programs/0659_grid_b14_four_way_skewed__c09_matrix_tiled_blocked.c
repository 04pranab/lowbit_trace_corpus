/*
 * LowBit -- 0659_grid_b14_four_way_skewed__c09_matrix_tiled_blocked.c
 * Branch: four_way_skewed | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0659_grid_b14_four_way_skewed__c09_matrix_tiled_blocked.c\n");
