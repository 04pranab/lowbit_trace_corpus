/*
 * LowBit -- 1886_grid_b38_decaying_hazard_probability__c36_im2col_overlapping_patch_gather.c
 * Branch: decaying_hazard_probability | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1886_grid_b38_decaying_hazard_probability__c36_im2col_overlapping_patch_gather.c\n");
