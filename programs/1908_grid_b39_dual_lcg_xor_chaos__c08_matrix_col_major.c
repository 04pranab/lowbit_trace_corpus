/*
 * LowBit -- 1908_grid_b39_dual_lcg_xor_chaos__c08_matrix_col_major.c
 * Branch: dual_lcg_xor_chaos | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1908_grid_b39_dual_lcg_xor_chaos__c08_matrix_col_major.c\n");
