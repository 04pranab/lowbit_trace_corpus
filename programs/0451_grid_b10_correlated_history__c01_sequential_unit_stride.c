/*
 * LowBit -- 0451_grid_b10_correlated_history__c01_sequential_unit_stride.c
 * Branch: correlated_history | Cache: sequential_unit_stride
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0451_grid_b10_correlated_history__c01_sequential_unit_stride.c\n");
