/*
 * LowBit -- 1395_grid_b28_data_driven_stack_machine__c45_read_hot_write_cold_split.c
 * Branch: data_driven_stack_machine | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1395_grid_b28_data_driven_stack_machine__c45_read_hot_write_cold_split.c\n");
