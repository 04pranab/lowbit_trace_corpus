/*
 * LowBit -- 1782_grid_b36_traffic_light_fsm__c32_hilbert_curve_traversal.c
 * Branch: traffic_light_fsm | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1782_grid_b36_traffic_light_fsm__c32_hilbert_curve_traversal.c\n");
