/*
 * LowBit -- 2429_grid_b49_interleaved_two_pattern_multiplex__c29_ping_pong_cache_thrash.c
 * Branch: interleaved_two_pattern_multiplex | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=2429_grid_b49_interleaved_two_pattern_multiplex__c29_ping_pong_cache_thrash.c\n");
