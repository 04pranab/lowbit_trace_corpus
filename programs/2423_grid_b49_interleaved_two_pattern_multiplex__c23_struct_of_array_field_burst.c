/*
 * LowBit -- 2423_grid_b49_interleaved_two_pattern_multiplex__c23_struct_of_array_field_burst.c
 * Branch: interleaved_two_pattern_multiplex | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=2423_grid_b49_interleaved_two_pattern_multiplex__c23_struct_of_array_field_burst.c\n");
