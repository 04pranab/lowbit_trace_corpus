/*
 * LowBit -- 1853_grid_b38_decaying_hazard_probability__c03_fixed_stride_small.c
 * Branch: decaying_hazard_probability | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1853_grid_b38_decaying_hazard_probability__c03_fixed_stride_small.c\n");
