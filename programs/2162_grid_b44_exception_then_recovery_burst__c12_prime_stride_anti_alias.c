/*
 * LowBit -- 2162_grid_b44_exception_then_recovery_burst__c12_prime_stride_anti_alias.c
 * Branch: exception_then_recovery_burst | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2162_grid_b44_exception_then_recovery_burst__c12_prime_stride_anti_alias.c\n");
