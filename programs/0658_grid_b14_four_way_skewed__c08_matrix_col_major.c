/*
 * LowBit -- 0658_grid_b14_four_way_skewed__c08_matrix_col_major.c
 * Branch: four_way_skewed | Cache: matrix_col_major
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0658_grid_b14_four_way_skewed__c08_matrix_col_major.c\n");
