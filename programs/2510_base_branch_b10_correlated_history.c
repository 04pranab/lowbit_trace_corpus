/*
 * LowBit -- 2510_base_branch_b10_correlated_history.c
 * Branch: correlated_history | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=2510_base_branch_b10_correlated_history.c\n");
