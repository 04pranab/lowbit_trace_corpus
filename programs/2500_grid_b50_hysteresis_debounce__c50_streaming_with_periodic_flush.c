/*
 * LowBit -- 2500_grid_b50_hysteresis_debounce__c50_streaming_with_periodic_flush.c
 * Branch: hysteresis_debounce | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2500_grid_b50_hysteresis_debounce__c50_streaming_with_periodic_flush.c\n");
