/*
 * LowBit -- 0331_grid_b07_nested_dependent__c31_fibonacci_stride.c
 * Branch: nested_dependent | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0331_grid_b07_nested_dependent__c31_fibonacci_stride.c\n");
