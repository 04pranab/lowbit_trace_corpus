/*
 * LowBit -- 0404_grid_b09_recursive_calls__c04_fixed_stride_large.c
 * Branch: recursive_calls | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0404_grid_b09_recursive_calls__c04_fixed_stride_large.c\n");
