/*
 * LowBit -- 2022_grid_b41_markov_chain_3state__c22_tensor_3d_slice_poor_locality.c
 * Branch: markov_chain_3state | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2022_grid_b41_markov_chain_3state__c22_tensor_3d_slice_poor_locality.c\n");
