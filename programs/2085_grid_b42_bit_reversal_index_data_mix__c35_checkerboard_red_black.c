/*
 * LowBit -- 2085_grid_b42_bit_reversal_index_data_mix__c35_checkerboard_red_black.c
 * Branch: bit_reversal_index_data_mix | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2085_grid_b42_bit_reversal_index_data_mix__c35_checkerboard_red_black.c\n");
