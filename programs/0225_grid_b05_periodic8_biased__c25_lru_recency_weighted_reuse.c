/*
 * LowBit -- 0225_grid_b05_periodic8_biased__c25_lru_recency_weighted_reuse.c
 * Branch: periodic8_biased | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0225_grid_b05_periodic8_biased__c25_lru_recency_weighted_reuse.c\n");
