/*
 * LowBit -- 0522_grid_b11_value_dependent_threshold__c22_tensor_3d_slice_poor_locality.c
 * Branch: value_dependent_threshold | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0522_grid_b11_value_dependent_threshold__c22_tensor_3d_slice_poor_locality.c\n");
