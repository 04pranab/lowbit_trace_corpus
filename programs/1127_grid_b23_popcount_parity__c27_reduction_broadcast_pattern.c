/*
 * LowBit -- 1127_grid_b23_popcount_parity__c27_reduction_broadcast_pattern.c
 * Branch: popcount_parity | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1127_grid_b23_popcount_parity__c27_reduction_broadcast_pattern.c\n");
