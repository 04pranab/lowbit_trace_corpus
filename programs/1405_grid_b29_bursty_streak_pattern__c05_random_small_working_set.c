/*
 * LowBit -- 1405_grid_b29_bursty_streak_pattern__c05_random_small_working_set.c
 * Branch: bursty_streak_pattern | Cache: random_small_working_set
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1405_grid_b29_bursty_streak_pattern__c05_random_small_working_set.c\n");
