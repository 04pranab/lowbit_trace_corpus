/*
 * LowBit -- 1380_grid_b28_data_driven_stack_machine__c30_gather_scatter_indirect_table.c
 * Branch: data_driven_stack_machine | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1380_grid_b28_data_driven_stack_machine__c30_gather_scatter_indirect_table.c\n");
