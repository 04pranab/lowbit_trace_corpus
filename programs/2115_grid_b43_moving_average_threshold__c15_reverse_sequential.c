/*
 * LowBit -- 2115_grid_b43_moving_average_threshold__c15_reverse_sequential.c
 * Branch: moving_average_threshold | Cache: reverse_sequential
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2115_grid_b43_moving_average_threshold__c15_reverse_sequential.c\n");
