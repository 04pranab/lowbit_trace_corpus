/*
 * LowBit -- 2055_grid_b42_bit_reversal_index_data_mix__c05_random_small_working_set.c
 * Branch: bit_reversal_index_data_mix | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2055_grid_b42_bit_reversal_index_data_mix__c05_random_small_working_set.c\n");
