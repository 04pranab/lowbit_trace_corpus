/*
 * LowBit -- 1254_grid_b26_warmup_then_steady__c04_fixed_stride_large.c
 * Branch: warmup_then_steady | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1254_grid_b26_warmup_then_steady__c04_fixed_stride_large.c\n");
