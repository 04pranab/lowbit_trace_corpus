/*
 * LowBit -- 0934_grid_b19_data_dependent_break_trip__c34_variable_length_burst_reuse.c
 * Branch: data_dependent_break_trip | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0934_grid_b19_data_dependent_break_trip__c34_variable_length_burst_reuse.c\n");
