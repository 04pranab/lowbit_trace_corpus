/*
 * LowBit -- 0458_grid_b10_correlated_history__c08_matrix_col_major.c
 * Branch: correlated_history | Cache: matrix_col_major
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0458_grid_b10_correlated_history__c08_matrix_col_major.c\n");
