/*
 * LowBit -- 1632_grid_b33_uniform_random_block_runs__c32_hilbert_curve_traversal.c
 * Branch: uniform_random_block_runs | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1632_grid_b33_uniform_random_block_runs__c32_hilbert_curve_traversal.c\n");
