/*
 * LowBit -- 1420_grid_b29_bursty_streak_pattern__c20_hot_cold_phase_alternation.c
 * Branch: bursty_streak_pattern | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1420_grid_b29_bursty_streak_pattern__c20_hot_cold_phase_alternation.c\n");
