/*
 * LowBit -- 0556_grid_b12_doubling_run_lengths__c06_random_full_working_set.c
 * Branch: doubling_run_lengths | Cache: random_full_working_set
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0556_grid_b12_doubling_run_lengths__c06_random_full_working_set.c\n");
