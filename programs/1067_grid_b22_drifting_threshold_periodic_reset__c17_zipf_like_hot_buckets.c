/*
 * LowBit -- 1067_grid_b22_drifting_threshold_periodic_reset__c17_zipf_like_hot_buckets.c
 * Branch: drifting_threshold_periodic_reset | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1067_grid_b22_drifting_threshold_periodic_reset__c17_zipf_like_hot_buckets.c\n");
