/*
 * LowBit -- 0782_grid_b16_sentinel_search_loop__c32_hilbert_curve_traversal.c
 * Branch: sentinel_search_loop | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0782_grid_b16_sentinel_search_loop__c32_hilbert_curve_traversal.c\n");
