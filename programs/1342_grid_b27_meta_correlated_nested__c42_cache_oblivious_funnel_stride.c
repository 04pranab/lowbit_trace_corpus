/*
 * LowBit -- 1342_grid_b27_meta_correlated_nested__c42_cache_oblivious_funnel_stride.c
 * Branch: meta_correlated_nested | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1342_grid_b27_meta_correlated_nested__c42_cache_oblivious_funnel_stride.c\n");
