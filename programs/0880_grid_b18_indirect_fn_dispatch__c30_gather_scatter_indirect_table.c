/*
 * LowBit -- 0880_grid_b18_indirect_fn_dispatch__c30_gather_scatter_indirect_table.c
 * Branch: indirect_fn_dispatch | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0880_grid_b18_indirect_fn_dispatch__c30_gather_scatter_indirect_table.c\n");
