/*
 * LowBit -- 0429_grid_b09_recursive_calls__c29_ping_pong_cache_thrash.c
 * Branch: recursive_calls | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0429_grid_b09_recursive_calls__c29_ping_pong_cache_thrash.c\n");
