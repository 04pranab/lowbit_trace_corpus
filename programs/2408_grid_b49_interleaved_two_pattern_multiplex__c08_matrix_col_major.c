/*
 * LowBit -- 2408_grid_b49_interleaved_two_pattern_multiplex__c08_matrix_col_major.c
 * Branch: interleaved_two_pattern_multiplex | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=2408_grid_b49_interleaved_two_pattern_multiplex__c08_matrix_col_major.c\n");
