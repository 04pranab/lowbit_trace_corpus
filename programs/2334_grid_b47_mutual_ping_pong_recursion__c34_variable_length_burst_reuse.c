/*
 * LowBit -- 2334_grid_b47_mutual_ping_pong_recursion__c34_variable_length_burst_reuse.c
 * Branch: mutual_ping_pong_recursion | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2334_grid_b47_mutual_ping_pong_recursion__c34_variable_length_burst_reuse.c\n");
