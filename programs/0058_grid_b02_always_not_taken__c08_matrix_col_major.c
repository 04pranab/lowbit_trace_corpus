/*
 * LowBit -- 0058_grid_b02_always_not_taken__c08_matrix_col_major.c
 * Branch: always_not_taken | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0058_grid_b02_always_not_taken__c08_matrix_col_major.c\n");
