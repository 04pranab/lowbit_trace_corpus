/*
 * LowBit -- 0698_grid_b14_four_way_skewed__c48_exponential_backoff_probe.c
 * Branch: four_way_skewed | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0698_grid_b14_four_way_skewed__c48_exponential_backoff_probe.c\n");
