/*
 * LowBit -- 0448_grid_b09_recursive_calls__c48_exponential_backoff_probe.c
 * Branch: recursive_calls | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0448_grid_b09_recursive_calls__c48_exponential_backoff_probe.c\n");
