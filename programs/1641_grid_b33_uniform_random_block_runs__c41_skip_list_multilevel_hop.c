/*
 * LowBit -- 1641_grid_b33_uniform_random_block_runs__c41_skip_list_multilevel_hop.c
 * Branch: uniform_random_block_runs | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1641_grid_b33_uniform_random_block_runs__c41_skip_list_multilevel_hop.c\n");
