/*
 * LowBit -- 0947_grid_b19_data_dependent_break_trip__c47_false_sharing_line_cycle.c
 * Branch: data_dependent_break_trip | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0947_grid_b19_data_dependent_break_trip__c47_false_sharing_line_cycle.c\n");
