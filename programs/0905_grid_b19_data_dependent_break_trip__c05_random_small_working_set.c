/*
 * LowBit -- 0905_grid_b19_data_dependent_break_trip__c05_random_small_working_set.c
 * Branch: data_dependent_break_trip | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0905_grid_b19_data_dependent_break_trip__c05_random_small_working_set.c\n");
