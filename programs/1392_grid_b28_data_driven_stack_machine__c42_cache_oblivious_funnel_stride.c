/*
 * LowBit -- 1392_grid_b28_data_driven_stack_machine__c42_cache_oblivious_funnel_stride.c
 * Branch: data_driven_stack_machine | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1392_grid_b28_data_driven_stack_machine__c42_cache_oblivious_funnel_stride.c\n");
