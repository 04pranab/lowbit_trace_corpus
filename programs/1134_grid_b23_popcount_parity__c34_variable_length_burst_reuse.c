/*
 * LowBit -- 1134_grid_b23_popcount_parity__c34_variable_length_burst_reuse.c
 * Branch: popcount_parity | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1134_grid_b23_popcount_parity__c34_variable_length_burst_reuse.c\n");
