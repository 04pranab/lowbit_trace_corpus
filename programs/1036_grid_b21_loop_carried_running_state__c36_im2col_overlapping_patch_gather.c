/*
 * LowBit -- 1036_grid_b21_loop_carried_running_state__c36_im2col_overlapping_patch_gather.c
 * Branch: loop_carried_running_state | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=1036_grid_b21_loop_carried_running_state__c36_im2col_overlapping_patch_gather.c\n");
