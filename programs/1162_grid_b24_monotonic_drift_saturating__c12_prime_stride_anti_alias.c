/*
 * LowBit -- 1162_grid_b24_monotonic_drift_saturating__c12_prime_stride_anti_alias.c
 * Branch: monotonic_drift_saturating | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1162_grid_b24_monotonic_drift_saturating__c12_prime_stride_anti_alias.c\n");
