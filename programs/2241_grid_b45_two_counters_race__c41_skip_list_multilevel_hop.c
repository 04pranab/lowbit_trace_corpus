/*
 * LowBit -- 2241_grid_b45_two_counters_race__c41_skip_list_multilevel_hop.c
 * Branch: two_counters_race | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2241_grid_b45_two_counters_race__c41_skip_list_multilevel_hop.c\n");
