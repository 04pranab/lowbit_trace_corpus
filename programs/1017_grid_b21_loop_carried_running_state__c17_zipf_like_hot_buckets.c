/*
 * LowBit -- 1017_grid_b21_loop_carried_running_state__c17_zipf_like_hot_buckets.c
 * Branch: loop_carried_running_state | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=1017_grid_b21_loop_carried_running_state__c17_zipf_like_hot_buckets.c\n");
