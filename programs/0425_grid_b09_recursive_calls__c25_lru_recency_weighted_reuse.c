/*
 * LowBit -- 0425_grid_b09_recursive_calls__c25_lru_recency_weighted_reuse.c
 * Branch: recursive_calls | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0425_grid_b09_recursive_calls__c25_lru_recency_weighted_reuse.c\n");
