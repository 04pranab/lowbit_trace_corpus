/*
 * LowBit -- 0417_grid_b09_recursive_calls__c17_zipf_like_hot_buckets.c
 * Branch: recursive_calls | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0417_grid_b09_recursive_calls__c17_zipf_like_hot_buckets.c\n");
