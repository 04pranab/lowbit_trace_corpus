/*
 * LowBit -- 0689_grid_b14_four_way_skewed__c39_bounded_random_walk.c
 * Branch: four_way_skewed | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0689_grid_b14_four_way_skewed__c39_bounded_random_walk.c\n");
