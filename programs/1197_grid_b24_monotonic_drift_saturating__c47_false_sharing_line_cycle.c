/*
 * LowBit -- 1197_grid_b24_monotonic_drift_saturating__c47_false_sharing_line_cycle.c
 * Branch: monotonic_drift_saturating | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1197_grid_b24_monotonic_drift_saturating__c47_false_sharing_line_cycle.c\n");
