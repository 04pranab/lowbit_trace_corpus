/*
 * LowBit -- 2172_grid_b44_exception_then_recovery_burst__c22_tensor_3d_slice_poor_locality.c
 * Branch: exception_then_recovery_burst | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2172_grid_b44_exception_then_recovery_burst__c22_tensor_3d_slice_poor_locality.c\n");
