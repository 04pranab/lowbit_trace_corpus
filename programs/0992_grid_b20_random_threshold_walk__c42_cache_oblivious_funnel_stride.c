/*
 * LowBit -- 0992_grid_b20_random_threshold_walk__c42_cache_oblivious_funnel_stride.c
 * Branch: random_threshold_walk | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0992_grid_b20_random_threshold_walk__c42_cache_oblivious_funnel_stride.c\n");
