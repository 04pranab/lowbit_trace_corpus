/*
 * LowBit -- 2426_grid_b49_interleaved_two_pattern_multiplex__c26_geometric_stride_growth.c
 * Branch: interleaved_two_pattern_multiplex | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=2426_grid_b49_interleaved_two_pattern_multiplex__c26_geometric_stride_growth.c\n");
