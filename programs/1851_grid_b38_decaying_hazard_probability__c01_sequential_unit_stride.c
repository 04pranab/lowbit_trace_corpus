/*
 * LowBit -- 1851_grid_b38_decaying_hazard_probability__c01_sequential_unit_stride.c
 * Branch: decaying_hazard_probability | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1851_grid_b38_decaying_hazard_probability__c01_sequential_unit_stride.c\n");
