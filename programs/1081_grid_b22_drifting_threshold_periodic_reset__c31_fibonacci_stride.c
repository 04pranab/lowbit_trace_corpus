/*
 * LowBit -- 1081_grid_b22_drifting_threshold_periodic_reset__c31_fibonacci_stride.c
 * Branch: drifting_threshold_periodic_reset | Cache: fibonacci_stride
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1081_grid_b22_drifting_threshold_periodic_reset__c31_fibonacci_stride.c\n");
