/*
 * LowBit -- 0156_grid_b04_periodic3__c06_random_full_working_set.c
 * Branch: periodic3 | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0156_grid_b04_periodic3__c06_random_full_working_set.c\n");
