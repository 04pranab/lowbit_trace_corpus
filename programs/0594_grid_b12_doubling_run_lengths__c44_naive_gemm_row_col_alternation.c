/*
 * LowBit -- 0594_grid_b12_doubling_run_lengths__c44_naive_gemm_row_col_alternation.c
 * Branch: doubling_run_lengths | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0594_grid_b12_doubling_run_lengths__c44_naive_gemm_row_col_alternation.c\n");
