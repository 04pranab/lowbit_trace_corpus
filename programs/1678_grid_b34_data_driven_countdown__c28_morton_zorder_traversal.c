/*
 * LowBit -- 1678_grid_b34_data_driven_countdown__c28_morton_zorder_traversal.c
 * Branch: data_driven_countdown | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1678_grid_b34_data_driven_countdown__c28_morton_zorder_traversal.c\n");
