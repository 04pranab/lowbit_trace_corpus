/*
 * LowBit -- 1153_grid_b24_monotonic_drift_saturating__c03_fixed_stride_small.c
 * Branch: monotonic_drift_saturating | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1153_grid_b24_monotonic_drift_saturating__c03_fixed_stride_small.c\n");
