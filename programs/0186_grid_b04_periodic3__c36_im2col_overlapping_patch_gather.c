/*
 * LowBit -- 0186_grid_b04_periodic3__c36_im2col_overlapping_patch_gather.c
 * Branch: periodic3 | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0186_grid_b04_periodic3__c36_im2col_overlapping_patch_gather.c\n");
