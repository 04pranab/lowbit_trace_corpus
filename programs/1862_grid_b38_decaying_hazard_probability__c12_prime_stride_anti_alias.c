/*
 * LowBit -- 1862_grid_b38_decaying_hazard_probability__c12_prime_stride_anti_alias.c
 * Branch: decaying_hazard_probability | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1862_grid_b38_decaying_hazard_probability__c12_prime_stride_anti_alias.c\n");
