/*
 * LowBit -- 1987_grid_b40_collatz_value_transform__c37_double_buffer_epoch_alternation.c
 * Branch: collatz_value_transform | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1987_grid_b40_collatz_value_transform__c37_double_buffer_epoch_alternation.c\n");
