/*
 * LowBit -- 1075_grid_b22_drifting_threshold_periodic_reset__c25_lru_recency_weighted_reuse.c
 * Branch: drifting_threshold_periodic_reset | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1075_grid_b22_drifting_threshold_periodic_reset__c25_lru_recency_weighted_reuse.c\n");
