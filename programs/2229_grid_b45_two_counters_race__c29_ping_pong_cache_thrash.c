/*
 * LowBit -- 2229_grid_b45_two_counters_race__c29_ping_pong_cache_thrash.c
 * Branch: two_counters_race | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2229_grid_b45_two_counters_race__c29_ping_pong_cache_thrash.c\n");
