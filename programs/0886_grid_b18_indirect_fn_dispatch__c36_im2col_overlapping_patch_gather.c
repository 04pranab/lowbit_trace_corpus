/*
 * LowBit -- 0886_grid_b18_indirect_fn_dispatch__c36_im2col_overlapping_patch_gather.c
 * Branch: indirect_fn_dispatch | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0886_grid_b18_indirect_fn_dispatch__c36_im2col_overlapping_patch_gather.c\n");
