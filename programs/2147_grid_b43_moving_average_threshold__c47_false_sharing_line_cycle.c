/*
 * LowBit -- 2147_grid_b43_moving_average_threshold__c47_false_sharing_line_cycle.c
 * Branch: moving_average_threshold | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2147_grid_b43_moving_average_threshold__c47_false_sharing_line_cycle.c\n");
