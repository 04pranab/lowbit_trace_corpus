/*
 * LowBit -- 2533_base_branch_b33_uniform_random_block_runs.c
 * Branch: uniform_random_block_runs | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=2533_base_branch_b33_uniform_random_block_runs.c\n");
