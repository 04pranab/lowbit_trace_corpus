/*
 * LowBit -- 0597_grid_b12_doubling_run_lengths__c47_false_sharing_line_cycle.c
 * Branch: doubling_run_lengths | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0597_grid_b12_doubling_run_lengths__c47_false_sharing_line_cycle.c\n");
