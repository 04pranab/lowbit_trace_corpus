/*
 * LowBit -- 0078_grid_b02_always_not_taken__c28_morton_zorder_traversal.c
 * Branch: always_not_taken | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0078_grid_b02_always_not_taken__c28_morton_zorder_traversal.c\n");
