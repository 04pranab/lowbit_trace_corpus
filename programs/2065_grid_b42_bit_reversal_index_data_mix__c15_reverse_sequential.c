/*
 * LowBit -- 2065_grid_b42_bit_reversal_index_data_mix__c15_reverse_sequential.c
 * Branch: bit_reversal_index_data_mix | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2065_grid_b42_bit_reversal_index_data_mix__c15_reverse_sequential.c\n");
