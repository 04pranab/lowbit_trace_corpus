/*
 * LowBit -- 0030_grid_b01_always_taken__c30_gather_scatter_indirect_table.c
 * Branch: always_taken | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0030_grid_b01_always_taken__c30_gather_scatter_indirect_table.c\n");
