/*
 * LowBit -- 2008_grid_b41_markov_chain_3state__c08_matrix_col_major.c
 * Branch: markov_chain_3state | Cache: matrix_col_major
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2008_grid_b41_markov_chain_3state__c08_matrix_col_major.c\n");
