/*
 * LowBit -- 1787_grid_b36_traffic_light_fsm__c37_double_buffer_epoch_alternation.c
 * Branch: traffic_light_fsm | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1787_grid_b36_traffic_light_fsm__c37_double_buffer_epoch_alternation.c\n");
