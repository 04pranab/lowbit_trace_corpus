/*
 * LowBit -- 1900_grid_b38_decaying_hazard_probability__c50_streaming_with_periodic_flush.c
 * Branch: decaying_hazard_probability | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1900_grid_b38_decaying_hazard_probability__c50_streaming_with_periodic_flush.c\n");
