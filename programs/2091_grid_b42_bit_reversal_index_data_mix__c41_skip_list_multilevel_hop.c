/*
 * LowBit -- 2091_grid_b42_bit_reversal_index_data_mix__c41_skip_list_multilevel_hop.c
 * Branch: bit_reversal_index_data_mix | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2091_grid_b42_bit_reversal_index_data_mix__c41_skip_list_multilevel_hop.c\n");
