/*
 * LowBit -- 2395_grid_b48_variable_step_signed_countdown__c45_read_hot_write_cold_split.c
 * Branch: variable_step_signed_countdown | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2395_grid_b48_variable_step_signed_countdown__c45_read_hot_write_cold_split.c\n");
