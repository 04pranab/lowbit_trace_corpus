/*
 * LowBit -- 1417_grid_b29_bursty_streak_pattern__c17_zipf_like_hot_buckets.c
 * Branch: bursty_streak_pattern | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1417_grid_b29_bursty_streak_pattern__c17_zipf_like_hot_buckets.c\n");
