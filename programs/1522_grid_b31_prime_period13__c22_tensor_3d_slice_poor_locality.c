/*
 * LowBit -- 1522_grid_b31_prime_period13__c22_tensor_3d_slice_poor_locality.c
 * Branch: prime_period13 | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=1522_grid_b31_prime_period13__c22_tensor_3d_slice_poor_locality.c\n");
