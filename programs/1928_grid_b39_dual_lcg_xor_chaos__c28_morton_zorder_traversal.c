/*
 * LowBit -- 1928_grid_b39_dual_lcg_xor_chaos__c28_morton_zorder_traversal.c
 * Branch: dual_lcg_xor_chaos | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1928_grid_b39_dual_lcg_xor_chaos__c28_morton_zorder_traversal.c\n");
