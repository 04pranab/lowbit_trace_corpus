/*
 * LowBit -- 2031_grid_b41_markov_chain_3state__c31_fibonacci_stride.c
 * Branch: markov_chain_3state | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2031_grid_b41_markov_chain_3state__c31_fibonacci_stride.c\n");
