/*
 * LowBit -- 0755_grid_b16_sentinel_search_loop__c05_random_small_working_set.c
 * Branch: sentinel_search_loop | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0755_grid_b16_sentinel_search_loop__c05_random_small_working_set.c\n");
