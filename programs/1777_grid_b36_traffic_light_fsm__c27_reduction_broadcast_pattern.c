/*
 * LowBit -- 1777_grid_b36_traffic_light_fsm__c27_reduction_broadcast_pattern.c
 * Branch: traffic_light_fsm | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1777_grid_b36_traffic_light_fsm__c27_reduction_broadcast_pattern.c\n");
