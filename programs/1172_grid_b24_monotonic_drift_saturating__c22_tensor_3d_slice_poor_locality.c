/*
 * LowBit -- 1172_grid_b24_monotonic_drift_saturating__c22_tensor_3d_slice_poor_locality.c
 * Branch: monotonic_drift_saturating | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1172_grid_b24_monotonic_drift_saturating__c22_tensor_3d_slice_poor_locality.c\n");
