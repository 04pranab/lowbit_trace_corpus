/*
 * LowBit -- 0715_grid_b15_manual_unroll4_sparse__c15_reverse_sequential.c
 * Branch: manual_unroll4_sparse | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0715_grid_b15_manual_unroll4_sparse__c15_reverse_sequential.c\n");
