/*
 * LowBit -- 1489_grid_b30_periodic_interrupt_override__c39_bounded_random_walk.c
 * Branch: periodic_interrupt_override | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=1489_grid_b30_periodic_interrupt_override__c39_bounded_random_walk.c\n");
