/*
 * LowBit -- 0390_grid_b08_switch_multiway__c40_causal_attention_triangular.c
 * Branch: switch_multiway | Cache: causal_attention_triangular
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0390_grid_b08_switch_multiway__c40_causal_attention_triangular.c\n");
