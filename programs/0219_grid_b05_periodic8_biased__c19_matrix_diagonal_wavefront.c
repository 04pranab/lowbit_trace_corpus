/*
 * LowBit -- 0219_grid_b05_periodic8_biased__c19_matrix_diagonal_wavefront.c
 * Branch: periodic8_biased | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0219_grid_b05_periodic8_biased__c19_matrix_diagonal_wavefront.c\n");
