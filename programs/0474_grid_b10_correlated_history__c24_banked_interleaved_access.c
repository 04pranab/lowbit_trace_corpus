/*
 * LowBit -- 0474_grid_b10_correlated_history__c24_banked_interleaved_access.c
 * Branch: correlated_history | Cache: banked_interleaved_access
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0474_grid_b10_correlated_history__c24_banked_interleaved_access.c\n");
