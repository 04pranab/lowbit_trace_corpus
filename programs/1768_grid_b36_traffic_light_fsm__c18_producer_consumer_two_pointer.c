/*
 * LowBit -- 1768_grid_b36_traffic_light_fsm__c18_producer_consumer_two_pointer.c
 * Branch: traffic_light_fsm | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1768_grid_b36_traffic_light_fsm__c18_producer_consumer_two_pointer.c\n");
