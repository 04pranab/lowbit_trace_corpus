/*
 * LowBit -- 0941_grid_b19_data_dependent_break_trip__c41_skip_list_multilevel_hop.c
 * Branch: data_dependent_break_trip | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0941_grid_b19_data_dependent_break_trip__c41_skip_list_multilevel_hop.c\n");
