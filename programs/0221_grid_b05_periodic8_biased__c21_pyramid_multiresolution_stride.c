/*
 * LowBit -- 0221_grid_b05_periodic8_biased__c21_pyramid_multiresolution_stride.c
 * Branch: periodic8_biased | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0221_grid_b05_periodic8_biased__c21_pyramid_multiresolution_stride.c\n");
