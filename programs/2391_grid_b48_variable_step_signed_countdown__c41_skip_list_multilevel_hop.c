/*
 * LowBit -- 2391_grid_b48_variable_step_signed_countdown__c41_skip_list_multilevel_hop.c
 * Branch: variable_step_signed_countdown | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2391_grid_b48_variable_step_signed_countdown__c41_skip_list_multilevel_hop.c\n");
