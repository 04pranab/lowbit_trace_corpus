/*
 * LowBit -- 2053_grid_b42_bit_reversal_index_data_mix__c03_fixed_stride_small.c
 * Branch: bit_reversal_index_data_mix | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2053_grid_b42_bit_reversal_index_data_mix__c03_fixed_stride_small.c\n");
