/*
 * LowBit -- 0252_grid_b06_pseudo_random_50__c02_sequential_wraparound_large.c
 * Branch: pseudo_random_50 | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0252_grid_b06_pseudo_random_50__c02_sequential_wraparound_large.c\n");
