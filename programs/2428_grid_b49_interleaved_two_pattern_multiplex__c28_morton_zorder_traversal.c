/*
 * LowBit -- 2428_grid_b49_interleaved_two_pattern_multiplex__c28_morton_zorder_traversal.c
 * Branch: interleaved_two_pattern_multiplex | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=2428_grid_b49_interleaved_two_pattern_multiplex__c28_morton_zorder_traversal.c\n");
