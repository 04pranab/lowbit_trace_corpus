/*
 * LowBit -- 0347_grid_b07_nested_dependent__c47_false_sharing_line_cycle.c
 * Branch: nested_dependent | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0347_grid_b07_nested_dependent__c47_false_sharing_line_cycle.c\n");
