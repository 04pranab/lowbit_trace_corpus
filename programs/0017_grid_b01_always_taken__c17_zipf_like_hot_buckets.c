/*
 * LowBit -- 0017_grid_b01_always_taken__c17_zipf_like_hot_buckets.c
 * Branch: always_taken | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0017_grid_b01_always_taken__c17_zipf_like_hot_buckets.c\n");
