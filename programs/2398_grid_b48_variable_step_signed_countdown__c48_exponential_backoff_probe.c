/*
 * LowBit -- 2398_grid_b48_variable_step_signed_countdown__c48_exponential_backoff_probe.c
 * Branch: variable_step_signed_countdown | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2398_grid_b48_variable_step_signed_countdown__c48_exponential_backoff_probe.c\n");
