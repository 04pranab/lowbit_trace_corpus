/*
 * LowBit -- 1023_grid_b21_loop_carried_running_state__c23_struct_of_array_field_burst.c
 * Branch: loop_carried_running_state | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=1023_grid_b21_loop_carried_running_state__c23_struct_of_array_field_burst.c\n");
