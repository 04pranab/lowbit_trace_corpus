/*
 * LowBit -- 2344_grid_b47_mutual_ping_pong_recursion__c44_naive_gemm_row_col_alternation.c
 * Branch: mutual_ping_pong_recursion | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2344_grid_b47_mutual_ping_pong_recursion__c44_naive_gemm_row_col_alternation.c\n");
