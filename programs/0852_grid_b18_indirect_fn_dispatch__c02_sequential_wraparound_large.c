/*
 * LowBit -- 0852_grid_b18_indirect_fn_dispatch__c02_sequential_wraparound_large.c
 * Branch: indirect_fn_dispatch | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0852_grid_b18_indirect_fn_dispatch__c02_sequential_wraparound_large.c\n");
