/*
 * LowBit -- 1924_grid_b39_dual_lcg_xor_chaos__c24_banked_interleaved_access.c
 * Branch: dual_lcg_xor_chaos | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1924_grid_b39_dual_lcg_xor_chaos__c24_banked_interleaved_access.c\n");
