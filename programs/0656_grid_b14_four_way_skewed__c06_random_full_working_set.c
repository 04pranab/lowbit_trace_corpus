/*
 * LowBit -- 0656_grid_b14_four_way_skewed__c06_random_full_working_set.c
 * Branch: four_way_skewed | Cache: random_full_working_set
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0656_grid_b14_four_way_skewed__c06_random_full_working_set.c\n");
