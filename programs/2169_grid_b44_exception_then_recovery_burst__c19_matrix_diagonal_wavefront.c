/*
 * LowBit -- 2169_grid_b44_exception_then_recovery_burst__c19_matrix_diagonal_wavefront.c
 * Branch: exception_then_recovery_burst | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2169_grid_b44_exception_then_recovery_burst__c19_matrix_diagonal_wavefront.c\n");
