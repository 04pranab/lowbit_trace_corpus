/*
 * LowBit -- 1706_grid_b35_xorshift_hash_mix__c06_random_full_working_set.c
 * Branch: xorshift_hash_mix | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1706_grid_b35_xorshift_hash_mix__c06_random_full_working_set.c\n");
