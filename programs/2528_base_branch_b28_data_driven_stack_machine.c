/*
 * LowBit -- 2528_base_branch_b28_data_driven_stack_machine.c
 * Branch: data_driven_stack_machine | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=2528_base_branch_b28_data_driven_stack_machine.c\n");
