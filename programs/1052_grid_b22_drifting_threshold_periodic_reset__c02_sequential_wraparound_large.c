/*
 * LowBit -- 1052_grid_b22_drifting_threshold_periodic_reset__c02_sequential_wraparound_large.c
 * Branch: drifting_threshold_periodic_reset | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1052_grid_b22_drifting_threshold_periodic_reset__c02_sequential_wraparound_large.c\n");
