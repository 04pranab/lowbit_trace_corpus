/*
 * LowBit -- 1455_grid_b30_periodic_interrupt_override__c05_random_small_working_set.c
 * Branch: periodic_interrupt_override | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=1455_grid_b30_periodic_interrupt_override__c05_random_small_working_set.c\n");
