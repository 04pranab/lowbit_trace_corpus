/*
 * LowBit -- 1181_grid_b24_monotonic_drift_saturating__c31_fibonacci_stride.c
 * Branch: monotonic_drift_saturating | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1181_grid_b24_monotonic_drift_saturating__c31_fibonacci_stride.c\n");
