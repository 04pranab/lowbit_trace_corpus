/*
 * LowBit -- 2045_grid_b41_markov_chain_3state__c45_read_hot_write_cold_split.c
 * Branch: markov_chain_3state | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2045_grid_b41_markov_chain_3state__c45_read_hot_write_cold_split.c\n");
