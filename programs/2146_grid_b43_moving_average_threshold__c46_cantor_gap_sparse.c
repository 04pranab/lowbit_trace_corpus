/*
 * LowBit -- 2146_grid_b43_moving_average_threshold__c46_cantor_gap_sparse.c
 * Branch: moving_average_threshold | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2146_grid_b43_moving_average_threshold__c46_cantor_gap_sparse.c\n");
