/*
 * LowBit -- 1441_grid_b29_bursty_streak_pattern__c41_skip_list_multilevel_hop.c
 * Branch: bursty_streak_pattern | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1441_grid_b29_bursty_streak_pattern__c41_skip_list_multilevel_hop.c\n");
