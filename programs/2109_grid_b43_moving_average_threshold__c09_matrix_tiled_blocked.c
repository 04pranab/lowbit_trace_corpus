/*
 * LowBit -- 2109_grid_b43_moving_average_threshold__c09_matrix_tiled_blocked.c
 * Branch: moving_average_threshold | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2109_grid_b43_moving_average_threshold__c09_matrix_tiled_blocked.c\n");
