/*
 * LowBit -- 1738_grid_b35_xorshift_hash_mix__c38_cuckoo_double_hash_probe.c
 * Branch: xorshift_hash_mix | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1738_grid_b35_xorshift_hash_mix__c38_cuckoo_double_hash_probe.c\n");
