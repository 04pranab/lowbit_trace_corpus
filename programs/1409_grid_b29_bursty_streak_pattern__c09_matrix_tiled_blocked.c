/*
 * LowBit -- 1409_grid_b29_bursty_streak_pattern__c09_matrix_tiled_blocked.c
 * Branch: bursty_streak_pattern | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1409_grid_b29_bursty_streak_pattern__c09_matrix_tiled_blocked.c\n");
