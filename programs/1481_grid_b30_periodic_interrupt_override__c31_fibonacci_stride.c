/*
 * LowBit -- 1481_grid_b30_periodic_interrupt_override__c31_fibonacci_stride.c
 * Branch: periodic_interrupt_override | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=1481_grid_b30_periodic_interrupt_override__c31_fibonacci_stride.c\n");
