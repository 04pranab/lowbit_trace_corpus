/*
 * LowBit -- 2354_grid_b48_variable_step_signed_countdown__c04_fixed_stride_large.c
 * Branch: variable_step_signed_countdown | Cache: fixed_stride_large
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2354_grid_b48_variable_step_signed_countdown__c04_fixed_stride_large.c\n");
