/*
 * LowBit -- 0022_grid_b01_always_taken__c22_tensor_3d_slice_poor_locality.c
 * Branch: always_taken | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0022_grid_b01_always_taken__c22_tensor_3d_slice_poor_locality.c\n");
