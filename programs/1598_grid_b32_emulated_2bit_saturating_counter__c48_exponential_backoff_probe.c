/*
 * LowBit -- 1598_grid_b32_emulated_2bit_saturating_counter__c48_exponential_backoff_probe.c
 * Branch: emulated_2bit_saturating_counter | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1598_grid_b32_emulated_2bit_saturating_counter__c48_exponential_backoff_probe.c\n");
