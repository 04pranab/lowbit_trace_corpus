/*
 * LowBit -- 1338_grid_b27_meta_correlated_nested__c38_cuckoo_double_hash_probe.c
 * Branch: meta_correlated_nested | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1338_grid_b27_meta_correlated_nested__c38_cuckoo_double_hash_probe.c\n");
