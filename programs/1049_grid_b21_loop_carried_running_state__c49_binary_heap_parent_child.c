/*
 * LowBit -- 1049_grid_b21_loop_carried_running_state__c49_binary_heap_parent_child.c
 * Branch: loop_carried_running_state | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=1049_grid_b21_loop_carried_running_state__c49_binary_heap_parent_child.c\n");
