/*
 * LowBit -- 1779_grid_b36_traffic_light_fsm__c29_ping_pong_cache_thrash.c
 * Branch: traffic_light_fsm | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1779_grid_b36_traffic_light_fsm__c29_ping_pong_cache_thrash.c\n");
