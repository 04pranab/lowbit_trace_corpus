/*
 * LowBit -- 2329_grid_b47_mutual_ping_pong_recursion__c29_ping_pong_cache_thrash.c
 * Branch: mutual_ping_pong_recursion | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2329_grid_b47_mutual_ping_pong_recursion__c29_ping_pong_cache_thrash.c\n");
