/*
 * LowBit -- 1661_grid_b34_data_driven_countdown__c11_sliding_window.c
 * Branch: data_driven_countdown | Cache: sliding_window
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1661_grid_b34_data_driven_countdown__c11_sliding_window.c\n");
