/*
 * LowBit -- 2580_base_cache_c30_gather_scatter_indirect_table.c
 * Branch: synthetic_always_taken | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=2580_base_cache_c30_gather_scatter_indirect_table.c\n");
