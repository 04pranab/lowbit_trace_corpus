/*
 * LowBit -- 0505_grid_b11_value_dependent_threshold__c05_random_small_working_set.c
 * Branch: value_dependent_threshold | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0505_grid_b11_value_dependent_threshold__c05_random_small_working_set.c\n");
