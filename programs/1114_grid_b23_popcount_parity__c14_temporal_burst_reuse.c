/*
 * LowBit -- 1114_grid_b23_popcount_parity__c14_temporal_burst_reuse.c
 * Branch: popcount_parity | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1114_grid_b23_popcount_parity__c14_temporal_burst_reuse.c\n");
