/*
 * LowBit -- 1579_grid_b32_emulated_2bit_saturating_counter__c29_ping_pong_cache_thrash.c
 * Branch: emulated_2bit_saturating_counter | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1579_grid_b32_emulated_2bit_saturating_counter__c29_ping_pong_cache_thrash.c\n");
