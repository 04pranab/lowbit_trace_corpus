/*
 * LowBit -- 0065_grid_b02_always_not_taken__c15_reverse_sequential.c
 * Branch: always_not_taken | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0065_grid_b02_always_not_taken__c15_reverse_sequential.c\n");
