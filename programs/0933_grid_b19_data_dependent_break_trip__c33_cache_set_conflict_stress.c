/*
 * LowBit -- 0933_grid_b19_data_dependent_break_trip__c33_cache_set_conflict_stress.c
 * Branch: data_dependent_break_trip | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0933_grid_b19_data_dependent_break_trip__c33_cache_set_conflict_stress.c\n");
