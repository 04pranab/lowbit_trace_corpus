/*
 * LowBit -- 1319_grid_b27_meta_correlated_nested__c19_matrix_diagonal_wavefront.c
 * Branch: meta_correlated_nested | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { uint32_t outer27_ = (uint32_t)((i >> 5) & 1u);
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1319_grid_b27_meta_correlated_nested__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=meta_correlated_nested\n");
