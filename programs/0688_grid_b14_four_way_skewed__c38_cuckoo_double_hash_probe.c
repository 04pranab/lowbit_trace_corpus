/*
 * LowBit -- 0688_grid_b14_four_way_skewed__c38_cuckoo_double_hash_probe.c
 * Branch: four_way_skewed | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0688_grid_b14_four_way_skewed__c38_cuckoo_double_hash_probe.c\n");
