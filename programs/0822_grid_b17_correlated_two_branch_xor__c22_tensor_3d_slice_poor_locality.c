/*
 * LowBit -- 0822_grid_b17_correlated_two_branch_xor__c22_tensor_3d_slice_poor_locality.c
 * Branch: correlated_two_branch_xor | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0822_grid_b17_correlated_two_branch_xor__c22_tensor_3d_slice_poor_locality.c\n");
