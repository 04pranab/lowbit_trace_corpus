/*
 * LowBit -- 0036_grid_b01_always_taken__c36_im2col_overlapping_patch_gather.c
 * Branch: always_taken | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0036_grid_b01_always_taken__c36_im2col_overlapping_patch_gather.c\n");
