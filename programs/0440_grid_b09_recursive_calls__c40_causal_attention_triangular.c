/*
 * LowBit -- 0440_grid_b09_recursive_calls__c40_causal_attention_triangular.c
 * Branch: recursive_calls | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0440_grid_b09_recursive_calls__c40_causal_attention_triangular.c\n");
