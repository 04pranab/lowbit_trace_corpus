/*
 * LowBit -- 1187_grid_b24_monotonic_drift_saturating__c37_double_buffer_epoch_alternation.c
 * Branch: monotonic_drift_saturating | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1187_grid_b24_monotonic_drift_saturating__c37_double_buffer_epoch_alternation.c\n");
