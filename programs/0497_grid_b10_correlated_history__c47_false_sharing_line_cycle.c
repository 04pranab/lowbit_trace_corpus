/*
 * LowBit -- 0497_grid_b10_correlated_history__c47_false_sharing_line_cycle.c
 * Branch: correlated_history | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0497_grid_b10_correlated_history__c47_false_sharing_line_cycle.c\n");
