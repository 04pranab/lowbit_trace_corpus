/*
 * LowBit -- 1741_grid_b35_xorshift_hash_mix__c41_skip_list_multilevel_hop.c
 * Branch: xorshift_hash_mix | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1741_grid_b35_xorshift_hash_mix__c41_skip_list_multilevel_hop.c\n");
