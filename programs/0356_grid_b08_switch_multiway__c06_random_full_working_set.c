/*
 * LowBit -- 0356_grid_b08_switch_multiway__c06_random_full_working_set.c
 * Branch: switch_multiway | Cache: random_full_working_set
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0356_grid_b08_switch_multiway__c06_random_full_working_set.c\n");
