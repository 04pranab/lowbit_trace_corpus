/*
 * LowBit -- 0310_grid_b07_nested_dependent__c10_pointer_chase_linked_list.c
 * Branch: nested_dependent | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0310_grid_b07_nested_dependent__c10_pointer_chase_linked_list.c\n");
