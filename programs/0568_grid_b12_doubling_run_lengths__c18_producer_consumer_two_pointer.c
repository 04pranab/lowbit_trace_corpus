/*
 * LowBit -- 0568_grid_b12_doubling_run_lengths__c18_producer_consumer_two_pointer.c
 * Branch: doubling_run_lengths | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0568_grid_b12_doubling_run_lengths__c18_producer_consumer_two_pointer.c\n");
