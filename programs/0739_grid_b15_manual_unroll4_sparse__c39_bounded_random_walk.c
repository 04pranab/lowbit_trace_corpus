/*
 * LowBit -- 0739_grid_b15_manual_unroll4_sparse__c39_bounded_random_walk.c
 * Branch: manual_unroll4_sparse | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0739_grid_b15_manual_unroll4_sparse__c39_bounded_random_walk.c\n");
