/*
 * LowBit -- 2272_grid_b46_lookup_table_driven__c22_tensor_3d_slice_poor_locality.c
 * Branch: lookup_table_driven | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2272_grid_b46_lookup_table_driven__c22_tensor_3d_slice_poor_locality.c\n");
