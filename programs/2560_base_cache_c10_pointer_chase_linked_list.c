/*
 * LowBit -- 2560_base_cache_c10_pointer_chase_linked_list.c
 * Branch: synthetic_always_taken | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=2560_base_cache_c10_pointer_chase_linked_list.c\n");
