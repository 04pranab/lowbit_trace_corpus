/*
 * LowBit -- 1324_grid_b27_meta_correlated_nested__c24_banked_interleaved_access.c
 * Branch: meta_correlated_nested | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1324_grid_b27_meta_correlated_nested__c24_banked_interleaved_access.c\n");
