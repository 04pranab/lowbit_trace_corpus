/*
 * LowBit -- 1283_grid_b26_warmup_then_steady__c33_cache_set_conflict_stress.c
 * Branch: warmup_then_steady | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1283_grid_b26_warmup_then_steady__c33_cache_set_conflict_stress.c\n");
