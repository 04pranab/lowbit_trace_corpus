/*
 * LowBit -- 0104_grid_b03_alternating__c04_fixed_stride_large.c
 * Branch: alternating | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0104_grid_b03_alternating__c04_fixed_stride_large.c\n");
