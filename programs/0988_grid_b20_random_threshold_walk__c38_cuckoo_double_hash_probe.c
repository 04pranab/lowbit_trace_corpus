/*
 * LowBit -- 0988_grid_b20_random_threshold_walk__c38_cuckoo_double_hash_probe.c
 * Branch: random_threshold_walk | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0988_grid_b20_random_threshold_walk__c38_cuckoo_double_hash_probe.c\n");
