/*
 * LowBit -- 0342_grid_b07_nested_dependent__c42_cache_oblivious_funnel_stride.c
 * Branch: nested_dependent | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0342_grid_b07_nested_dependent__c42_cache_oblivious_funnel_stride.c\n");
