/*
 * LowBit -- 2231_grid_b45_two_counters_race__c31_fibonacci_stride.c
 * Branch: two_counters_race | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2231_grid_b45_two_counters_race__c31_fibonacci_stride.c\n");
