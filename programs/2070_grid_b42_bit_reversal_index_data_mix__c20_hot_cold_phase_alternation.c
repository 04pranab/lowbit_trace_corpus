/*
 * LowBit -- 2070_grid_b42_bit_reversal_index_data_mix__c20_hot_cold_phase_alternation.c
 * Branch: bit_reversal_index_data_mix | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2070_grid_b42_bit_reversal_index_data_mix__c20_hot_cold_phase_alternation.c\n");
