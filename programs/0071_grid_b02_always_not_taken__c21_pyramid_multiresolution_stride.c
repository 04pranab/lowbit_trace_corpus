/*
 * LowBit -- 0071_grid_b02_always_not_taken__c21_pyramid_multiresolution_stride.c
 * Branch: always_not_taken | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0071_grid_b02_always_not_taken__c21_pyramid_multiresolution_stride.c\n");
