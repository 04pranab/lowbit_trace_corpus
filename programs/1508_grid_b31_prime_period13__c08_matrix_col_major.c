/*
 * LowBit -- 1508_grid_b31_prime_period13__c08_matrix_col_major.c
 * Branch: prime_period13 | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=1508_grid_b31_prime_period13__c08_matrix_col_major.c\n");
