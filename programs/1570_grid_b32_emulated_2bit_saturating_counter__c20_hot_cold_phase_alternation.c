/*
 * LowBit -- 1570_grid_b32_emulated_2bit_saturating_counter__c20_hot_cold_phase_alternation.c
 * Branch: emulated_2bit_saturating_counter | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1570_grid_b32_emulated_2bit_saturating_counter__c20_hot_cold_phase_alternation.c\n");
