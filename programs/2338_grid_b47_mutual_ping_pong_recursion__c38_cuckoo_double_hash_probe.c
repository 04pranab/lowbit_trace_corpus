/*
 * LowBit -- 2338_grid_b47_mutual_ping_pong_recursion__c38_cuckoo_double_hash_probe.c
 * Branch: mutual_ping_pong_recursion | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2338_grid_b47_mutual_ping_pong_recursion__c38_cuckoo_double_hash_probe.c\n");
