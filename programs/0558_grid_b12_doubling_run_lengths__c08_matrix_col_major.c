/*
 * LowBit -- 0558_grid_b12_doubling_run_lengths__c08_matrix_col_major.c
 * Branch: doubling_run_lengths | Cache: matrix_col_major
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0558_grid_b12_doubling_run_lengths__c08_matrix_col_major.c\n");
