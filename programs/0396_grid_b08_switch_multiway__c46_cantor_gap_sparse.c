/*
 * LowBit -- 0396_grid_b08_switch_multiway__c46_cantor_gap_sparse.c
 * Branch: switch_multiway | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0396_grid_b08_switch_multiway__c46_cantor_gap_sparse.c\n");
