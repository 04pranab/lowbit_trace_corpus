/*
 * LowBit -- 0682_grid_b14_four_way_skewed__c32_hilbert_curve_traversal.c
 * Branch: four_way_skewed | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0682_grid_b14_four_way_skewed__c32_hilbert_curve_traversal.c\n");
