/*
 * LowBit -- 2496_grid_b50_hysteresis_debounce__c46_cantor_gap_sparse.c
 * Branch: hysteresis_debounce | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2496_grid_b50_hysteresis_debounce__c46_cantor_gap_sparse.c\n");
