/*
 * LowBit -- 2295_grid_b46_lookup_table_driven__c45_read_hot_write_cold_split.c
 * Branch: lookup_table_driven | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2295_grid_b46_lookup_table_driven__c45_read_hot_write_cold_split.c\n");
