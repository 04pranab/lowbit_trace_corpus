/*
 * LowBit -- 2208_grid_b45_two_counters_race__c08_matrix_col_major.c
 * Branch: two_counters_race | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2208_grid_b45_two_counters_race__c08_matrix_col_major.c\n");
