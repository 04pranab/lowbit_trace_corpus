/*
 * LowBit -- 2297_grid_b46_lookup_table_driven__c47_false_sharing_line_cycle.c
 * Branch: lookup_table_driven | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2297_grid_b46_lookup_table_driven__c47_false_sharing_line_cycle.c\n");
