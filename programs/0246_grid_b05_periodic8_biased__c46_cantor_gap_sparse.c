/*
 * LowBit -- 0246_grid_b05_periodic8_biased__c46_cantor_gap_sparse.c
 * Branch: periodic8_biased | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0246_grid_b05_periodic8_biased__c46_cantor_gap_sparse.c\n");
