/*
 * LowBit -- 1080_grid_b22_drifting_threshold_periodic_reset__c30_gather_scatter_indirect_table.c
 * Branch: drifting_threshold_periodic_reset | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1080_grid_b22_drifting_threshold_periodic_reset__c30_gather_scatter_indirect_table.c\n");
