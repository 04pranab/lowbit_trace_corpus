/*
 * LowBit -- 2283_grid_b46_lookup_table_driven__c33_cache_set_conflict_stress.c
 * Branch: lookup_table_driven | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2283_grid_b46_lookup_table_driven__c33_cache_set_conflict_stress.c\n");
