/*
 * LowBit -- 2269_grid_b46_lookup_table_driven__c19_matrix_diagonal_wavefront.c
 * Branch: lookup_table_driven | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2269_grid_b46_lookup_table_driven__c19_matrix_diagonal_wavefront.c\n");
