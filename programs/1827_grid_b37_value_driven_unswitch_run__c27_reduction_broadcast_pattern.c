/*
 * LowBit -- 1827_grid_b37_value_driven_unswitch_run__c27_reduction_broadcast_pattern.c
 * Branch: value_driven_unswitch_run | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1827_grid_b37_value_driven_unswitch_run__c27_reduction_broadcast_pattern.c\n");
