/*
 * LowBit -- 1780_grid_b36_traffic_light_fsm__c30_gather_scatter_indirect_table.c
 * Branch: traffic_light_fsm | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1780_grid_b36_traffic_light_fsm__c30_gather_scatter_indirect_table.c\n");
