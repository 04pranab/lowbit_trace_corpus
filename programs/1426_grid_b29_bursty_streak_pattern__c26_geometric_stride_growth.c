/*
 * LowBit -- 1426_grid_b29_bursty_streak_pattern__c26_geometric_stride_growth.c
 * Branch: bursty_streak_pattern | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1426_grid_b29_bursty_streak_pattern__c26_geometric_stride_growth.c\n");
