/*
 * LowBit -- 0901_grid_b19_data_dependent_break_trip__c01_sequential_unit_stride.c
 * Branch: data_dependent_break_trip | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0901_grid_b19_data_dependent_break_trip__c01_sequential_unit_stride.c\n");
