/*
 * LowBit -- 1552_grid_b32_emulated_2bit_saturating_counter__c02_sequential_wraparound_large.c
 * Branch: emulated_2bit_saturating_counter | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1552_grid_b32_emulated_2bit_saturating_counter__c02_sequential_wraparound_large.c\n");
