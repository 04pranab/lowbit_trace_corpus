/*
 * LowBit -- 0224_grid_b05_periodic8_biased__c24_banked_interleaved_access.c
 * Branch: periodic8_biased | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0224_grid_b05_periodic8_biased__c24_banked_interleaved_access.c\n");
