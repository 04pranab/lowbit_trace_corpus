/*
 * LowBit -- 0684_grid_b14_four_way_skewed__c34_variable_length_burst_reuse.c
 * Branch: four_way_skewed | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0684_grid_b14_four_way_skewed__c34_variable_length_burst_reuse.c\n");
