/*
 * LowBit -- 2443_grid_b49_interleaved_two_pattern_multiplex__c43_whole_buffer_rotation.c
 * Branch: interleaved_two_pattern_multiplex | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=2443_grid_b49_interleaved_two_pattern_multiplex__c43_whole_buffer_rotation.c\n");
