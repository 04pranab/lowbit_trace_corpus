/*
 * LowBit -- 2148_grid_b43_moving_average_threshold__c48_exponential_backoff_probe.c
 * Branch: moving_average_threshold | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2148_grid_b43_moving_average_threshold__c48_exponential_backoff_probe.c\n");
