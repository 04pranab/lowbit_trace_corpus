/*
 * LowBit -- 0511_grid_b11_value_dependent_threshold__c11_sliding_window.c
 * Branch: value_dependent_threshold | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0511_grid_b11_value_dependent_threshold__c11_sliding_window.c\n");
