/*
 * LowBit -- 0929_grid_b19_data_dependent_break_trip__c29_ping_pong_cache_thrash.c
 * Branch: data_dependent_break_trip | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0929_grid_b19_data_dependent_break_trip__c29_ping_pong_cache_thrash.c\n");
