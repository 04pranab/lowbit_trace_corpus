/*
 * LowBit -- 0488_grid_b10_correlated_history__c38_cuckoo_double_hash_probe.c
 * Branch: correlated_history | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0488_grid_b10_correlated_history__c38_cuckoo_double_hash_probe.c\n");
