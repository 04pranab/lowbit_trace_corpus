/*
 * LowBit -- 2410_grid_b49_interleaved_two_pattern_multiplex__c10_pointer_chase_linked_list.c
 * Branch: interleaved_two_pattern_multiplex | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=2410_grid_b49_interleaved_two_pattern_multiplex__c10_pointer_chase_linked_list.c\n");
