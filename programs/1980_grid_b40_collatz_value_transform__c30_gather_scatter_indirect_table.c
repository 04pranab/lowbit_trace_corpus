/*
 * LowBit -- 1980_grid_b40_collatz_value_transform__c30_gather_scatter_indirect_table.c
 * Branch: collatz_value_transform | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1980_grid_b40_collatz_value_transform__c30_gather_scatter_indirect_table.c\n");
