/*
 * LowBit -- 1749_grid_b35_xorshift_hash_mix__c49_binary_heap_parent_child.c
 * Branch: xorshift_hash_mix | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1749_grid_b35_xorshift_hash_mix__c49_binary_heap_parent_child.c\n");
