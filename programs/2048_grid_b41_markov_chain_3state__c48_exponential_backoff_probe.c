/*
 * LowBit -- 2048_grid_b41_markov_chain_3state__c48_exponential_backoff_probe.c
 * Branch: markov_chain_3state | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2048_grid_b41_markov_chain_3state__c48_exponential_backoff_probe.c\n");
