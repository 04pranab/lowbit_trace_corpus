/*
 * LowBit -- 0631_grid_b13_single_phase_change__c31_fibonacci_stride.c
 * Branch: single_phase_change | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0631_grid_b13_single_phase_change__c31_fibonacci_stride.c\n");
