/*
 * LowBit -- 0508_grid_b11_value_dependent_threshold__c08_matrix_col_major.c
 * Branch: value_dependent_threshold | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0508_grid_b11_value_dependent_threshold__c08_matrix_col_major.c\n");
