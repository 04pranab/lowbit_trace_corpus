/*
 * LowBit -- 2227_grid_b45_two_counters_race__c27_reduction_broadcast_pattern.c
 * Branch: two_counters_race | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2227_grid_b45_two_counters_race__c27_reduction_broadcast_pattern.c\n");
