/*
 * LowBit -- 2529_base_branch_b29_bursty_streak_pattern.c
 * Branch: bursty_streak_pattern | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=2529_base_branch_b29_bursty_streak_pattern.c\n");
