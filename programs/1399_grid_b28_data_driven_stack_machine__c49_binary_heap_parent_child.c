/*
 * LowBit -- 1399_grid_b28_data_driven_stack_machine__c49_binary_heap_parent_child.c
 * Branch: data_driven_stack_machine | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1399_grid_b28_data_driven_stack_machine__c49_binary_heap_parent_child.c\n");
