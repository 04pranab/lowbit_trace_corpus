/*
 * LowBit -- 2019_grid_b41_markov_chain_3state__c19_matrix_diagonal_wavefront.c
 * Branch: markov_chain_3state | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2019_grid_b41_markov_chain_3state__c19_matrix_diagonal_wavefront.c\n");
