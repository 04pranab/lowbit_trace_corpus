/*
 * LowBit -- 0203_grid_b05_periodic8_biased__c03_fixed_stride_small.c
 * Branch: periodic8_biased | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0203_grid_b05_periodic8_biased__c03_fixed_stride_small.c\n");
