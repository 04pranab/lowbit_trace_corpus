/*
 * LowBit -- 0810_grid_b17_correlated_two_branch_xor__c10_pointer_chase_linked_list.c
 * Branch: correlated_two_branch_xor | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0810_grid_b17_correlated_two_branch_xor__c10_pointer_chase_linked_list.c\n");
