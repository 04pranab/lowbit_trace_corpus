/*
 * LowBit -- 2176_grid_b44_exception_then_recovery_burst__c26_geometric_stride_growth.c
 * Branch: exception_then_recovery_burst | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2176_grid_b44_exception_then_recovery_burst__c26_geometric_stride_growth.c\n");
