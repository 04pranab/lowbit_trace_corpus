/*
 * LowBit -- 0403_grid_b09_recursive_calls__c03_fixed_stride_small.c
 * Branch: recursive_calls | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0403_grid_b09_recursive_calls__c03_fixed_stride_small.c\n");
