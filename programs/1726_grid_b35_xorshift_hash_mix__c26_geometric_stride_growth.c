/*
 * LowBit -- 1726_grid_b35_xorshift_hash_mix__c26_geometric_stride_growth.c
 * Branch: xorshift_hash_mix | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1726_grid_b35_xorshift_hash_mix__c26_geometric_stride_growth.c\n");
