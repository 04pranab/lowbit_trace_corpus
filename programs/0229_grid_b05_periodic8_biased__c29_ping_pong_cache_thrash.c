/*
 * LowBit -- 0229_grid_b05_periodic8_biased__c29_ping_pong_cache_thrash.c
 * Branch: periodic8_biased | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0229_grid_b05_periodic8_biased__c29_ping_pong_cache_thrash.c\n");
