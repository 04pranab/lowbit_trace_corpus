/*
 * LowBit -- 2205_grid_b45_two_counters_race__c05_random_small_working_set.c
 * Branch: two_counters_race | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2205_grid_b45_two_counters_race__c05_random_small_working_set.c\n");
