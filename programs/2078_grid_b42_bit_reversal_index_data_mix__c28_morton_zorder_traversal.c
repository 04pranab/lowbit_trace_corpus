/*
 * LowBit -- 2078_grid_b42_bit_reversal_index_data_mix__c28_morton_zorder_traversal.c
 * Branch: bit_reversal_index_data_mix | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2078_grid_b42_bit_reversal_index_data_mix__c28_morton_zorder_traversal.c\n");
