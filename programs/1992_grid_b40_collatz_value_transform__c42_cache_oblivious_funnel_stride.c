/*
 * LowBit -- 1992_grid_b40_collatz_value_transform__c42_cache_oblivious_funnel_stride.c
 * Branch: collatz_value_transform | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1992_grid_b40_collatz_value_transform__c42_cache_oblivious_funnel_stride.c\n");
