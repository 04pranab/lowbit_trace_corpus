/*
 * LowBit -- 1896_grid_b38_decaying_hazard_probability__c46_cantor_gap_sparse.c
 * Branch: decaying_hazard_probability | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1896_grid_b38_decaying_hazard_probability__c46_cantor_gap_sparse.c\n");
