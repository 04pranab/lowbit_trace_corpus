/*
 * LowBit -- 1517_grid_b31_prime_period13__c17_zipf_like_hot_buckets.c
 * Branch: prime_period13 | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=1517_grid_b31_prime_period13__c17_zipf_like_hot_buckets.c\n");
