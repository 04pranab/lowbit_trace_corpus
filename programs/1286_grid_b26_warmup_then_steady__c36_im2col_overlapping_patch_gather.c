/*
 * LowBit -- 1286_grid_b26_warmup_then_steady__c36_im2col_overlapping_patch_gather.c
 * Branch: warmup_then_steady | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1286_grid_b26_warmup_then_steady__c36_im2col_overlapping_patch_gather.c\n");
