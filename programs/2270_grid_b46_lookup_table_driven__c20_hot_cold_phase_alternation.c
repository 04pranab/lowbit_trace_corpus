/*
 * LowBit -- 2270_grid_b46_lookup_table_driven__c20_hot_cold_phase_alternation.c
 * Branch: lookup_table_driven | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2270_grid_b46_lookup_table_driven__c20_hot_cold_phase_alternation.c\n");
