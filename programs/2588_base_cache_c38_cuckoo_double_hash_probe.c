/*
 * LowBit -- 2588_base_cache_c38_cuckoo_double_hash_probe.c
 * Branch: synthetic_always_taken | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=2588_base_cache_c38_cuckoo_double_hash_probe.c\n");
