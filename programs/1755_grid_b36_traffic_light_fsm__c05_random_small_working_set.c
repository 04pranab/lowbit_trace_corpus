/*
 * LowBit -- 1755_grid_b36_traffic_light_fsm__c05_random_small_working_set.c
 * Branch: traffic_light_fsm | Cache: random_small_working_set
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1755_grid_b36_traffic_light_fsm__c05_random_small_working_set.c\n");
