/*
 * LowBit -- 2573_base_cache_c23_struct_of_array_field_burst.c
 * Branch: synthetic_always_taken | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=2573_base_cache_c23_struct_of_array_field_burst.c\n");
