/*
 * LowBit -- 0493_grid_b10_correlated_history__c43_whole_buffer_rotation.c
 * Branch: correlated_history | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0493_grid_b10_correlated_history__c43_whole_buffer_rotation.c\n");
