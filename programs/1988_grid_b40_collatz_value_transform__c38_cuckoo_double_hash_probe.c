/*
 * LowBit -- 1988_grid_b40_collatz_value_transform__c38_cuckoo_double_hash_probe.c
 * Branch: collatz_value_transform | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1988_grid_b40_collatz_value_transform__c38_cuckoo_double_hash_probe.c\n");
