/*
 * LowBit -- 1460_grid_b30_periodic_interrupt_override__c10_pointer_chase_linked_list.c
 * Branch: periodic_interrupt_override | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=1460_grid_b30_periodic_interrupt_override__c10_pointer_chase_linked_list.c\n");
