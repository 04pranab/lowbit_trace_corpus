/*
 * LowBit -- 0742_grid_b15_manual_unroll4_sparse__c42_cache_oblivious_funnel_stride.c
 * Branch: manual_unroll4_sparse | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0742_grid_b15_manual_unroll4_sparse__c42_cache_oblivious_funnel_stride.c\n");
