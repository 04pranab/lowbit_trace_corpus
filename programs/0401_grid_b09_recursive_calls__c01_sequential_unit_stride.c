/*
 * LowBit -- 0401_grid_b09_recursive_calls__c01_sequential_unit_stride.c
 * Branch: recursive_calls | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0401_grid_b09_recursive_calls__c01_sequential_unit_stride.c\n");
