/*
 * LowBit -- 1955_grid_b40_collatz_value_transform__c05_random_small_working_set.c
 * Branch: collatz_value_transform | Cache: random_small_working_set
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1955_grid_b40_collatz_value_transform__c05_random_small_working_set.c\n");
