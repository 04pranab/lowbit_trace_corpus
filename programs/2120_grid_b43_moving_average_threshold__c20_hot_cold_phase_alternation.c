/*
 * LowBit -- 2120_grid_b43_moving_average_threshold__c20_hot_cold_phase_alternation.c
 * Branch: moving_average_threshold | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2120_grid_b43_moving_average_threshold__c20_hot_cold_phase_alternation.c\n");
