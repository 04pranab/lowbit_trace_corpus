/*
 * LowBit -- 2290_grid_b46_lookup_table_driven__c40_causal_attention_triangular.c
 * Branch: lookup_table_driven | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2290_grid_b46_lookup_table_driven__c40_causal_attention_triangular.c\n");
