/*
 * LowBit -- 1115_grid_b23_popcount_parity__c15_reverse_sequential.c
 * Branch: popcount_parity | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1115_grid_b23_popcount_parity__c15_reverse_sequential.c\n");
