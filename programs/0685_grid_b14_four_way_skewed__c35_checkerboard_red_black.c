/*
 * LowBit -- 0685_grid_b14_four_way_skewed__c35_checkerboard_red_black.c
 * Branch: four_way_skewed | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0685_grid_b14_four_way_skewed__c35_checkerboard_red_black.c\n");
