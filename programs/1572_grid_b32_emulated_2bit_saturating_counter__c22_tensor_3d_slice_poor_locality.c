/*
 * LowBit -- 1572_grid_b32_emulated_2bit_saturating_counter__c22_tensor_3d_slice_poor_locality.c
 * Branch: emulated_2bit_saturating_counter | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1572_grid_b32_emulated_2bit_saturating_counter__c22_tensor_3d_slice_poor_locality.c\n");
