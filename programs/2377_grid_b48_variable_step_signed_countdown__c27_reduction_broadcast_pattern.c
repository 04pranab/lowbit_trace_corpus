/*
 * LowBit -- 2377_grid_b48_variable_step_signed_countdown__c27_reduction_broadcast_pattern.c
 * Branch: variable_step_signed_countdown | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2377_grid_b48_variable_step_signed_countdown__c27_reduction_broadcast_pattern.c\n");
