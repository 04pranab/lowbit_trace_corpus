/*
 * LowBit -- 0735_grid_b15_manual_unroll4_sparse__c35_checkerboard_red_black.c
 * Branch: manual_unroll4_sparse | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0735_grid_b15_manual_unroll4_sparse__c35_checkerboard_red_black.c\n");
