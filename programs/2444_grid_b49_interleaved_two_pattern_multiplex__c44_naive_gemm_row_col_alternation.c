/*
 * LowBit -- 2444_grid_b49_interleaved_two_pattern_multiplex__c44_naive_gemm_row_col_alternation.c
 * Branch: interleaved_two_pattern_multiplex | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=2444_grid_b49_interleaved_two_pattern_multiplex__c44_naive_gemm_row_col_alternation.c\n");
