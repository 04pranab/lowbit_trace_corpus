/*
 * LowBit -- 1363_grid_b28_data_driven_stack_machine__c13_two_stream_interleaved.c
 * Branch: data_driven_stack_machine | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1363_grid_b28_data_driven_stack_machine__c13_two_stream_interleaved.c\n");
