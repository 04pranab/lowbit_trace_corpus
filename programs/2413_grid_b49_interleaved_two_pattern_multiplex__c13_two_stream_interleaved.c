/*
 * LowBit -- 2413_grid_b49_interleaved_two_pattern_multiplex__c13_two_stream_interleaved.c
 * Branch: interleaved_two_pattern_multiplex | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=2413_grid_b49_interleaved_two_pattern_multiplex__c13_two_stream_interleaved.c\n");
