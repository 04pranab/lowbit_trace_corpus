/*
 * LowBit -- 0720_grid_b15_manual_unroll4_sparse__c20_hot_cold_phase_alternation.c
 * Branch: manual_unroll4_sparse | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0720_grid_b15_manual_unroll4_sparse__c20_hot_cold_phase_alternation.c\n");
