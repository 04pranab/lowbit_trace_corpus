/*
 * LowBit -- 0649_grid_b13_single_phase_change__c49_binary_heap_parent_child.c
 * Branch: single_phase_change | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0649_grid_b13_single_phase_change__c49_binary_heap_parent_child.c\n");
