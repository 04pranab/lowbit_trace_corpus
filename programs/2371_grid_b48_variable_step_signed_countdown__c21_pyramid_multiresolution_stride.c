/*
 * LowBit -- 2371_grid_b48_variable_step_signed_countdown__c21_pyramid_multiresolution_stride.c
 * Branch: variable_step_signed_countdown | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2371_grid_b48_variable_step_signed_countdown__c21_pyramid_multiresolution_stride.c\n");
