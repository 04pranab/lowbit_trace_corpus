/*
 * LowBit -- 0637_grid_b13_single_phase_change__c37_double_buffer_epoch_alternation.c
 * Branch: single_phase_change | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0637_grid_b13_single_phase_change__c37_double_buffer_epoch_alternation.c\n");
