/*
 * LowBit -- 0459_grid_b10_correlated_history__c09_matrix_tiled_blocked.c
 * Branch: correlated_history | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0459_grid_b10_correlated_history__c09_matrix_tiled_blocked.c\n");
