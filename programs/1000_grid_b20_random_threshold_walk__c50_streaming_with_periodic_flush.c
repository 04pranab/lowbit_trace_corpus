/*
 * LowBit -- 1000_grid_b20_random_threshold_walk__c50_streaming_with_periodic_flush.c
 * Branch: random_threshold_walk | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=1000_grid_b20_random_threshold_walk__c50_streaming_with_periodic_flush.c\n");
