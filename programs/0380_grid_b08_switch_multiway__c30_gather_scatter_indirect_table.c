/*
 * LowBit -- 0380_grid_b08_switch_multiway__c30_gather_scatter_indirect_table.c
 * Branch: switch_multiway | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0380_grid_b08_switch_multiway__c30_gather_scatter_indirect_table.c\n");
