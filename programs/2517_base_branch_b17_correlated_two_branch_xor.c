/*
 * LowBit -- 2517_base_branch_b17_correlated_two_branch_xor.c
 * Branch: correlated_two_branch_xor | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=2517_base_branch_b17_correlated_two_branch_xor.c\n");
