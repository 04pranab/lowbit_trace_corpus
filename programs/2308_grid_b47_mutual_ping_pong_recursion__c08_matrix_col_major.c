/*
 * LowBit -- 2308_grid_b47_mutual_ping_pong_recursion__c08_matrix_col_major.c
 * Branch: mutual_ping_pong_recursion | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2308_grid_b47_mutual_ping_pong_recursion__c08_matrix_col_major.c\n");
