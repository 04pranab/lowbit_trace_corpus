/*
 * LowBit -- 1952_grid_b40_collatz_value_transform__c02_sequential_wraparound_large.c
 * Branch: collatz_value_transform | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1952_grid_b40_collatz_value_transform__c02_sequential_wraparound_large.c\n");
