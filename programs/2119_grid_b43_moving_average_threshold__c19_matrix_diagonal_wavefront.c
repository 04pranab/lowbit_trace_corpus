/*
 * LowBit -- 2119_grid_b43_moving_average_threshold__c19_matrix_diagonal_wavefront.c
 * Branch: moving_average_threshold | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static uint32_t hist43_[4] = {0u, 0u, 0u, 0u}; static int pos43_ = 0;
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2119_grid_b43_moving_average_threshold__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=moving_average_threshold\n");
