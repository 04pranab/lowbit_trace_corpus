/*
 * LowBit -- 1144_grid_b23_popcount_parity__c44_naive_gemm_row_col_alternation.c
 * Branch: popcount_parity | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1144_grid_b23_popcount_parity__c44_naive_gemm_row_col_alternation.c\n");
