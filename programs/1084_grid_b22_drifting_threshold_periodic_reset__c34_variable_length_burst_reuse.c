/*
 * LowBit -- 1084_grid_b22_drifting_threshold_periodic_reset__c34_variable_length_burst_reuse.c
 * Branch: drifting_threshold_periodic_reset | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1084_grid_b22_drifting_threshold_periodic_reset__c34_variable_length_burst_reuse.c\n");
