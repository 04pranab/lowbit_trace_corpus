/*
 * LowBit -- 0407_grid_b09_recursive_calls__c07_matrix_row_major.c
 * Branch: recursive_calls | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0407_grid_b09_recursive_calls__c07_matrix_row_major.c\n");
