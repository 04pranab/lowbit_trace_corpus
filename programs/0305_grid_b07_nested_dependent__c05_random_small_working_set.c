/*
 * LowBit -- 0305_grid_b07_nested_dependent__c05_random_small_working_set.c
 * Branch: nested_dependent | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0305_grid_b07_nested_dependent__c05_random_small_working_set.c\n");
