/*
 * LowBit -- 1416_grid_b29_bursty_streak_pattern__c16_block_sparse.c
 * Branch: bursty_streak_pattern | Cache: block_sparse
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1416_grid_b29_bursty_streak_pattern__c16_block_sparse.c\n");
