/*
 * LowBit -- 1469_grid_b30_periodic_interrupt_override__c19_matrix_diagonal_wavefront.c
 * Branch: periodic_interrupt_override | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=1469_grid_b30_periodic_interrupt_override__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=periodic_interrupt_override\n");
