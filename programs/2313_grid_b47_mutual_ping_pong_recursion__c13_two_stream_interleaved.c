/*
 * LowBit -- 2313_grid_b47_mutual_ping_pong_recursion__c13_two_stream_interleaved.c
 * Branch: mutual_ping_pong_recursion | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2313_grid_b47_mutual_ping_pong_recursion__c13_two_stream_interleaved.c\n");
