/*
 * LowBit -- 0494_grid_b10_correlated_history__c44_naive_gemm_row_col_alternation.c
 * Branch: correlated_history | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0494_grid_b10_correlated_history__c44_naive_gemm_row_col_alternation.c\n");
