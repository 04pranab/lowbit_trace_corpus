/*
 * LowBit -- 0904_grid_b19_data_dependent_break_trip__c04_fixed_stride_large.c
 * Branch: data_dependent_break_trip | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0904_grid_b19_data_dependent_break_trip__c04_fixed_stride_large.c\n");
