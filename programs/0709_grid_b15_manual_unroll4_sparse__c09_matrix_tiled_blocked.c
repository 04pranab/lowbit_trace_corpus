/*
 * LowBit -- 0709_grid_b15_manual_unroll4_sparse__c09_matrix_tiled_blocked.c
 * Branch: manual_unroll4_sparse | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0709_grid_b15_manual_unroll4_sparse__c09_matrix_tiled_blocked.c\n");
