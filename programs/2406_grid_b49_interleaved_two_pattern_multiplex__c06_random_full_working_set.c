/*
 * LowBit -- 2406_grid_b49_interleaved_two_pattern_multiplex__c06_random_full_working_set.c
 * Branch: interleaved_two_pattern_multiplex | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=2406_grid_b49_interleaved_two_pattern_multiplex__c06_random_full_working_set.c\n");
