/*
 * LowBit -- 2455_grid_b50_hysteresis_debounce__c05_random_small_working_set.c
 * Branch: hysteresis_debounce | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2455_grid_b50_hysteresis_debounce__c05_random_small_working_set.c\n");
