/*
 * LowBit -- 0027_grid_b01_always_taken__c27_reduction_broadcast_pattern.c
 * Branch: always_taken | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0027_grid_b01_always_taken__c27_reduction_broadcast_pattern.c\n");
