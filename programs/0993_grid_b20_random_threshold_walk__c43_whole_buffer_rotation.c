/*
 * LowBit -- 0993_grid_b20_random_threshold_walk__c43_whole_buffer_rotation.c
 * Branch: random_threshold_walk | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0993_grid_b20_random_threshold_walk__c43_whole_buffer_rotation.c\n");
