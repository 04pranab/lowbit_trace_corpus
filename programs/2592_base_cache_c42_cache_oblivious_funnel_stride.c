/*
 * LowBit -- 2592_base_cache_c42_cache_oblivious_funnel_stride.c
 * Branch: synthetic_always_taken | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=2592_base_cache_c42_cache_oblivious_funnel_stride.c\n");
