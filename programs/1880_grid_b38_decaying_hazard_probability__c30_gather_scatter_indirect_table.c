/*
 * LowBit -- 1880_grid_b38_decaying_hazard_probability__c30_gather_scatter_indirect_table.c
 * Branch: decaying_hazard_probability | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1880_grid_b38_decaying_hazard_probability__c30_gather_scatter_indirect_table.c\n");
