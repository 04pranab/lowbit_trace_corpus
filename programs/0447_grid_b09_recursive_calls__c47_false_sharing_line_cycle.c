/*
 * LowBit -- 0447_grid_b09_recursive_calls__c47_false_sharing_line_cycle.c
 * Branch: recursive_calls | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0447_grid_b09_recursive_calls__c47_false_sharing_line_cycle.c\n");
