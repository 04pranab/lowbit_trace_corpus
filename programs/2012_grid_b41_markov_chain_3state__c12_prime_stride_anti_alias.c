/*
 * LowBit -- 2012_grid_b41_markov_chain_3state__c12_prime_stride_anti_alias.c
 * Branch: markov_chain_3state | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2012_grid_b41_markov_chain_3state__c12_prime_stride_anti_alias.c\n");
