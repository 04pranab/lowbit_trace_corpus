/*
 * LowBit -- 2396_grid_b48_variable_step_signed_countdown__c46_cantor_gap_sparse.c
 * Branch: variable_step_signed_countdown | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2396_grid_b48_variable_step_signed_countdown__c46_cantor_gap_sparse.c\n");
