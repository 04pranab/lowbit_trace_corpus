/*
 * LowBit -- 0884_grid_b18_indirect_fn_dispatch__c34_variable_length_burst_reuse.c
 * Branch: indirect_fn_dispatch | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0884_grid_b18_indirect_fn_dispatch__c34_variable_length_burst_reuse.c\n");
