/*
 * LowBit -- 2209_grid_b45_two_counters_race__c09_matrix_tiled_blocked.c
 * Branch: two_counters_race | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2209_grid_b45_two_counters_race__c09_matrix_tiled_blocked.c\n");
