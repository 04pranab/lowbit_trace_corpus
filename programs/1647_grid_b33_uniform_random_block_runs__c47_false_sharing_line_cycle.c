/*
 * LowBit -- 1647_grid_b33_uniform_random_block_runs__c47_false_sharing_line_cycle.c
 * Branch: uniform_random_block_runs | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        const uint32_t NTHREADS47_ = 4u; const uint32_t LINEWIDTH47_ = 16u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t thread47_ = (uint32_t)(i % NTHREADS47_);
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1647_grid_b33_uniform_random_block_runs__c47_false_sharing_line_cycle.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=false_sharing_line_cycle\n");
