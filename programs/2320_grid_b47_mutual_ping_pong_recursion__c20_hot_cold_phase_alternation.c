/*
 * LowBit -- 2320_grid_b47_mutual_ping_pong_recursion__c20_hot_cold_phase_alternation.c
 * Branch: mutual_ping_pong_recursion | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2320_grid_b47_mutual_ping_pong_recursion__c20_hot_cold_phase_alternation.c\n");
