/*
 * LowBit -- 1871_grid_b38_decaying_hazard_probability__c21_pyramid_multiresolution_stride.c
 * Branch: decaying_hazard_probability | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1871_grid_b38_decaying_hazard_probability__c21_pyramid_multiresolution_stride.c\n");
