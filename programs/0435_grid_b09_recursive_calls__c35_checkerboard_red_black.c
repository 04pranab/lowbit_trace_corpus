/*
 * LowBit -- 0435_grid_b09_recursive_calls__c35_checkerboard_red_black.c
 * Branch: recursive_calls | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0435_grid_b09_recursive_calls__c35_checkerboard_red_black.c\n");
