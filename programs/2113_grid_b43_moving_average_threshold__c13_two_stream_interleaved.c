/*
 * LowBit -- 2113_grid_b43_moving_average_threshold__c13_two_stream_interleaved.c
 * Branch: moving_average_threshold | Cache: two_stream_interleaved
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2113_grid_b43_moving_average_threshold__c13_two_stream_interleaved.c\n");
