/*
 * LowBit -- 1981_grid_b40_collatz_value_transform__c31_fibonacci_stride.c
 * Branch: collatz_value_transform | Cache: fibonacci_stride
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1981_grid_b40_collatz_value_transform__c31_fibonacci_stride.c\n");
