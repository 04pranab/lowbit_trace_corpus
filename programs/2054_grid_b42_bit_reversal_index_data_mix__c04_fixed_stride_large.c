/*
 * LowBit -- 2054_grid_b42_bit_reversal_index_data_mix__c04_fixed_stride_large.c
 * Branch: bit_reversal_index_data_mix | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2054_grid_b42_bit_reversal_index_data_mix__c04_fixed_stride_large.c\n");
