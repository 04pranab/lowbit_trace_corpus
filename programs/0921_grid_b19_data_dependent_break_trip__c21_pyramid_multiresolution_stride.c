/*
 * LowBit -- 0921_grid_b19_data_dependent_break_trip__c21_pyramid_multiresolution_stride.c
 * Branch: data_dependent_break_trip | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0921_grid_b19_data_dependent_break_trip__c21_pyramid_multiresolution_stride.c\n");
