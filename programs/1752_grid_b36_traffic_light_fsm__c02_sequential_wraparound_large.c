/*
 * LowBit -- 1752_grid_b36_traffic_light_fsm__c02_sequential_wraparound_large.c
 * Branch: traffic_light_fsm | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1752_grid_b36_traffic_light_fsm__c02_sequential_wraparound_large.c\n");
