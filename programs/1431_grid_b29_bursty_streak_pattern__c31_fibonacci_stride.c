/*
 * LowBit -- 1431_grid_b29_bursty_streak_pattern__c31_fibonacci_stride.c
 * Branch: bursty_streak_pattern | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1431_grid_b29_bursty_streak_pattern__c31_fibonacci_stride.c\n");
