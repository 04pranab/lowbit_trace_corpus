/*
 * LowBit -- 1901_grid_b39_dual_lcg_xor_chaos__c01_sequential_unit_stride.c
 * Branch: dual_lcg_xor_chaos | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1901_grid_b39_dual_lcg_xor_chaos__c01_sequential_unit_stride.c\n");
