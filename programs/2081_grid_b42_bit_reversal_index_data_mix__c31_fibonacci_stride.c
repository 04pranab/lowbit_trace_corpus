/*
 * LowBit -- 2081_grid_b42_bit_reversal_index_data_mix__c31_fibonacci_stride.c
 * Branch: bit_reversal_index_data_mix | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2081_grid_b42_bit_reversal_index_data_mix__c31_fibonacci_stride.c\n");
