/*
 * LowBit -- 2497_grid_b50_hysteresis_debounce__c47_false_sharing_line_cycle.c
 * Branch: hysteresis_debounce | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2497_grid_b50_hysteresis_debounce__c47_false_sharing_line_cycle.c\n");
