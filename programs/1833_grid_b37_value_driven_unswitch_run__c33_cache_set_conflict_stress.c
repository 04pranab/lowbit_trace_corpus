/*
 * LowBit -- 1833_grid_b37_value_driven_unswitch_run__c33_cache_set_conflict_stress.c
 * Branch: value_driven_unswitch_run | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1833_grid_b37_value_driven_unswitch_run__c33_cache_set_conflict_stress.c\n");
