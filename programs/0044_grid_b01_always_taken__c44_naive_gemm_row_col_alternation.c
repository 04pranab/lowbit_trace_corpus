/*
 * LowBit -- 0044_grid_b01_always_taken__c44_naive_gemm_row_col_alternation.c
 * Branch: always_taken | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0044_grid_b01_always_taken__c44_naive_gemm_row_col_alternation.c\n");
