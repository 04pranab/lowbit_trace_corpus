/*
 * LowBit -- 1479_grid_b30_periodic_interrupt_override__c29_ping_pong_cache_thrash.c
 * Branch: periodic_interrupt_override | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=1479_grid_b30_periodic_interrupt_override__c29_ping_pong_cache_thrash.c\n");
