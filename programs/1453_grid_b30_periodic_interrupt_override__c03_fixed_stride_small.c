/*
 * LowBit -- 1453_grid_b30_periodic_interrupt_override__c03_fixed_stride_small.c
 * Branch: periodic_interrupt_override | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=1453_grid_b30_periodic_interrupt_override__c03_fixed_stride_small.c\n");
