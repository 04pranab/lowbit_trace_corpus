/*
 * LowBit -- 1997_grid_b40_collatz_value_transform__c47_false_sharing_line_cycle.c
 * Branch: collatz_value_transform | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1997_grid_b40_collatz_value_transform__c47_false_sharing_line_cycle.c\n");
