/*
 * LowBit -- 2235_grid_b45_two_counters_race__c35_checkerboard_red_black.c
 * Branch: two_counters_race | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2235_grid_b45_two_counters_race__c35_checkerboard_red_black.c\n");
