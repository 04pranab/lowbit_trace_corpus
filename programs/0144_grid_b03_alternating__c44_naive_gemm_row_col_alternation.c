/*
 * LowBit -- 0144_grid_b03_alternating__c44_naive_gemm_row_col_alternation.c
 * Branch: alternating | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0144_grid_b03_alternating__c44_naive_gemm_row_col_alternation.c\n");
