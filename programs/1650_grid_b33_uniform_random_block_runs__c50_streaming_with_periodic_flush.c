/*
 * LowBit -- 1650_grid_b33_uniform_random_block_runs__c50_streaming_with_periodic_flush.c
 * Branch: uniform_random_block_runs | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1650_grid_b33_uniform_random_block_runs__c50_streaming_with_periodic_flush.c\n");
