/*
 * LowBit -- 1912_grid_b39_dual_lcg_xor_chaos__c12_prime_stride_anti_alias.c
 * Branch: dual_lcg_xor_chaos | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1912_grid_b39_dual_lcg_xor_chaos__c12_prime_stride_anti_alias.c\n");
