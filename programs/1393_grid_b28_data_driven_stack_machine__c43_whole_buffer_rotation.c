/*
 * LowBit -- 1393_grid_b28_data_driven_stack_machine__c43_whole_buffer_rotation.c
 * Branch: data_driven_stack_machine | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1393_grid_b28_data_driven_stack_machine__c43_whole_buffer_rotation.c\n");
