/*
 * LowBit -- 0603_grid_b13_single_phase_change__c03_fixed_stride_small.c
 * Branch: single_phase_change | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0603_grid_b13_single_phase_change__c03_fixed_stride_small.c\n");
