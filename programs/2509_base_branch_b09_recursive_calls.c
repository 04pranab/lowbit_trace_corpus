/*
 * LowBit -- 2509_base_branch_b09_recursive_calls.c
 * Branch: recursive_calls | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=2509_base_branch_b09_recursive_calls.c\n");
