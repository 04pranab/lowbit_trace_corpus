/*
 * LowBit -- 2470_grid_b50_hysteresis_debounce__c20_hot_cold_phase_alternation.c
 * Branch: hysteresis_debounce | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2470_grid_b50_hysteresis_debounce__c20_hot_cold_phase_alternation.c\n");
