/*
 * LowBit -- 2584_base_cache_c34_variable_length_burst_reuse.c
 * Branch: synthetic_always_taken | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=2584_base_cache_c34_variable_length_burst_reuse.c\n");
