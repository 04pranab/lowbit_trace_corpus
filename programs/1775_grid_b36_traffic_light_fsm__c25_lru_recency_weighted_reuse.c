/*
 * LowBit -- 1775_grid_b36_traffic_light_fsm__c25_lru_recency_weighted_reuse.c
 * Branch: traffic_light_fsm | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1775_grid_b36_traffic_light_fsm__c25_lru_recency_weighted_reuse.c\n");
