/*
 * LowBit -- 0326_grid_b07_nested_dependent__c26_geometric_stride_growth.c
 * Branch: nested_dependent | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0326_grid_b07_nested_dependent__c26_geometric_stride_growth.c\n");
