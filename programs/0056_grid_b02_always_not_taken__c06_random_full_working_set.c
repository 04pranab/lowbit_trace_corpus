/*
 * LowBit -- 0056_grid_b02_always_not_taken__c06_random_full_working_set.c
 * Branch: always_not_taken | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0056_grid_b02_always_not_taken__c06_random_full_working_set.c\n");
