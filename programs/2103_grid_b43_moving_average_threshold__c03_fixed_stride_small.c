/*
 * LowBit -- 2103_grid_b43_moving_average_threshold__c03_fixed_stride_small.c
 * Branch: moving_average_threshold | Cache: fixed_stride_small
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2103_grid_b43_moving_average_threshold__c03_fixed_stride_small.c\n");
