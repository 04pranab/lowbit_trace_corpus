/*
 * LowBit -- 2567_base_cache_c17_zipf_like_hot_buckets.c
 * Branch: synthetic_always_taken | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=2567_base_cache_c17_zipf_like_hot_buckets.c\n");
