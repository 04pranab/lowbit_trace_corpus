/*
 * LowBit -- 0690_grid_b14_four_way_skewed__c40_causal_attention_triangular.c
 * Branch: four_way_skewed | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0690_grid_b14_four_way_skewed__c40_causal_attention_triangular.c\n");
