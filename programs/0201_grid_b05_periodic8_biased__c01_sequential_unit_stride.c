/*
 * LowBit -- 0201_grid_b05_periodic8_biased__c01_sequential_unit_stride.c
 * Branch: periodic8_biased | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0201_grid_b05_periodic8_biased__c01_sequential_unit_stride.c\n");
