/*
 * LowBit -- 0766_grid_b16_sentinel_search_loop__c16_block_sparse.c
 * Branch: sentinel_search_loop | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0766_grid_b16_sentinel_search_loop__c16_block_sparse.c\n");
