/*
 * LowBit -- 1379_grid_b28_data_driven_stack_machine__c29_ping_pong_cache_thrash.c
 * Branch: data_driven_stack_machine | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1379_grid_b28_data_driven_stack_machine__c29_ping_pong_cache_thrash.c\n");
