/*
 * LowBit -- 2552_base_cache_c02_sequential_wraparound_large.c
 * Branch: synthetic_always_taken | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=2552_base_cache_c02_sequential_wraparound_large.c\n");
