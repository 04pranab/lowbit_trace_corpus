/*
 * LowBit -- 2298_grid_b46_lookup_table_driven__c48_exponential_backoff_probe.c
 * Branch: lookup_table_driven | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2298_grid_b46_lookup_table_driven__c48_exponential_backoff_probe.c\n");
