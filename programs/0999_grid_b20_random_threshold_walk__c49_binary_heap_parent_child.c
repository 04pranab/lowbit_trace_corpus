/*
 * LowBit -- 0999_grid_b20_random_threshold_walk__c49_binary_heap_parent_child.c
 * Branch: random_threshold_walk | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0999_grid_b20_random_threshold_walk__c49_binary_heap_parent_child.c\n");
