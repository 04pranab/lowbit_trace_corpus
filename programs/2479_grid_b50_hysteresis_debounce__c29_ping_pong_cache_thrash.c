/*
 * LowBit -- 2479_grid_b50_hysteresis_debounce__c29_ping_pong_cache_thrash.c
 * Branch: hysteresis_debounce | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2479_grid_b50_hysteresis_debounce__c29_ping_pong_cache_thrash.c\n");
