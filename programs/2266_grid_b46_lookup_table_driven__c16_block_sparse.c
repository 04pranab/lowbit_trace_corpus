/*
 * LowBit -- 2266_grid_b46_lookup_table_driven__c16_block_sparse.c
 * Branch: lookup_table_driven | Cache: block_sparse
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2266_grid_b46_lookup_table_driven__c16_block_sparse.c\n");
