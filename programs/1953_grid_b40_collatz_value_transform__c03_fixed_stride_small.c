/*
 * LowBit -- 1953_grid_b40_collatz_value_transform__c03_fixed_stride_small.c
 * Branch: collatz_value_transform | Cache: fixed_stride_small
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1953_grid_b40_collatz_value_transform__c03_fixed_stride_small.c\n");
