/*
 * LowBit -- 1382_grid_b28_data_driven_stack_machine__c32_hilbert_curve_traversal.c
 * Branch: data_driven_stack_machine | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1382_grid_b28_data_driven_stack_machine__c32_hilbert_curve_traversal.c\n");
