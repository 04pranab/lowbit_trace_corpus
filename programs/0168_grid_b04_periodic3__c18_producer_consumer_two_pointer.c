/*
 * LowBit -- 0168_grid_b04_periodic3__c18_producer_consumer_two_pointer.c
 * Branch: periodic3 | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0168_grid_b04_periodic3__c18_producer_consumer_two_pointer.c\n");
