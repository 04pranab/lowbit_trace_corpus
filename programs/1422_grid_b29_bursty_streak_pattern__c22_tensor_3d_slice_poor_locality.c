/*
 * LowBit -- 1422_grid_b29_bursty_streak_pattern__c22_tensor_3d_slice_poor_locality.c
 * Branch: bursty_streak_pattern | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1422_grid_b29_bursty_streak_pattern__c22_tensor_3d_slice_poor_locality.c\n");
