/*
 * LowBit -- 2558_base_cache_c08_matrix_col_major.c
 * Branch: synthetic_always_taken | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=2558_base_cache_c08_matrix_col_major.c\n");
