/*
 * LowBit -- 1702_grid_b35_xorshift_hash_mix__c02_sequential_wraparound_large.c
 * Branch: xorshift_hash_mix | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1702_grid_b35_xorshift_hash_mix__c02_sequential_wraparound_large.c\n");
