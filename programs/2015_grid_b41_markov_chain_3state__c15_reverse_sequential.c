/*
 * LowBit -- 2015_grid_b41_markov_chain_3state__c15_reverse_sequential.c
 * Branch: markov_chain_3state | Cache: reverse_sequential
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2015_grid_b41_markov_chain_3state__c15_reverse_sequential.c\n");
