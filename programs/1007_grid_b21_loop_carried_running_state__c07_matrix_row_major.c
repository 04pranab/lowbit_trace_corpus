/*
 * LowBit -- 1007_grid_b21_loop_carried_running_state__c07_matrix_row_major.c
 * Branch: loop_carried_running_state | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=1007_grid_b21_loop_carried_running_state__c07_matrix_row_major.c\n");
