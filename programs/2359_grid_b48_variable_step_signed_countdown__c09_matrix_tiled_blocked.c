/*
 * LowBit -- 2359_grid_b48_variable_step_signed_countdown__c09_matrix_tiled_blocked.c
 * Branch: variable_step_signed_countdown | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2359_grid_b48_variable_step_signed_countdown__c09_matrix_tiled_blocked.c\n");
