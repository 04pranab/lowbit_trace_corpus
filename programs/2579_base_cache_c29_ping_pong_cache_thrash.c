/*
 * LowBit -- 2579_base_cache_c29_ping_pong_cache_thrash.c
 * Branch: synthetic_always_taken | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=2579_base_cache_c29_ping_pong_cache_thrash.c\n");
