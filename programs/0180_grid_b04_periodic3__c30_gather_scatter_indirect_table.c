/*
 * LowBit -- 0180_grid_b04_periodic3__c30_gather_scatter_indirect_table.c
 * Branch: periodic3 | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0180_grid_b04_periodic3__c30_gather_scatter_indirect_table.c\n");
