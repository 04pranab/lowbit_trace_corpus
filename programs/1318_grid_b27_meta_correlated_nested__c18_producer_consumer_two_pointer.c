/*
 * LowBit -- 1318_grid_b27_meta_correlated_nested__c18_producer_consumer_two_pointer.c
 * Branch: meta_correlated_nested | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1318_grid_b27_meta_correlated_nested__c18_producer_consumer_two_pointer.c\n");
