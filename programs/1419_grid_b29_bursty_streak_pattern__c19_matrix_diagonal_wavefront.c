/*
 * LowBit -- 1419_grid_b29_bursty_streak_pattern__c19_matrix_diagonal_wavefront.c
 * Branch: bursty_streak_pattern | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static int burst29_remaining_ = 0;
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1419_grid_b29_bursty_streak_pattern__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=bursty_streak_pattern\n");
