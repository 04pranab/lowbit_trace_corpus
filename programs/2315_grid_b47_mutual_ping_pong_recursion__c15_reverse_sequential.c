/*
 * LowBit -- 2315_grid_b47_mutual_ping_pong_recursion__c15_reverse_sequential.c
 * Branch: mutual_ping_pong_recursion | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2315_grid_b47_mutual_ping_pong_recursion__c15_reverse_sequential.c\n");
