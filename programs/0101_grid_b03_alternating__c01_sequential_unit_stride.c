/*
 * LowBit -- 0101_grid_b03_alternating__c01_sequential_unit_stride.c
 * Branch: alternating | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0101_grid_b03_alternating__c01_sequential_unit_stride.c\n");
