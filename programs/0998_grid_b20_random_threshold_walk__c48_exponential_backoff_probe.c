/*
 * LowBit -- 0998_grid_b20_random_threshold_walk__c48_exponential_backoff_probe.c
 * Branch: random_threshold_walk | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0998_grid_b20_random_threshold_walk__c48_exponential_backoff_probe.c\n");
