/*
 * LowBit -- 1941_grid_b39_dual_lcg_xor_chaos__c41_skip_list_multilevel_hop.c
 * Branch: dual_lcg_xor_chaos | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1941_grid_b39_dual_lcg_xor_chaos__c41_skip_list_multilevel_hop.c\n");
