/*
 * LowBit -- 2131_grid_b43_moving_average_threshold__c31_fibonacci_stride.c
 * Branch: moving_average_threshold | Cache: fibonacci_stride
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2131_grid_b43_moving_average_threshold__c31_fibonacci_stride.c\n");
