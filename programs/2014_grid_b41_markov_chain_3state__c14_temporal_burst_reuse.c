/*
 * LowBit -- 2014_grid_b41_markov_chain_3state__c14_temporal_burst_reuse.c
 * Branch: markov_chain_3state | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2014_grid_b41_markov_chain_3state__c14_temporal_burst_reuse.c\n");
