/*
 * LowBit -- 2133_grid_b43_moving_average_threshold__c33_cache_set_conflict_stress.c
 * Branch: moving_average_threshold | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2133_grid_b43_moving_average_threshold__c33_cache_set_conflict_stress.c\n");
