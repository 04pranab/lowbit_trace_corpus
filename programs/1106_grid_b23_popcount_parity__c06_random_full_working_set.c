/*
 * LowBit -- 1106_grid_b23_popcount_parity__c06_random_full_working_set.c
 * Branch: popcount_parity | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1106_grid_b23_popcount_parity__c06_random_full_working_set.c\n");
