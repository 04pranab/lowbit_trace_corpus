/*
 * LowBit -- 1852_grid_b38_decaying_hazard_probability__c02_sequential_wraparound_large.c
 * Branch: decaying_hazard_probability | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1852_grid_b38_decaying_hazard_probability__c02_sequential_wraparound_large.c\n");
