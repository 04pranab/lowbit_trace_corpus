/*
 * LowBit -- 2225_grid_b45_two_counters_race__c25_lru_recency_weighted_reuse.c
 * Branch: two_counters_race | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2225_grid_b45_two_counters_race__c25_lru_recency_weighted_reuse.c\n");
