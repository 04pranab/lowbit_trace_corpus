/*
 * LowBit -- 0146_grid_b03_alternating__c46_cantor_gap_sparse.c
 * Branch: alternating | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0146_grid_b03_alternating__c46_cantor_gap_sparse.c\n");
