/*
 * LowBit -- 2456_grid_b50_hysteresis_debounce__c06_random_full_working_set.c
 * Branch: hysteresis_debounce | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2456_grid_b50_hysteresis_debounce__c06_random_full_working_set.c\n");
