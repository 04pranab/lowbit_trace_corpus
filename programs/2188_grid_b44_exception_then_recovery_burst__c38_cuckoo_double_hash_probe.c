/*
 * LowBit -- 2188_grid_b44_exception_then_recovery_burst__c38_cuckoo_double_hash_probe.c
 * Branch: exception_then_recovery_burst | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2188_grid_b44_exception_then_recovery_burst__c38_cuckoo_double_hash_probe.c\n");
