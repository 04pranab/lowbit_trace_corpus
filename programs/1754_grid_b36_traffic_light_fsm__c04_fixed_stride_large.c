/*
 * LowBit -- 1754_grid_b36_traffic_light_fsm__c04_fixed_stride_large.c
 * Branch: traffic_light_fsm | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1754_grid_b36_traffic_light_fsm__c04_fixed_stride_large.c\n");
