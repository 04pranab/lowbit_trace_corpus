/*
 * LowBit -- 1764_grid_b36_traffic_light_fsm__c14_temporal_burst_reuse.c
 * Branch: traffic_light_fsm | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1764_grid_b36_traffic_light_fsm__c14_temporal_burst_reuse.c\n");
