/*
 * LowBit -- 1861_grid_b38_decaying_hazard_probability__c11_sliding_window.c
 * Branch: decaying_hazard_probability | Cache: sliding_window
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1861_grid_b38_decaying_hazard_probability__c11_sliding_window.c\n");
