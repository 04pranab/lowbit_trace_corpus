/*
 * LowBit -- 0571_grid_b12_doubling_run_lengths__c21_pyramid_multiresolution_stride.c
 * Branch: doubling_run_lengths | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t lvl_ = (uint32_t)((i / BLOCK21_) % NLEVELS21_);
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0571_grid_b12_doubling_run_lengths__c21_pyramid_multiresolution_stride.c\n");
    printf("branch_pattern=doubling_run_lengths\n");
    printf("cache_pattern=pyramid_multiresolution_stride\n");
