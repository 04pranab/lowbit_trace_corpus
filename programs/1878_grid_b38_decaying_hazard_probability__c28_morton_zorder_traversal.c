/*
 * LowBit -- 1878_grid_b38_decaying_hazard_probability__c28_morton_zorder_traversal.c
 * Branch: decaying_hazard_probability | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1878_grid_b38_decaying_hazard_probability__c28_morton_zorder_traversal.c\n");
