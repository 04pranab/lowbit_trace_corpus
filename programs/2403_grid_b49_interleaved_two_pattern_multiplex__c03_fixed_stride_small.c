/*
 * LowBit -- 2403_grid_b49_interleaved_two_pattern_multiplex__c03_fixed_stride_small.c
 * Branch: interleaved_two_pattern_multiplex | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=2403_grid_b49_interleaved_two_pattern_multiplex__c03_fixed_stride_small.c\n");
