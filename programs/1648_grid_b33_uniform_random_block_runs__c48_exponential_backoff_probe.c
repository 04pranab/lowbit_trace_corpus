/*
 * LowBit -- 1648_grid_b33_uniform_random_block_runs__c48_exponential_backoff_probe.c
 * Branch: uniform_random_block_runs | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1648_grid_b33_uniform_random_block_runs__c48_exponential_backoff_probe.c\n");
