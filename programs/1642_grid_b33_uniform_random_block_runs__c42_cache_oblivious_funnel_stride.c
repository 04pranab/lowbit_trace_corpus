/*
 * LowBit -- 1642_grid_b33_uniform_random_block_runs__c42_cache_oblivious_funnel_stride.c
 * Branch: uniform_random_block_runs | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1642_grid_b33_uniform_random_block_runs__c42_cache_oblivious_funnel_stride.c\n");
