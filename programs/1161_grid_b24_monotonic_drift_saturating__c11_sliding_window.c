/*
 * LowBit -- 1161_grid_b24_monotonic_drift_saturating__c11_sliding_window.c
 * Branch: monotonic_drift_saturating | Cache: sliding_window
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1161_grid_b24_monotonic_drift_saturating__c11_sliding_window.c\n");
