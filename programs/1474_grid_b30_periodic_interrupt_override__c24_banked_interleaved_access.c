/*
 * LowBit -- 1474_grid_b30_periodic_interrupt_override__c24_banked_interleaved_access.c
 * Branch: periodic_interrupt_override | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=1474_grid_b30_periodic_interrupt_override__c24_banked_interleaved_access.c\n");
