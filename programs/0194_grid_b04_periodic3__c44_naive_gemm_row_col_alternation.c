/*
 * LowBit -- 0194_grid_b04_periodic3__c44_naive_gemm_row_col_alternation.c
 * Branch: periodic3 | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0194_grid_b04_periodic3__c44_naive_gemm_row_col_alternation.c\n");
