/*
 * LowBit -- 1668_grid_b34_data_driven_countdown__c18_producer_consumer_two_pointer.c
 * Branch: data_driven_countdown | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1668_grid_b34_data_driven_countdown__c18_producer_consumer_two_pointer.c\n");
