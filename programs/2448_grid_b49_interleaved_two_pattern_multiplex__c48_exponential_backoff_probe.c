/*
 * LowBit -- 2448_grid_b49_interleaved_two_pattern_multiplex__c48_exponential_backoff_probe.c
 * Branch: interleaved_two_pattern_multiplex | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=2448_grid_b49_interleaved_two_pattern_multiplex__c48_exponential_backoff_probe.c\n");
