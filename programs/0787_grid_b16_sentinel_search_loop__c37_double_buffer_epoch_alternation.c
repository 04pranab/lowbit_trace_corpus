/*
 * LowBit -- 0787_grid_b16_sentinel_search_loop__c37_double_buffer_epoch_alternation.c
 * Branch: sentinel_search_loop | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0787_grid_b16_sentinel_search_loop__c37_double_buffer_epoch_alternation.c\n");
