/*
 * LowBit -- 1942_grid_b39_dual_lcg_xor_chaos__c42_cache_oblivious_funnel_stride.c
 * Branch: dual_lcg_xor_chaos | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1942_grid_b39_dual_lcg_xor_chaos__c42_cache_oblivious_funnel_stride.c\n");
