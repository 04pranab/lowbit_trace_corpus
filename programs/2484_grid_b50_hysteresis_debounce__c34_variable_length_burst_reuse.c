/*
 * LowBit -- 2484_grid_b50_hysteresis_debounce__c34_variable_length_burst_reuse.c
 * Branch: hysteresis_debounce | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2484_grid_b50_hysteresis_debounce__c34_variable_length_burst_reuse.c\n");
