/*
 * LowBit -- 0244_grid_b05_periodic8_biased__c44_naive_gemm_row_col_alternation.c
 * Branch: periodic8_biased | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0244_grid_b05_periodic8_biased__c44_naive_gemm_row_col_alternation.c\n");
