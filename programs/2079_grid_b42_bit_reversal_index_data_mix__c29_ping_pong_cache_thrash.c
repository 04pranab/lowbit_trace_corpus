/*
 * LowBit -- 2079_grid_b42_bit_reversal_index_data_mix__c29_ping_pong_cache_thrash.c
 * Branch: bit_reversal_index_data_mix | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2079_grid_b42_bit_reversal_index_data_mix__c29_ping_pong_cache_thrash.c\n");
