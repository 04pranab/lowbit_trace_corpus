/*
 * LowBit -- 2240_grid_b45_two_counters_race__c40_causal_attention_triangular.c
 * Branch: two_counters_race | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2240_grid_b45_two_counters_race__c40_causal_attention_triangular.c\n");
