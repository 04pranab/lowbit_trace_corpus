/*
 * LowBit -- 1343_grid_b27_meta_correlated_nested__c43_whole_buffer_rotation.c
 * Branch: meta_correlated_nested | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1343_grid_b27_meta_correlated_nested__c43_whole_buffer_rotation.c\n");
