/*
 * LowBit -- 0788_grid_b16_sentinel_search_loop__c38_cuckoo_double_hash_probe.c
 * Branch: sentinel_search_loop | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0788_grid_b16_sentinel_search_loop__c38_cuckoo_double_hash_probe.c\n");
