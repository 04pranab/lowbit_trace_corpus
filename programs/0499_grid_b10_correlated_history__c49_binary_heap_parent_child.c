/*
 * LowBit -- 0499_grid_b10_correlated_history__c49_binary_heap_parent_child.c
 * Branch: correlated_history | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0499_grid_b10_correlated_history__c49_binary_heap_parent_child.c\n");
