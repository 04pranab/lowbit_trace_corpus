/*
 * LowBit -- 0775_grid_b16_sentinel_search_loop__c25_lru_recency_weighted_reuse.c
 * Branch: sentinel_search_loop | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0775_grid_b16_sentinel_search_loop__c25_lru_recency_weighted_reuse.c\n");
