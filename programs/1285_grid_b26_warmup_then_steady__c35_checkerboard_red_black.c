/*
 * LowBit -- 1285_grid_b26_warmup_then_steady__c35_checkerboard_red_black.c
 * Branch: warmup_then_steady | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1285_grid_b26_warmup_then_steady__c35_checkerboard_red_black.c\n");
