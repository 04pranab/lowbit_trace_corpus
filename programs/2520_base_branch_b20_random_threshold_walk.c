/*
 * LowBit -- 2520_base_branch_b20_random_threshold_walk.c
 * Branch: random_threshold_walk | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=2520_base_branch_b20_random_threshold_walk.c\n");
