/*
 * LowBit -- 1374_grid_b28_data_driven_stack_machine__c24_banked_interleaved_access.c
 * Branch: data_driven_stack_machine | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1374_grid_b28_data_driven_stack_machine__c24_banked_interleaved_access.c\n");
