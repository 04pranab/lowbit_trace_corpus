/*
 * LowBit -- 1164_grid_b24_monotonic_drift_saturating__c14_temporal_burst_reuse.c
 * Branch: monotonic_drift_saturating | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1164_grid_b24_monotonic_drift_saturating__c14_temporal_burst_reuse.c\n");
