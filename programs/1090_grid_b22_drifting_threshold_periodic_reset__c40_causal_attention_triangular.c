/*
 * LowBit -- 1090_grid_b22_drifting_threshold_periodic_reset__c40_causal_attention_triangular.c
 * Branch: drifting_threshold_periodic_reset | Cache: causal_attention_triangular
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1090_grid_b22_drifting_threshold_periodic_reset__c40_causal_attention_triangular.c\n");
