/*
 * LowBit -- 0397_grid_b08_switch_multiway__c47_false_sharing_line_cycle.c
 * Branch: switch_multiway | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0397_grid_b08_switch_multiway__c47_false_sharing_line_cycle.c\n");
