/*
 * LowBit -- 1096_grid_b22_drifting_threshold_periodic_reset__c46_cantor_gap_sparse.c
 * Branch: drifting_threshold_periodic_reset | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1096_grid_b22_drifting_threshold_periodic_reset__c46_cantor_gap_sparse.c\n");
