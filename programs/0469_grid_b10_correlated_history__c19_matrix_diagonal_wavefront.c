/*
 * LowBit -- 0469_grid_b10_correlated_history__c19_matrix_diagonal_wavefront.c
 * Branch: correlated_history | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { uint32_t hist_ = (uint32_t)((*prev_taken) & 3u);
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0469_grid_b10_correlated_history__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=correlated_history\n");
