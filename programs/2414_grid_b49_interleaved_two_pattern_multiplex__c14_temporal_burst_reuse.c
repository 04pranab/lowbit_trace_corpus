/*
 * LowBit -- 2414_grid_b49_interleaved_two_pattern_multiplex__c14_temporal_burst_reuse.c
 * Branch: interleaved_two_pattern_multiplex | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=2414_grid_b49_interleaved_two_pattern_multiplex__c14_temporal_burst_reuse.c\n");
