/*
 * LowBit -- 1126_grid_b23_popcount_parity__c26_geometric_stride_growth.c
 * Branch: popcount_parity | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1126_grid_b23_popcount_parity__c26_geometric_stride_growth.c\n");
