/*
 * LowBit -- 2363_grid_b48_variable_step_signed_countdown__c13_two_stream_interleaved.c
 * Branch: variable_step_signed_countdown | Cache: two_stream_interleaved
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2363_grid_b48_variable_step_signed_countdown__c13_two_stream_interleaved.c\n");
