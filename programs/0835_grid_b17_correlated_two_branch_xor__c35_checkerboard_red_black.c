/*
 * LowBit -- 0835_grid_b17_correlated_two_branch_xor__c35_checkerboard_red_black.c
 * Branch: correlated_two_branch_xor | Cache: checkerboard_red_black
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0835_grid_b17_correlated_two_branch_xor__c35_checkerboard_red_black.c\n");
