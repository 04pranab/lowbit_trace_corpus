/*
 * LowBit -- 1436_grid_b29_bursty_streak_pattern__c36_im2col_overlapping_patch_gather.c
 * Branch: bursty_streak_pattern | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1436_grid_b29_bursty_streak_pattern__c36_im2col_overlapping_patch_gather.c\n");
