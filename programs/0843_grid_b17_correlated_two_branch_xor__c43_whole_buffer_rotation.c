/*
 * LowBit -- 0843_grid_b17_correlated_two_branch_xor__c43_whole_buffer_rotation.c
 * Branch: correlated_two_branch_xor | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0843_grid_b17_correlated_two_branch_xor__c43_whole_buffer_rotation.c\n");
