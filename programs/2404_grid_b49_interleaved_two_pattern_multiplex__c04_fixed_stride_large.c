/*
 * LowBit -- 2404_grid_b49_interleaved_two_pattern_multiplex__c04_fixed_stride_large.c
 * Branch: interleaved_two_pattern_multiplex | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=2404_grid_b49_interleaved_two_pattern_multiplex__c04_fixed_stride_large.c\n");
