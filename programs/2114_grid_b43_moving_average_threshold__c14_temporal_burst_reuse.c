/*
 * LowBit -- 2114_grid_b43_moving_average_threshold__c14_temporal_burst_reuse.c
 * Branch: moving_average_threshold | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2114_grid_b43_moving_average_threshold__c14_temporal_burst_reuse.c\n");
