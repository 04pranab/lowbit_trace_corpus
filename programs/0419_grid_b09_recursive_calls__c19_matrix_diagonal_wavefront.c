/*
 * LowBit -- 0419_grid_b09_recursive_calls__c19_matrix_diagonal_wavefront.c
 * Branch: recursive_calls | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0419_grid_b09_recursive_calls__c19_matrix_diagonal_wavefront.c\n");
