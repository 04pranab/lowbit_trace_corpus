/*
 * LowBit -- 1830_grid_b37_value_driven_unswitch_run__c30_gather_scatter_indirect_table.c
 * Branch: value_driven_unswitch_run | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1830_grid_b37_value_driven_unswitch_run__c30_gather_scatter_indirect_table.c\n");
