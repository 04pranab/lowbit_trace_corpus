/*
 * LowBit -- 0189_grid_b04_periodic3__c39_bounded_random_walk.c
 * Branch: periodic3 | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0189_grid_b04_periodic3__c39_bounded_random_walk.c\n");
