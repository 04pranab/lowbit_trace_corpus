/*
 * LowBit -- 0976_grid_b20_random_threshold_walk__c26_geometric_stride_growth.c
 * Branch: random_threshold_walk | Cache: geometric_stride_growth
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0976_grid_b20_random_threshold_walk__c26_geometric_stride_growth.c\n");
