/*
 * LowBit -- 1373_grid_b28_data_driven_stack_machine__c23_struct_of_array_field_burst.c
 * Branch: data_driven_stack_machine | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1373_grid_b28_data_driven_stack_machine__c23_struct_of_array_field_burst.c\n");
