/*
 * LowBit -- 1966_grid_b40_collatz_value_transform__c16_block_sparse.c
 * Branch: collatz_value_transform | Cache: block_sparse
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1966_grid_b40_collatz_value_transform__c16_block_sparse.c\n");
