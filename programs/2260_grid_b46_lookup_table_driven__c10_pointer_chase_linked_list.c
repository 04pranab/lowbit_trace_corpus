/*
 * LowBit -- 2260_grid_b46_lookup_table_driven__c10_pointer_chase_linked_list.c
 * Branch: lookup_table_driven | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2260_grid_b46_lookup_table_driven__c10_pointer_chase_linked_list.c\n");
