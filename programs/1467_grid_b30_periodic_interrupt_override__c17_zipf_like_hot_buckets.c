/*
 * LowBit -- 1467_grid_b30_periodic_interrupt_override__c17_zipf_like_hot_buckets.c
 * Branch: periodic_interrupt_override | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=1467_grid_b30_periodic_interrupt_override__c17_zipf_like_hot_buckets.c\n");
