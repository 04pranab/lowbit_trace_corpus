/*
 * LowBit -- 1958_grid_b40_collatz_value_transform__c08_matrix_col_major.c
 * Branch: collatz_value_transform | Cache: matrix_col_major
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1958_grid_b40_collatz_value_transform__c08_matrix_col_major.c\n");
