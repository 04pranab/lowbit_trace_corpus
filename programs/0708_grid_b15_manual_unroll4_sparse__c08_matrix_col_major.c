/*
 * LowBit -- 0708_grid_b15_manual_unroll4_sparse__c08_matrix_col_major.c
 * Branch: manual_unroll4_sparse | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0708_grid_b15_manual_unroll4_sparse__c08_matrix_col_major.c\n");
