/*
 * LowBit -- 0966_grid_b20_random_threshold_walk__c16_block_sparse.c
 * Branch: random_threshold_walk | Cache: block_sparse
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0966_grid_b20_random_threshold_walk__c16_block_sparse.c\n");
