/*
 * LowBit -- 1803_grid_b37_value_driven_unswitch_run__c03_fixed_stride_small.c
 * Branch: value_driven_unswitch_run | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1803_grid_b37_value_driven_unswitch_run__c03_fixed_stride_small.c\n");
