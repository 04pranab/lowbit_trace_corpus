/*
 * LowBit -- 2072_grid_b42_bit_reversal_index_data_mix__c22_tensor_3d_slice_poor_locality.c
 * Branch: bit_reversal_index_data_mix | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2072_grid_b42_bit_reversal_index_data_mix__c22_tensor_3d_slice_poor_locality.c\n");
