/*
 * LowBit -- 1189_grid_b24_monotonic_drift_saturating__c39_bounded_random_walk.c
 * Branch: monotonic_drift_saturating | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1189_grid_b24_monotonic_drift_saturating__c39_bounded_random_walk.c\n");
