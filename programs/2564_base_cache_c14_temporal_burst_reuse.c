/*
 * LowBit -- 2564_base_cache_c14_temporal_burst_reuse.c
 * Branch: synthetic_always_taken | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=2564_base_cache_c14_temporal_burst_reuse.c\n");
