/*
 * LowBit -- 1087_grid_b22_drifting_threshold_periodic_reset__c37_double_buffer_epoch_alternation.c
 * Branch: drifting_threshold_periodic_reset | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1087_grid_b22_drifting_threshold_periodic_reset__c37_double_buffer_epoch_alternation.c\n");
