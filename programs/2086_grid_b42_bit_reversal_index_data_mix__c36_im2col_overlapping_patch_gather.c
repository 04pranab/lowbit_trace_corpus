/*
 * LowBit -- 2086_grid_b42_bit_reversal_index_data_mix__c36_im2col_overlapping_patch_gather.c
 * Branch: bit_reversal_index_data_mix | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2086_grid_b42_bit_reversal_index_data_mix__c36_im2col_overlapping_patch_gather.c\n");
