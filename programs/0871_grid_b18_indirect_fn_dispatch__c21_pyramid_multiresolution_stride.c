/*
 * LowBit -- 0871_grid_b18_indirect_fn_dispatch__c21_pyramid_multiresolution_stride.c
 * Branch: indirect_fn_dispatch | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0871_grid_b18_indirect_fn_dispatch__c21_pyramid_multiresolution_stride.c\n");
