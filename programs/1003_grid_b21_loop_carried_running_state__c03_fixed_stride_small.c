/*
 * LowBit -- 1003_grid_b21_loop_carried_running_state__c03_fixed_stride_small.c
 * Branch: loop_carried_running_state | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=1003_grid_b21_loop_carried_running_state__c03_fixed_stride_small.c\n");
