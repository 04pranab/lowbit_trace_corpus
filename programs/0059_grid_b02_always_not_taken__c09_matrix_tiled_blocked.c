/*
 * LowBit -- 0059_grid_b02_always_not_taken__c09_matrix_tiled_blocked.c
 * Branch: always_not_taken | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0059_grid_b02_always_not_taken__c09_matrix_tiled_blocked.c\n");
