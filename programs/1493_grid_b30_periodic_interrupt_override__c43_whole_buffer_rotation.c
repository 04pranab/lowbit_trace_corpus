/*
 * LowBit -- 1493_grid_b30_periodic_interrupt_override__c43_whole_buffer_rotation.c
 * Branch: periodic_interrupt_override | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=1493_grid_b30_periodic_interrupt_override__c43_whole_buffer_rotation.c\n");
