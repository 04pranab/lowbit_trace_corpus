/*
 * LowBit -- 0831_grid_b17_correlated_two_branch_xor__c31_fibonacci_stride.c
 * Branch: correlated_two_branch_xor | Cache: fibonacci_stride
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0831_grid_b17_correlated_two_branch_xor__c31_fibonacci_stride.c\n");
