/*
 * LowBit -- 1001_grid_b21_loop_carried_running_state__c01_sequential_unit_stride.c
 * Branch: loop_carried_running_state | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=1001_grid_b21_loop_carried_running_state__c01_sequential_unit_stride.c\n");
