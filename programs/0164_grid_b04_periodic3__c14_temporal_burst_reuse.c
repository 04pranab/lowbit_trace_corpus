/*
 * LowBit -- 0164_grid_b04_periodic3__c14_temporal_burst_reuse.c
 * Branch: periodic3 | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0164_grid_b04_periodic3__c14_temporal_burst_reuse.c\n");
