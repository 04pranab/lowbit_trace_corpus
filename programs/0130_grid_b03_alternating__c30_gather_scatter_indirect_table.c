/*
 * LowBit -- 0130_grid_b03_alternating__c30_gather_scatter_indirect_table.c
 * Branch: alternating | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0130_grid_b03_alternating__c30_gather_scatter_indirect_table.c\n");
