/*
 * LowBit -- 2144_grid_b43_moving_average_threshold__c44_naive_gemm_row_col_alternation.c
 * Branch: moving_average_threshold | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2144_grid_b43_moving_average_threshold__c44_naive_gemm_row_col_alternation.c\n");
