/*
 * LowBit -- 0391_grid_b08_switch_multiway__c41_skip_list_multilevel_hop.c
 * Branch: switch_multiway | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0391_grid_b08_switch_multiway__c41_skip_list_multilevel_hop.c\n");
