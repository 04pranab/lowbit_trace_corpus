/*
 * LowBit -- 2547_base_branch_b47_mutual_ping_pong_recursion.c
 * Branch: mutual_ping_pong_recursion | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2547_base_branch_b47_mutual_ping_pong_recursion.c\n");
