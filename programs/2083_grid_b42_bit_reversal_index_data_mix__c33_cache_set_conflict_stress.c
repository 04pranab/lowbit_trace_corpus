/*
 * LowBit -- 2083_grid_b42_bit_reversal_index_data_mix__c33_cache_set_conflict_stress.c
 * Branch: bit_reversal_index_data_mix | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2083_grid_b42_bit_reversal_index_data_mix__c33_cache_set_conflict_stress.c\n");
