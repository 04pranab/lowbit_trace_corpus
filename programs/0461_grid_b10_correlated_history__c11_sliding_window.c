/*
 * LowBit -- 0461_grid_b10_correlated_history__c11_sliding_window.c
 * Branch: correlated_history | Cache: sliding_window
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0461_grid_b10_correlated_history__c11_sliding_window.c\n");
