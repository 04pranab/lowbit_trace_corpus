/*
 * LowBit -- 0012_grid_b01_always_taken__c12_prime_stride_anti_alias.c
 * Branch: always_taken | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0012_grid_b01_always_taken__c12_prime_stride_anti_alias.c\n");
