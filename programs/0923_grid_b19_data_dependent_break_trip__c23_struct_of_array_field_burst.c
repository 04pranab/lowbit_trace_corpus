/*
 * LowBit -- 0923_grid_b19_data_dependent_break_trip__c23_struct_of_array_field_burst.c
 * Branch: data_dependent_break_trip | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0923_grid_b19_data_dependent_break_trip__c23_struct_of_array_field_burst.c\n");
