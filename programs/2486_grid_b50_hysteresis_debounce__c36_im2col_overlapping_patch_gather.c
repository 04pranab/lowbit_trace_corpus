/*
 * LowBit -- 2486_grid_b50_hysteresis_debounce__c36_im2col_overlapping_patch_gather.c
 * Branch: hysteresis_debounce | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2486_grid_b50_hysteresis_debounce__c36_im2col_overlapping_patch_gather.c\n");
