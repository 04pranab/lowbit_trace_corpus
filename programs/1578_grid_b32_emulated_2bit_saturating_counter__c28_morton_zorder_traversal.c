/*
 * LowBit -- 1578_grid_b32_emulated_2bit_saturating_counter__c28_morton_zorder_traversal.c
 * Branch: emulated_2bit_saturating_counter | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1578_grid_b32_emulated_2bit_saturating_counter__c28_morton_zorder_traversal.c\n");
