/*
 * LowBit -- 0617_grid_b13_single_phase_change__c17_zipf_like_hot_buckets.c
 * Branch: single_phase_change | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0617_grid_b13_single_phase_change__c17_zipf_like_hot_buckets.c\n");
