/*
 * LowBit -- 1107_grid_b23_popcount_parity__c07_matrix_row_major.c
 * Branch: popcount_parity | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1107_grid_b23_popcount_parity__c07_matrix_row_major.c\n");
