/*
 * LowBit -- 2541_base_branch_b41_markov_chain_3state.c
 * Branch: markov_chain_3state | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2541_base_branch_b41_markov_chain_3state.c\n");
