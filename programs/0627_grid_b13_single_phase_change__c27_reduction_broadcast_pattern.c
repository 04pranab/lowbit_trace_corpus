/*
 * LowBit -- 0627_grid_b13_single_phase_change__c27_reduction_broadcast_pattern.c
 * Branch: single_phase_change | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0627_grid_b13_single_phase_change__c27_reduction_broadcast_pattern.c\n");
