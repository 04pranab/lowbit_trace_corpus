/*
 * LowBit -- 0780_grid_b16_sentinel_search_loop__c30_gather_scatter_indirect_table.c
 * Branch: sentinel_search_loop | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0780_grid_b16_sentinel_search_loop__c30_gather_scatter_indirect_table.c\n");
