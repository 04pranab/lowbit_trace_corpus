/*
 * LowBit -- 2452_grid_b50_hysteresis_debounce__c02_sequential_wraparound_large.c
 * Branch: hysteresis_debounce | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2452_grid_b50_hysteresis_debounce__c02_sequential_wraparound_large.c\n");
