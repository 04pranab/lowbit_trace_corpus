/*
 * LowBit -- 0037_grid_b01_always_taken__c37_double_buffer_epoch_alternation.c
 * Branch: always_taken | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0037_grid_b01_always_taken__c37_double_buffer_epoch_alternation.c\n");
