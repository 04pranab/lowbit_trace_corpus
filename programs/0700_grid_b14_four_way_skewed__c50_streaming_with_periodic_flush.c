/*
 * LowBit -- 0700_grid_b14_four_way_skewed__c50_streaming_with_periodic_flush.c
 * Branch: four_way_skewed | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0700_grid_b14_four_way_skewed__c50_streaming_with_periodic_flush.c\n");
