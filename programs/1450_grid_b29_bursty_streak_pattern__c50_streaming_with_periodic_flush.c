/*
 * LowBit -- 1450_grid_b29_bursty_streak_pattern__c50_streaming_with_periodic_flush.c
 * Branch: bursty_streak_pattern | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1450_grid_b29_bursty_streak_pattern__c50_streaming_with_periodic_flush.c\n");
