/*
 * LowBit -- 1447_grid_b29_bursty_streak_pattern__c47_false_sharing_line_cycle.c
 * Branch: bursty_streak_pattern | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1447_grid_b29_bursty_streak_pattern__c47_false_sharing_line_cycle.c\n");
