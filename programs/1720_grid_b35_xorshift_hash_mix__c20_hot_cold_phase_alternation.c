/*
 * LowBit -- 1720_grid_b35_xorshift_hash_mix__c20_hot_cold_phase_alternation.c
 * Branch: xorshift_hash_mix | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1720_grid_b35_xorshift_hash_mix__c20_hot_cold_phase_alternation.c\n");
