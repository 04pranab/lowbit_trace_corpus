/*
 * LowBit -- 1945_grid_b39_dual_lcg_xor_chaos__c45_read_hot_write_cold_split.c
 * Branch: dual_lcg_xor_chaos | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1945_grid_b39_dual_lcg_xor_chaos__c45_read_hot_write_cold_split.c\n");
