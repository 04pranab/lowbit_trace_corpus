/*
 * LowBit -- 1446_grid_b29_bursty_streak_pattern__c46_cantor_gap_sparse.c
 * Branch: bursty_streak_pattern | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1446_grid_b29_bursty_streak_pattern__c46_cantor_gap_sparse.c\n");
