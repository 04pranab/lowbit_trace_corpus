/*
 * LowBit -- 1194_grid_b24_monotonic_drift_saturating__c44_naive_gemm_row_col_alternation.c
 * Branch: monotonic_drift_saturating | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1194_grid_b24_monotonic_drift_saturating__c44_naive_gemm_row_col_alternation.c\n");
