/*
 * LowBit -- 1684_grid_b34_data_driven_countdown__c34_variable_length_burst_reuse.c
 * Branch: data_driven_countdown | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1684_grid_b34_data_driven_countdown__c34_variable_length_burst_reuse.c\n");
