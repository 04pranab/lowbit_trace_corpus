/*
 * LowBit -- 1708_grid_b35_xorshift_hash_mix__c08_matrix_col_major.c
 * Branch: xorshift_hash_mix | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1708_grid_b35_xorshift_hash_mix__c08_matrix_col_major.c\n");
