/*
 * LowBit -- 0657_grid_b14_four_way_skewed__c07_matrix_row_major.c
 * Branch: four_way_skewed | Cache: matrix_row_major
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0657_grid_b14_four_way_skewed__c07_matrix_row_major.c\n");
