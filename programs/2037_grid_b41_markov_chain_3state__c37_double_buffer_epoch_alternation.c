/*
 * LowBit -- 2037_grid_b41_markov_chain_3state__c37_double_buffer_epoch_alternation.c
 * Branch: markov_chain_3state | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2037_grid_b41_markov_chain_3state__c37_double_buffer_epoch_alternation.c\n");
