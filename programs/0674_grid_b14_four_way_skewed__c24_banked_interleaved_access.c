/*
 * LowBit -- 0674_grid_b14_four_way_skewed__c24_banked_interleaved_access.c
 * Branch: four_way_skewed | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0674_grid_b14_four_way_skewed__c24_banked_interleaved_access.c\n");
