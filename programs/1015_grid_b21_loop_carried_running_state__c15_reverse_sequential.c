/*
 * LowBit -- 1015_grid_b21_loop_carried_running_state__c15_reverse_sequential.c
 * Branch: loop_carried_running_state | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=1015_grid_b21_loop_carried_running_state__c15_reverse_sequential.c\n");
