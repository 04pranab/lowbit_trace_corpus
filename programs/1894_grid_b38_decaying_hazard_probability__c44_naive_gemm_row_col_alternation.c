/*
 * LowBit -- 1894_grid_b38_decaying_hazard_probability__c44_naive_gemm_row_col_alternation.c
 * Branch: decaying_hazard_probability | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1894_grid_b38_decaying_hazard_probability__c44_naive_gemm_row_col_alternation.c\n");
