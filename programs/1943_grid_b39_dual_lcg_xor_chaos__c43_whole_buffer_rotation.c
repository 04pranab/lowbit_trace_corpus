/*
 * LowBit -- 1943_grid_b39_dual_lcg_xor_chaos__c43_whole_buffer_rotation.c
 * Branch: dual_lcg_xor_chaos | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1943_grid_b39_dual_lcg_xor_chaos__c43_whole_buffer_rotation.c\n");
