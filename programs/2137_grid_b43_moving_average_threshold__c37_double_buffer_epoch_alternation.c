/*
 * LowBit -- 2137_grid_b43_moving_average_threshold__c37_double_buffer_epoch_alternation.c
 * Branch: moving_average_threshold | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2137_grid_b43_moving_average_threshold__c37_double_buffer_epoch_alternation.c\n");
