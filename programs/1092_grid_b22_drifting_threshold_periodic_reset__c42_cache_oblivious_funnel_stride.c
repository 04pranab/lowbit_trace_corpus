/*
 * LowBit -- 1092_grid_b22_drifting_threshold_periodic_reset__c42_cache_oblivious_funnel_stride.c
 * Branch: drifting_threshold_periodic_reset | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1092_grid_b22_drifting_threshold_periodic_reset__c42_cache_oblivious_funnel_stride.c\n");
