/*
 * LowBit -- 2215_grid_b45_two_counters_race__c15_reverse_sequential.c
 * Branch: two_counters_race | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2215_grid_b45_two_counters_race__c15_reverse_sequential.c\n");
