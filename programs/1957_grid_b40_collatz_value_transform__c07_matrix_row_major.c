/*
 * LowBit -- 1957_grid_b40_collatz_value_transform__c07_matrix_row_major.c
 * Branch: collatz_value_transform | Cache: matrix_row_major
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1957_grid_b40_collatz_value_transform__c07_matrix_row_major.c\n");
