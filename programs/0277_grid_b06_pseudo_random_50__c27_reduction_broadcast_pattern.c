/*
 * LowBit -- 0277_grid_b06_pseudo_random_50__c27_reduction_broadcast_pattern.c
 * Branch: pseudo_random_50 | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0277_grid_b06_pseudo_random_50__c27_reduction_broadcast_pattern.c\n");
