/*
 * LowBit -- 0442_grid_b09_recursive_calls__c42_cache_oblivious_funnel_stride.c
 * Branch: recursive_calls | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0442_grid_b09_recursive_calls__c42_cache_oblivious_funnel_stride.c\n");
