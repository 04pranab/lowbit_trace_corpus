/*
 * LowBit -- 0800_grid_b16_sentinel_search_loop__c50_streaming_with_periodic_flush.c
 * Branch: sentinel_search_loop | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0800_grid_b16_sentinel_search_loop__c50_streaming_with_periodic_flush.c\n");
