/*
 * LowBit -- 1143_grid_b23_popcount_parity__c43_whole_buffer_rotation.c
 * Branch: popcount_parity | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1143_grid_b23_popcount_parity__c43_whole_buffer_rotation.c\n");
