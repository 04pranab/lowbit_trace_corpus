/*
 * LowBit -- 0540_grid_b11_value_dependent_threshold__c40_causal_attention_triangular.c
 * Branch: value_dependent_threshold | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0540_grid_b11_value_dependent_threshold__c40_causal_attention_triangular.c\n");
