/*
 * LowBit -- 1772_grid_b36_traffic_light_fsm__c22_tensor_3d_slice_poor_locality.c
 * Branch: traffic_light_fsm | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1772_grid_b36_traffic_light_fsm__c22_tensor_3d_slice_poor_locality.c\n");
