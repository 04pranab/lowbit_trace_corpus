/*
 * LowBit -- 1791_grid_b36_traffic_light_fsm__c41_skip_list_multilevel_hop.c
 * Branch: traffic_light_fsm | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1791_grid_b36_traffic_light_fsm__c41_skip_list_multilevel_hop.c\n");
