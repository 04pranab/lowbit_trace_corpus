/*
 * LowBit -- 2032_grid_b41_markov_chain_3state__c32_hilbert_curve_traversal.c
 * Branch: markov_chain_3state | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2032_grid_b41_markov_chain_3state__c32_hilbert_curve_traversal.c\n");
