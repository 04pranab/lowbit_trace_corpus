/*
 * LowBit -- 1353_grid_b28_data_driven_stack_machine__c03_fixed_stride_small.c
 * Branch: data_driven_stack_machine | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1353_grid_b28_data_driven_stack_machine__c03_fixed_stride_small.c\n");
