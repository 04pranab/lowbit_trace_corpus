/*
 * LowBit -- 2287_grid_b46_lookup_table_driven__c37_double_buffer_epoch_alternation.c
 * Branch: lookup_table_driven | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2287_grid_b46_lookup_table_driven__c37_double_buffer_epoch_alternation.c\n");
