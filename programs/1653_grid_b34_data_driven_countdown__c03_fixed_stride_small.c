/*
 * LowBit -- 1653_grid_b34_data_driven_countdown__c03_fixed_stride_small.c
 * Branch: data_driven_countdown | Cache: fixed_stride_small
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1653_grid_b34_data_driven_countdown__c03_fixed_stride_small.c\n");
