/*
 * LowBit -- 0408_grid_b09_recursive_calls__c08_matrix_col_major.c
 * Branch: recursive_calls | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0408_grid_b09_recursive_calls__c08_matrix_col_major.c\n");
