/*
 * LowBit -- 1119_grid_b23_popcount_parity__c19_matrix_diagonal_wavefront.c
 * Branch: popcount_parity | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1119_grid_b23_popcount_parity__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=popcount_parity\n");
