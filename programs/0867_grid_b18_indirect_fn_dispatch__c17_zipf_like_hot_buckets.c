/*
 * LowBit -- 0867_grid_b18_indirect_fn_dispatch__c17_zipf_like_hot_buckets.c
 * Branch: indirect_fn_dispatch | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0867_grid_b18_indirect_fn_dispatch__c17_zipf_like_hot_buckets.c\n");
