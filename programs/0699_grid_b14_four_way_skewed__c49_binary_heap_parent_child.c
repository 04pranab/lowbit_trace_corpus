/*
 * LowBit -- 0699_grid_b14_four_way_skewed__c49_binary_heap_parent_child.c
 * Branch: four_way_skewed | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0699_grid_b14_four_way_skewed__c49_binary_heap_parent_child.c\n");
