/*
 * LowBit -- 1560_grid_b32_emulated_2bit_saturating_counter__c10_pointer_chase_linked_list.c
 * Branch: emulated_2bit_saturating_counter | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1560_grid_b32_emulated_2bit_saturating_counter__c10_pointer_chase_linked_list.c\n");
