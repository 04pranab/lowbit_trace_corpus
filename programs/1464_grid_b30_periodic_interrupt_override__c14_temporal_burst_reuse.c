/*
 * LowBit -- 1464_grid_b30_periodic_interrupt_override__c14_temporal_burst_reuse.c
 * Branch: periodic_interrupt_override | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=1464_grid_b30_periodic_interrupt_override__c14_temporal_burst_reuse.c\n");
