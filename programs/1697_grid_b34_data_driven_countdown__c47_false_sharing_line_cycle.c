/*
 * LowBit -- 1697_grid_b34_data_driven_countdown__c47_false_sharing_line_cycle.c
 * Branch: data_driven_countdown | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1697_grid_b34_data_driven_countdown__c47_false_sharing_line_cycle.c\n");
