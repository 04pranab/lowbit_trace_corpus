/*
 * LowBit -- 0124_grid_b03_alternating__c24_banked_interleaved_access.c
 * Branch: alternating | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0124_grid_b03_alternating__c24_banked_interleaved_access.c\n");
