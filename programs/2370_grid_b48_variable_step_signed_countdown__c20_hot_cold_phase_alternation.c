/*
 * LowBit -- 2370_grid_b48_variable_step_signed_countdown__c20_hot_cold_phase_alternation.c
 * Branch: variable_step_signed_countdown | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2370_grid_b48_variable_step_signed_countdown__c20_hot_cold_phase_alternation.c\n");
