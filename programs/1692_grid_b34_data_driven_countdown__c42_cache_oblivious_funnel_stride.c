/*
 * LowBit -- 1692_grid_b34_data_driven_countdown__c42_cache_oblivious_funnel_stride.c
 * Branch: data_driven_countdown | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1692_grid_b34_data_driven_countdown__c42_cache_oblivious_funnel_stride.c\n");
