/*
 * LowBit -- 2000_grid_b40_collatz_value_transform__c50_streaming_with_periodic_flush.c
 * Branch: collatz_value_transform | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=2000_grid_b40_collatz_value_transform__c50_streaming_with_periodic_flush.c\n");
