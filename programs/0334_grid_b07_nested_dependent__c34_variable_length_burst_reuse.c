/*
 * LowBit -- 0334_grid_b07_nested_dependent__c34_variable_length_burst_reuse.c
 * Branch: nested_dependent | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0334_grid_b07_nested_dependent__c34_variable_length_burst_reuse.c\n");
