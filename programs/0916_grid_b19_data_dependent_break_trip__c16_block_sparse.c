/*
 * LowBit -- 0916_grid_b19_data_dependent_break_trip__c16_block_sparse.c
 * Branch: data_dependent_break_trip | Cache: block_sparse
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0916_grid_b19_data_dependent_break_trip__c16_block_sparse.c\n");
