/*
 * LowBit -- 0210_grid_b05_periodic8_biased__c10_pointer_chase_linked_list.c
 * Branch: periodic8_biased | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0210_grid_b05_periodic8_biased__c10_pointer_chase_linked_list.c\n");
