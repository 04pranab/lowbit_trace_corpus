/*
 * LowBit -- 1050_grid_b21_loop_carried_running_state__c50_streaming_with_periodic_flush.c
 * Branch: loop_carried_running_state | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=1050_grid_b21_loop_carried_running_state__c50_streaming_with_periodic_flush.c\n");
