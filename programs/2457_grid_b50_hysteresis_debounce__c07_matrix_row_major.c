/*
 * LowBit -- 2457_grid_b50_hysteresis_debounce__c07_matrix_row_major.c
 * Branch: hysteresis_debounce | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2457_grid_b50_hysteresis_debounce__c07_matrix_row_major.c\n");
