/*
 * LowBit -- 0478_grid_b10_correlated_history__c28_morton_zorder_traversal.c
 * Branch: correlated_history | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0478_grid_b10_correlated_history__c28_morton_zorder_traversal.c\n");
