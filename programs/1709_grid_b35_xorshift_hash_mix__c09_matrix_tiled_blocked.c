/*
 * LowBit -- 1709_grid_b35_xorshift_hash_mix__c09_matrix_tiled_blocked.c
 * Branch: xorshift_hash_mix | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1709_grid_b35_xorshift_hash_mix__c09_matrix_tiled_blocked.c\n");
