/*
 * LowBit -- 0128_grid_b03_alternating__c28_morton_zorder_traversal.c
 * Branch: alternating | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0128_grid_b03_alternating__c28_morton_zorder_traversal.c\n");
