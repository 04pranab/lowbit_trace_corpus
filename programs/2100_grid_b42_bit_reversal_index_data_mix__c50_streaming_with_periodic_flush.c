/*
 * LowBit -- 2100_grid_b42_bit_reversal_index_data_mix__c50_streaming_with_periodic_flush.c
 * Branch: bit_reversal_index_data_mix | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2100_grid_b42_bit_reversal_index_data_mix__c50_streaming_with_periodic_flush.c\n");
