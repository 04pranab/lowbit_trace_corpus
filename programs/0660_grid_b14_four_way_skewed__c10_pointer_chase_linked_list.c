/*
 * LowBit -- 0660_grid_b14_four_way_skewed__c10_pointer_chase_linked_list.c
 * Branch: four_way_skewed | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0660_grid_b14_four_way_skewed__c10_pointer_chase_linked_list.c\n");
