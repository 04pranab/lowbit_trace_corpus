/*
 * LowBit -- 0258_grid_b06_pseudo_random_50__c08_matrix_col_major.c
 * Branch: pseudo_random_50 | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0258_grid_b06_pseudo_random_50__c08_matrix_col_major.c\n");
