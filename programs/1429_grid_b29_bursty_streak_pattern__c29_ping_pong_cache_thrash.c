/*
 * LowBit -- 1429_grid_b29_bursty_streak_pattern__c29_ping_pong_cache_thrash.c
 * Branch: bursty_streak_pattern | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1429_grid_b29_bursty_streak_pattern__c29_ping_pong_cache_thrash.c\n");
