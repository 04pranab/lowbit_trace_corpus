/*
 * LowBit -- 1401_grid_b29_bursty_streak_pattern__c01_sequential_unit_stride.c
 * Branch: bursty_streak_pattern | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1401_grid_b29_bursty_streak_pattern__c01_sequential_unit_stride.c\n");
