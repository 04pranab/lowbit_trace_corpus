/*
 * LowBit -- 2442_grid_b49_interleaved_two_pattern_multiplex__c42_cache_oblivious_funnel_stride.c
 * Branch: interleaved_two_pattern_multiplex | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=2442_grid_b49_interleaved_two_pattern_multiplex__c42_cache_oblivious_funnel_stride.c\n");
