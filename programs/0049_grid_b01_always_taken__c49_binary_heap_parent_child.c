/*
 * LowBit -- 0049_grid_b01_always_taken__c49_binary_heap_parent_child.c
 * Branch: always_taken | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0049_grid_b01_always_taken__c49_binary_heap_parent_child.c\n");
