/*
 * LowBit -- 0648_grid_b13_single_phase_change__c48_exponential_backoff_probe.c
 * Branch: single_phase_change | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0648_grid_b13_single_phase_change__c48_exponential_backoff_probe.c\n");
