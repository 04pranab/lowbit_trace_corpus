/*
 * LowBit -- 0915_grid_b19_data_dependent_break_trip__c15_reverse_sequential.c
 * Branch: data_dependent_break_trip | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0915_grid_b19_data_dependent_break_trip__c15_reverse_sequential.c\n");
