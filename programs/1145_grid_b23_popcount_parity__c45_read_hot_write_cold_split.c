/*
 * LowBit -- 1145_grid_b23_popcount_parity__c45_read_hot_write_cold_split.c
 * Branch: popcount_parity | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1145_grid_b23_popcount_parity__c45_read_hot_write_cold_split.c\n");
