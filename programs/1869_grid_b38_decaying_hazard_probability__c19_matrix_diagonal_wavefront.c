/*
 * LowBit -- 1869_grid_b38_decaying_hazard_probability__c19_matrix_diagonal_wavefront.c
 * Branch: decaying_hazard_probability | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static uint32_t bseed38_ = 0x38383838u;
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1869_grid_b38_decaying_hazard_probability__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=decaying_hazard_probability\n");
