/*
 * LowBit -- 0702_grid_b15_manual_unroll4_sparse__c02_sequential_wraparound_large.c
 * Branch: manual_unroll4_sparse | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0702_grid_b15_manual_unroll4_sparse__c02_sequential_wraparound_large.c\n");
