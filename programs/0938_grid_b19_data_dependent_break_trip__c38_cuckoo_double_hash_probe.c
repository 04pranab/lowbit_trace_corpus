/*
 * LowBit -- 0938_grid_b19_data_dependent_break_trip__c38_cuckoo_double_hash_probe.c
 * Branch: data_dependent_break_trip | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0938_grid_b19_data_dependent_break_trip__c38_cuckoo_double_hash_probe.c\n");
