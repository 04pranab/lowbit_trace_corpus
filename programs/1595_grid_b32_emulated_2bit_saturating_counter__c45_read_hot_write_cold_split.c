/*
 * LowBit -- 1595_grid_b32_emulated_2bit_saturating_counter__c45_read_hot_write_cold_split.c
 * Branch: emulated_2bit_saturating_counter | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1595_grid_b32_emulated_2bit_saturating_counter__c45_read_hot_write_cold_split.c\n");
