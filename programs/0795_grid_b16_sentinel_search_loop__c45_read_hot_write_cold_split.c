/*
 * LowBit -- 0795_grid_b16_sentinel_search_loop__c45_read_hot_write_cold_split.c
 * Branch: sentinel_search_loop | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0795_grid_b16_sentinel_search_loop__c45_read_hot_write_cold_split.c\n");
