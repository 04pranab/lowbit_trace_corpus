/*
 * LowBit -- 2233_grid_b45_two_counters_race__c33_cache_set_conflict_stress.c
 * Branch: two_counters_race | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2233_grid_b45_two_counters_race__c33_cache_set_conflict_stress.c\n");
