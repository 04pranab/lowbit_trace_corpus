/*
 * LowBit -- 1520_grid_b31_prime_period13__c20_hot_cold_phase_alternation.c
 * Branch: prime_period13 | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=1520_grid_b31_prime_period13__c20_hot_cold_phase_alternation.c\n");
