/*
 * LowBit -- 1425_grid_b29_bursty_streak_pattern__c25_lru_recency_weighted_reuse.c
 * Branch: bursty_streak_pattern | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1425_grid_b29_bursty_streak_pattern__c25_lru_recency_weighted_reuse.c\n");
