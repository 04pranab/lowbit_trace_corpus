/*
 * LowBit -- 1462_grid_b30_periodic_interrupt_override__c12_prime_stride_anti_alias.c
 * Branch: periodic_interrupt_override | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=1462_grid_b30_periodic_interrupt_override__c12_prime_stride_anti_alias.c\n");
