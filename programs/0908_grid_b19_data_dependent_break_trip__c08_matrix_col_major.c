/*
 * LowBit -- 0908_grid_b19_data_dependent_break_trip__c08_matrix_col_major.c
 * Branch: data_dependent_break_trip | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0908_grid_b19_data_dependent_break_trip__c08_matrix_col_major.c\n");
