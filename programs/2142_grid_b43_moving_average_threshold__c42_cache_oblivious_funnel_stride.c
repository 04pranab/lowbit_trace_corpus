/*
 * LowBit -- 2142_grid_b43_moving_average_threshold__c42_cache_oblivious_funnel_stride.c
 * Branch: moving_average_threshold | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2142_grid_b43_moving_average_threshold__c42_cache_oblivious_funnel_stride.c\n");
