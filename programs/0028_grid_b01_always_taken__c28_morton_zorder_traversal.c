/*
 * LowBit -- 0028_grid_b01_always_taken__c28_morton_zorder_traversal.c
 * Branch: always_taken | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0028_grid_b01_always_taken__c28_morton_zorder_traversal.c\n");
