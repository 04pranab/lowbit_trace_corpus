/*
 * LowBit -- 1584_grid_b32_emulated_2bit_saturating_counter__c34_variable_length_burst_reuse.c
 * Branch: emulated_2bit_saturating_counter | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1584_grid_b32_emulated_2bit_saturating_counter__c34_variable_length_burst_reuse.c\n");
