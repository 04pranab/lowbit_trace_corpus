/*
 * LowBit -- 0134_grid_b03_alternating__c34_variable_length_burst_reuse.c
 * Branch: alternating | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0134_grid_b03_alternating__c34_variable_length_burst_reuse.c\n");
