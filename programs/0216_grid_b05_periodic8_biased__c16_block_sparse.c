/*
 * LowBit -- 0216_grid_b05_periodic8_biased__c16_block_sparse.c
 * Branch: periodic8_biased | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0216_grid_b05_periodic8_biased__c16_block_sparse.c\n");
