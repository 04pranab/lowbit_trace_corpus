/*
 * LowBit -- 0077_grid_b02_always_not_taken__c27_reduction_broadcast_pattern.c
 * Branch: always_not_taken | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0077_grid_b02_always_not_taken__c27_reduction_broadcast_pattern.c\n");
