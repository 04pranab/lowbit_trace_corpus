/*
 * LowBit -- 0378_grid_b08_switch_multiway__c28_morton_zorder_traversal.c
 * Branch: switch_multiway | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0378_grid_b08_switch_multiway__c28_morton_zorder_traversal.c\n");
