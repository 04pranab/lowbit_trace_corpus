/*
 * LowBit -- 2207_grid_b45_two_counters_race__c07_matrix_row_major.c
 * Branch: two_counters_race | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2207_grid_b45_two_counters_race__c07_matrix_row_major.c\n");
