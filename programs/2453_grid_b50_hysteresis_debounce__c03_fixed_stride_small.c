/*
 * LowBit -- 2453_grid_b50_hysteresis_debounce__c03_fixed_stride_small.c
 * Branch: hysteresis_debounce | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2453_grid_b50_hysteresis_debounce__c03_fixed_stride_small.c\n");
