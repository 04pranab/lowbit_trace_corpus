/*
 * LowBit -- 2236_grid_b45_two_counters_race__c36_im2col_overlapping_patch_gather.c
 * Branch: two_counters_race | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2236_grid_b45_two_counters_race__c36_im2col_overlapping_patch_gather.c\n");
