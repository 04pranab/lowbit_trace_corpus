/*
 * LowBit -- 0415_grid_b09_recursive_calls__c15_reverse_sequential.c
 * Branch: recursive_calls | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0415_grid_b09_recursive_calls__c15_reverse_sequential.c\n");
