/*
 * LowBit -- 1345_grid_b27_meta_correlated_nested__c45_read_hot_write_cold_split.c
 * Branch: meta_correlated_nested | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1345_grid_b27_meta_correlated_nested__c45_read_hot_write_cold_split.c\n");
