/*
 * LowBit -- 0859_grid_b18_indirect_fn_dispatch__c09_matrix_tiled_blocked.c
 * Branch: indirect_fn_dispatch | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0859_grid_b18_indirect_fn_dispatch__c09_matrix_tiled_blocked.c\n");
