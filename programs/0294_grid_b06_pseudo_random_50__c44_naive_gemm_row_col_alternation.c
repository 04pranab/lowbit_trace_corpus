/*
 * LowBit -- 0294_grid_b06_pseudo_random_50__c44_naive_gemm_row_col_alternation.c
 * Branch: pseudo_random_50 | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0294_grid_b06_pseudo_random_50__c44_naive_gemm_row_col_alternation.c\n");
