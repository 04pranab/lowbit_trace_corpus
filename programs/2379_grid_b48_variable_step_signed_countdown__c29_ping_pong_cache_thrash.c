/*
 * LowBit -- 2379_grid_b48_variable_step_signed_countdown__c29_ping_pong_cache_thrash.c
 * Branch: variable_step_signed_countdown | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2379_grid_b48_variable_step_signed_countdown__c29_ping_pong_cache_thrash.c\n");
