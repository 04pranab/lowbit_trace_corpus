/*
 * LowBit -- 1565_grid_b32_emulated_2bit_saturating_counter__c15_reverse_sequential.c
 * Branch: emulated_2bit_saturating_counter | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1565_grid_b32_emulated_2bit_saturating_counter__c15_reverse_sequential.c\n");
