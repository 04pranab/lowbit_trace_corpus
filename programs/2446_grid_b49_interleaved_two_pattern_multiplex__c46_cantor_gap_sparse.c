/*
 * LowBit -- 2446_grid_b49_interleaved_two_pattern_multiplex__c46_cantor_gap_sparse.c
 * Branch: interleaved_two_pattern_multiplex | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=2446_grid_b49_interleaved_two_pattern_multiplex__c46_cantor_gap_sparse.c\n");
