/*
 * LowBit -- 1027_grid_b21_loop_carried_running_state__c27_reduction_broadcast_pattern.c
 * Branch: loop_carried_running_state | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=1027_grid_b21_loop_carried_running_state__c27_reduction_broadcast_pattern.c\n");
