/*
 * LowBit -- 2539_base_branch_b39_dual_lcg_xor_chaos.c
 * Branch: dual_lcg_xor_chaos | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=2539_base_branch_b39_dual_lcg_xor_chaos.c\n");
