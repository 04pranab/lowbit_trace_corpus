/*
 * LowBit -- 0506_grid_b11_value_dependent_threshold__c06_random_full_working_set.c
 * Branch: value_dependent_threshold | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0506_grid_b11_value_dependent_threshold__c06_random_full_working_set.c\n");
