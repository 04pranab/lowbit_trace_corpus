/*
 * LowBit -- 0812_grid_b17_correlated_two_branch_xor__c12_prime_stride_anti_alias.c
 * Branch: correlated_two_branch_xor | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0812_grid_b17_correlated_two_branch_xor__c12_prime_stride_anti_alias.c\n");
