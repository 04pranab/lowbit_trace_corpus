/*
 * LowBit -- 1060_grid_b22_drifting_threshold_periodic_reset__c10_pointer_chase_linked_list.c
 * Branch: drifting_threshold_periodic_reset | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1060_grid_b22_drifting_threshold_periodic_reset__c10_pointer_chase_linked_list.c\n");
