/*
 * LowBit -- 2481_grid_b50_hysteresis_debounce__c31_fibonacci_stride.c
 * Branch: hysteresis_debounce | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2481_grid_b50_hysteresis_debounce__c31_fibonacci_stride.c\n");
