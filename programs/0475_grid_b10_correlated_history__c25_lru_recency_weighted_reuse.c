/*
 * LowBit -- 0475_grid_b10_correlated_history__c25_lru_recency_weighted_reuse.c
 * Branch: correlated_history | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0475_grid_b10_correlated_history__c25_lru_recency_weighted_reuse.c\n");
