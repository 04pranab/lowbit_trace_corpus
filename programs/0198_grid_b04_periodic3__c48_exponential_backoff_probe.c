/*
 * LowBit -- 0198_grid_b04_periodic3__c48_exponential_backoff_probe.c
 * Branch: periodic3 | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0198_grid_b04_periodic3__c48_exponential_backoff_probe.c\n");
