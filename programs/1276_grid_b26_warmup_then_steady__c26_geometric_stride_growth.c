/*
 * LowBit -- 1276_grid_b26_warmup_then_steady__c26_geometric_stride_growth.c
 * Branch: warmup_then_steady | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1276_grid_b26_warmup_then_steady__c26_geometric_stride_growth.c\n");
