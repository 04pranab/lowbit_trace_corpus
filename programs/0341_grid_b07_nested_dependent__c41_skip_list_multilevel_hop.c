/*
 * LowBit -- 0341_grid_b07_nested_dependent__c41_skip_list_multilevel_hop.c
 * Branch: nested_dependent | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0341_grid_b07_nested_dependent__c41_skip_list_multilevel_hop.c\n");
