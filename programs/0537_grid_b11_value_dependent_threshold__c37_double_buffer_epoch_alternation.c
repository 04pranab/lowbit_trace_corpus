/*
 * LowBit -- 0537_grid_b11_value_dependent_threshold__c37_double_buffer_epoch_alternation.c
 * Branch: value_dependent_threshold | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0537_grid_b11_value_dependent_threshold__c37_double_buffer_epoch_alternation.c\n");
