/*
 * LowBit -- 1174_grid_b24_monotonic_drift_saturating__c24_banked_interleaved_access.c
 * Branch: monotonic_drift_saturating | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1174_grid_b24_monotonic_drift_saturating__c24_banked_interleaved_access.c\n");
