/*
 * LowBit -- 0081_grid_b02_always_not_taken__c31_fibonacci_stride.c
 * Branch: always_not_taken | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0081_grid_b02_always_not_taken__c31_fibonacci_stride.c\n");
