/*
 * LowBit -- 2515_base_branch_b15_manual_unroll4_sparse.c
 * Branch: manual_unroll4_sparse | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2515_base_branch_b15_manual_unroll4_sparse.c\n");
