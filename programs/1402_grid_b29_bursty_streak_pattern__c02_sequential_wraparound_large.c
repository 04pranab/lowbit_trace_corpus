/*
 * LowBit -- 1402_grid_b29_bursty_streak_pattern__c02_sequential_wraparound_large.c
 * Branch: bursty_streak_pattern | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1402_grid_b29_bursty_streak_pattern__c02_sequential_wraparound_large.c\n");
