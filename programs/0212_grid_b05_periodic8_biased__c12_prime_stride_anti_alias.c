/*
 * LowBit -- 0212_grid_b05_periodic8_biased__c12_prime_stride_anti_alias.c
 * Branch: periodic8_biased | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0212_grid_b05_periodic8_biased__c12_prime_stride_anti_alias.c\n");
