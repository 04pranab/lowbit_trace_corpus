/*
 * LowBit -- 2071_grid_b42_bit_reversal_index_data_mix__c21_pyramid_multiresolution_stride.c
 * Branch: bit_reversal_index_data_mix | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2071_grid_b42_bit_reversal_index_data_mix__c21_pyramid_multiresolution_stride.c\n");
