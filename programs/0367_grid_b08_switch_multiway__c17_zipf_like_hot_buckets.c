/*
 * LowBit -- 0367_grid_b08_switch_multiway__c17_zipf_like_hot_buckets.c
 * Branch: switch_multiway | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0367_grid_b08_switch_multiway__c17_zipf_like_hot_buckets.c\n");
