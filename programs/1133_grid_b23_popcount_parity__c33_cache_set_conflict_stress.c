/*
 * LowBit -- 1133_grid_b23_popcount_parity__c33_cache_set_conflict_stress.c
 * Branch: popcount_parity | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1133_grid_b23_popcount_parity__c33_cache_set_conflict_stress.c\n");
