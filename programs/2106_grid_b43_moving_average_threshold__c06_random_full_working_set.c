/*
 * LowBit -- 2106_grid_b43_moving_average_threshold__c06_random_full_working_set.c
 * Branch: moving_average_threshold | Cache: random_full_working_set
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2106_grid_b43_moving_average_threshold__c06_random_full_working_set.c\n");
