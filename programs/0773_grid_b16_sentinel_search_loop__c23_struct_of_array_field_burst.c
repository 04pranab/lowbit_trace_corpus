/*
 * LowBit -- 0773_grid_b16_sentinel_search_loop__c23_struct_of_array_field_burst.c
 * Branch: sentinel_search_loop | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0773_grid_b16_sentinel_search_loop__c23_struct_of_array_field_burst.c\n");
