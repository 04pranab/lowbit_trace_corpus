/*
 * LowBit -- 0613_grid_b13_single_phase_change__c13_two_stream_interleaved.c
 * Branch: single_phase_change | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0613_grid_b13_single_phase_change__c13_two_stream_interleaved.c\n");
