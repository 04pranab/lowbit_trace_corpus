/*
 * LowBit -- 0703_grid_b15_manual_unroll4_sparse__c03_fixed_stride_small.c
 * Branch: manual_unroll4_sparse | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0703_grid_b15_manual_unroll4_sparse__c03_fixed_stride_small.c\n");
