/*
 * LowBit -- 1789_grid_b36_traffic_light_fsm__c39_bounded_random_walk.c
 * Branch: traffic_light_fsm | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1789_grid_b36_traffic_light_fsm__c39_bounded_random_walk.c\n");
