/*
 * LowBit -- 2546_base_branch_b46_lookup_table_driven.c
 * Branch: lookup_table_driven | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2546_base_branch_b46_lookup_table_driven.c\n");
