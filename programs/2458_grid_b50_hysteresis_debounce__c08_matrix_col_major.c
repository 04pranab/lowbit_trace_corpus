/*
 * LowBit -- 2458_grid_b50_hysteresis_debounce__c08_matrix_col_major.c
 * Branch: hysteresis_debounce | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2458_grid_b50_hysteresis_debounce__c08_matrix_col_major.c\n");
