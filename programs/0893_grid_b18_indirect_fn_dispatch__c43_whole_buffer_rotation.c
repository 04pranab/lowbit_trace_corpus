/*
 * LowBit -- 0893_grid_b18_indirect_fn_dispatch__c43_whole_buffer_rotation.c
 * Branch: indirect_fn_dispatch | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0893_grid_b18_indirect_fn_dispatch__c43_whole_buffer_rotation.c\n");
