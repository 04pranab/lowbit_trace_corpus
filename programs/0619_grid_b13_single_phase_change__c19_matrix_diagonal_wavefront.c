/*
 * LowBit -- 0619_grid_b13_single_phase_change__c19_matrix_diagonal_wavefront.c
 * Branch: single_phase_change | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0619_grid_b13_single_phase_change__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=single_phase_change\n");
