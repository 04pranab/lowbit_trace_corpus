/*
 * LowBit -- 1677_grid_b34_data_driven_countdown__c27_reduction_broadcast_pattern.c
 * Branch: data_driven_countdown | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1677_grid_b34_data_driven_countdown__c27_reduction_broadcast_pattern.c\n");
