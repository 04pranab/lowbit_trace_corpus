/*
 * LowBit -- 1445_grid_b29_bursty_streak_pattern__c45_read_hot_write_cold_split.c
 * Branch: bursty_streak_pattern | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1445_grid_b29_bursty_streak_pattern__c45_read_hot_write_cold_split.c\n");
