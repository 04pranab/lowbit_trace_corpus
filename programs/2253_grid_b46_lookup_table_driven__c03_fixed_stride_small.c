/*
 * LowBit -- 2253_grid_b46_lookup_table_driven__c03_fixed_stride_small.c
 * Branch: lookup_table_driven | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2253_grid_b46_lookup_table_driven__c03_fixed_stride_small.c\n");
