/*
 * LowBit -- 1037_grid_b21_loop_carried_running_state__c37_double_buffer_epoch_alternation.c
 * Branch: loop_carried_running_state | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=1037_grid_b21_loop_carried_running_state__c37_double_buffer_epoch_alternation.c\n");
