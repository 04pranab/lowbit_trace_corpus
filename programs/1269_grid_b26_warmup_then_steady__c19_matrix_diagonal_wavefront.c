/*
 * LowBit -- 1269_grid_b26_warmup_then_steady__c19_matrix_diagonal_wavefront.c
 * Branch: warmup_then_steady | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { uint64_t warm26_ = N / 20u; if (warm26_ == 0u) warm26_ = 1u;
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1269_grid_b26_warmup_then_steady__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=warmup_then_steady\n");
