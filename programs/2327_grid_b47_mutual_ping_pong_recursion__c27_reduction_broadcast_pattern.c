/*
 * LowBit -- 2327_grid_b47_mutual_ping_pong_recursion__c27_reduction_broadcast_pattern.c
 * Branch: mutual_ping_pong_recursion | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2327_grid_b47_mutual_ping_pong_recursion__c27_reduction_broadcast_pattern.c\n");
