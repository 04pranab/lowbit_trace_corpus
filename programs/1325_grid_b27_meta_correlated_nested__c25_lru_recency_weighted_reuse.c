/*
 * LowBit -- 1325_grid_b27_meta_correlated_nested__c25_lru_recency_weighted_reuse.c
 * Branch: meta_correlated_nested | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1325_grid_b27_meta_correlated_nested__c25_lru_recency_weighted_reuse.c\n");
