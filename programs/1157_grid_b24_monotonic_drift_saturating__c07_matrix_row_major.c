/*
 * LowBit -- 1157_grid_b24_monotonic_drift_saturating__c07_matrix_row_major.c
 * Branch: monotonic_drift_saturating | Cache: matrix_row_major
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1157_grid_b24_monotonic_drift_saturating__c07_matrix_row_major.c\n");
