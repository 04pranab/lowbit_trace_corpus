/*
 * LowBit -- 0449_grid_b09_recursive_calls__c49_binary_heap_parent_child.c
 * Branch: recursive_calls | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0449_grid_b09_recursive_calls__c49_binary_heap_parent_child.c\n");
