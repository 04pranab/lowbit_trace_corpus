/*
 * LowBit -- 0321_grid_b07_nested_dependent__c21_pyramid_multiresolution_stride.c
 * Branch: nested_dependent | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0321_grid_b07_nested_dependent__c21_pyramid_multiresolution_stride.c\n");
