/*
 * LowBit -- 0336_grid_b07_nested_dependent__c36_im2col_overlapping_patch_gather.c
 * Branch: nested_dependent | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0336_grid_b07_nested_dependent__c36_im2col_overlapping_patch_gather.c\n");
