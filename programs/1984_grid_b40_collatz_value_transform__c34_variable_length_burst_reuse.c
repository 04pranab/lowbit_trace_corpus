/*
 * LowBit -- 1984_grid_b40_collatz_value_transform__c34_variable_length_burst_reuse.c
 * Branch: collatz_value_transform | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1984_grid_b40_collatz_value_transform__c34_variable_length_burst_reuse.c\n");
