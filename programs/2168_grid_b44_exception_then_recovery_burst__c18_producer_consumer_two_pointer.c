/*
 * LowBit -- 2168_grid_b44_exception_then_recovery_burst__c18_producer_consumer_two_pointer.c
 * Branch: exception_then_recovery_burst | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2168_grid_b44_exception_then_recovery_burst__c18_producer_consumer_two_pointer.c\n");
