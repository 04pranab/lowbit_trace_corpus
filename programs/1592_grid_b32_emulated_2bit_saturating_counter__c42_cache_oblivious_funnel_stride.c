/*
 * LowBit -- 1592_grid_b32_emulated_2bit_saturating_counter__c42_cache_oblivious_funnel_stride.c
 * Branch: emulated_2bit_saturating_counter | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1592_grid_b32_emulated_2bit_saturating_counter__c42_cache_oblivious_funnel_stride.c\n");
