/*
 * LowBit -- 1100_grid_b22_drifting_threshold_periodic_reset__c50_streaming_with_periodic_flush.c
 * Branch: drifting_threshold_periodic_reset | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1100_grid_b22_drifting_threshold_periodic_reset__c50_streaming_with_periodic_flush.c\n");
