/*
 * LowBit -- 0765_grid_b16_sentinel_search_loop__c15_reverse_sequential.c
 * Branch: sentinel_search_loop | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0765_grid_b16_sentinel_search_loop__c15_reverse_sequential.c\n");
