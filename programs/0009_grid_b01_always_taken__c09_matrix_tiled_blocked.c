/*
 * LowBit -- 0009_grid_b01_always_taken__c09_matrix_tiled_blocked.c
 * Branch: always_taken | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0009_grid_b01_always_taken__c09_matrix_tiled_blocked.c\n");
