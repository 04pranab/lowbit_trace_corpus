/*
 * LowBit -- 1272_grid_b26_warmup_then_steady__c22_tensor_3d_slice_poor_locality.c
 * Branch: warmup_then_steady | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1272_grid_b26_warmup_then_steady__c22_tensor_3d_slice_poor_locality.c\n");
