/*
 * LowBit -- 0520_grid_b11_value_dependent_threshold__c20_hot_cold_phase_alternation.c
 * Branch: value_dependent_threshold | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0520_grid_b11_value_dependent_threshold__c20_hot_cold_phase_alternation.c\n");
