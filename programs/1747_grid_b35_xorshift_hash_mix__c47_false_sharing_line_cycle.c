/*
 * LowBit -- 1747_grid_b35_xorshift_hash_mix__c47_false_sharing_line_cycle.c
 * Branch: xorshift_hash_mix | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1747_grid_b35_xorshift_hash_mix__c47_false_sharing_line_cycle.c\n");
