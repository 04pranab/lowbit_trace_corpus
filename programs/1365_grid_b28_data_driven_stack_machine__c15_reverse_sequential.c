/*
 * LowBit -- 1365_grid_b28_data_driven_stack_machine__c15_reverse_sequential.c
 * Branch: data_driven_stack_machine | Cache: reverse_sequential
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1365_grid_b28_data_driven_stack_machine__c15_reverse_sequential.c\n");
