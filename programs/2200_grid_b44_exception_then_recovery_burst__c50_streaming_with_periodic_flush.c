/*
 * LowBit -- 2200_grid_b44_exception_then_recovery_burst__c50_streaming_with_periodic_flush.c
 * Branch: exception_then_recovery_burst | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2200_grid_b44_exception_then_recovery_burst__c50_streaming_with_periodic_flush.c\n");
