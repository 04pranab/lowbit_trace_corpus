/*
 * LowBit -- 0182_grid_b04_periodic3__c32_hilbert_curve_traversal.c
 * Branch: periodic3 | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0182_grid_b04_periodic3__c32_hilbert_curve_traversal.c\n");
