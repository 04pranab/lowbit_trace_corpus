/*
 * LowBit -- 0771_grid_b16_sentinel_search_loop__c21_pyramid_multiresolution_stride.c
 * Branch: sentinel_search_loop | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0771_grid_b16_sentinel_search_loop__c21_pyramid_multiresolution_stride.c\n");
