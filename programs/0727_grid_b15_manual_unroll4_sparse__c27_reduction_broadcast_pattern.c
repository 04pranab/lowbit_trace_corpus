/*
 * LowBit -- 0727_grid_b15_manual_unroll4_sparse__c27_reduction_broadcast_pattern.c
 * Branch: manual_unroll4_sparse | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0727_grid_b15_manual_unroll4_sparse__c27_reduction_broadcast_pattern.c\n");
