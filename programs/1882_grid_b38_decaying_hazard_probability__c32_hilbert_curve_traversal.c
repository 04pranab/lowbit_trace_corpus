/*
 * LowBit -- 1882_grid_b38_decaying_hazard_probability__c32_hilbert_curve_traversal.c
 * Branch: decaying_hazard_probability | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1882_grid_b38_decaying_hazard_probability__c32_hilbert_curve_traversal.c\n");
