/*
 * LowBit -- 0654_grid_b14_four_way_skewed__c04_fixed_stride_large.c
 * Branch: four_way_skewed | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0654_grid_b14_four_way_skewed__c04_fixed_stride_large.c\n");
