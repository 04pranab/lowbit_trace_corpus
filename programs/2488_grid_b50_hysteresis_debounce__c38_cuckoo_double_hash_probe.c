/*
 * LowBit -- 2488_grid_b50_hysteresis_debounce__c38_cuckoo_double_hash_probe.c
 * Branch: hysteresis_debounce | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2488_grid_b50_hysteresis_debounce__c38_cuckoo_double_hash_probe.c\n");
