/*
 * LowBit -- 0503_grid_b11_value_dependent_threshold__c03_fixed_stride_small.c
 * Branch: value_dependent_threshold | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0503_grid_b11_value_dependent_threshold__c03_fixed_stride_small.c\n");
