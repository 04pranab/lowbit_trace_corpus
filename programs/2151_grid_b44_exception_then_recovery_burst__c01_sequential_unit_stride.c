/*
 * LowBit -- 2151_grid_b44_exception_then_recovery_burst__c01_sequential_unit_stride.c
 * Branch: exception_then_recovery_burst | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2151_grid_b44_exception_then_recovery_burst__c01_sequential_unit_stride.c\n");
