/*
 * LowBit -- 1929_grid_b39_dual_lcg_xor_chaos__c29_ping_pong_cache_thrash.c
 * Branch: dual_lcg_xor_chaos | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1929_grid_b39_dual_lcg_xor_chaos__c29_ping_pong_cache_thrash.c\n");
