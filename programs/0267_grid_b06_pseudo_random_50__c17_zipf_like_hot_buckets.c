/*
 * LowBit -- 0267_grid_b06_pseudo_random_50__c17_zipf_like_hot_buckets.c
 * Branch: pseudo_random_50 | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0267_grid_b06_pseudo_random_50__c17_zipf_like_hot_buckets.c\n");
