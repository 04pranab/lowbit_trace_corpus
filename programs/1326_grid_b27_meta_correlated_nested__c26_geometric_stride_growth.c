/*
 * LowBit -- 1326_grid_b27_meta_correlated_nested__c26_geometric_stride_growth.c
 * Branch: meta_correlated_nested | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1326_grid_b27_meta_correlated_nested__c26_geometric_stride_growth.c\n");
