/*
 * LowBit -- 1495_grid_b30_periodic_interrupt_override__c45_read_hot_write_cold_split.c
 * Branch: periodic_interrupt_override | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=1495_grid_b30_periodic_interrupt_override__c45_read_hot_write_cold_split.c\n");
