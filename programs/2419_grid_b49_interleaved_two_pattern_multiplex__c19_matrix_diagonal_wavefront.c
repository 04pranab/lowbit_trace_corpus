/*
 * LowBit -- 2419_grid_b49_interleaved_two_pattern_multiplex__c19_matrix_diagonal_wavefront.c
 * Branch: interleaved_two_pattern_multiplex | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=2419_grid_b49_interleaved_two_pattern_multiplex__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=interleaved_two_pattern_multiplex\n");
