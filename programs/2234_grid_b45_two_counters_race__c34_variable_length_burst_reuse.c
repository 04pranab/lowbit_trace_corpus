/*
 * LowBit -- 2234_grid_b45_two_counters_race__c34_variable_length_burst_reuse.c
 * Branch: two_counters_race | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2234_grid_b45_two_counters_race__c34_variable_length_burst_reuse.c\n");
