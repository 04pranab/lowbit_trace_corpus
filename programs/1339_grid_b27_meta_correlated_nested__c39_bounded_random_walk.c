/*
 * LowBit -- 1339_grid_b27_meta_correlated_nested__c39_bounded_random_walk.c
 * Branch: meta_correlated_nested | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1339_grid_b27_meta_correlated_nested__c39_bounded_random_walk.c\n");
