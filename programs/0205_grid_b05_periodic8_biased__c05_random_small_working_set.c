/*
 * LowBit -- 0205_grid_b05_periodic8_biased__c05_random_small_working_set.c
 * Branch: periodic8_biased | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0205_grid_b05_periodic8_biased__c05_random_small_working_set.c\n");
