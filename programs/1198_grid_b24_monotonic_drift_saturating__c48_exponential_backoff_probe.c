/*
 * LowBit -- 1198_grid_b24_monotonic_drift_saturating__c48_exponential_backoff_probe.c
 * Branch: monotonic_drift_saturating | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1198_grid_b24_monotonic_drift_saturating__c48_exponential_backoff_probe.c\n");
