/*
 * LowBit -- 0837_grid_b17_correlated_two_branch_xor__c37_double_buffer_epoch_alternation.c
 * Branch: correlated_two_branch_xor | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0837_grid_b17_correlated_two_branch_xor__c37_double_buffer_epoch_alternation.c\n");
