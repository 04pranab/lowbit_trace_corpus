/*
 * LowBit -- 1771_grid_b36_traffic_light_fsm__c21_pyramid_multiresolution_stride.c
 * Branch: traffic_light_fsm | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1771_grid_b36_traffic_light_fsm__c21_pyramid_multiresolution_stride.c\n");
