/*
 * LowBit -- 2595_base_cache_c45_read_hot_write_cold_split.c
 * Branch: synthetic_always_taken | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=2595_base_cache_c45_read_hot_write_cold_split.c\n");
