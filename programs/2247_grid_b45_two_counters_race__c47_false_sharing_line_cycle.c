/*
 * LowBit -- 2247_grid_b45_two_counters_race__c47_false_sharing_line_cycle.c
 * Branch: two_counters_race | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2247_grid_b45_two_counters_race__c47_false_sharing_line_cycle.c\n");
