/*
 * LowBit -- 1826_grid_b37_value_driven_unswitch_run__c26_geometric_stride_growth.c
 * Branch: value_driven_unswitch_run | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1826_grid_b37_value_driven_unswitch_run__c26_geometric_stride_growth.c\n");
