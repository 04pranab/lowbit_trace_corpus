/*
 * LowBit -- 0350_grid_b07_nested_dependent__c50_streaming_with_periodic_flush.c
 * Branch: nested_dependent | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0350_grid_b07_nested_dependent__c50_streaming_with_periodic_flush.c\n");
