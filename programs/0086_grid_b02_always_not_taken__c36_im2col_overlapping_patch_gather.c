/*
 * LowBit -- 0086_grid_b02_always_not_taken__c36_im2col_overlapping_patch_gather.c
 * Branch: always_not_taken | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0086_grid_b02_always_not_taken__c36_im2col_overlapping_patch_gather.c\n");
