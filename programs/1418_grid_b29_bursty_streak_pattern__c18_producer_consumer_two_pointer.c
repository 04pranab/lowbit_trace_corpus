/*
 * LowBit -- 1418_grid_b29_bursty_streak_pattern__c18_producer_consumer_two_pointer.c
 * Branch: bursty_streak_pattern | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1418_grid_b29_bursty_streak_pattern__c18_producer_consumer_two_pointer.c\n");
