/*
 * LowBit -- 0100_grid_b02_always_not_taken__c50_streaming_with_periodic_flush.c
 * Branch: always_not_taken | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0100_grid_b02_always_not_taken__c50_streaming_with_periodic_flush.c\n");
