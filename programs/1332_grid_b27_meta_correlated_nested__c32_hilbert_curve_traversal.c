/*
 * LowBit -- 1332_grid_b27_meta_correlated_nested__c32_hilbert_curve_traversal.c
 * Branch: meta_correlated_nested | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1332_grid_b27_meta_correlated_nested__c32_hilbert_curve_traversal.c\n");
