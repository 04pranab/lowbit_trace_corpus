/*
 * LowBit -- 1870_grid_b38_decaying_hazard_probability__c20_hot_cold_phase_alternation.c
 * Branch: decaying_hazard_probability | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1870_grid_b38_decaying_hazard_probability__c20_hot_cold_phase_alternation.c\n");
