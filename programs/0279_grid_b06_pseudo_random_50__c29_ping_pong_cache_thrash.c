/*
 * LowBit -- 0279_grid_b06_pseudo_random_50__c29_ping_pong_cache_thrash.c
 * Branch: pseudo_random_50 | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0279_grid_b06_pseudo_random_50__c29_ping_pong_cache_thrash.c\n");
