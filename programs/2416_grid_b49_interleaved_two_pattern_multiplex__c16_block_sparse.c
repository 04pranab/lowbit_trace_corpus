/*
 * LowBit -- 2416_grid_b49_interleaved_two_pattern_multiplex__c16_block_sparse.c
 * Branch: interleaved_two_pattern_multiplex | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=2416_grid_b49_interleaved_two_pattern_multiplex__c16_block_sparse.c\n");
