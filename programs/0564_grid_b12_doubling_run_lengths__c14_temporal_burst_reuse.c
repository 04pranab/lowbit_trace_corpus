/*
 * LowBit -- 0564_grid_b12_doubling_run_lengths__c14_temporal_burst_reuse.c
 * Branch: doubling_run_lengths | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0564_grid_b12_doubling_run_lengths__c14_temporal_burst_reuse.c\n");
