/*
 * LowBit -- 1568_grid_b32_emulated_2bit_saturating_counter__c18_producer_consumer_two_pointer.c
 * Branch: emulated_2bit_saturating_counter | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1568_grid_b32_emulated_2bit_saturating_counter__c18_producer_consumer_two_pointer.c\n");
