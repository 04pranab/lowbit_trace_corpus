/*
 * LowBit -- 1770_grid_b36_traffic_light_fsm__c20_hot_cold_phase_alternation.c
 * Branch: traffic_light_fsm | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1770_grid_b36_traffic_light_fsm__c20_hot_cold_phase_alternation.c\n");
