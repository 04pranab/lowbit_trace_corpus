/*
 * LowBit -- 2219_grid_b45_two_counters_race__c19_matrix_diagonal_wavefront.c
 * Branch: two_counters_race | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2219_grid_b45_two_counters_race__c19_matrix_diagonal_wavefront.c\n");
