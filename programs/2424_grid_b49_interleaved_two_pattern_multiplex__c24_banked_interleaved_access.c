/*
 * LowBit -- 2424_grid_b49_interleaved_two_pattern_multiplex__c24_banked_interleaved_access.c
 * Branch: interleaved_two_pattern_multiplex | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=2424_grid_b49_interleaved_two_pattern_multiplex__c24_banked_interleaved_access.c\n");
