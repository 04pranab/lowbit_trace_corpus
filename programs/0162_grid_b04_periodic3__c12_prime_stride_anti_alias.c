/*
 * LowBit -- 0162_grid_b04_periodic3__c12_prime_stride_anti_alias.c
 * Branch: periodic3 | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0162_grid_b04_periodic3__c12_prime_stride_anti_alias.c\n");
