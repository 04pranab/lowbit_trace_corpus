/*
 * LowBit -- 2482_grid_b50_hysteresis_debounce__c32_hilbert_curve_traversal.c
 * Branch: hysteresis_debounce | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2482_grid_b50_hysteresis_debounce__c32_hilbert_curve_traversal.c\n");
