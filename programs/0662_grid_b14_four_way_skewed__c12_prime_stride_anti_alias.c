/*
 * LowBit -- 0662_grid_b14_four_way_skewed__c12_prime_stride_anti_alias.c
 * Branch: four_way_skewed | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0662_grid_b14_four_way_skewed__c12_prime_stride_anti_alias.c\n");
