/*
 * LowBit -- 2330_grid_b47_mutual_ping_pong_recursion__c30_gather_scatter_indirect_table.c
 * Branch: mutual_ping_pong_recursion | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2330_grid_b47_mutual_ping_pong_recursion__c30_gather_scatter_indirect_table.c\n");
