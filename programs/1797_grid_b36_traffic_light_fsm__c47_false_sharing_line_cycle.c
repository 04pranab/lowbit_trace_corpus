/*
 * LowBit -- 1797_grid_b36_traffic_light_fsm__c47_false_sharing_line_cycle.c
 * Branch: traffic_light_fsm | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1797_grid_b36_traffic_light_fsm__c47_false_sharing_line_cycle.c\n");
