/*
 * LowBit -- 0762_grid_b16_sentinel_search_loop__c12_prime_stride_anti_alias.c
 * Branch: sentinel_search_loop | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0762_grid_b16_sentinel_search_loop__c12_prime_stride_anti_alias.c\n");
