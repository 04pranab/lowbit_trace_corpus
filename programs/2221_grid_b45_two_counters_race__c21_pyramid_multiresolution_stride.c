/*
 * LowBit -- 2221_grid_b45_two_counters_race__c21_pyramid_multiresolution_stride.c
 * Branch: two_counters_race | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2221_grid_b45_two_counters_race__c21_pyramid_multiresolution_stride.c\n");
