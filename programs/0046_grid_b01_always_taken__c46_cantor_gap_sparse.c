/*
 * LowBit -- 0046_grid_b01_always_taken__c46_cantor_gap_sparse.c
 * Branch: always_taken | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0046_grid_b01_always_taken__c46_cantor_gap_sparse.c\n");
