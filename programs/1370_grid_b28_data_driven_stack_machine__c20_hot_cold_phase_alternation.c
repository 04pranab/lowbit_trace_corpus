/*
 * LowBit -- 1370_grid_b28_data_driven_stack_machine__c20_hot_cold_phase_alternation.c
 * Branch: data_driven_stack_machine | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1370_grid_b28_data_driven_stack_machine__c20_hot_cold_phase_alternation.c\n");
