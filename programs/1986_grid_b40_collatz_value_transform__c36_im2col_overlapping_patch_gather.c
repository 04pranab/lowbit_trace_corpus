/*
 * LowBit -- 1986_grid_b40_collatz_value_transform__c36_im2col_overlapping_patch_gather.c
 * Branch: collatz_value_transform | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1986_grid_b40_collatz_value_transform__c36_im2col_overlapping_patch_gather.c\n");
