/*
 * LowBit -- 0680_grid_b14_four_way_skewed__c30_gather_scatter_indirect_table.c
 * Branch: four_way_skewed | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0680_grid_b14_four_way_skewed__c30_gather_scatter_indirect_table.c\n");
