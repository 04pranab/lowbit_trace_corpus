/*
 * LowBit -- 0346_grid_b07_nested_dependent__c46_cantor_gap_sparse.c
 * Branch: nested_dependent | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0346_grid_b07_nested_dependent__c46_cantor_gap_sparse.c\n");
