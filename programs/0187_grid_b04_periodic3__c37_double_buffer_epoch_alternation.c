/*
 * LowBit -- 0187_grid_b04_periodic3__c37_double_buffer_epoch_alternation.c
 * Branch: periodic3 | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0187_grid_b04_periodic3__c37_double_buffer_epoch_alternation.c\n");
