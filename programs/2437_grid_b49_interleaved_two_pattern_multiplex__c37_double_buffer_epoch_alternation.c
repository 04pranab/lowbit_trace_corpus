/*
 * LowBit -- 2437_grid_b49_interleaved_two_pattern_multiplex__c37_double_buffer_epoch_alternation.c
 * Branch: interleaved_two_pattern_multiplex | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=2437_grid_b49_interleaved_two_pattern_multiplex__c37_double_buffer_epoch_alternation.c\n");
