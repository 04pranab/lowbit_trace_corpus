/*
 * LowBit -- 1674_grid_b34_data_driven_countdown__c24_banked_interleaved_access.c
 * Branch: data_driven_countdown | Cache: banked_interleaved_access
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1674_grid_b34_data_driven_countdown__c24_banked_interleaved_access.c\n");
