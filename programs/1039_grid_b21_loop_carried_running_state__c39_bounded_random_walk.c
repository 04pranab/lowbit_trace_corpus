/*
 * LowBit -- 1039_grid_b21_loop_carried_running_state__c39_bounded_random_walk.c
 * Branch: loop_carried_running_state | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=1039_grid_b21_loop_carried_running_state__c39_bounded_random_walk.c\n");
