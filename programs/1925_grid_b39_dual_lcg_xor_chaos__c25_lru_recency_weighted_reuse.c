/*
 * LowBit -- 1925_grid_b39_dual_lcg_xor_chaos__c25_lru_recency_weighted_reuse.c
 * Branch: dual_lcg_xor_chaos | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1925_grid_b39_dual_lcg_xor_chaos__c25_lru_recency_weighted_reuse.c\n");
