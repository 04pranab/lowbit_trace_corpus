/*
 * LowBit -- 2244_grid_b45_two_counters_race__c44_naive_gemm_row_col_alternation.c
 * Branch: two_counters_race | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2244_grid_b45_two_counters_race__c44_naive_gemm_row_col_alternation.c\n");
