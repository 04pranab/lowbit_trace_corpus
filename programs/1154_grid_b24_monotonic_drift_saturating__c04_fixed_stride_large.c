/*
 * LowBit -- 1154_grid_b24_monotonic_drift_saturating__c04_fixed_stride_large.c
 * Branch: monotonic_drift_saturating | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1154_grid_b24_monotonic_drift_saturating__c04_fixed_stride_large.c\n");
