/*
 * LowBit -- 0526_grid_b11_value_dependent_threshold__c26_geometric_stride_growth.c
 * Branch: value_dependent_threshold | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0526_grid_b11_value_dependent_threshold__c26_geometric_stride_growth.c\n");
