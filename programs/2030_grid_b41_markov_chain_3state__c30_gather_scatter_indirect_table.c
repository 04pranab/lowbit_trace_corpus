/*
 * LowBit -- 2030_grid_b41_markov_chain_3state__c30_gather_scatter_indirect_table.c
 * Branch: markov_chain_3state | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2030_grid_b41_markov_chain_3state__c30_gather_scatter_indirect_table.c\n");
