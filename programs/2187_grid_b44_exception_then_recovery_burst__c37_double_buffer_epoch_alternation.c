/*
 * LowBit -- 2187_grid_b44_exception_then_recovery_burst__c37_double_buffer_epoch_alternation.c
 * Branch: exception_then_recovery_burst | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2187_grid_b44_exception_then_recovery_burst__c37_double_buffer_epoch_alternation.c\n");
