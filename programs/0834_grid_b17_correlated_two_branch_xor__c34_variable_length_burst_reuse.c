/*
 * LowBit -- 0834_grid_b17_correlated_two_branch_xor__c34_variable_length_burst_reuse.c
 * Branch: correlated_two_branch_xor | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0834_grid_b17_correlated_two_branch_xor__c34_variable_length_burst_reuse.c\n");
