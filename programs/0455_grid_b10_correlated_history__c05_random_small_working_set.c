/*
 * LowBit -- 0455_grid_b10_correlated_history__c05_random_small_working_set.c
 * Branch: correlated_history | Cache: random_small_working_set
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0455_grid_b10_correlated_history__c05_random_small_working_set.c\n");
