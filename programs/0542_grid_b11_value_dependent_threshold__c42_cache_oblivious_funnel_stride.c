/*
 * LowBit -- 0542_grid_b11_value_dependent_threshold__c42_cache_oblivious_funnel_stride.c
 * Branch: value_dependent_threshold | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0542_grid_b11_value_dependent_threshold__c42_cache_oblivious_funnel_stride.c\n");
