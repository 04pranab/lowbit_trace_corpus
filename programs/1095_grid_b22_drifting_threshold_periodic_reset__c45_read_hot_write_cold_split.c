/*
 * LowBit -- 1095_grid_b22_drifting_threshold_periodic_reset__c45_read_hot_write_cold_split.c
 * Branch: drifting_threshold_periodic_reset | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1095_grid_b22_drifting_threshold_periodic_reset__c45_read_hot_write_cold_split.c\n");
