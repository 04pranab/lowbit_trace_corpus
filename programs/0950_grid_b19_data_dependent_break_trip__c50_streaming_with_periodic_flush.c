/*
 * LowBit -- 0950_grid_b19_data_dependent_break_trip__c50_streaming_with_periodic_flush.c
 * Branch: data_dependent_break_trip | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0950_grid_b19_data_dependent_break_trip__c50_streaming_with_periodic_flush.c\n");
