/*
 * LowBit -- 2088_grid_b42_bit_reversal_index_data_mix__c38_cuckoo_double_hash_probe.c
 * Branch: bit_reversal_index_data_mix | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2088_grid_b42_bit_reversal_index_data_mix__c38_cuckoo_double_hash_probe.c\n");
