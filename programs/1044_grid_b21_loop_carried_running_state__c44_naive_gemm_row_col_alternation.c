/*
 * LowBit -- 1044_grid_b21_loop_carried_running_state__c44_naive_gemm_row_col_alternation.c
 * Branch: loop_carried_running_state | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=1044_grid_b21_loop_carried_running_state__c44_naive_gemm_row_col_alternation.c\n");
