/*
 * LowBit -- 0686_grid_b14_four_way_skewed__c36_im2col_overlapping_patch_gather.c
 * Branch: four_way_skewed | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0686_grid_b14_four_way_skewed__c36_im2col_overlapping_patch_gather.c\n");
