/*
 * LowBit -- 0149_grid_b03_alternating__c49_binary_heap_parent_child.c
 * Branch: alternating | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0149_grid_b03_alternating__c49_binary_heap_parent_child.c\n");
