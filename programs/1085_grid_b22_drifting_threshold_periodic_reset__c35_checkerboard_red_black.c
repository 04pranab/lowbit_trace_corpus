/*
 * LowBit -- 1085_grid_b22_drifting_threshold_periodic_reset__c35_checkerboard_red_black.c
 * Branch: drifting_threshold_periodic_reset | Cache: checkerboard_red_black
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1085_grid_b22_drifting_threshold_periodic_reset__c35_checkerboard_red_black.c\n");
