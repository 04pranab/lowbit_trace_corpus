/*
 * LowBit -- 0980_grid_b20_random_threshold_walk__c30_gather_scatter_indirect_table.c
 * Branch: random_threshold_walk | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0980_grid_b20_random_threshold_walk__c30_gather_scatter_indirect_table.c\n");
