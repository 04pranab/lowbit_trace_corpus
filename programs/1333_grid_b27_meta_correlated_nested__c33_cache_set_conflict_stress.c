/*
 * LowBit -- 1333_grid_b27_meta_correlated_nested__c33_cache_set_conflict_stress.c
 * Branch: meta_correlated_nested | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1333_grid_b27_meta_correlated_nested__c33_cache_set_conflict_stress.c\n");
