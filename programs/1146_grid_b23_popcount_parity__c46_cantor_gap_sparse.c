/*
 * LowBit -- 1146_grid_b23_popcount_parity__c46_cantor_gap_sparse.c
 * Branch: popcount_parity | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1146_grid_b23_popcount_parity__c46_cantor_gap_sparse.c\n");
