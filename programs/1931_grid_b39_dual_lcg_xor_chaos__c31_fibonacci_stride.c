/*
 * LowBit -- 1931_grid_b39_dual_lcg_xor_chaos__c31_fibonacci_stride.c
 * Branch: dual_lcg_xor_chaos | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1931_grid_b39_dual_lcg_xor_chaos__c31_fibonacci_stride.c\n");
