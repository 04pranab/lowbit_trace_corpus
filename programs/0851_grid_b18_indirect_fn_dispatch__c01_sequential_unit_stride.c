/*
 * LowBit -- 0851_grid_b18_indirect_fn_dispatch__c01_sequential_unit_stride.c
 * Branch: indirect_fn_dispatch | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0851_grid_b18_indirect_fn_dispatch__c01_sequential_unit_stride.c\n");
