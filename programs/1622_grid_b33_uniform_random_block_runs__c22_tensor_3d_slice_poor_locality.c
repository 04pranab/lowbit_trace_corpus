/*
 * LowBit -- 1622_grid_b33_uniform_random_block_runs__c22_tensor_3d_slice_poor_locality.c
 * Branch: uniform_random_block_runs | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1622_grid_b33_uniform_random_block_runs__c22_tensor_3d_slice_poor_locality.c\n");
