/*
 * LowBit -- 1842_grid_b37_value_driven_unswitch_run__c42_cache_oblivious_funnel_stride.c
 * Branch: value_driven_unswitch_run | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1842_grid_b37_value_driven_unswitch_run__c42_cache_oblivious_funnel_stride.c\n");
