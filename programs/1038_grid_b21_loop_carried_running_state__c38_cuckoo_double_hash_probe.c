/*
 * LowBit -- 1038_grid_b21_loop_carried_running_state__c38_cuckoo_double_hash_probe.c
 * Branch: loop_carried_running_state | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=1038_grid_b21_loop_carried_running_state__c38_cuckoo_double_hash_probe.c\n");
