/*
 * LowBit -- 2593_base_cache_c43_whole_buffer_rotation.c
 * Branch: synthetic_always_taken | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=2593_base_cache_c43_whole_buffer_rotation.c\n");
