/*
 * LowBit -- 0770_grid_b16_sentinel_search_loop__c20_hot_cold_phase_alternation.c
 * Branch: sentinel_search_loop | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0770_grid_b16_sentinel_search_loop__c20_hot_cold_phase_alternation.c\n");
