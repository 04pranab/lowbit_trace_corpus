/*
 * LowBit -- 0778_grid_b16_sentinel_search_loop__c28_morton_zorder_traversal.c
 * Branch: sentinel_search_loop | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0778_grid_b16_sentinel_search_loop__c28_morton_zorder_traversal.c\n");
