/*
 * LowBit -- 2058_grid_b42_bit_reversal_index_data_mix__c08_matrix_col_major.c
 * Branch: bit_reversal_index_data_mix | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2058_grid_b42_bit_reversal_index_data_mix__c08_matrix_col_major.c\n");
