/*
 * LowBit -- 2305_grid_b47_mutual_ping_pong_recursion__c05_random_small_working_set.c
 * Branch: mutual_ping_pong_recursion | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2305_grid_b47_mutual_ping_pong_recursion__c05_random_small_working_set.c\n");
