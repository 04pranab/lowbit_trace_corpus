/*
 * LowBit -- 0473_grid_b10_correlated_history__c23_struct_of_array_field_burst.c
 * Branch: correlated_history | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0473_grid_b10_correlated_history__c23_struct_of_array_field_burst.c\n");
