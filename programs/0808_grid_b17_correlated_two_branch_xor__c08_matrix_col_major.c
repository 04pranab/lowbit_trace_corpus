/*
 * LowBit -- 0808_grid_b17_correlated_two_branch_xor__c08_matrix_col_major.c
 * Branch: correlated_two_branch_xor | Cache: matrix_col_major
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0808_grid_b17_correlated_two_branch_xor__c08_matrix_col_major.c\n");
