/*
 * LowBit -- 0148_grid_b03_alternating__c48_exponential_backoff_probe.c
 * Branch: alternating | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0148_grid_b03_alternating__c48_exponential_backoff_probe.c\n");
