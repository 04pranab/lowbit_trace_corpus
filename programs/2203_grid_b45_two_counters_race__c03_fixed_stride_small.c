/*
 * LowBit -- 2203_grid_b45_two_counters_race__c03_fixed_stride_small.c
 * Branch: two_counters_race | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2203_grid_b45_two_counters_race__c03_fixed_stride_small.c\n");
