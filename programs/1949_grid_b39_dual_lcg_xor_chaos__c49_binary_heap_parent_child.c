/*
 * LowBit -- 1949_grid_b39_dual_lcg_xor_chaos__c49_binary_heap_parent_child.c
 * Branch: dual_lcg_xor_chaos | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1949_grid_b39_dual_lcg_xor_chaos__c49_binary_heap_parent_child.c\n");
