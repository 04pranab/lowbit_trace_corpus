/*
 * LowBit -- 0959_grid_b20_random_threshold_walk__c09_matrix_tiled_blocked.c
 * Branch: random_threshold_walk | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0959_grid_b20_random_threshold_walk__c09_matrix_tiled_blocked.c\n");
