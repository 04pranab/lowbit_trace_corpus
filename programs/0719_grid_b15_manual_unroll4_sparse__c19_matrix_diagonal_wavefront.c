/*
 * LowBit -- 0719_grid_b15_manual_unroll4_sparse__c19_matrix_diagonal_wavefront.c
 * Branch: manual_unroll4_sparse | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0719_grid_b15_manual_unroll4_sparse__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=manual_unroll4_sparse\n");
