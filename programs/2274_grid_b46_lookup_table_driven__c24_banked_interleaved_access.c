/*
 * LowBit -- 2274_grid_b46_lookup_table_driven__c24_banked_interleaved_access.c
 * Branch: lookup_table_driven | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2274_grid_b46_lookup_table_driven__c24_banked_interleaved_access.c\n");
