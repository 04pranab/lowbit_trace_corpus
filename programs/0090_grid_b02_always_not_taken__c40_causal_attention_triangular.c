/*
 * LowBit -- 0090_grid_b02_always_not_taken__c40_causal_attention_triangular.c
 * Branch: always_not_taken | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0090_grid_b02_always_not_taken__c40_causal_attention_triangular.c\n");
