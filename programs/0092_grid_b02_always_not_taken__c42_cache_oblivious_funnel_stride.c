/*
 * LowBit -- 0092_grid_b02_always_not_taken__c42_cache_oblivious_funnel_stride.c
 * Branch: always_not_taken | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0092_grid_b02_always_not_taken__c42_cache_oblivious_funnel_stride.c\n");
