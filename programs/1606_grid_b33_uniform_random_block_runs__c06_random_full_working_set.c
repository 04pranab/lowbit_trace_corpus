/*
 * LowBit -- 1606_grid_b33_uniform_random_block_runs__c06_random_full_working_set.c
 * Branch: uniform_random_block_runs | Cache: random_full_working_set
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1606_grid_b33_uniform_random_block_runs__c06_random_full_working_set.c\n");
