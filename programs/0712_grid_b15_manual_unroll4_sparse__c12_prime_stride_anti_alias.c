/*
 * LowBit -- 0712_grid_b15_manual_unroll4_sparse__c12_prime_stride_anti_alias.c
 * Branch: manual_unroll4_sparse | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0712_grid_b15_manual_unroll4_sparse__c12_prime_stride_anti_alias.c\n");
