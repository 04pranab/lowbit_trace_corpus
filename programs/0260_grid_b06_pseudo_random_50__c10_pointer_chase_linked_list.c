/*
 * LowBit -- 0260_grid_b06_pseudo_random_50__c10_pointer_chase_linked_list.c
 * Branch: pseudo_random_50 | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0260_grid_b06_pseudo_random_50__c10_pointer_chase_linked_list.c\n");
