/*
 * LowBit -- 2465_grid_b50_hysteresis_debounce__c15_reverse_sequential.c
 * Branch: hysteresis_debounce | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2465_grid_b50_hysteresis_debounce__c15_reverse_sequential.c\n");
