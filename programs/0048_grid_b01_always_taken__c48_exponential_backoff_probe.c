/*
 * LowBit -- 0048_grid_b01_always_taken__c48_exponential_backoff_probe.c
 * Branch: always_taken | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0048_grid_b01_always_taken__c48_exponential_backoff_probe.c\n");
