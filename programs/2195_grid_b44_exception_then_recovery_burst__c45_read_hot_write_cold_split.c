/*
 * LowBit -- 2195_grid_b44_exception_then_recovery_burst__c45_read_hot_write_cold_split.c
 * Branch: exception_then_recovery_burst | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2195_grid_b44_exception_then_recovery_burst__c45_read_hot_write_cold_split.c\n");
