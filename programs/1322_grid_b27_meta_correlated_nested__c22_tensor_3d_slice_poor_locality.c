/*
 * LowBit -- 1322_grid_b27_meta_correlated_nested__c22_tensor_3d_slice_poor_locality.c
 * Branch: meta_correlated_nested | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1322_grid_b27_meta_correlated_nested__c22_tensor_3d_slice_poor_locality.c\n");
