/*
 * LowBit -- 0970_grid_b20_random_threshold_walk__c20_hot_cold_phase_alternation.c
 * Branch: random_threshold_walk | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0970_grid_b20_random_threshold_walk__c20_hot_cold_phase_alternation.c\n");
