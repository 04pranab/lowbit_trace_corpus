/*
 * LowBit -- 0200_grid_b04_periodic3__c50_streaming_with_periodic_flush.c
 * Branch: periodic3 | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0200_grid_b04_periodic3__c50_streaming_with_periodic_flush.c\n");
