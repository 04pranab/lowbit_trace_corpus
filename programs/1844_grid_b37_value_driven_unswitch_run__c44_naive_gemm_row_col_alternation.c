/*
 * LowBit -- 1844_grid_b37_value_driven_unswitch_run__c44_naive_gemm_row_col_alternation.c
 * Branch: value_driven_unswitch_run | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1844_grid_b37_value_driven_unswitch_run__c44_naive_gemm_row_col_alternation.c\n");
