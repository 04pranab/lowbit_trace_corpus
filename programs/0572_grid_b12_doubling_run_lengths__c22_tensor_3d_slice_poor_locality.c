/*
 * LowBit -- 0572_grid_b12_doubling_run_lengths__c22_tensor_3d_slice_poor_locality.c
 * Branch: doubling_run_lengths | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0572_grid_b12_doubling_run_lengths__c22_tensor_3d_slice_poor_locality.c\n");
