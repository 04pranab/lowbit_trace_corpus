/*
 * LowBit -- 2243_grid_b45_two_counters_race__c43_whole_buffer_rotation.c
 * Branch: two_counters_race | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2243_grid_b45_two_counters_race__c43_whole_buffer_rotation.c\n");
