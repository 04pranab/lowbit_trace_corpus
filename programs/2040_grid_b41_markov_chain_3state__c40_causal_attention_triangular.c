/*
 * LowBit -- 2040_grid_b41_markov_chain_3state__c40_causal_attention_triangular.c
 * Branch: markov_chain_3state | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2040_grid_b41_markov_chain_3state__c40_causal_attention_triangular.c\n");
