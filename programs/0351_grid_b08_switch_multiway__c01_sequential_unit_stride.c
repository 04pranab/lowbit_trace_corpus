/*
 * LowBit -- 0351_grid_b08_switch_multiway__c01_sequential_unit_stride.c
 * Branch: switch_multiway | Cache: sequential_unit_stride
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0351_grid_b08_switch_multiway__c01_sequential_unit_stride.c\n");
