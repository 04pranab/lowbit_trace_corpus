/*
 * LowBit -- 0034_grid_b01_always_taken__c34_variable_length_burst_reuse.c
 * Branch: always_taken | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0034_grid_b01_always_taken__c34_variable_length_burst_reuse.c\n");
