/*
 * LowBit -- 2434_grid_b49_interleaved_two_pattern_multiplex__c34_variable_length_burst_reuse.c
 * Branch: interleaved_two_pattern_multiplex | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=2434_grid_b49_interleaved_two_pattern_multiplex__c34_variable_length_burst_reuse.c\n");
