/*
 * LowBit -- 2029_grid_b41_markov_chain_3state__c29_ping_pong_cache_thrash.c
 * Branch: markov_chain_3state | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2029_grid_b41_markov_chain_3state__c29_ping_pong_cache_thrash.c\n");
