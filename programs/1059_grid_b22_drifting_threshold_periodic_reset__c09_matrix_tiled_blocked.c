/*
 * LowBit -- 1059_grid_b22_drifting_threshold_periodic_reset__c09_matrix_tiled_blocked.c
 * Branch: drifting_threshold_periodic_reset | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1059_grid_b22_drifting_threshold_periodic_reset__c09_matrix_tiled_blocked.c\n");
