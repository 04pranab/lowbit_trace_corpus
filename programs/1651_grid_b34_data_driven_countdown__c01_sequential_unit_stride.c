/*
 * LowBit -- 1651_grid_b34_data_driven_countdown__c01_sequential_unit_stride.c
 * Branch: data_driven_countdown | Cache: sequential_unit_stride
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1651_grid_b34_data_driven_countdown__c01_sequential_unit_stride.c\n");
