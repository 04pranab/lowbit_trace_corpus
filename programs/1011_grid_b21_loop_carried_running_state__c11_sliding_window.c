/*
 * LowBit -- 1011_grid_b21_loop_carried_running_state__c11_sliding_window.c
 * Branch: loop_carried_running_state | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=1011_grid_b21_loop_carried_running_state__c11_sliding_window.c\n");
