/*
 * LowBit -- 0726_grid_b15_manual_unroll4_sparse__c26_geometric_stride_growth.c
 * Branch: manual_unroll4_sparse | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0726_grid_b15_manual_unroll4_sparse__c26_geometric_stride_growth.c\n");
