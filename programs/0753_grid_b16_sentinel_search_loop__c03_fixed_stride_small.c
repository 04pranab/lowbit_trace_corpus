/*
 * LowBit -- 0753_grid_b16_sentinel_search_loop__c03_fixed_stride_small.c
 * Branch: sentinel_search_loop | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0753_grid_b16_sentinel_search_loop__c03_fixed_stride_small.c\n");
