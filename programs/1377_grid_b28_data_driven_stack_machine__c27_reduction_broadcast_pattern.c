/*
 * LowBit -- 1377_grid_b28_data_driven_stack_machine__c27_reduction_broadcast_pattern.c
 * Branch: data_driven_stack_machine | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1377_grid_b28_data_driven_stack_machine__c27_reduction_broadcast_pattern.c\n");
