/*
 * LowBit -- 0033_grid_b01_always_taken__c33_cache_set_conflict_stress.c
 * Branch: always_taken | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0033_grid_b01_always_taken__c33_cache_set_conflict_stress.c\n");
