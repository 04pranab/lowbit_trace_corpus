/*
 * LowBit -- 0677_grid_b14_four_way_skewed__c27_reduction_broadcast_pattern.c
 * Branch: four_way_skewed | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0677_grid_b14_four_way_skewed__c27_reduction_broadcast_pattern.c\n");
