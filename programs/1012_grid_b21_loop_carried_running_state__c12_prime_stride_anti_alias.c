/*
 * LowBit -- 1012_grid_b21_loop_carried_running_state__c12_prime_stride_anti_alias.c
 * Branch: loop_carried_running_state | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=1012_grid_b21_loop_carried_running_state__c12_prime_stride_anti_alias.c\n");
