/*
 * LowBit -- 0930_grid_b19_data_dependent_break_trip__c30_gather_scatter_indirect_table.c
 * Branch: data_dependent_break_trip | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0930_grid_b19_data_dependent_break_trip__c30_gather_scatter_indirect_table.c\n");
