/*
 * LowBit -- 0443_grid_b09_recursive_calls__c43_whole_buffer_rotation.c
 * Branch: recursive_calls | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0443_grid_b09_recursive_calls__c43_whole_buffer_rotation.c\n");
