/*
 * LowBit -- 1139_grid_b23_popcount_parity__c39_bounded_random_walk.c
 * Branch: popcount_parity | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1139_grid_b23_popcount_parity__c39_bounded_random_walk.c\n");
