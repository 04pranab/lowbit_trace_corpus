/*
 * LowBit -- 1435_grid_b29_bursty_streak_pattern__c35_checkerboard_red_black.c
 * Branch: bursty_streak_pattern | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1435_grid_b29_bursty_streak_pattern__c35_checkerboard_red_black.c\n");
