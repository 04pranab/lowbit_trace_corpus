/*
 * LowBit -- 1031_grid_b21_loop_carried_running_state__c31_fibonacci_stride.c
 * Branch: loop_carried_running_state | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=1031_grid_b21_loop_carried_running_state__c31_fibonacci_stride.c\n");
