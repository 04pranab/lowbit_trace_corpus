/*
 * LowBit -- 1494_grid_b30_periodic_interrupt_override__c44_naive_gemm_row_col_alternation.c
 * Branch: periodic_interrupt_override | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=1494_grid_b30_periodic_interrupt_override__c44_naive_gemm_row_col_alternation.c\n");
