/*
 * LowBit -- 1135_grid_b23_popcount_parity__c35_checkerboard_red_black.c
 * Branch: popcount_parity | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1135_grid_b23_popcount_parity__c35_checkerboard_red_black.c\n");
