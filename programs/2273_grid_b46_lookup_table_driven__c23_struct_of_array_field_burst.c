/*
 * LowBit -- 2273_grid_b46_lookup_table_driven__c23_struct_of_array_field_burst.c
 * Branch: lookup_table_driven | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2273_grid_b46_lookup_table_driven__c23_struct_of_array_field_burst.c\n");
