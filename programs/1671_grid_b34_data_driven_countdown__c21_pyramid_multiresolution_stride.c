/*
 * LowBit -- 1671_grid_b34_data_driven_countdown__c21_pyramid_multiresolution_stride.c
 * Branch: data_driven_countdown | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1671_grid_b34_data_driven_countdown__c21_pyramid_multiresolution_stride.c\n");
