/*
 * LowBit -- 1719_grid_b35_xorshift_hash_mix__c19_matrix_diagonal_wavefront.c
 * Branch: xorshift_hash_mix | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1719_grid_b35_xorshift_hash_mix__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=xorshift_hash_mix\n");
