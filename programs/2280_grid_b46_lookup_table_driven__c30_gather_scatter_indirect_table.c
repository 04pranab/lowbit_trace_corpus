/*
 * LowBit -- 2280_grid_b46_lookup_table_driven__c30_gather_scatter_indirect_table.c
 * Branch: lookup_table_driven | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2280_grid_b46_lookup_table_driven__c30_gather_scatter_indirect_table.c\n");
