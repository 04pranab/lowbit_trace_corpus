/*
 * LowBit -- 0882_grid_b18_indirect_fn_dispatch__c32_hilbert_curve_traversal.c
 * Branch: indirect_fn_dispatch | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0882_grid_b18_indirect_fn_dispatch__c32_hilbert_curve_traversal.c\n");
