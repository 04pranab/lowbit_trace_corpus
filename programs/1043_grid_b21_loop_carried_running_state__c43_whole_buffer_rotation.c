/*
 * LowBit -- 1043_grid_b21_loop_carried_running_state__c43_whole_buffer_rotation.c
 * Branch: loop_carried_running_state | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=1043_grid_b21_loop_carried_running_state__c43_whole_buffer_rotation.c\n");
