/*
 * LowBit -- 1072_grid_b22_drifting_threshold_periodic_reset__c22_tensor_3d_slice_poor_locality.c
 * Branch: drifting_threshold_periodic_reset | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1072_grid_b22_drifting_threshold_periodic_reset__c22_tensor_3d_slice_poor_locality.c\n");
