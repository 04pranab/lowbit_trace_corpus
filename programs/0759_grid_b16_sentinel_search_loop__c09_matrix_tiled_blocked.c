/*
 * LowBit -- 0759_grid_b16_sentinel_search_loop__c09_matrix_tiled_blocked.c
 * Branch: sentinel_search_loop | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0759_grid_b16_sentinel_search_loop__c09_matrix_tiled_blocked.c\n");
