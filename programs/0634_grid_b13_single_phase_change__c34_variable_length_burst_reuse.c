/*
 * LowBit -- 0634_grid_b13_single_phase_change__c34_variable_length_burst_reuse.c
 * Branch: single_phase_change | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0634_grid_b13_single_phase_change__c34_variable_length_burst_reuse.c\n");
