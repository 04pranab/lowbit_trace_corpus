/*
 * LowBit -- 2551_base_cache_c01_sequential_unit_stride.c
 * Branch: synthetic_always_taken | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=2551_base_cache_c01_sequential_unit_stride.c\n");
