/*
 * LowBit -- 1211_grid_b25_rare_exception_1_in_1024__c11_sliding_window.c
 * Branch: rare_exception_1_in_1024 | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=1211_grid_b25_rare_exception_1_in_1024__c11_sliding_window.c\n");
