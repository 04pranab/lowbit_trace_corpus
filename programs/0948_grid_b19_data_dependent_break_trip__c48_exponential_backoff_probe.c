/*
 * LowBit -- 0948_grid_b19_data_dependent_break_trip__c48_exponential_backoff_probe.c
 * Branch: data_dependent_break_trip | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0948_grid_b19_data_dependent_break_trip__c48_exponential_backoff_probe.c\n");
