/*
 * LowBit -- 0398_grid_b08_switch_multiway__c48_exponential_backoff_probe.c
 * Branch: switch_multiway | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0398_grid_b08_switch_multiway__c48_exponential_backoff_probe.c\n");
