/*
 * LowBit -- 2569_base_cache_c19_matrix_diagonal_wavefront.c
 * Branch: synthetic_always_taken | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=2569_base_cache_c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=synthetic_always_taken\n");
    printf("cache_pattern=matrix_diagonal_wavefront\n");
    printf("predictor_stress_type=n/a (synthetic baseline)\n");
