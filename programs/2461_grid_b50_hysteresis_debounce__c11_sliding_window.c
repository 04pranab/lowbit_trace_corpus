/*
 * LowBit -- 2461_grid_b50_hysteresis_debounce__c11_sliding_window.c
 * Branch: hysteresis_debounce | Cache: sliding_window
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2461_grid_b50_hysteresis_debounce__c11_sliding_window.c\n");
