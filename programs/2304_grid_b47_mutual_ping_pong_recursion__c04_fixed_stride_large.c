/*
 * LowBit -- 2304_grid_b47_mutual_ping_pong_recursion__c04_fixed_stride_large.c
 * Branch: mutual_ping_pong_recursion | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2304_grid_b47_mutual_ping_pong_recursion__c04_fixed_stride_large.c\n");
