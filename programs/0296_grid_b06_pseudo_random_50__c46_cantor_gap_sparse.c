/*
 * LowBit -- 0296_grid_b06_pseudo_random_50__c46_cantor_gap_sparse.c
 * Branch: pseudo_random_50 | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0296_grid_b06_pseudo_random_50__c46_cantor_gap_sparse.c\n");
