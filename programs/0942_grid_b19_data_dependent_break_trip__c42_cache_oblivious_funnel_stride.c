/*
 * LowBit -- 0942_grid_b19_data_dependent_break_trip__c42_cache_oblivious_funnel_stride.c
 * Branch: data_dependent_break_trip | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0942_grid_b19_data_dependent_break_trip__c42_cache_oblivious_funnel_stride.c\n");
