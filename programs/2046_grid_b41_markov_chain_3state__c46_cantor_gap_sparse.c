/*
 * LowBit -- 2046_grid_b41_markov_chain_3state__c46_cantor_gap_sparse.c
 * Branch: markov_chain_3state | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2046_grid_b41_markov_chain_3state__c46_cantor_gap_sparse.c\n");
