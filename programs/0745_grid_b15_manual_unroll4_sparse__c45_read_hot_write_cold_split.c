/*
 * LowBit -- 0745_grid_b15_manual_unroll4_sparse__c45_read_hot_write_cold_split.c
 * Branch: manual_unroll4_sparse | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0745_grid_b15_manual_unroll4_sparse__c45_read_hot_write_cold_split.c\n");
