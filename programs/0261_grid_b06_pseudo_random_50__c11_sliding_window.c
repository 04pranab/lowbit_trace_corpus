/*
 * LowBit -- 0261_grid_b06_pseudo_random_50__c11_sliding_window.c
 * Branch: pseudo_random_50 | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0261_grid_b06_pseudo_random_50__c11_sliding_window.c\n");
