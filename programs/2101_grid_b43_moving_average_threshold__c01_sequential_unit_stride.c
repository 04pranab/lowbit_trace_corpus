/*
 * LowBit -- 2101_grid_b43_moving_average_threshold__c01_sequential_unit_stride.c
 * Branch: moving_average_threshold | Cache: sequential_unit_stride
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2101_grid_b43_moving_average_threshold__c01_sequential_unit_stride.c\n");
