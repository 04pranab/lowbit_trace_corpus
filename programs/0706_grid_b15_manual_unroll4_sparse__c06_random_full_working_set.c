/*
 * LowBit -- 0706_grid_b15_manual_unroll4_sparse__c06_random_full_working_set.c
 * Branch: manual_unroll4_sparse | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0706_grid_b15_manual_unroll4_sparse__c06_random_full_working_set.c\n");
