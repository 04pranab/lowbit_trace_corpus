/*
 * LowBit -- 2472_grid_b50_hysteresis_debounce__c22_tensor_3d_slice_poor_locality.c
 * Branch: hysteresis_debounce | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2472_grid_b50_hysteresis_debounce__c22_tensor_3d_slice_poor_locality.c\n");
