/*
 * LowBit -- 0477_grid_b10_correlated_history__c27_reduction_broadcast_pattern.c
 * Branch: correlated_history | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0477_grid_b10_correlated_history__c27_reduction_broadcast_pattern.c\n");
