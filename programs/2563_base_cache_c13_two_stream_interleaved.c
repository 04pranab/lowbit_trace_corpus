/*
 * LowBit -- 2563_base_cache_c13_two_stream_interleaved.c
 * Branch: synthetic_always_taken | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=2563_base_cache_c13_two_stream_interleaved.c\n");
