/*
 * LowBit -- 1629_grid_b33_uniform_random_block_runs__c29_ping_pong_cache_thrash.c
 * Branch: uniform_random_block_runs | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1629_grid_b33_uniform_random_block_runs__c29_ping_pong_cache_thrash.c\n");
