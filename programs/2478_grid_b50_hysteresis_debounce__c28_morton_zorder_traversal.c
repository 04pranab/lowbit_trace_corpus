/*
 * LowBit -- 2478_grid_b50_hysteresis_debounce__c28_morton_zorder_traversal.c
 * Branch: hysteresis_debounce | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2478_grid_b50_hysteresis_debounce__c28_morton_zorder_traversal.c\n");
