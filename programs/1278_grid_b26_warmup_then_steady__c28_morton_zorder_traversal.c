/*
 * LowBit -- 1278_grid_b26_warmup_then_steady__c28_morton_zorder_traversal.c
 * Branch: warmup_then_steady | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1278_grid_b26_warmup_then_steady__c28_morton_zorder_traversal.c\n");
