/*
 * LowBit -- 0620_grid_b13_single_phase_change__c20_hot_cold_phase_alternation.c
 * Branch: single_phase_change | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0620_grid_b13_single_phase_change__c20_hot_cold_phase_alternation.c\n");
