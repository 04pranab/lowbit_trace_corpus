/*
 * LowBit -- 1633_grid_b33_uniform_random_block_runs__c33_cache_set_conflict_stress.c
 * Branch: uniform_random_block_runs | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1633_grid_b33_uniform_random_block_runs__c33_cache_set_conflict_stress.c\n");
