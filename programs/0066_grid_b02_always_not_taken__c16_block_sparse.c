/*
 * LowBit -- 0066_grid_b02_always_not_taken__c16_block_sparse.c
 * Branch: always_not_taken | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0066_grid_b02_always_not_taken__c16_block_sparse.c\n");
