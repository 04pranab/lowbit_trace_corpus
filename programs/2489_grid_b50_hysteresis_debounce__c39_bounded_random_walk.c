/*
 * LowBit -- 2489_grid_b50_hysteresis_debounce__c39_bounded_random_walk.c
 * Branch: hysteresis_debounce | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2489_grid_b50_hysteresis_debounce__c39_bounded_random_walk.c\n");
