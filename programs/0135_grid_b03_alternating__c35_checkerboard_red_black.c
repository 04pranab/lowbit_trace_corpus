/*
 * LowBit -- 0135_grid_b03_alternating__c35_checkerboard_red_black.c
 * Branch: alternating | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0135_grid_b03_alternating__c35_checkerboard_red_black.c\n");
