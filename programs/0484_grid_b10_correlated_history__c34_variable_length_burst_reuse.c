/*
 * LowBit -- 0484_grid_b10_correlated_history__c34_variable_length_burst_reuse.c
 * Branch: correlated_history | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0484_grid_b10_correlated_history__c34_variable_length_burst_reuse.c\n");
