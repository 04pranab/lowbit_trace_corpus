/*
 * LowBit -- 1932_grid_b39_dual_lcg_xor_chaos__c32_hilbert_curve_traversal.c
 * Branch: dual_lcg_xor_chaos | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1932_grid_b39_dual_lcg_xor_chaos__c32_hilbert_curve_traversal.c\n");
