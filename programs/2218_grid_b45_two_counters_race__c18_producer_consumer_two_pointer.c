/*
 * LowBit -- 2218_grid_b45_two_counters_race__c18_producer_consumer_two_pointer.c
 * Branch: two_counters_race | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2218_grid_b45_two_counters_race__c18_producer_consumer_two_pointer.c\n");
