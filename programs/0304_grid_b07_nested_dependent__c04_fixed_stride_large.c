/*
 * LowBit -- 0304_grid_b07_nested_dependent__c04_fixed_stride_large.c
 * Branch: nested_dependent | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0304_grid_b07_nested_dependent__c04_fixed_stride_large.c\n");
