/*
 * LowBit -- 2178_grid_b44_exception_then_recovery_burst__c28_morton_zorder_traversal.c
 * Branch: exception_then_recovery_burst | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2178_grid_b44_exception_then_recovery_burst__c28_morton_zorder_traversal.c\n");
