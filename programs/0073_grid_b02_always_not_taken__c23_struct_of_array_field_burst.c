/*
 * LowBit -- 0073_grid_b02_always_not_taken__c23_struct_of_array_field_burst.c
 * Branch: always_not_taken | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0073_grid_b02_always_not_taken__c23_struct_of_array_field_burst.c\n");
