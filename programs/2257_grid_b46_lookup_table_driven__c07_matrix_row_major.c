/*
 * LowBit -- 2257_grid_b46_lookup_table_driven__c07_matrix_row_major.c
 * Branch: lookup_table_driven | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2257_grid_b46_lookup_table_driven__c07_matrix_row_major.c\n");
