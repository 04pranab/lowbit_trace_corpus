/*
 * LowBit -- 2258_grid_b46_lookup_table_driven__c08_matrix_col_major.c
 * Branch: lookup_table_driven | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2258_grid_b46_lookup_table_driven__c08_matrix_col_major.c\n");
