/*
 * LowBit -- 0772_grid_b16_sentinel_search_loop__c22_tensor_3d_slice_poor_locality.c
 * Branch: sentinel_search_loop | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0772_grid_b16_sentinel_search_loop__c22_tensor_3d_slice_poor_locality.c\n");
