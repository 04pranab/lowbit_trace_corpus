/*
 * LowBit -- 1666_grid_b34_data_driven_countdown__c16_block_sparse.c
 * Branch: data_driven_countdown | Cache: block_sparse
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1666_grid_b34_data_driven_countdown__c16_block_sparse.c\n");
