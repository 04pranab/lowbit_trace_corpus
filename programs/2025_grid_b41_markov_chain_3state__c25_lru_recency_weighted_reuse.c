/*
 * LowBit -- 2025_grid_b41_markov_chain_3state__c25_lru_recency_weighted_reuse.c
 * Branch: markov_chain_3state | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2025_grid_b41_markov_chain_3state__c25_lru_recency_weighted_reuse.c\n");
