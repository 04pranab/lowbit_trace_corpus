/*
 * LowBit -- 1022_grid_b21_loop_carried_running_state__c22_tensor_3d_slice_poor_locality.c
 * Branch: loop_carried_running_state | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=1022_grid_b21_loop_carried_running_state__c22_tensor_3d_slice_poor_locality.c\n");
