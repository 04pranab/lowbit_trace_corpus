/*
 * LowBit -- 0273_grid_b06_pseudo_random_50__c23_struct_of_array_field_burst.c
 * Branch: pseudo_random_50 | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0273_grid_b06_pseudo_random_50__c23_struct_of_array_field_burst.c\n");
