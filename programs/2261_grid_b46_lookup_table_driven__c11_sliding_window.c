/*
 * LowBit -- 2261_grid_b46_lookup_table_driven__c11_sliding_window.c
 * Branch: lookup_table_driven | Cache: sliding_window
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2261_grid_b46_lookup_table_driven__c11_sliding_window.c\n");
