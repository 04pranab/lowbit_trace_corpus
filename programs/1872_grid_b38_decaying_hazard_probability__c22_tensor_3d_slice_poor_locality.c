/*
 * LowBit -- 1872_grid_b38_decaying_hazard_probability__c22_tensor_3d_slice_poor_locality.c
 * Branch: decaying_hazard_probability | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1872_grid_b38_decaying_hazard_probability__c22_tensor_3d_slice_poor_locality.c\n");
