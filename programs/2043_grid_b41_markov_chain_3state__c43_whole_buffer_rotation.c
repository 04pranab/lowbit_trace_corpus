/*
 * LowBit -- 2043_grid_b41_markov_chain_3state__c43_whole_buffer_rotation.c
 * Branch: markov_chain_3state | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2043_grid_b41_markov_chain_3state__c43_whole_buffer_rotation.c\n");
