/*
 * LowBit -- 1287_grid_b26_warmup_then_steady__c37_double_buffer_epoch_alternation.c
 * Branch: warmup_then_steady | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1287_grid_b26_warmup_then_steady__c37_double_buffer_epoch_alternation.c\n");
