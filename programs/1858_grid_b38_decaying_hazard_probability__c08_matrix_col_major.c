/*
 * LowBit -- 1858_grid_b38_decaying_hazard_probability__c08_matrix_col_major.c
 * Branch: decaying_hazard_probability | Cache: matrix_col_major
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1858_grid_b38_decaying_hazard_probability__c08_matrix_col_major.c\n");
