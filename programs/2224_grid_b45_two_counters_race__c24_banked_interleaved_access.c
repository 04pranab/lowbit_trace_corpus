/*
 * LowBit -- 2224_grid_b45_two_counters_race__c24_banked_interleaved_access.c
 * Branch: two_counters_race | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2224_grid_b45_two_counters_race__c24_banked_interleaved_access.c\n");
