/*
 * LowBit -- 1073_grid_b22_drifting_threshold_periodic_reset__c23_struct_of_array_field_burst.c
 * Branch: drifting_threshold_periodic_reset | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1073_grid_b22_drifting_threshold_periodic_reset__c23_struct_of_array_field_burst.c\n");
