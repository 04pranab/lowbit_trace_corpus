/*
 * LowBit -- 2214_grid_b45_two_counters_race__c14_temporal_burst_reuse.c
 * Branch: two_counters_race | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2214_grid_b45_two_counters_race__c14_temporal_burst_reuse.c\n");
