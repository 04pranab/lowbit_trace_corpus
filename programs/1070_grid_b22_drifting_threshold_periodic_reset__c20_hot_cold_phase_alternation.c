/*
 * LowBit -- 1070_grid_b22_drifting_threshold_periodic_reset__c20_hot_cold_phase_alternation.c
 * Branch: drifting_threshold_periodic_reset | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1070_grid_b22_drifting_threshold_periodic_reset__c20_hot_cold_phase_alternation.c\n");
