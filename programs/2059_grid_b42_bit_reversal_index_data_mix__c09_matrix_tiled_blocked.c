/*
 * LowBit -- 2059_grid_b42_bit_reversal_index_data_mix__c09_matrix_tiled_blocked.c
 * Branch: bit_reversal_index_data_mix | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2059_grid_b42_bit_reversal_index_data_mix__c09_matrix_tiled_blocked.c\n");
