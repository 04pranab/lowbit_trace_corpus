/*
 * LowBit -- 1822_grid_b37_value_driven_unswitch_run__c22_tensor_3d_slice_poor_locality.c
 * Branch: value_driven_unswitch_run | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1822_grid_b37_value_driven_unswitch_run__c22_tensor_3d_slice_poor_locality.c\n");
