/*
 * LowBit -- 0438_grid_b09_recursive_calls__c38_cuckoo_double_hash_probe.c
 * Branch: recursive_calls | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0438_grid_b09_recursive_calls__c38_cuckoo_double_hash_probe.c\n");
