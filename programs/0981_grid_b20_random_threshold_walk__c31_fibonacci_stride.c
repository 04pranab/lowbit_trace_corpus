/*
 * LowBit -- 0981_grid_b20_random_threshold_walk__c31_fibonacci_stride.c
 * Branch: random_threshold_walk | Cache: fibonacci_stride
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0981_grid_b20_random_threshold_walk__c31_fibonacci_stride.c\n");
