/*
 * LowBit -- 2382_grid_b48_variable_step_signed_countdown__c32_hilbert_curve_traversal.c
 * Branch: variable_step_signed_countdown | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2382_grid_b48_variable_step_signed_countdown__c32_hilbert_curve_traversal.c\n");
