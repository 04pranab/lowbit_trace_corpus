/*
 * LowBit -- 0633_grid_b13_single_phase_change__c33_cache_set_conflict_stress.c
 * Branch: single_phase_change | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0633_grid_b13_single_phase_change__c33_cache_set_conflict_stress.c\n");
