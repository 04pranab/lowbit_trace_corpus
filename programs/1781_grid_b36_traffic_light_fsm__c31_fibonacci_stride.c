/*
 * LowBit -- 1781_grid_b36_traffic_light_fsm__c31_fibonacci_stride.c
 * Branch: traffic_light_fsm | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1781_grid_b36_traffic_light_fsm__c31_fibonacci_stride.c\n");
