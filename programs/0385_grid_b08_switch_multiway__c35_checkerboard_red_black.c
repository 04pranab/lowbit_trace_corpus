/*
 * LowBit -- 0385_grid_b08_switch_multiway__c35_checkerboard_red_black.c
 * Branch: switch_multiway | Cache: checkerboard_red_black
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0385_grid_b08_switch_multiway__c35_checkerboard_red_black.c\n");
