/*
 * LowBit -- 1969_grid_b40_collatz_value_transform__c19_matrix_diagonal_wavefront.c
 * Branch: collatz_value_transform | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1969_grid_b40_collatz_value_transform__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=collatz_value_transform\n");
