/*
 * LowBit -- 2017_grid_b41_markov_chain_3state__c17_zipf_like_hot_buckets.c
 * Branch: markov_chain_3state | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2017_grid_b41_markov_chain_3state__c17_zipf_like_hot_buckets.c\n");
