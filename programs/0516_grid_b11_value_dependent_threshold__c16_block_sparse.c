/*
 * LowBit -- 0516_grid_b11_value_dependent_threshold__c16_block_sparse.c
 * Branch: value_dependent_threshold | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0516_grid_b11_value_dependent_threshold__c16_block_sparse.c\n");
