/*
 * LowBit -- 0492_grid_b10_correlated_history__c42_cache_oblivious_funnel_stride.c
 * Branch: correlated_history | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0492_grid_b10_correlated_history__c42_cache_oblivious_funnel_stride.c\n");
