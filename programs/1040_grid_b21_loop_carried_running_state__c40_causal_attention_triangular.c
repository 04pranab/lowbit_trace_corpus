/*
 * LowBit -- 1040_grid_b21_loop_carried_running_state__c40_causal_attention_triangular.c
 * Branch: loop_carried_running_state | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=1040_grid_b21_loop_carried_running_state__c40_causal_attention_triangular.c\n");
