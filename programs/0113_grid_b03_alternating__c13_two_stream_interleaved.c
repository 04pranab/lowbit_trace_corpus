/*
 * LowBit -- 0113_grid_b03_alternating__c13_two_stream_interleaved.c
 * Branch: alternating | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0113_grid_b03_alternating__c13_two_stream_interleaved.c\n");
