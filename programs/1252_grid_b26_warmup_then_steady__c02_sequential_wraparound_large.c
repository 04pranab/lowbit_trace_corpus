/*
 * LowBit -- 1252_grid_b26_warmup_then_steady__c02_sequential_wraparound_large.c
 * Branch: warmup_then_steady | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1252_grid_b26_warmup_then_steady__c02_sequential_wraparound_large.c\n");
