/*
 * LowBit -- 1636_grid_b33_uniform_random_block_runs__c36_im2col_overlapping_patch_gather.c
 * Branch: uniform_random_block_runs | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1636_grid_b33_uniform_random_block_runs__c36_im2col_overlapping_patch_gather.c\n");
