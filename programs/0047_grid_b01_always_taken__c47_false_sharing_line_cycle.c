/*
 * LowBit -- 0047_grid_b01_always_taken__c47_false_sharing_line_cycle.c
 * Branch: always_taken | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0047_grid_b01_always_taken__c47_false_sharing_line_cycle.c\n");
