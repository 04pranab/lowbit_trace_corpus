/*
 * LowBit -- 1711_grid_b35_xorshift_hash_mix__c11_sliding_window.c
 * Branch: xorshift_hash_mix | Cache: sliding_window
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1711_grid_b35_xorshift_hash_mix__c11_sliding_window.c\n");
