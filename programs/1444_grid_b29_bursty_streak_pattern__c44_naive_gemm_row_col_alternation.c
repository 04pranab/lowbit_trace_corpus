/*
 * LowBit -- 1444_grid_b29_bursty_streak_pattern__c44_naive_gemm_row_col_alternation.c
 * Branch: bursty_streak_pattern | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1444_grid_b29_bursty_streak_pattern__c44_naive_gemm_row_col_alternation.c\n");
