/*
 * LowBit -- 0575_grid_b12_doubling_run_lengths__c25_lru_recency_weighted_reuse.c
 * Branch: doubling_run_lengths | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t cseed25_ = SEED0 ^ 0x25252525u;
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0575_grid_b12_doubling_run_lengths__c25_lru_recency_weighted_reuse.c\n");
    printf("branch_pattern=doubling_run_lengths\n");
    printf("cache_pattern=lru_recency_weighted_reuse\n");
