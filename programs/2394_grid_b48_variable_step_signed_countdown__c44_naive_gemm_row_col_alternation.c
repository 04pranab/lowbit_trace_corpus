/*
 * LowBit -- 2394_grid_b48_variable_step_signed_countdown__c44_naive_gemm_row_col_alternation.c
 * Branch: variable_step_signed_countdown | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2394_grid_b48_variable_step_signed_countdown__c44_naive_gemm_row_col_alternation.c\n");
