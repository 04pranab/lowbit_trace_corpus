/*
 * LowBit -- 0855_grid_b18_indirect_fn_dispatch__c05_random_small_working_set.c
 * Branch: indirect_fn_dispatch | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0855_grid_b18_indirect_fn_dispatch__c05_random_small_working_set.c\n");
