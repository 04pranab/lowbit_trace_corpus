/*
 * LowBit -- 2259_grid_b46_lookup_table_driven__c09_matrix_tiled_blocked.c
 * Branch: lookup_table_driven | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2259_grid_b46_lookup_table_driven__c09_matrix_tiled_blocked.c\n");
