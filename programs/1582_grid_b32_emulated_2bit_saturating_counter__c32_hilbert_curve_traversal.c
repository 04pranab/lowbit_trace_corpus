/*
 * LowBit -- 1582_grid_b32_emulated_2bit_saturating_counter__c32_hilbert_curve_traversal.c
 * Branch: emulated_2bit_saturating_counter | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1582_grid_b32_emulated_2bit_saturating_counter__c32_hilbert_curve_traversal.c\n");
