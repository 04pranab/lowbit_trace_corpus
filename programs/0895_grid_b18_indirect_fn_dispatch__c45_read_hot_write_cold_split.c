/*
 * LowBit -- 0895_grid_b18_indirect_fn_dispatch__c45_read_hot_write_cold_split.c
 * Branch: indirect_fn_dispatch | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0895_grid_b18_indirect_fn_dispatch__c45_read_hot_write_cold_split.c\n");
