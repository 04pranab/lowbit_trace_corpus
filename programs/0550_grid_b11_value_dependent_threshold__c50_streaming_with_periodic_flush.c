/*
 * LowBit -- 0550_grid_b11_value_dependent_threshold__c50_streaming_with_periodic_flush.c
 * Branch: value_dependent_threshold | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0550_grid_b11_value_dependent_threshold__c50_streaming_with_periodic_flush.c\n");
