/*
 * LowBit -- 1956_grid_b40_collatz_value_transform__c06_random_full_working_set.c
 * Branch: collatz_value_transform | Cache: random_full_working_set
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1956_grid_b40_collatz_value_transform__c06_random_full_working_set.c\n");
