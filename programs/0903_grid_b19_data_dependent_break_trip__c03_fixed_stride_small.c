/*
 * LowBit -- 0903_grid_b19_data_dependent_break_trip__c03_fixed_stride_small.c
 * Branch: data_dependent_break_trip | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0903_grid_b19_data_dependent_break_trip__c03_fixed_stride_small.c\n");
