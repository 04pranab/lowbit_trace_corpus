/*
 * LowBit -- 1744_grid_b35_xorshift_hash_mix__c44_naive_gemm_row_col_alternation.c
 * Branch: xorshift_hash_mix | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1744_grid_b35_xorshift_hash_mix__c44_naive_gemm_row_col_alternation.c\n");
