/*
 * LowBit -- 0799_grid_b16_sentinel_search_loop__c49_binary_heap_parent_child.c
 * Branch: sentinel_search_loop | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0799_grid_b16_sentinel_search_loop__c49_binary_heap_parent_child.c\n");
