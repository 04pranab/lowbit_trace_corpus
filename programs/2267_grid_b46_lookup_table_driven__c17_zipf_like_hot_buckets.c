/*
 * LowBit -- 2267_grid_b46_lookup_table_driven__c17_zipf_like_hot_buckets.c
 * Branch: lookup_table_driven | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2267_grid_b46_lookup_table_driven__c17_zipf_like_hot_buckets.c\n");
