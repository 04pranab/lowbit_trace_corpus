/*
 * LowBit -- 2322_grid_b47_mutual_ping_pong_recursion__c22_tensor_3d_slice_poor_locality.c
 * Branch: mutual_ping_pong_recursion | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2322_grid_b47_mutual_ping_pong_recursion__c22_tensor_3d_slice_poor_locality.c\n");
