/*
 * LowBit -- 2192_grid_b44_exception_then_recovery_burst__c42_cache_oblivious_funnel_stride.c
 * Branch: exception_then_recovery_burst | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2192_grid_b44_exception_then_recovery_burst__c42_cache_oblivious_funnel_stride.c\n");
