/*
 * LowBit -- 2074_grid_b42_bit_reversal_index_data_mix__c24_banked_interleaved_access.c
 * Branch: bit_reversal_index_data_mix | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2074_grid_b42_bit_reversal_index_data_mix__c24_banked_interleaved_access.c\n");
