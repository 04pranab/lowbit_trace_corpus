/*
 * LowBit -- 1028_grid_b21_loop_carried_running_state__c28_morton_zorder_traversal.c
 * Branch: loop_carried_running_state | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=1028_grid_b21_loop_carried_running_state__c28_morton_zorder_traversal.c\n");
