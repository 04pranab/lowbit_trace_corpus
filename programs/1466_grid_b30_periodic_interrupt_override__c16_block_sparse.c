/*
 * LowBit -- 1466_grid_b30_periodic_interrupt_override__c16_block_sparse.c
 * Branch: periodic_interrupt_override | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=1466_grid_b30_periodic_interrupt_override__c16_block_sparse.c\n");
