/*
 * LowBit -- 1566_grid_b32_emulated_2bit_saturating_counter__c16_block_sparse.c
 * Branch: emulated_2bit_saturating_counter | Cache: block_sparse
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1566_grid_b32_emulated_2bit_saturating_counter__c16_block_sparse.c\n");
