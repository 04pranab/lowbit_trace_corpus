/*
 * LowBit -- 0801_grid_b17_correlated_two_branch_xor__c01_sequential_unit_stride.c
 * Branch: correlated_two_branch_xor | Cache: sequential_unit_stride
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0801_grid_b17_correlated_two_branch_xor__c01_sequential_unit_stride.c\n");
