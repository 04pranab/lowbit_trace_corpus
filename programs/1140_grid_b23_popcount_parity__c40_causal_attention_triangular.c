/*
 * LowBit -- 1140_grid_b23_popcount_parity__c40_causal_attention_triangular.c
 * Branch: popcount_parity | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1140_grid_b23_popcount_parity__c40_causal_attention_triangular.c\n");
