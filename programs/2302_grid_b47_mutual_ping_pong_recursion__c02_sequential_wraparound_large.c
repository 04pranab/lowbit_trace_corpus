/*
 * LowBit -- 2302_grid_b47_mutual_ping_pong_recursion__c02_sequential_wraparound_large.c
 * Branch: mutual_ping_pong_recursion | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2302_grid_b47_mutual_ping_pong_recursion__c02_sequential_wraparound_large.c\n");
