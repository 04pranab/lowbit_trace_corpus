/*
 * LowBit -- 1313_grid_b27_meta_correlated_nested__c13_two_stream_interleaved.c
 * Branch: meta_correlated_nested | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1313_grid_b27_meta_correlated_nested__c13_two_stream_interleaved.c\n");
