/*
 * LowBit -- 1823_grid_b37_value_driven_unswitch_run__c23_struct_of_array_field_burst.c
 * Branch: value_driven_unswitch_run | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1823_grid_b37_value_driven_unswitch_run__c23_struct_of_array_field_burst.c\n");
