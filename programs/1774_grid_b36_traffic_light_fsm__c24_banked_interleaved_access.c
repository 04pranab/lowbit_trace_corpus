/*
 * LowBit -- 1774_grid_b36_traffic_light_fsm__c24_banked_interleaved_access.c
 * Branch: traffic_light_fsm | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1774_grid_b36_traffic_light_fsm__c24_banked_interleaved_access.c\n");
