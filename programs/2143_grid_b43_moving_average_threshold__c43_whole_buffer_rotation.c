/*
 * LowBit -- 2143_grid_b43_moving_average_threshold__c43_whole_buffer_rotation.c
 * Branch: moving_average_threshold | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2143_grid_b43_moving_average_threshold__c43_whole_buffer_rotation.c\n");
