/*
 * LowBit -- 2196_grid_b44_exception_then_recovery_burst__c46_cantor_gap_sparse.c
 * Branch: exception_then_recovery_burst | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2196_grid_b44_exception_then_recovery_burst__c46_cantor_gap_sparse.c\n");
