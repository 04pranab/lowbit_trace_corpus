/*
 * LowBit -- 0427_grid_b09_recursive_calls__c27_reduction_broadcast_pattern.c
 * Branch: recursive_calls | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0427_grid_b09_recursive_calls__c27_reduction_broadcast_pattern.c\n");
