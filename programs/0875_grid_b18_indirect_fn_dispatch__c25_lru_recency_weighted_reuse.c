/*
 * LowBit -- 0875_grid_b18_indirect_fn_dispatch__c25_lru_recency_weighted_reuse.c
 * Branch: indirect_fn_dispatch | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0875_grid_b18_indirect_fn_dispatch__c25_lru_recency_weighted_reuse.c\n");
