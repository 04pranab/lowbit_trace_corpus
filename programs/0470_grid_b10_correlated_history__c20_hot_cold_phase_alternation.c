/*
 * LowBit -- 0470_grid_b10_correlated_history__c20_hot_cold_phase_alternation.c
 * Branch: correlated_history | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0470_grid_b10_correlated_history__c20_hot_cold_phase_alternation.c\n");
