/*
 * LowBit -- 0084_grid_b02_always_not_taken__c34_variable_length_burst_reuse.c
 * Branch: always_not_taken | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0084_grid_b02_always_not_taken__c34_variable_length_burst_reuse.c\n");
