/*
 * LowBit -- 1110_grid_b23_popcount_parity__c10_pointer_chase_linked_list.c
 * Branch: popcount_parity | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1110_grid_b23_popcount_parity__c10_pointer_chase_linked_list.c\n");
