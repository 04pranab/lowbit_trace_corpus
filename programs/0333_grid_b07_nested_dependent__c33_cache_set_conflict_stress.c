/*
 * LowBit -- 0333_grid_b07_nested_dependent__c33_cache_set_conflict_stress.c
 * Branch: nested_dependent | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0333_grid_b07_nested_dependent__c33_cache_set_conflict_stress.c\n");
