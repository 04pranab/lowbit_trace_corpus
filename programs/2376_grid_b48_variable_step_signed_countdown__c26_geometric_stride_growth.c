/*
 * LowBit -- 2376_grid_b48_variable_step_signed_countdown__c26_geometric_stride_growth.c
 * Branch: variable_step_signed_countdown | Cache: geometric_stride_growth
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2376_grid_b48_variable_step_signed_countdown__c26_geometric_stride_growth.c\n");
