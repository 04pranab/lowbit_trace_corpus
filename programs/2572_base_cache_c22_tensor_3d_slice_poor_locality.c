/*
 * LowBit -- 2572_base_cache_c22_tensor_3d_slice_poor_locality.c
 * Branch: synthetic_always_taken | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=2572_base_cache_c22_tensor_3d_slice_poor_locality.c\n");
