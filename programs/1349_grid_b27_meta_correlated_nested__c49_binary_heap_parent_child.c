/*
 * LowBit -- 1349_grid_b27_meta_correlated_nested__c49_binary_heap_parent_child.c
 * Branch: meta_correlated_nested | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1349_grid_b27_meta_correlated_nested__c49_binary_heap_parent_child.c\n");
