/*
 * LowBit -- 2132_grid_b43_moving_average_threshold__c32_hilbert_curve_traversal.c
 * Branch: moving_average_threshold | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2132_grid_b43_moving_average_threshold__c32_hilbert_curve_traversal.c\n");
