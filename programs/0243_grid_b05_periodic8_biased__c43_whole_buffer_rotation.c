/*
 * LowBit -- 0243_grid_b05_periodic8_biased__c43_whole_buffer_rotation.c
 * Branch: periodic8_biased | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0243_grid_b05_periodic8_biased__c43_whole_buffer_rotation.c\n");
