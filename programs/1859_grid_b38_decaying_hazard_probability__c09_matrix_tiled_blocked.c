/*
 * LowBit -- 1859_grid_b38_decaying_hazard_probability__c09_matrix_tiled_blocked.c
 * Branch: decaying_hazard_probability | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1859_grid_b38_decaying_hazard_probability__c09_matrix_tiled_blocked.c\n");
