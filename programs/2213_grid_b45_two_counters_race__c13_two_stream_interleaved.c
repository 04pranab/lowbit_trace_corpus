/*
 * LowBit -- 2213_grid_b45_two_counters_race__c13_two_stream_interleaved.c
 * Branch: two_counters_race | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2213_grid_b45_two_counters_race__c13_two_stream_interleaved.c\n");
