/*
 * LowBit -- 1300_grid_b26_warmup_then_steady__c50_streaming_with_periodic_flush.c
 * Branch: warmup_then_steady | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1300_grid_b26_warmup_then_steady__c50_streaming_with_periodic_flush.c\n");
