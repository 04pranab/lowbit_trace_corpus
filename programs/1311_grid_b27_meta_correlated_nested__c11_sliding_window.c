/*
 * LowBit -- 1311_grid_b27_meta_correlated_nested__c11_sliding_window.c
 * Branch: meta_correlated_nested | Cache: sliding_window
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1311_grid_b27_meta_correlated_nested__c11_sliding_window.c\n");
