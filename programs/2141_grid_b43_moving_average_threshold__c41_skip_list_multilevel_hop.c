/*
 * LowBit -- 2141_grid_b43_moving_average_threshold__c41_skip_list_multilevel_hop.c
 * Branch: moving_average_threshold | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2141_grid_b43_moving_average_threshold__c41_skip_list_multilevel_hop.c\n");
