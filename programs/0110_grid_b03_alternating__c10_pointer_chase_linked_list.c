/*
 * LowBit -- 0110_grid_b03_alternating__c10_pointer_chase_linked_list.c
 * Branch: alternating | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0110_grid_b03_alternating__c10_pointer_chase_linked_list.c\n");
