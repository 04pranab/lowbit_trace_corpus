/*
 * LowBit -- 1054_grid_b22_drifting_threshold_periodic_reset__c04_fixed_stride_large.c
 * Branch: drifting_threshold_periodic_reset | Cache: fixed_stride_large
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1054_grid_b22_drifting_threshold_periodic_reset__c04_fixed_stride_large.c\n");
