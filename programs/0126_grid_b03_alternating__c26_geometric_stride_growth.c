/*
 * LowBit -- 0126_grid_b03_alternating__c26_geometric_stride_growth.c
 * Branch: alternating | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0126_grid_b03_alternating__c26_geometric_stride_growth.c\n");
