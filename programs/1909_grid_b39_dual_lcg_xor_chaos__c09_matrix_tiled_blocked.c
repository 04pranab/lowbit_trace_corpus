/*
 * LowBit -- 1909_grid_b39_dual_lcg_xor_chaos__c09_matrix_tiled_blocked.c
 * Branch: dual_lcg_xor_chaos | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1909_grid_b39_dual_lcg_xor_chaos__c09_matrix_tiled_blocked.c\n");
