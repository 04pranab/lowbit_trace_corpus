/*
 * LowBit -- 2328_grid_b47_mutual_ping_pong_recursion__c28_morton_zorder_traversal.c
 * Branch: mutual_ping_pong_recursion | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2328_grid_b47_mutual_ping_pong_recursion__c28_morton_zorder_traversal.c\n");
