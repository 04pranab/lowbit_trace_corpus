/*
 * LowBit -- 1804_grid_b37_value_driven_unswitch_run__c04_fixed_stride_large.c
 * Branch: value_driven_unswitch_run | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1804_grid_b37_value_driven_unswitch_run__c04_fixed_stride_large.c\n");
