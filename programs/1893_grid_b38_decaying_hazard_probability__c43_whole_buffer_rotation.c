/*
 * LowBit -- 1893_grid_b38_decaying_hazard_probability__c43_whole_buffer_rotation.c
 * Branch: decaying_hazard_probability | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1893_grid_b38_decaying_hazard_probability__c43_whole_buffer_rotation.c\n");
