/*
 * LowBit -- 0361_grid_b08_switch_multiway__c11_sliding_window.c
 * Branch: switch_multiway | Cache: sliding_window
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0361_grid_b08_switch_multiway__c11_sliding_window.c\n");
