/*
 * LowBit -- 2436_grid_b49_interleaved_two_pattern_multiplex__c36_im2col_overlapping_patch_gather.c
 * Branch: interleaved_two_pattern_multiplex | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=2436_grid_b49_interleaved_two_pattern_multiplex__c36_im2col_overlapping_patch_gather.c\n");
