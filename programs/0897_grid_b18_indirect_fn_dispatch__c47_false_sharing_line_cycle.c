/*
 * LowBit -- 0897_grid_b18_indirect_fn_dispatch__c47_false_sharing_line_cycle.c
 * Branch: indirect_fn_dispatch | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0897_grid_b18_indirect_fn_dispatch__c47_false_sharing_line_cycle.c\n");
