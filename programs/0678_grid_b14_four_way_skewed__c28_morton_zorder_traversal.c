/*
 * LowBit -- 0678_grid_b14_four_way_skewed__c28_morton_zorder_traversal.c
 * Branch: four_way_skewed | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0678_grid_b14_four_way_skewed__c28_morton_zorder_traversal.c\n");
