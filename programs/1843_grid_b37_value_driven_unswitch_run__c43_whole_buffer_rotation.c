/*
 * LowBit -- 1843_grid_b37_value_driven_unswitch_run__c43_whole_buffer_rotation.c
 * Branch: value_driven_unswitch_run | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1843_grid_b37_value_driven_unswitch_run__c43_whole_buffer_rotation.c\n");
