/*
 * LowBit -- 2263_grid_b46_lookup_table_driven__c13_two_stream_interleaved.c
 * Branch: lookup_table_driven | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2263_grid_b46_lookup_table_driven__c13_two_stream_interleaved.c\n");
