/*
 * LowBit -- 2262_grid_b46_lookup_table_driven__c12_prime_stride_anti_alias.c
 * Branch: lookup_table_driven | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2262_grid_b46_lookup_table_driven__c12_prime_stride_anti_alias.c\n");
