/*
 * LowBit -- 1236_grid_b25_rare_exception_1_in_1024__c36_im2col_overlapping_patch_gather.c
 * Branch: rare_exception_1_in_1024 | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=1236_grid_b25_rare_exception_1_in_1024__c36_im2col_overlapping_patch_gather.c\n");
