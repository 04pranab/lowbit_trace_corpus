/*
 * LowBit -- 0153_grid_b04_periodic3__c03_fixed_stride_small.c
 * Branch: periodic3 | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0153_grid_b04_periodic3__c03_fixed_stride_small.c\n");
