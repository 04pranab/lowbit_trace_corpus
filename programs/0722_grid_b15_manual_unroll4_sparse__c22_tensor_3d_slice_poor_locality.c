/*
 * LowBit -- 0722_grid_b15_manual_unroll4_sparse__c22_tensor_3d_slice_poor_locality.c
 * Branch: manual_unroll4_sparse | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0722_grid_b15_manual_unroll4_sparse__c22_tensor_3d_slice_poor_locality.c\n");
