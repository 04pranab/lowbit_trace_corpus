/*
 * LowBit -- 1624_grid_b33_uniform_random_block_runs__c24_banked_interleaved_access.c
 * Branch: uniform_random_block_runs | Cache: banked_interleaved_access
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t bank_ = (uint32_t)(i % NBANKS24_);
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1624_grid_b33_uniform_random_block_runs__c24_banked_interleaved_access.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=banked_interleaved_access\n");
