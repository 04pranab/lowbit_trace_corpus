/*
 * LowBit -- 1473_grid_b30_periodic_interrupt_override__c23_struct_of_array_field_burst.c
 * Branch: periodic_interrupt_override | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=1473_grid_b30_periodic_interrupt_override__c23_struct_of_array_field_burst.c\n");
