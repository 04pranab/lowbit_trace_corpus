/*
 * LowBit -- 1710_grid_b35_xorshift_hash_mix__c10_pointer_chase_linked_list.c
 * Branch: xorshift_hash_mix | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1710_grid_b35_xorshift_hash_mix__c10_pointer_chase_linked_list.c\n");
