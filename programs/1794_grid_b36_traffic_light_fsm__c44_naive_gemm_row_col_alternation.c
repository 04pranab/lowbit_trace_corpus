/*
 * LowBit -- 1794_grid_b36_traffic_light_fsm__c44_naive_gemm_row_col_alternation.c
 * Branch: traffic_light_fsm | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1794_grid_b36_traffic_light_fsm__c44_naive_gemm_row_col_alternation.c\n");
