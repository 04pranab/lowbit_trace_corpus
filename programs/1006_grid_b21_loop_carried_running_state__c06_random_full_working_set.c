/*
 * LowBit -- 1006_grid_b21_loop_carried_running_state__c06_random_full_working_set.c
 * Branch: loop_carried_running_state | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=1006_grid_b21_loop_carried_running_state__c06_random_full_working_set.c\n");
