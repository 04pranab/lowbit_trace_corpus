/*
 * LowBit -- 0790_grid_b16_sentinel_search_loop__c40_causal_attention_triangular.c
 * Branch: sentinel_search_loop | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0790_grid_b16_sentinel_search_loop__c40_causal_attention_triangular.c\n");
