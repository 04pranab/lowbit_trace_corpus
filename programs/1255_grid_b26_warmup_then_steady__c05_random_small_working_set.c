/*
 * LowBit -- 1255_grid_b26_warmup_then_steady__c05_random_small_working_set.c
 * Branch: warmup_then_steady | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1255_grid_b26_warmup_then_steady__c05_random_small_working_set.c\n");
