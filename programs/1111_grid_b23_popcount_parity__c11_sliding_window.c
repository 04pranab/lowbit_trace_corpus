/*
 * LowBit -- 1111_grid_b23_popcount_parity__c11_sliding_window.c
 * Branch: popcount_parity | Cache: sliding_window
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1111_grid_b23_popcount_parity__c11_sliding_window.c\n");
