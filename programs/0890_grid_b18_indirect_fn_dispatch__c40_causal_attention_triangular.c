/*
 * LowBit -- 0890_grid_b18_indirect_fn_dispatch__c40_causal_attention_triangular.c
 * Branch: indirect_fn_dispatch | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0890_grid_b18_indirect_fn_dispatch__c40_causal_attention_triangular.c\n");
