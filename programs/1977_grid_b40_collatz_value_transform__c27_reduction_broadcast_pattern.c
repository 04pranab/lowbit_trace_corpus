/*
 * LowBit -- 1977_grid_b40_collatz_value_transform__c27_reduction_broadcast_pattern.c
 * Branch: collatz_value_transform | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1977_grid_b40_collatz_value_transform__c27_reduction_broadcast_pattern.c\n");
