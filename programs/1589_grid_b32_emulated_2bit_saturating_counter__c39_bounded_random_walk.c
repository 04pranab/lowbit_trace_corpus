/*
 * LowBit -- 1589_grid_b32_emulated_2bit_saturating_counter__c39_bounded_random_walk.c
 * Branch: emulated_2bit_saturating_counter | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1589_grid_b32_emulated_2bit_saturating_counter__c39_bounded_random_walk.c\n");
