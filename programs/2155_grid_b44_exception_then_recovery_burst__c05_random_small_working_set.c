/*
 * LowBit -- 2155_grid_b44_exception_then_recovery_burst__c05_random_small_working_set.c
 * Branch: exception_then_recovery_burst | Cache: random_small_working_set
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2155_grid_b44_exception_then_recovery_burst__c05_random_small_working_set.c\n");
