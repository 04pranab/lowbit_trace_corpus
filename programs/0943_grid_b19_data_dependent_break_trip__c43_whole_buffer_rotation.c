/*
 * LowBit -- 0943_grid_b19_data_dependent_break_trip__c43_whole_buffer_rotation.c
 * Branch: data_dependent_break_trip | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0943_grid_b19_data_dependent_break_trip__c43_whole_buffer_rotation.c\n");
