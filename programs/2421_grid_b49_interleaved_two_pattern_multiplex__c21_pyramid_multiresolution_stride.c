/*
 * LowBit -- 2421_grid_b49_interleaved_two_pattern_multiplex__c21_pyramid_multiresolution_stride.c
 * Branch: interleaved_two_pattern_multiplex | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=2421_grid_b49_interleaved_two_pattern_multiplex__c21_pyramid_multiresolution_stride.c\n");
