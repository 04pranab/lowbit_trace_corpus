/*
 * LowBit -- 0718_grid_b15_manual_unroll4_sparse__c18_producer_consumer_two_pointer.c
 * Branch: manual_unroll4_sparse | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0718_grid_b15_manual_unroll4_sparse__c18_producer_consumer_two_pointer.c\n");
