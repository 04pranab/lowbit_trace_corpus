/*
 * LowBit -- 1904_grid_b39_dual_lcg_xor_chaos__c04_fixed_stride_large.c
 * Branch: dual_lcg_xor_chaos | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1904_grid_b39_dual_lcg_xor_chaos__c04_fixed_stride_large.c\n");
