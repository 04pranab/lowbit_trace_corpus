/*
 * LowBit -- 0962_grid_b20_random_threshold_walk__c12_prime_stride_anti_alias.c
 * Branch: random_threshold_walk | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0962_grid_b20_random_threshold_walk__c12_prime_stride_anti_alias.c\n");
