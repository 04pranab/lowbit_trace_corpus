/*
 * LowBit -- 0227_grid_b05_periodic8_biased__c27_reduction_broadcast_pattern.c
 * Branch: periodic8_biased | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0227_grid_b05_periodic8_biased__c27_reduction_broadcast_pattern.c\n");
