/*
 * LowBit -- 2586_base_cache_c36_im2col_overlapping_patch_gather.c
 * Branch: synthetic_always_taken | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=2586_base_cache_c36_im2col_overlapping_patch_gather.c\n");
