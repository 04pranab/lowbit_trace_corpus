/*
 * LowBit -- 1108_grid_b23_popcount_parity__c08_matrix_col_major.c
 * Branch: popcount_parity | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1108_grid_b23_popcount_parity__c08_matrix_col_major.c\n");
