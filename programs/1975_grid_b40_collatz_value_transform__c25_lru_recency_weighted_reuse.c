/*
 * LowBit -- 1975_grid_b40_collatz_value_transform__c25_lru_recency_weighted_reuse.c
 * Branch: collatz_value_transform | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1975_grid_b40_collatz_value_transform__c25_lru_recency_weighted_reuse.c\n");
