/*
 * LowBit -- 0994_grid_b20_random_threshold_walk__c44_naive_gemm_row_col_alternation.c
 * Branch: random_threshold_walk | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0994_grid_b20_random_threshold_walk__c44_naive_gemm_row_col_alternation.c\n");
