/*
 * LowBit -- 1062_grid_b22_drifting_threshold_periodic_reset__c12_prime_stride_anti_alias.c
 * Branch: drifting_threshold_periodic_reset | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1062_grid_b22_drifting_threshold_periodic_reset__c12_prime_stride_anti_alias.c\n");
