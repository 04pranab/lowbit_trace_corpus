/*
 * LowBit -- 0861_grid_b18_indirect_fn_dispatch__c11_sliding_window.c
 * Branch: indirect_fn_dispatch | Cache: sliding_window
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0861_grid_b18_indirect_fn_dispatch__c11_sliding_window.c\n");
