/*
 * LowBit -- 1476_grid_b30_periodic_interrupt_override__c26_geometric_stride_growth.c
 * Branch: periodic_interrupt_override | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=1476_grid_b30_periodic_interrupt_override__c26_geometric_stride_growth.c\n");
