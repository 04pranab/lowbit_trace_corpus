/*
 * LowBit -- 1936_grid_b39_dual_lcg_xor_chaos__c36_im2col_overlapping_patch_gather.c
 * Branch: dual_lcg_xor_chaos | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1936_grid_b39_dual_lcg_xor_chaos__c36_im2col_overlapping_patch_gather.c\n");
