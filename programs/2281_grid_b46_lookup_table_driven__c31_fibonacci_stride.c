/*
 * LowBit -- 2281_grid_b46_lookup_table_driven__c31_fibonacci_stride.c
 * Branch: lookup_table_driven | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2281_grid_b46_lookup_table_driven__c31_fibonacci_stride.c\n");
