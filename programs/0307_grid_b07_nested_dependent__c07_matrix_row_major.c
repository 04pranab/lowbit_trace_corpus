/*
 * LowBit -- 0307_grid_b07_nested_dependent__c07_matrix_row_major.c
 * Branch: nested_dependent | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0307_grid_b07_nested_dependent__c07_matrix_row_major.c\n");
