/*
 * LowBit -- 1639_grid_b33_uniform_random_block_runs__c39_bounded_random_walk.c
 * Branch: uniform_random_block_runs | Cache: bounded_random_walk
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t cseed39_ = SEED0 ^ 0x39393939u; uint32_t pos39_ = SIZE / 2u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ int32_t delta39_ = (int32_t)(lcg_next(&cseed39_) % 17u) - 8;
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1639_grid_b33_uniform_random_block_runs__c39_bounded_random_walk.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=bounded_random_walk\n");
