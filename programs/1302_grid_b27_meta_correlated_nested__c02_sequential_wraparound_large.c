/*
 * LowBit -- 1302_grid_b27_meta_correlated_nested__c02_sequential_wraparound_large.c
 * Branch: meta_correlated_nested | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1302_grid_b27_meta_correlated_nested__c02_sequential_wraparound_large.c\n");
