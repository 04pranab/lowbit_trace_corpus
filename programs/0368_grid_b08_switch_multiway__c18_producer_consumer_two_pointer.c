/*
 * LowBit -- 0368_grid_b08_switch_multiway__c18_producer_consumer_two_pointer.c
 * Branch: switch_multiway | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0368_grid_b08_switch_multiway__c18_producer_consumer_two_pointer.c\n");
