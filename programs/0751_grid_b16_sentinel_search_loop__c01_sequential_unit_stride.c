/*
 * LowBit -- 0751_grid_b16_sentinel_search_loop__c01_sequential_unit_stride.c
 * Branch: sentinel_search_loop | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0751_grid_b16_sentinel_search_loop__c01_sequential_unit_stride.c\n");
