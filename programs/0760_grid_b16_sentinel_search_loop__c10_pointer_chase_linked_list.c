/*
 * LowBit -- 0760_grid_b16_sentinel_search_loop__c10_pointer_chase_linked_list.c
 * Branch: sentinel_search_loop | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0760_grid_b16_sentinel_search_loop__c10_pointer_chase_linked_list.c\n");
