/*
 * LowBit -- 1122_grid_b23_popcount_parity__c22_tensor_3d_slice_poor_locality.c
 * Branch: popcount_parity | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1122_grid_b23_popcount_parity__c22_tensor_3d_slice_poor_locality.c\n");
