/*
 * LowBit -- 1414_grid_b29_bursty_streak_pattern__c14_temporal_burst_reuse.c
 * Branch: bursty_streak_pattern | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1414_grid_b29_bursty_streak_pattern__c14_temporal_burst_reuse.c\n");
