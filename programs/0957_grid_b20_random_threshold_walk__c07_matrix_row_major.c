/*
 * LowBit -- 0957_grid_b20_random_threshold_walk__c07_matrix_row_major.c
 * Branch: random_threshold_walk | Cache: matrix_row_major
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0957_grid_b20_random_threshold_walk__c07_matrix_row_major.c\n");
