/*
 * LowBit -- 0918_grid_b19_data_dependent_break_trip__c18_producer_consumer_two_pointer.c
 * Branch: data_dependent_break_trip | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0918_grid_b19_data_dependent_break_trip__c18_producer_consumer_two_pointer.c\n");
