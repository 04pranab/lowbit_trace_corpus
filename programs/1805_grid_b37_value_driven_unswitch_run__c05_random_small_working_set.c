/*
 * LowBit -- 1805_grid_b37_value_driven_unswitch_run__c05_random_small_working_set.c
 * Branch: value_driven_unswitch_run | Cache: random_small_working_set
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1805_grid_b37_value_driven_unswitch_run__c05_random_small_working_set.c\n");
