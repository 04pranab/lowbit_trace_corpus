/*
 * LowBit -- 1159_grid_b24_monotonic_drift_saturating__c09_matrix_tiled_blocked.c
 * Branch: monotonic_drift_saturating | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1159_grid_b24_monotonic_drift_saturating__c09_matrix_tiled_blocked.c\n");
