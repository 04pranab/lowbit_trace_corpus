/*
 * LowBit -- 0395_grid_b08_switch_multiway__c45_read_hot_write_cold_split.c
 * Branch: switch_multiway | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0395_grid_b08_switch_multiway__c45_read_hot_write_cold_split.c\n");
