/*
 * LowBit -- 2294_grid_b46_lookup_table_driven__c44_naive_gemm_row_col_alternation.c
 * Branch: lookup_table_driven | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2294_grid_b46_lookup_table_driven__c44_naive_gemm_row_col_alternation.c\n");
