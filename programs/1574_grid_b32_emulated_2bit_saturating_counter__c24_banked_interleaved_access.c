/*
 * LowBit -- 1574_grid_b32_emulated_2bit_saturating_counter__c24_banked_interleaved_access.c
 * Branch: emulated_2bit_saturating_counter | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1574_grid_b32_emulated_2bit_saturating_counter__c24_banked_interleaved_access.c\n");
