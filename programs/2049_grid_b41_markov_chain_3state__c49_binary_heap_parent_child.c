/*
 * LowBit -- 2049_grid_b41_markov_chain_3state__c49_binary_heap_parent_child.c
 * Branch: markov_chain_3state | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2049_grid_b41_markov_chain_3state__c49_binary_heap_parent_child.c\n");
