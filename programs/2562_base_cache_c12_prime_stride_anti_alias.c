/*
 * LowBit -- 2562_base_cache_c12_prime_stride_anti_alias.c
 * Branch: synthetic_always_taken | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=2562_base_cache_c12_prime_stride_anti_alias.c\n");
