/*
 * LowBit -- 1026_grid_b21_loop_carried_running_state__c26_geometric_stride_growth.c
 * Branch: loop_carried_running_state | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=1026_grid_b21_loop_carried_running_state__c26_geometric_stride_growth.c\n");
