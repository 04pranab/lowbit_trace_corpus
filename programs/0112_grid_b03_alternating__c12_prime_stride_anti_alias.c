/*
 * LowBit -- 0112_grid_b03_alternating__c12_prime_stride_anti_alias.c
 * Branch: alternating | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0112_grid_b03_alternating__c12_prime_stride_anti_alias.c\n");
