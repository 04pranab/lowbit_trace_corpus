/*
 * LowBit -- 0220_grid_b05_periodic8_biased__c20_hot_cold_phase_alternation.c
 * Branch: periodic8_biased | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0220_grid_b05_periodic8_biased__c20_hot_cold_phase_alternation.c\n");
