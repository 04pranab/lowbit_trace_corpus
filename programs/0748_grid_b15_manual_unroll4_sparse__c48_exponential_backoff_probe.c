/*
 * LowBit -- 0748_grid_b15_manual_unroll4_sparse__c48_exponential_backoff_probe.c
 * Branch: manual_unroll4_sparse | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0748_grid_b15_manual_unroll4_sparse__c48_exponential_backoff_probe.c\n");
