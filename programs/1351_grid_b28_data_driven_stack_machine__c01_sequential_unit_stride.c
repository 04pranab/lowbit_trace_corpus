/*
 * LowBit -- 1351_grid_b28_data_driven_stack_machine__c01_sequential_unit_stride.c
 * Branch: data_driven_stack_machine | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1351_grid_b28_data_driven_stack_machine__c01_sequential_unit_stride.c\n");
