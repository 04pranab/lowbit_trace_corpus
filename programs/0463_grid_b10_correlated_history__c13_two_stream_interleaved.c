/*
 * LowBit -- 0463_grid_b10_correlated_history__c13_two_stream_interleaved.c
 * Branch: correlated_history | Cache: two_stream_interleaved
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0463_grid_b10_correlated_history__c13_two_stream_interleaved.c\n");
