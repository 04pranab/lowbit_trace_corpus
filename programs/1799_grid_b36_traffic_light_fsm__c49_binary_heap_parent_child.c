/*
 * LowBit -- 1799_grid_b36_traffic_light_fsm__c49_binary_heap_parent_child.c
 * Branch: traffic_light_fsm | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1799_grid_b36_traffic_light_fsm__c49_binary_heap_parent_child.c\n");
