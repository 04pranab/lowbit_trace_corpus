/*
 * LowBit -- 2417_grid_b49_interleaved_two_pattern_multiplex__c17_zipf_like_hot_buckets.c
 * Branch: interleaved_two_pattern_multiplex | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=2417_grid_b49_interleaved_two_pattern_multiplex__c17_zipf_like_hot_buckets.c\n");
