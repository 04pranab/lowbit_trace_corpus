/*
 * LowBit -- 0749_grid_b15_manual_unroll4_sparse__c49_binary_heap_parent_child.c
 * Branch: manual_unroll4_sparse | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0749_grid_b15_manual_unroll4_sparse__c49_binary_heap_parent_child.c\n");
