/*
 * LowBit -- 0955_grid_b20_random_threshold_walk__c05_random_small_working_set.c
 * Branch: random_threshold_walk | Cache: random_small_working_set
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0955_grid_b20_random_threshold_walk__c05_random_small_working_set.c\n");
