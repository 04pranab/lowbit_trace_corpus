/*
 * LowBit -- 0439_grid_b09_recursive_calls__c39_bounded_random_walk.c
 * Branch: recursive_calls | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0439_grid_b09_recursive_calls__c39_bounded_random_walk.c\n");
