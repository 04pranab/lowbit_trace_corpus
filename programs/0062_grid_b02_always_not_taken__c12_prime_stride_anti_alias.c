/*
 * LowBit -- 0062_grid_b02_always_not_taken__c12_prime_stride_anti_alias.c
 * Branch: always_not_taken | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0062_grid_b02_always_not_taken__c12_prime_stride_anti_alias.c\n");
