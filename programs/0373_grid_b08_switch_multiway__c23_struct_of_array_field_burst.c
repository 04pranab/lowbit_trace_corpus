/*
 * LowBit -- 0373_grid_b08_switch_multiway__c23_struct_of_array_field_burst.c
 * Branch: switch_multiway | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0373_grid_b08_switch_multiway__c23_struct_of_array_field_burst.c\n");
