/*
 * LowBit -- 1769_grid_b36_traffic_light_fsm__c19_matrix_diagonal_wavefront.c
 * Branch: traffic_light_fsm | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static int state36_ = 0; static int dwell36_ = 0;
  static const int dwell_times36_[3] = {10, 3, 20};
  taken = (state36_ == 0);
  dwell36_++;
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1769_grid_b36_traffic_light_fsm__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=traffic_light_fsm\n");
    printf("cache_pattern=matrix_diagonal_wavefront\n");
    printf("predictor_stress_type=mixed/other\n");
