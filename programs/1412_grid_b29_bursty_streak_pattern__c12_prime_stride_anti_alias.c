/*
 * LowBit -- 1412_grid_b29_bursty_streak_pattern__c12_prime_stride_anti_alias.c
 * Branch: bursty_streak_pattern | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1412_grid_b29_bursty_streak_pattern__c12_prime_stride_anti_alias.c\n");
