/*
 * LowBit -- 0820_grid_b17_correlated_two_branch_xor__c20_hot_cold_phase_alternation.c
 * Branch: correlated_two_branch_xor | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0820_grid_b17_correlated_two_branch_xor__c20_hot_cold_phase_alternation.c\n");
