/*
 * LowBit -- 0769_grid_b16_sentinel_search_loop__c19_matrix_diagonal_wavefront.c
 * Branch: sentinel_search_loop | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0769_grid_b16_sentinel_search_loop__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=sentinel_search_loop\n");
