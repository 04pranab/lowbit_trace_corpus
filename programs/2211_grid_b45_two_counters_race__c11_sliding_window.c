/*
 * LowBit -- 2211_grid_b45_two_counters_race__c11_sliding_window.c
 * Branch: two_counters_race | Cache: sliding_window
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2211_grid_b45_two_counters_race__c11_sliding_window.c\n");
