/*
 * LowBit -- 1064_grid_b22_drifting_threshold_periodic_reset__c14_temporal_burst_reuse.c
 * Branch: drifting_threshold_periodic_reset | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1064_grid_b22_drifting_threshold_periodic_reset__c14_temporal_burst_reuse.c\n");
