/*
 * LowBit -- 2202_grid_b45_two_counters_race__c02_sequential_wraparound_large.c
 * Branch: two_counters_race | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2202_grid_b45_two_counters_race__c02_sequential_wraparound_large.c\n");
