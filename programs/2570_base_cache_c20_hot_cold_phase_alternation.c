/*
 * LowBit -- 2570_base_cache_c20_hot_cold_phase_alternation.c
 * Branch: synthetic_always_taken | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=2570_base_cache_c20_hot_cold_phase_alternation.c\n");
