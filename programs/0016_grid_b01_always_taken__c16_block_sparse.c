/*
 * LowBit -- 0016_grid_b01_always_taken__c16_block_sparse.c
 * Branch: always_taken | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0016_grid_b01_always_taken__c16_block_sparse.c\n");
