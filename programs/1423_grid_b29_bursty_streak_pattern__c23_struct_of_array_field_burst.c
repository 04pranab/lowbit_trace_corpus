/*
 * LowBit -- 1423_grid_b29_bursty_streak_pattern__c23_struct_of_array_field_burst.c
 * Branch: bursty_streak_pattern | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1423_grid_b29_bursty_streak_pattern__c23_struct_of_array_field_burst.c\n");
