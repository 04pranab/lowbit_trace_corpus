/*
 * LowBit -- 1583_grid_b32_emulated_2bit_saturating_counter__c33_cache_set_conflict_stress.c
 * Branch: emulated_2bit_saturating_counter | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1583_grid_b32_emulated_2bit_saturating_counter__c33_cache_set_conflict_stress.c\n");
