/*
 * LowBit -- 0483_grid_b10_correlated_history__c33_cache_set_conflict_stress.c
 * Branch: correlated_history | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0483_grid_b10_correlated_history__c33_cache_set_conflict_stress.c\n");
