/*
 * LowBit -- 0964_grid_b20_random_threshold_walk__c14_temporal_burst_reuse.c
 * Branch: random_threshold_walk | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0964_grid_b20_random_threshold_walk__c14_temporal_burst_reuse.c\n");
