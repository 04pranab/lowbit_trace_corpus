/*
 * LowBit -- 2316_grid_b47_mutual_ping_pong_recursion__c16_block_sparse.c
 * Branch: mutual_ping_pong_recursion | Cache: block_sparse
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2316_grid_b47_mutual_ping_pong_recursion__c16_block_sparse.c\n");
