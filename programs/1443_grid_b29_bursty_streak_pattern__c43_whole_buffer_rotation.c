/*
 * LowBit -- 1443_grid_b29_bursty_streak_pattern__c43_whole_buffer_rotation.c
 * Branch: bursty_streak_pattern | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1443_grid_b29_bursty_streak_pattern__c43_whole_buffer_rotation.c\n");
