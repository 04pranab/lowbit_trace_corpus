/*
 * LowBit -- 1016_grid_b21_loop_carried_running_state__c16_block_sparse.c
 * Branch: loop_carried_running_state | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=1016_grid_b21_loop_carried_running_state__c16_block_sparse.c\n");
