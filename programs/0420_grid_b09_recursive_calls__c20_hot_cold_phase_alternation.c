/*
 * LowBit -- 0420_grid_b09_recursive_calls__c20_hot_cold_phase_alternation.c
 * Branch: recursive_calls | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0420_grid_b09_recursive_calls__c20_hot_cold_phase_alternation.c\n");
