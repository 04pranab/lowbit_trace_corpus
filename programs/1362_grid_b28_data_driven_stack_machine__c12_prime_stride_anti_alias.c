/*
 * LowBit -- 1362_grid_b28_data_driven_stack_machine__c12_prime_stride_anti_alias.c
 * Branch: data_driven_stack_machine | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1362_grid_b28_data_driven_stack_machine__c12_prime_stride_anti_alias.c\n");
