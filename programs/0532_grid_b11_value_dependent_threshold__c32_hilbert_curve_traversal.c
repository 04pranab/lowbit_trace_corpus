/*
 * LowBit -- 0532_grid_b11_value_dependent_threshold__c32_hilbert_curve_traversal.c
 * Branch: value_dependent_threshold | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0532_grid_b11_value_dependent_threshold__c32_hilbert_curve_traversal.c\n");
