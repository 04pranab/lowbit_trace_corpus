/*
 * LowBit -- 1188_grid_b24_monotonic_drift_saturating__c38_cuckoo_double_hash_probe.c
 * Branch: monotonic_drift_saturating | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1188_grid_b24_monotonic_drift_saturating__c38_cuckoo_double_hash_probe.c\n");
