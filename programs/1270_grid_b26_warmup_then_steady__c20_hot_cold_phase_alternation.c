/*
 * LowBit -- 1270_grid_b26_warmup_then_steady__c20_hot_cold_phase_alternation.c
 * Branch: warmup_then_steady | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1270_grid_b26_warmup_then_steady__c20_hot_cold_phase_alternation.c\n");
