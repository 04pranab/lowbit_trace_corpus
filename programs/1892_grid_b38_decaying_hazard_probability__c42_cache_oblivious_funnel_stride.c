/*
 * LowBit -- 1892_grid_b38_decaying_hazard_probability__c42_cache_oblivious_funnel_stride.c
 * Branch: decaying_hazard_probability | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1892_grid_b38_decaying_hazard_probability__c42_cache_oblivious_funnel_stride.c\n");
