/*
 * LowBit -- 2084_grid_b42_bit_reversal_index_data_mix__c34_variable_length_burst_reuse.c
 * Branch: bit_reversal_index_data_mix | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2084_grid_b42_bit_reversal_index_data_mix__c34_variable_length_burst_reuse.c\n");
