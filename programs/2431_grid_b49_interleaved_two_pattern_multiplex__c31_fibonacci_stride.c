/*
 * LowBit -- 2431_grid_b49_interleaved_two_pattern_multiplex__c31_fibonacci_stride.c
 * Branch: interleaved_two_pattern_multiplex | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=2431_grid_b49_interleaved_two_pattern_multiplex__c31_fibonacci_stride.c\n");
