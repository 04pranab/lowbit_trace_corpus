/*
 * LowBit -- 0061_grid_b02_always_not_taken__c11_sliding_window.c
 * Branch: always_not_taken | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0061_grid_b02_always_not_taken__c11_sliding_window.c\n");
