/*
 * LowBit -- 2480_grid_b50_hysteresis_debounce__c30_gather_scatter_indirect_table.c
 * Branch: hysteresis_debounce | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2480_grid_b50_hysteresis_debounce__c30_gather_scatter_indirect_table.c\n");
