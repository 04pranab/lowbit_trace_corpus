/*
 * LowBit -- 0668_grid_b14_four_way_skewed__c18_producer_consumer_two_pointer.c
 * Branch: four_way_skewed | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0668_grid_b14_four_way_skewed__c18_producer_consumer_two_pointer.c\n");
