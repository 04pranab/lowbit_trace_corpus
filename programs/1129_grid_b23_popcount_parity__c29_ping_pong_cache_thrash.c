/*
 * LowBit -- 1129_grid_b23_popcount_parity__c29_ping_pong_cache_thrash.c
 * Branch: popcount_parity | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1129_grid_b23_popcount_parity__c29_ping_pong_cache_thrash.c\n");
