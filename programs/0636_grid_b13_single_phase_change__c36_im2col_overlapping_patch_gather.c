/*
 * LowBit -- 0636_grid_b13_single_phase_change__c36_im2col_overlapping_patch_gather.c
 * Branch: single_phase_change | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0636_grid_b13_single_phase_change__c36_im2col_overlapping_patch_gather.c\n");
