/*
 * LowBit -- 0275_grid_b06_pseudo_random_50__c25_lru_recency_weighted_reuse.c
 * Branch: pseudo_random_50 | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0275_grid_b06_pseudo_random_50__c25_lru_recency_weighted_reuse.c\n");
