/*
 * LowBit -- 0491_grid_b10_correlated_history__c41_skip_list_multilevel_hop.c
 * Branch: correlated_history | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0491_grid_b10_correlated_history__c41_skip_list_multilevel_hop.c\n");
