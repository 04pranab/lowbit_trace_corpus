/*
 * LowBit -- 2525_base_branch_b25_rare_exception_1_in_1024.c
 * Branch: rare_exception_1_in_1024 | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2525_base_branch_b25_rare_exception_1_in_1024.c\n");
