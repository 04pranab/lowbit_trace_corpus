/*
 * LowBit -- 1645_grid_b33_uniform_random_block_runs__c45_read_hot_write_cold_split.c
 * Branch: uniform_random_block_runs | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1645_grid_b33_uniform_random_block_runs__c45_read_hot_write_cold_split.c\n");
