/*
 * LowBit -- 0909_grid_b19_data_dependent_break_trip__c09_matrix_tiled_blocked.c
 * Branch: data_dependent_break_trip | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0909_grid_b19_data_dependent_break_trip__c09_matrix_tiled_blocked.c\n");
