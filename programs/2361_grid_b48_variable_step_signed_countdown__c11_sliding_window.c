/*
 * LowBit -- 2361_grid_b48_variable_step_signed_countdown__c11_sliding_window.c
 * Branch: variable_step_signed_countdown | Cache: sliding_window
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2361_grid_b48_variable_step_signed_countdown__c11_sliding_window.c\n");
