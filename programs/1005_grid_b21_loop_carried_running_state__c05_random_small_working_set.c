/*
 * LowBit -- 1005_grid_b21_loop_carried_running_state__c05_random_small_working_set.c
 * Branch: loop_carried_running_state | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=1005_grid_b21_loop_carried_running_state__c05_random_small_working_set.c\n");
