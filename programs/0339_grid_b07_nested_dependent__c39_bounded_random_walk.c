/*
 * LowBit -- 0339_grid_b07_nested_dependent__c39_bounded_random_walk.c
 * Branch: nested_dependent | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0339_grid_b07_nested_dependent__c39_bounded_random_walk.c\n");
