/*
 * LowBit -- 0826_grid_b17_correlated_two_branch_xor__c26_geometric_stride_growth.c
 * Branch: correlated_two_branch_xor | Cache: geometric_stride_growth
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0826_grid_b17_correlated_two_branch_xor__c26_geometric_stride_growth.c\n");
