/*
 * LowBit -- 0728_grid_b15_manual_unroll4_sparse__c28_morton_zorder_traversal.c
 * Branch: manual_unroll4_sparse | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0728_grid_b15_manual_unroll4_sparse__c28_morton_zorder_traversal.c\n");
