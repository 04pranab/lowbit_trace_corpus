/*
 * LowBit -- 1701_grid_b35_xorshift_hash_mix__c01_sequential_unit_stride.c
 * Branch: xorshift_hash_mix | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1701_grid_b35_xorshift_hash_mix__c01_sequential_unit_stride.c\n");
