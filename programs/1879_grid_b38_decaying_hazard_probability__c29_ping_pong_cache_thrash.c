/*
 * LowBit -- 1879_grid_b38_decaying_hazard_probability__c29_ping_pong_cache_thrash.c
 * Branch: decaying_hazard_probability | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1879_grid_b38_decaying_hazard_probability__c29_ping_pong_cache_thrash.c\n");
