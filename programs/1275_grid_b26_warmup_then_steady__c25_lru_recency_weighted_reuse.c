/*
 * LowBit -- 1275_grid_b26_warmup_then_steady__c25_lru_recency_weighted_reuse.c
 * Branch: warmup_then_steady | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1275_grid_b26_warmup_then_steady__c25_lru_recency_weighted_reuse.c\n");
