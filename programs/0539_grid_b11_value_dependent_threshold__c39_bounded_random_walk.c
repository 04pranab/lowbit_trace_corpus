/*
 * LowBit -- 0539_grid_b11_value_dependent_threshold__c39_bounded_random_walk.c
 * Branch: value_dependent_threshold | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0539_grid_b11_value_dependent_threshold__c39_bounded_random_walk.c\n");
