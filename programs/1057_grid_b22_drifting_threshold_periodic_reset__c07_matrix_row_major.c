/*
 * LowBit -- 1057_grid_b22_drifting_threshold_periodic_reset__c07_matrix_row_major.c
 * Branch: drifting_threshold_periodic_reset | Cache: matrix_row_major
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1057_grid_b22_drifting_threshold_periodic_reset__c07_matrix_row_major.c\n");
