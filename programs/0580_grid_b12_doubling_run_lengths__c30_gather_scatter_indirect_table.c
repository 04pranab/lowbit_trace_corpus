/*
 * LowBit -- 0580_grid_b12_doubling_run_lengths__c30_gather_scatter_indirect_table.c
 * Branch: doubling_run_lengths | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0580_grid_b12_doubling_run_lengths__c30_gather_scatter_indirect_table.c\n");
