/*
 * LowBit -- 0971_grid_b20_random_threshold_walk__c21_pyramid_multiresolution_stride.c
 * Branch: random_threshold_walk | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0971_grid_b20_random_threshold_walk__c21_pyramid_multiresolution_stride.c\n");
