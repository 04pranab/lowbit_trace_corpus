/*
 * LowBit -- 1156_grid_b24_monotonic_drift_saturating__c06_random_full_working_set.c
 * Branch: monotonic_drift_saturating | Cache: random_full_working_set
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1156_grid_b24_monotonic_drift_saturating__c06_random_full_working_set.c\n");
