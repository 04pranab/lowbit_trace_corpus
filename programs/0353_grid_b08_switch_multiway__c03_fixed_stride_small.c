/*
 * LowBit -- 0353_grid_b08_switch_multiway__c03_fixed_stride_small.c
 * Branch: switch_multiway | Cache: fixed_stride_small
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0353_grid_b08_switch_multiway__c03_fixed_stride_small.c\n");
