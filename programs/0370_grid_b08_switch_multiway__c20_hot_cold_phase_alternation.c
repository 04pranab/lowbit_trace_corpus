/*
 * LowBit -- 0370_grid_b08_switch_multiway__c20_hot_cold_phase_alternation.c
 * Branch: switch_multiway | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0370_grid_b08_switch_multiway__c20_hot_cold_phase_alternation.c\n");
