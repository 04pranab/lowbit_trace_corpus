/*
 * LowBit -- 2335_grid_b47_mutual_ping_pong_recursion__c35_checkerboard_red_black.c
 * Branch: mutual_ping_pong_recursion | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2335_grid_b47_mutual_ping_pong_recursion__c35_checkerboard_red_black.c\n");
