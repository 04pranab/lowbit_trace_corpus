/*
 * LowBit -- 0394_grid_b08_switch_multiway__c44_naive_gemm_row_col_alternation.c
 * Branch: switch_multiway | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0394_grid_b08_switch_multiway__c44_naive_gemm_row_col_alternation.c\n");
