/*
 * LowBit -- 0989_grid_b20_random_threshold_walk__c39_bounded_random_walk.c
 * Branch: random_threshold_walk | Cache: bounded_random_walk
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0989_grid_b20_random_threshold_walk__c39_bounded_random_walk.c\n");
