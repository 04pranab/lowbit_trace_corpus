/*
 * LowBit -- 0963_grid_b20_random_threshold_walk__c13_two_stream_interleaved.c
 * Branch: random_threshold_walk | Cache: two_stream_interleaved
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0963_grid_b20_random_threshold_walk__c13_two_stream_interleaved.c\n");
