/*
 * LowBit -- 0040_grid_b01_always_taken__c40_causal_attention_triangular.c
 * Branch: always_taken | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0040_grid_b01_always_taken__c40_causal_attention_triangular.c\n");
