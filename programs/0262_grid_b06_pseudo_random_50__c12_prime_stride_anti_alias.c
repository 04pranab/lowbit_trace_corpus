/*
 * LowBit -- 0262_grid_b06_pseudo_random_50__c12_prime_stride_anti_alias.c
 * Branch: pseudo_random_50 | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0262_grid_b06_pseudo_random_50__c12_prime_stride_anti_alias.c\n");
