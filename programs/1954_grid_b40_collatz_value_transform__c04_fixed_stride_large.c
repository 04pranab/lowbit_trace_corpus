/*
 * LowBit -- 1954_grid_b40_collatz_value_transform__c04_fixed_stride_large.c
 * Branch: collatz_value_transform | Cache: fixed_stride_large
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1954_grid_b40_collatz_value_transform__c04_fixed_stride_large.c\n");
