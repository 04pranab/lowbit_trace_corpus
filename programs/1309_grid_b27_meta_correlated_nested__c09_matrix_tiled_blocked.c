/*
 * LowBit -- 1309_grid_b27_meta_correlated_nested__c09_matrix_tiled_blocked.c
 * Branch: meta_correlated_nested | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1309_grid_b27_meta_correlated_nested__c09_matrix_tiled_blocked.c\n");
