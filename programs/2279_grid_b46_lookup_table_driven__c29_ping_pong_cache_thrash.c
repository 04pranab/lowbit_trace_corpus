/*
 * LowBit -- 2279_grid_b46_lookup_table_driven__c29_ping_pong_cache_thrash.c
 * Branch: lookup_table_driven | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2279_grid_b46_lookup_table_driven__c29_ping_pong_cache_thrash.c\n");
