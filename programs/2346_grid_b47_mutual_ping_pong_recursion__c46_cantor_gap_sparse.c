/*
 * LowBit -- 2346_grid_b47_mutual_ping_pong_recursion__c46_cantor_gap_sparse.c
 * Branch: mutual_ping_pong_recursion | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2346_grid_b47_mutual_ping_pong_recursion__c46_cantor_gap_sparse.c\n");
