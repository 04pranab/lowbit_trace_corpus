/*
 * LowBit -- 0051_grid_b02_always_not_taken__c01_sequential_unit_stride.c
 * Branch: always_not_taken | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0051_grid_b02_always_not_taken__c01_sequential_unit_stride.c\n");
