/*
 * LowBit -- 1596_grid_b32_emulated_2bit_saturating_counter__c46_cantor_gap_sparse.c
 * Branch: emulated_2bit_saturating_counter | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1596_grid_b32_emulated_2bit_saturating_counter__c46_cantor_gap_sparse.c\n");
