/*
 * LowBit -- 2210_grid_b45_two_counters_race__c10_pointer_chase_linked_list.c
 * Branch: two_counters_race | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2210_grid_b45_two_counters_race__c10_pointer_chase_linked_list.c\n");
