/*
 * LowBit -- 0803_grid_b17_correlated_two_branch_xor__c03_fixed_stride_small.c
 * Branch: correlated_two_branch_xor | Cache: fixed_stride_small
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0803_grid_b17_correlated_two_branch_xor__c03_fixed_stride_small.c\n");
