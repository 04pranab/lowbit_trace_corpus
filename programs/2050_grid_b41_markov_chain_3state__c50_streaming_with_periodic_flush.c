/*
 * LowBit -- 2050_grid_b41_markov_chain_3state__c50_streaming_with_periodic_flush.c
 * Branch: markov_chain_3state | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2050_grid_b41_markov_chain_3state__c50_streaming_with_periodic_flush.c\n");
