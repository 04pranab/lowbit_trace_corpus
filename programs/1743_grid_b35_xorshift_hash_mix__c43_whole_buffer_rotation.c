/*
 * LowBit -- 1743_grid_b35_xorshift_hash_mix__c43_whole_buffer_rotation.c
 * Branch: xorshift_hash_mix | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1743_grid_b35_xorshift_hash_mix__c43_whole_buffer_rotation.c\n");
