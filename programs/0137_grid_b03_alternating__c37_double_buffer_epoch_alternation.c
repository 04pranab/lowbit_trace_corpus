/*
 * LowBit -- 0137_grid_b03_alternating__c37_double_buffer_epoch_alternation.c
 * Branch: alternating | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0137_grid_b03_alternating__c37_double_buffer_epoch_alternation.c\n");
