/*
 * LowBit -- 0434_grid_b09_recursive_calls__c34_variable_length_burst_reuse.c
 * Branch: recursive_calls | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0434_grid_b09_recursive_calls__c34_variable_length_burst_reuse.c\n");
