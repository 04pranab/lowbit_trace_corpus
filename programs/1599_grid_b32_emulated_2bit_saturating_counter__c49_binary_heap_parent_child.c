/*
 * LowBit -- 1599_grid_b32_emulated_2bit_saturating_counter__c49_binary_heap_parent_child.c
 * Branch: emulated_2bit_saturating_counter | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1599_grid_b32_emulated_2bit_saturating_counter__c49_binary_heap_parent_child.c\n");
