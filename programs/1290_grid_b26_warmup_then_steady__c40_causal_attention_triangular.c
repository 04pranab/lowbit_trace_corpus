/*
 * LowBit -- 1290_grid_b26_warmup_then_steady__c40_causal_attention_triangular.c
 * Branch: warmup_then_steady | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1290_grid_b26_warmup_then_steady__c40_causal_attention_triangular.c\n");
