/*
 * LowBit -- 2278_grid_b46_lookup_table_driven__c28_morton_zorder_traversal.c
 * Branch: lookup_table_driven | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2278_grid_b46_lookup_table_driven__c28_morton_zorder_traversal.c\n");
