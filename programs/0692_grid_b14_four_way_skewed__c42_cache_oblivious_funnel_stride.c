/*
 * LowBit -- 0692_grid_b14_four_way_skewed__c42_cache_oblivious_funnel_stride.c
 * Branch: four_way_skewed | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0692_grid_b14_four_way_skewed__c42_cache_oblivious_funnel_stride.c\n");
