/*
 * LowBit -- 0794_grid_b16_sentinel_search_loop__c44_naive_gemm_row_col_alternation.c
 * Branch: sentinel_search_loop | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0794_grid_b16_sentinel_search_loop__c44_naive_gemm_row_col_alternation.c\n");
