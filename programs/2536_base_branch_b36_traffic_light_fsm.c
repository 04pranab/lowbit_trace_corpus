/*
 * LowBit -- 2536_base_branch_b36_traffic_light_fsm.c
 * Branch: traffic_light_fsm | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=2536_base_branch_b36_traffic_light_fsm.c\n");
