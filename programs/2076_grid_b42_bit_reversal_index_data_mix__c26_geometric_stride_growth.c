/*
 * LowBit -- 2076_grid_b42_bit_reversal_index_data_mix__c26_geometric_stride_growth.c
 * Branch: bit_reversal_index_data_mix | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2076_grid_b42_bit_reversal_index_data_mix__c26_geometric_stride_growth.c\n");
