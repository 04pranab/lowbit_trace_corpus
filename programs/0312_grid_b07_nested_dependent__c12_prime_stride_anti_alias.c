/*
 * LowBit -- 0312_grid_b07_nested_dependent__c12_prime_stride_anti_alias.c
 * Branch: nested_dependent | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0312_grid_b07_nested_dependent__c12_prime_stride_anti_alias.c\n");
