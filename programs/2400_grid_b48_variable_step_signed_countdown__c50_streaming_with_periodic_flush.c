/*
 * LowBit -- 2400_grid_b48_variable_step_signed_countdown__c50_streaming_with_periodic_flush.c
 * Branch: variable_step_signed_countdown | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2400_grid_b48_variable_step_signed_countdown__c50_streaming_with_periodic_flush.c\n");
