/*
 * LowBit -- 1875_grid_b38_decaying_hazard_probability__c25_lru_recency_weighted_reuse.c
 * Branch: decaying_hazard_probability | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1875_grid_b38_decaying_hazard_probability__c25_lru_recency_weighted_reuse.c\n");
