/*
 * LowBit -- 1991_grid_b40_collatz_value_transform__c41_skip_list_multilevel_hop.c
 * Branch: collatz_value_transform | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1991_grid_b40_collatz_value_transform__c41_skip_list_multilevel_hop.c\n");
