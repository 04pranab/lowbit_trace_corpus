/*
 * LowBit -- 1113_grid_b23_popcount_parity__c13_two_stream_interleaved.c
 * Branch: popcount_parity | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1113_grid_b23_popcount_parity__c13_two_stream_interleaved.c\n");
