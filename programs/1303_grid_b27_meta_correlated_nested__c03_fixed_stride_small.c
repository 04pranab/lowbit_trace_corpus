/*
 * LowBit -- 1303_grid_b27_meta_correlated_nested__c03_fixed_stride_small.c
 * Branch: meta_correlated_nested | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1303_grid_b27_meta_correlated_nested__c03_fixed_stride_small.c\n");
