/*
 * LowBit -- 1009_grid_b21_loop_carried_running_state__c09_matrix_tiled_blocked.c
 * Branch: loop_carried_running_state | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=1009_grid_b21_loop_carried_running_state__c09_matrix_tiled_blocked.c\n");
