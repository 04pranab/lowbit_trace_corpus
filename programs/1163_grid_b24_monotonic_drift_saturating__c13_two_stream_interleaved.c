/*
 * LowBit -- 1163_grid_b24_monotonic_drift_saturating__c13_two_stream_interleaved.c
 * Branch: monotonic_drift_saturating | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1163_grid_b24_monotonic_drift_saturating__c13_two_stream_interleaved.c\n");
