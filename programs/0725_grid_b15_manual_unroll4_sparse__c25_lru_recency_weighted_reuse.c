/*
 * LowBit -- 0725_grid_b15_manual_unroll4_sparse__c25_lru_recency_weighted_reuse.c
 * Branch: manual_unroll4_sparse | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0725_grid_b15_manual_unroll4_sparse__c25_lru_recency_weighted_reuse.c\n");
