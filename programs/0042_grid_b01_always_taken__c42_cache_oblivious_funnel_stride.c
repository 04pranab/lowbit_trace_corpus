/*
 * LowBit -- 0042_grid_b01_always_taken__c42_cache_oblivious_funnel_stride.c
 * Branch: always_taken | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0042_grid_b01_always_taken__c42_cache_oblivious_funnel_stride.c\n");
