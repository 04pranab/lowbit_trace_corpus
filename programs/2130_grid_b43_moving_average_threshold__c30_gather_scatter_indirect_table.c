/*
 * LowBit -- 2130_grid_b43_moving_average_threshold__c30_gather_scatter_indirect_table.c
 * Branch: moving_average_threshold | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2130_grid_b43_moving_average_threshold__c30_gather_scatter_indirect_table.c\n");
