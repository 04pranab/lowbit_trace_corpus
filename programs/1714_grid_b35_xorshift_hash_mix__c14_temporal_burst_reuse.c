/*
 * LowBit -- 1714_grid_b35_xorshift_hash_mix__c14_temporal_burst_reuse.c
 * Branch: xorshift_hash_mix | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1714_grid_b35_xorshift_hash_mix__c14_temporal_burst_reuse.c\n");
