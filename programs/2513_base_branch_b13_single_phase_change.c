/*
 * LowBit -- 2513_base_branch_b13_single_phase_change.c
 * Branch: single_phase_change | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2513_base_branch_b13_single_phase_change.c\n");
