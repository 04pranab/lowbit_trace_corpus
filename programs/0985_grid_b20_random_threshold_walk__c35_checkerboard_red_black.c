/*
 * LowBit -- 0985_grid_b20_random_threshold_walk__c35_checkerboard_red_black.c
 * Branch: random_threshold_walk | Cache: checkerboard_red_black
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0985_grid_b20_random_threshold_walk__c35_checkerboard_red_black.c\n");
