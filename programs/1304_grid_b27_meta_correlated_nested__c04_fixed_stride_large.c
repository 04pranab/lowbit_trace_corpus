/*
 * LowBit -- 1304_grid_b27_meta_correlated_nested__c04_fixed_stride_large.c
 * Branch: meta_correlated_nested | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1304_grid_b27_meta_correlated_nested__c04_fixed_stride_large.c\n");
