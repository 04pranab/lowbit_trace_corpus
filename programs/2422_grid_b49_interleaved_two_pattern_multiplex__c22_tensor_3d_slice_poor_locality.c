/*
 * LowBit -- 2422_grid_b49_interleaved_two_pattern_multiplex__c22_tensor_3d_slice_poor_locality.c
 * Branch: interleaved_two_pattern_multiplex | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=2422_grid_b49_interleaved_two_pattern_multiplex__c22_tensor_3d_slice_poor_locality.c\n");
