/*
 * LowBit -- 0858_grid_b18_indirect_fn_dispatch__c08_matrix_col_major.c
 * Branch: indirect_fn_dispatch | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0858_grid_b18_indirect_fn_dispatch__c08_matrix_col_major.c\n");
