/*
 * LowBit -- 0885_grid_b18_indirect_fn_dispatch__c35_checkerboard_red_black.c
 * Branch: indirect_fn_dispatch | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0885_grid_b18_indirect_fn_dispatch__c35_checkerboard_red_black.c\n");
