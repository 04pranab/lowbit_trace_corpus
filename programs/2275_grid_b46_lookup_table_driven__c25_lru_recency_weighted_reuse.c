/*
 * LowBit -- 2275_grid_b46_lookup_table_driven__c25_lru_recency_weighted_reuse.c
 * Branch: lookup_table_driven | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2275_grid_b46_lookup_table_driven__c25_lru_recency_weighted_reuse.c\n");
