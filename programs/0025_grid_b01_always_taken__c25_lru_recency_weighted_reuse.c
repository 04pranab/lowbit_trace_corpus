/*
 * LowBit -- 0025_grid_b01_always_taken__c25_lru_recency_weighted_reuse.c
 * Branch: always_taken | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0025_grid_b01_always_taken__c25_lru_recency_weighted_reuse.c\n");
