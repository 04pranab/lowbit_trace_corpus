/*
 * LowBit -- 2282_grid_b46_lookup_table_driven__c32_hilbert_curve_traversal.c
 * Branch: lookup_table_driven | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2282_grid_b46_lookup_table_driven__c32_hilbert_curve_traversal.c\n");
