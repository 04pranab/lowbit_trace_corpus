/*
 * LowBit -- 1959_grid_b40_collatz_value_transform__c09_matrix_tiled_blocked.c
 * Branch: collatz_value_transform | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1959_grid_b40_collatz_value_transform__c09_matrix_tiled_blocked.c\n");
