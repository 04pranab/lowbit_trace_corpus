/*
 * LowBit -- 1707_grid_b35_xorshift_hash_mix__c07_matrix_row_major.c
 * Branch: xorshift_hash_mix | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1707_grid_b35_xorshift_hash_mix__c07_matrix_row_major.c\n");
