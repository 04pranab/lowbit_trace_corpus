/*
 * LowBit -- 0388_grid_b08_switch_multiway__c38_cuckoo_double_hash_probe.c
 * Branch: switch_multiway | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0388_grid_b08_switch_multiway__c38_cuckoo_double_hash_probe.c\n");
