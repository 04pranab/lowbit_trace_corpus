/*
 * LowBit -- 2004_grid_b41_markov_chain_3state__c04_fixed_stride_large.c
 * Branch: markov_chain_3state | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2004_grid_b41_markov_chain_3state__c04_fixed_stride_large.c\n");
