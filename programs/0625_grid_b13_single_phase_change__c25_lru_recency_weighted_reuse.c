/*
 * LowBit -- 0625_grid_b13_single_phase_change__c25_lru_recency_weighted_reuse.c
 * Branch: single_phase_change | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0625_grid_b13_single_phase_change__c25_lru_recency_weighted_reuse.c\n");
