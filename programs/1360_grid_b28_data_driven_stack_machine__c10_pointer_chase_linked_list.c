/*
 * LowBit -- 1360_grid_b28_data_driven_stack_machine__c10_pointer_chase_linked_list.c
 * Branch: data_driven_stack_machine | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1360_grid_b28_data_driven_stack_machine__c10_pointer_chase_linked_list.c\n");
