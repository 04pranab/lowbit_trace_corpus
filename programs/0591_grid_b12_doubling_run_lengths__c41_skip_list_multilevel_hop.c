/*
 * LowBit -- 0591_grid_b12_doubling_run_lengths__c41_skip_list_multilevel_hop.c
 * Branch: doubling_run_lengths | Cache: skip_list_multilevel_hop
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t cseed41_ = SEED0 ^ 0x41414141u; uint32_t pos41_ = 0u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t lvl41_ = lcg_next(&cseed41_) % 16u;
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0591_grid_b12_doubling_run_lengths__c41_skip_list_multilevel_hop.c\n");
    printf("branch_pattern=doubling_run_lengths\n");
    printf("cache_pattern=skip_list_multilevel_hop\n");
