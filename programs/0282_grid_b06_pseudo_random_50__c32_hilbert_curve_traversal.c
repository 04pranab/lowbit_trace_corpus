/*
 * LowBit -- 0282_grid_b06_pseudo_random_50__c32_hilbert_curve_traversal.c
 * Branch: pseudo_random_50 | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0282_grid_b06_pseudo_random_50__c32_hilbert_curve_traversal.c\n");
