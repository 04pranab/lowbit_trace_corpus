/*
 * LowBit -- 2201_grid_b45_two_counters_race__c01_sequential_unit_stride.c
 * Branch: two_counters_race | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2201_grid_b45_two_counters_race__c01_sequential_unit_stride.c\n");
