/*
 * LowBit -- 1448_grid_b29_bursty_streak_pattern__c48_exponential_backoff_probe.c
 * Branch: bursty_streak_pattern | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1448_grid_b29_bursty_streak_pattern__c48_exponential_backoff_probe.c\n");
