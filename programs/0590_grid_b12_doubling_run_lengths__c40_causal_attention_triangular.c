/*
 * LowBit -- 0590_grid_b12_doubling_run_lengths__c40_causal_attention_triangular.c
 * Branch: doubling_run_lengths | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0590_grid_b12_doubling_run_lengths__c40_causal_attention_triangular.c\n");
