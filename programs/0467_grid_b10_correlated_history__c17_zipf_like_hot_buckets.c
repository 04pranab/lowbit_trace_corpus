/*
 * LowBit -- 0467_grid_b10_correlated_history__c17_zipf_like_hot_buckets.c
 * Branch: correlated_history | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0467_grid_b10_correlated_history__c17_zipf_like_hot_buckets.c\n");
