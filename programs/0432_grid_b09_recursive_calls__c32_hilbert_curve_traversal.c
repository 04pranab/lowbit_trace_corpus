/*
 * LowBit -- 0432_grid_b09_recursive_calls__c32_hilbert_curve_traversal.c
 * Branch: recursive_calls | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0432_grid_b09_recursive_calls__c32_hilbert_curve_traversal.c\n");
