/*
 * LowBit -- 0977_grid_b20_random_threshold_walk__c27_reduction_broadcast_pattern.c
 * Branch: random_threshold_walk | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0977_grid_b20_random_threshold_walk__c27_reduction_broadcast_pattern.c\n");
