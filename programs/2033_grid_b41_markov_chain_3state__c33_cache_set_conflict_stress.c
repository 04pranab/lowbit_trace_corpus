/*
 * LowBit -- 2033_grid_b41_markov_chain_3state__c33_cache_set_conflict_stress.c
 * Branch: markov_chain_3state | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2033_grid_b41_markov_chain_3state__c33_cache_set_conflict_stress.c\n");
