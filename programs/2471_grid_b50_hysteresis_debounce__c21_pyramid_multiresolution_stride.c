/*
 * LowBit -- 2471_grid_b50_hysteresis_debounce__c21_pyramid_multiresolution_stride.c
 * Branch: hysteresis_debounce | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2471_grid_b50_hysteresis_debounce__c21_pyramid_multiresolution_stride.c\n");
