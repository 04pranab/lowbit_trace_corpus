/*
 * LowBit -- 1970_grid_b40_collatz_value_transform__c20_hot_cold_phase_alternation.c
 * Branch: collatz_value_transform | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1970_grid_b40_collatz_value_transform__c20_hot_cold_phase_alternation.c\n");
