/*
 * LowBit -- 2476_grid_b50_hysteresis_debounce__c26_geometric_stride_growth.c
 * Branch: hysteresis_debounce | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2476_grid_b50_hysteresis_debounce__c26_geometric_stride_growth.c\n");
