/*
 * LowBit -- 0665_grid_b14_four_way_skewed__c15_reverse_sequential.c
 * Branch: four_way_skewed | Cache: reverse_sequential
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0665_grid_b14_four_way_skewed__c15_reverse_sequential.c\n");
