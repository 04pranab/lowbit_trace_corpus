/*
 * LowBit -- 0605_grid_b13_single_phase_change__c05_random_small_working_set.c
 * Branch: single_phase_change | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0605_grid_b13_single_phase_change__c05_random_small_working_set.c\n");
