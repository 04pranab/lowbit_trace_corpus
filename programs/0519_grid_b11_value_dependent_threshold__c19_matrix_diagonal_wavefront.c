/*
 * LowBit -- 0519_grid_b11_value_dependent_threshold__c19_matrix_diagonal_wavefront.c
 * Branch: value_dependent_threshold | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0519_grid_b11_value_dependent_threshold__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=value_dependent_threshold\n");
