/*
 * LowBit -- 1765_grid_b36_traffic_light_fsm__c15_reverse_sequential.c
 * Branch: traffic_light_fsm | Cache: reverse_sequential
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1765_grid_b36_traffic_light_fsm__c15_reverse_sequential.c\n");
