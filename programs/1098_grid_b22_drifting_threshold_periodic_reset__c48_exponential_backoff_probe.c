/*
 * LowBit -- 1098_grid_b22_drifting_threshold_periodic_reset__c48_exponential_backoff_probe.c
 * Branch: drifting_threshold_periodic_reset | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1098_grid_b22_drifting_threshold_periodic_reset__c48_exponential_backoff_probe.c\n");
