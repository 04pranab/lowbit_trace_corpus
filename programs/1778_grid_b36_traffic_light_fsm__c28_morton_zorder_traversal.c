/*
 * LowBit -- 1778_grid_b36_traffic_light_fsm__c28_morton_zorder_traversal.c
 * Branch: traffic_light_fsm | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1778_grid_b36_traffic_light_fsm__c28_morton_zorder_traversal.c\n");
