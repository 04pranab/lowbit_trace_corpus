/*
 * LowBit -- 0681_grid_b14_four_way_skewed__c31_fibonacci_stride.c
 * Branch: four_way_skewed | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0681_grid_b14_four_way_skewed__c31_fibonacci_stride.c\n");
