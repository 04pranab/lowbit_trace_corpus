/*
 * LowBit -- 0673_grid_b14_four_way_skewed__c23_struct_of_array_field_burst.c
 * Branch: four_way_skewed | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0673_grid_b14_four_way_skewed__c23_struct_of_array_field_burst.c\n");
