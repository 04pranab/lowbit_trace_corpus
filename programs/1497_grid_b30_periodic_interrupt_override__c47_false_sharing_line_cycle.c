/*
 * LowBit -- 1497_grid_b30_periodic_interrupt_override__c47_false_sharing_line_cycle.c
 * Branch: periodic_interrupt_override | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=1497_grid_b30_periodic_interrupt_override__c47_false_sharing_line_cycle.c\n");
