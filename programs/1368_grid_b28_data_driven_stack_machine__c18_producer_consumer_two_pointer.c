/*
 * LowBit -- 1368_grid_b28_data_driven_stack_machine__c18_producer_consumer_two_pointer.c
 * Branch: data_driven_stack_machine | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1368_grid_b28_data_driven_stack_machine__c18_producer_consumer_two_pointer.c\n");
