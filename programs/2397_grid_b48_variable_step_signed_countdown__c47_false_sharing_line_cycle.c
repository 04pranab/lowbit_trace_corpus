/*
 * LowBit -- 2397_grid_b48_variable_step_signed_countdown__c47_false_sharing_line_cycle.c
 * Branch: variable_step_signed_countdown | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2397_grid_b48_variable_step_signed_countdown__c47_false_sharing_line_cycle.c\n");
