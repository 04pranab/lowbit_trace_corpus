/*
 * LowBit -- 2073_grid_b42_bit_reversal_index_data_mix__c23_struct_of_array_field_burst.c
 * Branch: bit_reversal_index_data_mix | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2073_grid_b42_bit_reversal_index_data_mix__c23_struct_of_array_field_burst.c\n");
