/*
 * LowBit -- 2401_grid_b49_interleaved_two_pattern_multiplex__c01_sequential_unit_stride.c
 * Branch: interleaved_two_pattern_multiplex | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=2401_grid_b49_interleaved_two_pattern_multiplex__c01_sequential_unit_stride.c\n");
