/*
 * LowBit -- 2535_base_branch_b35_xorshift_hash_mix.c
 * Branch: xorshift_hash_mix | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=2535_base_branch_b35_xorshift_hash_mix.c\n");
