/*
 * LowBit -- 1035_grid_b21_loop_carried_running_state__c35_checkerboard_red_black.c
 * Branch: loop_carried_running_state | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=1035_grid_b21_loop_carried_running_state__c35_checkerboard_red_black.c\n");
