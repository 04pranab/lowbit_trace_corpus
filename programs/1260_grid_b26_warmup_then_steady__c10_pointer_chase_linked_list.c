/*
 * LowBit -- 1260_grid_b26_warmup_then_steady__c10_pointer_chase_linked_list.c
 * Branch: warmup_then_steady | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1260_grid_b26_warmup_then_steady__c10_pointer_chase_linked_list.c\n");
