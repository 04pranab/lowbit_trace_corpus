/*
 * LowBit -- 1722_grid_b35_xorshift_hash_mix__c22_tensor_3d_slice_poor_locality.c
 * Branch: xorshift_hash_mix | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1722_grid_b35_xorshift_hash_mix__c22_tensor_3d_slice_poor_locality.c\n");
