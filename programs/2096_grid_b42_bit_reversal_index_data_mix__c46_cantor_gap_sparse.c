/*
 * LowBit -- 2096_grid_b42_bit_reversal_index_data_mix__c46_cantor_gap_sparse.c
 * Branch: bit_reversal_index_data_mix | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2096_grid_b42_bit_reversal_index_data_mix__c46_cantor_gap_sparse.c\n");
