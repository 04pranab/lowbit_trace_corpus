/*
 * LowBit -- 1471_grid_b30_periodic_interrupt_override__c21_pyramid_multiresolution_stride.c
 * Branch: periodic_interrupt_override | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=1471_grid_b30_periodic_interrupt_override__c21_pyramid_multiresolution_stride.c\n");
