/*
 * LowBit -- 0521_grid_b11_value_dependent_threshold__c21_pyramid_multiresolution_stride.c
 * Branch: value_dependent_threshold | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0521_grid_b11_value_dependent_threshold__c21_pyramid_multiresolution_stride.c\n");
