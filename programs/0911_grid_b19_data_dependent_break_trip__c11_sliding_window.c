/*
 * LowBit -- 0911_grid_b19_data_dependent_break_trip__c11_sliding_window.c
 * Branch: data_dependent_break_trip | Cache: sliding_window
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0911_grid_b19_data_dependent_break_trip__c11_sliding_window.c\n");
