/*
 * LowBit -- 0679_grid_b14_four_way_skewed__c29_ping_pong_cache_thrash.c
 * Branch: four_way_skewed | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0679_grid_b14_four_way_skewed__c29_ping_pong_cache_thrash.c\n");
