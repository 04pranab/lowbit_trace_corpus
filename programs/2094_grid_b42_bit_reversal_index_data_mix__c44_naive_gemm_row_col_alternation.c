/*
 * LowBit -- 2094_grid_b42_bit_reversal_index_data_mix__c44_naive_gemm_row_col_alternation.c
 * Branch: bit_reversal_index_data_mix | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2094_grid_b42_bit_reversal_index_data_mix__c44_naive_gemm_row_col_alternation.c\n");
