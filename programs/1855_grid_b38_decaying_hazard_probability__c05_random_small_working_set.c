/*
 * LowBit -- 1855_grid_b38_decaying_hazard_probability__c05_random_small_working_set.c
 * Branch: decaying_hazard_probability | Cache: random_small_working_set
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1855_grid_b38_decaying_hazard_probability__c05_random_small_working_set.c\n");
