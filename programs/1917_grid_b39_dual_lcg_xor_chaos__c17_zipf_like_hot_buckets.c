/*
 * LowBit -- 1917_grid_b39_dual_lcg_xor_chaos__c17_zipf_like_hot_buckets.c
 * Branch: dual_lcg_xor_chaos | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1917_grid_b39_dual_lcg_xor_chaos__c17_zipf_like_hot_buckets.c\n");
