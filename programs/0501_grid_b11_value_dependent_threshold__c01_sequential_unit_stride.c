/*
 * LowBit -- 0501_grid_b11_value_dependent_threshold__c01_sequential_unit_stride.c
 * Branch: value_dependent_threshold | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0501_grid_b11_value_dependent_threshold__c01_sequential_unit_stride.c\n");
