/*
 * LowBit -- 2387_grid_b48_variable_step_signed_countdown__c37_double_buffer_epoch_alternation.c
 * Branch: variable_step_signed_countdown | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2387_grid_b48_variable_step_signed_countdown__c37_double_buffer_epoch_alternation.c\n");
