/*
 * LowBit -- 0318_grid_b07_nested_dependent__c18_producer_consumer_two_pointer.c
 * Branch: nested_dependent | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0318_grid_b07_nested_dependent__c18_producer_consumer_two_pointer.c\n");
