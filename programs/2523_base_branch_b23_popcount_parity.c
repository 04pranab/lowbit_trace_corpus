/*
 * LowBit -- 2523_base_branch_b23_popcount_parity.c
 * Branch: popcount_parity | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=2523_base_branch_b23_popcount_parity.c\n");
