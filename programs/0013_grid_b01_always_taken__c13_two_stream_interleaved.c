/*
 * LowBit -- 0013_grid_b01_always_taken__c13_two_stream_interleaved.c
 * Branch: always_taken | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0013_grid_b01_always_taken__c13_two_stream_interleaved.c\n");
