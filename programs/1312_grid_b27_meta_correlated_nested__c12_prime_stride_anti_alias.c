/*
 * LowBit -- 1312_grid_b27_meta_correlated_nested__c12_prime_stride_anti_alias.c
 * Branch: meta_correlated_nested | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1312_grid_b27_meta_correlated_nested__c12_prime_stride_anti_alias.c\n");
