/*
 * LowBit -- 0159_grid_b04_periodic3__c09_matrix_tiled_blocked.c
 * Branch: periodic3 | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0159_grid_b04_periodic3__c09_matrix_tiled_blocked.c\n");
