/*
 * LowBit -- 0115_grid_b03_alternating__c15_reverse_sequential.c
 * Branch: alternating | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0115_grid_b03_alternating__c15_reverse_sequential.c\n");
