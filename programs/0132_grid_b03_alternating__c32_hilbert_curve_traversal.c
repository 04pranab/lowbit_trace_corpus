/*
 * LowBit -- 0132_grid_b03_alternating__c32_hilbert_curve_traversal.c
 * Branch: alternating | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0132_grid_b03_alternating__c32_hilbert_curve_traversal.c\n");
