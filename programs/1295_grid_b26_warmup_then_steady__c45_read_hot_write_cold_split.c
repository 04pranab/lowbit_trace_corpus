/*
 * LowBit -- 1295_grid_b26_warmup_then_steady__c45_read_hot_write_cold_split.c
 * Branch: warmup_then_steady | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1295_grid_b26_warmup_then_steady__c45_read_hot_write_cold_split.c\n");
