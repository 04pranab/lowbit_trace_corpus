/*
 * LowBit -- 2576_base_cache_c26_geometric_stride_growth.c
 * Branch: synthetic_always_taken | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=2576_base_cache_c26_geometric_stride_growth.c\n");
