/*
 * LowBit -- 1864_grid_b38_decaying_hazard_probability__c14_temporal_burst_reuse.c
 * Branch: decaying_hazard_probability | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1864_grid_b38_decaying_hazard_probability__c14_temporal_burst_reuse.c\n");
