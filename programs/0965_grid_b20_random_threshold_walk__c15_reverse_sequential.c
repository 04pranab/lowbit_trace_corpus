/*
 * LowBit -- 0965_grid_b20_random_threshold_walk__c15_reverse_sequential.c
 * Branch: random_threshold_walk | Cache: reverse_sequential
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0965_grid_b20_random_threshold_walk__c15_reverse_sequential.c\n");
