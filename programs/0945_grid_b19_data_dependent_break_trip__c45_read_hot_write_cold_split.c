/*
 * LowBit -- 0945_grid_b19_data_dependent_break_trip__c45_read_hot_write_cold_split.c
 * Branch: data_dependent_break_trip | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0945_grid_b19_data_dependent_break_trip__c45_read_hot_write_cold_split.c\n");
