/*
 * LowBit -- 1546_grid_b31_prime_period13__c46_cantor_gap_sparse.c
 * Branch: prime_period13 | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=1546_grid_b31_prime_period13__c46_cantor_gap_sparse.c\n");
