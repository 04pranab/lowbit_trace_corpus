/*
 * LowBit -- 0847_grid_b17_correlated_two_branch_xor__c47_false_sharing_line_cycle.c
 * Branch: correlated_two_branch_xor | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0847_grid_b17_correlated_two_branch_xor__c47_false_sharing_line_cycle.c\n");
