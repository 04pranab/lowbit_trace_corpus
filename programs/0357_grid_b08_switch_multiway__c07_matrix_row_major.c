/*
 * LowBit -- 0357_grid_b08_switch_multiway__c07_matrix_row_major.c
 * Branch: switch_multiway | Cache: matrix_row_major
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0357_grid_b08_switch_multiway__c07_matrix_row_major.c\n");
