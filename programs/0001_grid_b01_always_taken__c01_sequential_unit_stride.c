/*
 * LowBit -- 0001_grid_b01_always_taken__c01_sequential_unit_stride.c
 * Branch: always_taken | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0001_grid_b01_always_taken__c01_sequential_unit_stride.c\n");
