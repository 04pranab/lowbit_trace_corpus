/*
 * LowBit -- 2057_grid_b42_bit_reversal_index_data_mix__c07_matrix_row_major.c
 * Branch: bit_reversal_index_data_mix | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2057_grid_b42_bit_reversal_index_data_mix__c07_matrix_row_major.c\n");
