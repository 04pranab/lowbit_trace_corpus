/*
 * LowBit -- 1776_grid_b36_traffic_light_fsm__c26_geometric_stride_growth.c
 * Branch: traffic_light_fsm | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1776_grid_b36_traffic_light_fsm__c26_geometric_stride_growth.c\n");
