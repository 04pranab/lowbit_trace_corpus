/*
 * LowBit -- 0920_grid_b19_data_dependent_break_trip__c20_hot_cold_phase_alternation.c
 * Branch: data_dependent_break_trip | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0920_grid_b19_data_dependent_break_trip__c20_hot_cold_phase_alternation.c\n");
