/*
 * LowBit -- 1387_grid_b28_data_driven_stack_machine__c37_double_buffer_epoch_alternation.c
 * Branch: data_driven_stack_machine | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1387_grid_b28_data_driven_stack_machine__c37_double_buffer_epoch_alternation.c\n");
