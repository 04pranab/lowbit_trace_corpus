/*
 * LowBit -- 2402_grid_b49_interleaved_two_pattern_multiplex__c02_sequential_wraparound_large.c
 * Branch: interleaved_two_pattern_multiplex | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=2402_grid_b49_interleaved_two_pattern_multiplex__c02_sequential_wraparound_large.c\n");
