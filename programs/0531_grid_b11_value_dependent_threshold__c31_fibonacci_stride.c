/*
 * LowBit -- 0531_grid_b11_value_dependent_threshold__c31_fibonacci_stride.c
 * Branch: value_dependent_threshold | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0531_grid_b11_value_dependent_threshold__c31_fibonacci_stride.c\n");
