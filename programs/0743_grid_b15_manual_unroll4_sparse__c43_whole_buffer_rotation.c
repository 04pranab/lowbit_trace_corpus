/*
 * LowBit -- 0743_grid_b15_manual_unroll4_sparse__c43_whole_buffer_rotation.c
 * Branch: manual_unroll4_sparse | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0743_grid_b15_manual_unroll4_sparse__c43_whole_buffer_rotation.c\n");
