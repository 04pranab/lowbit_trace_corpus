/*
 * LowBit -- 0308_grid_b07_nested_dependent__c08_matrix_col_major.c
 * Branch: nested_dependent | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0308_grid_b07_nested_dependent__c08_matrix_col_major.c\n");
