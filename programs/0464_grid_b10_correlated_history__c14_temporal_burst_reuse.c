/*
 * LowBit -- 0464_grid_b10_correlated_history__c14_temporal_burst_reuse.c
 * Branch: correlated_history | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0464_grid_b10_correlated_history__c14_temporal_burst_reuse.c\n");
