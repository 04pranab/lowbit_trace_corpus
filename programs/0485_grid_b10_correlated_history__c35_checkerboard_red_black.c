/*
 * LowBit -- 0485_grid_b10_correlated_history__c35_checkerboard_red_black.c
 * Branch: correlated_history | Cache: checkerboard_red_black
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0485_grid_b10_correlated_history__c35_checkerboard_red_black.c\n");
