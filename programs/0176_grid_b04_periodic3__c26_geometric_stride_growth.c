/*
 * LowBit -- 0176_grid_b04_periodic3__c26_geometric_stride_growth.c
 * Branch: periodic3 | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0176_grid_b04_periodic3__c26_geometric_stride_growth.c\n");
