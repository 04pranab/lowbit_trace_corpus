/*
 * LowBit -- 0067_grid_b02_always_not_taken__c17_zipf_like_hot_buckets.c
 * Branch: always_not_taken | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0067_grid_b02_always_not_taken__c17_zipf_like_hot_buckets.c\n");
