/*
 * LowBit -- 2118_grid_b43_moving_average_threshold__c18_producer_consumer_two_pointer.c
 * Branch: moving_average_threshold | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2118_grid_b43_moving_average_threshold__c18_producer_consumer_two_pointer.c\n");
