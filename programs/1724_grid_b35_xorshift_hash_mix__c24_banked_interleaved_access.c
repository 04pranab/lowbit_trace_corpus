/*
 * LowBit -- 1724_grid_b35_xorshift_hash_mix__c24_banked_interleaved_access.c
 * Branch: xorshift_hash_mix | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1724_grid_b35_xorshift_hash_mix__c24_banked_interleaved_access.c\n");
