/*
 * LowBit -- 1180_grid_b24_monotonic_drift_saturating__c30_gather_scatter_indirect_table.c
 * Branch: monotonic_drift_saturating | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1180_grid_b24_monotonic_drift_saturating__c30_gather_scatter_indirect_table.c\n");
