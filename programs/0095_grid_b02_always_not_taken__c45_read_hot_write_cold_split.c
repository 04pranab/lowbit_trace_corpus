/*
 * LowBit -- 0095_grid_b02_always_not_taken__c45_read_hot_write_cold_split.c
 * Branch: always_not_taken | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0095_grid_b02_always_not_taken__c45_read_hot_write_cold_split.c\n");
