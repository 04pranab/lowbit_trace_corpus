/*
 * LowBit -- 0233_grid_b05_periodic8_biased__c33_cache_set_conflict_stress.c
 * Branch: periodic8_biased | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0233_grid_b05_periodic8_biased__c33_cache_set_conflict_stress.c\n");
