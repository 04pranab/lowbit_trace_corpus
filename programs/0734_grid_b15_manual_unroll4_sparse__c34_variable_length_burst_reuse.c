/*
 * LowBit -- 0734_grid_b15_manual_unroll4_sparse__c34_variable_length_burst_reuse.c
 * Branch: manual_unroll4_sparse | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0734_grid_b15_manual_unroll4_sparse__c34_variable_length_burst_reuse.c\n");
