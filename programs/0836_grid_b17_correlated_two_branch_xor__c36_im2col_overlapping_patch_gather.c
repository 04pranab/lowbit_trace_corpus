/*
 * LowBit -- 0836_grid_b17_correlated_two_branch_xor__c36_im2col_overlapping_patch_gather.c
 * Branch: correlated_two_branch_xor | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0836_grid_b17_correlated_two_branch_xor__c36_im2col_overlapping_patch_gather.c\n");
