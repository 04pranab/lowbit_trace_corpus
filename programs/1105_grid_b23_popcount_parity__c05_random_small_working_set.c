/*
 * LowBit -- 1105_grid_b23_popcount_parity__c05_random_small_working_set.c
 * Branch: popcount_parity | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1105_grid_b23_popcount_parity__c05_random_small_working_set.c\n");
