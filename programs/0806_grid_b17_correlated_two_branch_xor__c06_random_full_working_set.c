/*
 * LowBit -- 0806_grid_b17_correlated_two_branch_xor__c06_random_full_working_set.c
 * Branch: correlated_two_branch_xor | Cache: random_full_working_set
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0806_grid_b17_correlated_two_branch_xor__c06_random_full_working_set.c\n");
