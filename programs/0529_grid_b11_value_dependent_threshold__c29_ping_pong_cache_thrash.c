/*
 * LowBit -- 0529_grid_b11_value_dependent_threshold__c29_ping_pong_cache_thrash.c
 * Branch: value_dependent_threshold | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0529_grid_b11_value_dependent_threshold__c29_ping_pong_cache_thrash.c\n");
