/*
 * LowBit -- 1262_grid_b26_warmup_then_steady__c12_prime_stride_anti_alias.c
 * Branch: warmup_then_steady | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1262_grid_b26_warmup_then_steady__c12_prime_stride_anti_alias.c\n");
