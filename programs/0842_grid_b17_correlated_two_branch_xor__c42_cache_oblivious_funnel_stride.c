/*
 * LowBit -- 0842_grid_b17_correlated_two_branch_xor__c42_cache_oblivious_funnel_stride.c
 * Branch: correlated_two_branch_xor | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0842_grid_b17_correlated_two_branch_xor__c42_cache_oblivious_funnel_stride.c\n");
