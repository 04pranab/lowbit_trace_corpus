/*
 * LowBit -- 1047_grid_b21_loop_carried_running_state__c47_false_sharing_line_cycle.c
 * Branch: loop_carried_running_state | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=1047_grid_b21_loop_carried_running_state__c47_false_sharing_line_cycle.c\n");
