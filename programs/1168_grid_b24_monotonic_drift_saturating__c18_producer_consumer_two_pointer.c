/*
 * LowBit -- 1168_grid_b24_monotonic_drift_saturating__c18_producer_consumer_two_pointer.c
 * Branch: monotonic_drift_saturating | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1168_grid_b24_monotonic_drift_saturating__c18_producer_consumer_two_pointer.c\n");
