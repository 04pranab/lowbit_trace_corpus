/*
 * LowBit -- 0228_grid_b05_periodic8_biased__c28_morton_zorder_traversal.c
 * Branch: periodic8_biased | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0228_grid_b05_periodic8_biased__c28_morton_zorder_traversal.c\n");
