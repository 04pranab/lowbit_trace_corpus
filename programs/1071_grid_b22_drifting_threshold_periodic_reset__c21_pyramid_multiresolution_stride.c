/*
 * LowBit -- 1071_grid_b22_drifting_threshold_periodic_reset__c21_pyramid_multiresolution_stride.c
 * Branch: drifting_threshold_periodic_reset | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1071_grid_b22_drifting_threshold_periodic_reset__c21_pyramid_multiresolution_stride.c\n");
