/*
 * LowBit -- 2524_base_branch_b24_monotonic_drift_saturating.c
 * Branch: monotonic_drift_saturating | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=2524_base_branch_b24_monotonic_drift_saturating.c\n");
