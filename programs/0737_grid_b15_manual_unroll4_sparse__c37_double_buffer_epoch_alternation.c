/*
 * LowBit -- 0737_grid_b15_manual_unroll4_sparse__c37_double_buffer_epoch_alternation.c
 * Branch: manual_unroll4_sparse | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0737_grid_b15_manual_unroll4_sparse__c37_double_buffer_epoch_alternation.c\n");
