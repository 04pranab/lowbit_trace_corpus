/*
 * LowBit -- 1939_grid_b39_dual_lcg_xor_chaos__c39_bounded_random_walk.c
 * Branch: dual_lcg_xor_chaos | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1939_grid_b39_dual_lcg_xor_chaos__c39_bounded_random_walk.c\n");
