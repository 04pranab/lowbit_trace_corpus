/*
 * LowBit -- 1863_grid_b38_decaying_hazard_probability__c13_two_stream_interleaved.c
 * Branch: decaying_hazard_probability | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1863_grid_b38_decaying_hazard_probability__c13_two_stream_interleaved.c\n");
