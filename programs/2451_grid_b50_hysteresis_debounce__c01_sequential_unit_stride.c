/*
 * LowBit -- 2451_grid_b50_hysteresis_debounce__c01_sequential_unit_stride.c
 * Branch: hysteresis_debounce | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2451_grid_b50_hysteresis_debounce__c01_sequential_unit_stride.c\n");
