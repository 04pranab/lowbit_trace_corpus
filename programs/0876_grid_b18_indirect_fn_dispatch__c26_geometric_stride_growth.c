/*
 * LowBit -- 0876_grid_b18_indirect_fn_dispatch__c26_geometric_stride_growth.c
 * Branch: indirect_fn_dispatch | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0876_grid_b18_indirect_fn_dispatch__c26_geometric_stride_growth.c\n");
