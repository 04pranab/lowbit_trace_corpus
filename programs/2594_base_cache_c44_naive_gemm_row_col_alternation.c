/*
 * LowBit -- 2594_base_cache_c44_naive_gemm_row_col_alternation.c
 * Branch: synthetic_always_taken | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=2594_base_cache_c44_naive_gemm_row_col_alternation.c\n");
