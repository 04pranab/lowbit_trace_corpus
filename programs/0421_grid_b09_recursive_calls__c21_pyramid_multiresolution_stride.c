/*
 * LowBit -- 0421_grid_b09_recursive_calls__c21_pyramid_multiresolution_stride.c
 * Branch: recursive_calls | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0421_grid_b09_recursive_calls__c21_pyramid_multiresolution_stride.c\n");
