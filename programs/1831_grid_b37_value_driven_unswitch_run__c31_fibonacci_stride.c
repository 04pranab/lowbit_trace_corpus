/*
 * LowBit -- 1831_grid_b37_value_driven_unswitch_run__c31_fibonacci_stride.c
 * Branch: value_driven_unswitch_run | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1831_grid_b37_value_driven_unswitch_run__c31_fibonacci_stride.c\n");
