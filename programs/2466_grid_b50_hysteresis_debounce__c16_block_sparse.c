/*
 * LowBit -- 2466_grid_b50_hysteresis_debounce__c16_block_sparse.c
 * Branch: hysteresis_debounce | Cache: block_sparse
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2466_grid_b50_hysteresis_debounce__c16_block_sparse.c\n");
