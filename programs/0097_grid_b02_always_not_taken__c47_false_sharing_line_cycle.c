/*
 * LowBit -- 0097_grid_b02_always_not_taken__c47_false_sharing_line_cycle.c
 * Branch: always_not_taken | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0097_grid_b02_always_not_taken__c47_false_sharing_line_cycle.c\n");
