/*
 * LowBit -- 1369_grid_b28_data_driven_stack_machine__c19_matrix_diagonal_wavefront.c
 * Branch: data_driven_stack_machine | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static int depth28_ = 0; static int stack28_[64];
  uint32_t op28_ = v & 3u;
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1369_grid_b28_data_driven_stack_machine__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=data_driven_stack_machine\n");
