/*
 * LowBit -- 0729_grid_b15_manual_unroll4_sparse__c29_ping_pong_cache_thrash.c
 * Branch: manual_unroll4_sparse | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0729_grid_b15_manual_unroll4_sparse__c29_ping_pong_cache_thrash.c\n");
