/*
 * LowBit -- 2006_grid_b41_markov_chain_3state__c06_random_full_working_set.c
 * Branch: markov_chain_3state | Cache: random_full_working_set
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2006_grid_b41_markov_chain_3state__c06_random_full_working_set.c\n");
