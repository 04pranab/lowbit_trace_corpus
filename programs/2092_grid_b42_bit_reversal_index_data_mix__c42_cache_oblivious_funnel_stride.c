/*
 * LowBit -- 2092_grid_b42_bit_reversal_index_data_mix__c42_cache_oblivious_funnel_stride.c
 * Branch: bit_reversal_index_data_mix | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2092_grid_b42_bit_reversal_index_data_mix__c42_cache_oblivious_funnel_stride.c\n");
