/*
 * LowBit -- 0352_grid_b08_switch_multiway__c02_sequential_wraparound_large.c
 * Branch: switch_multiway | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0352_grid_b08_switch_multiway__c02_sequential_wraparound_large.c\n");
