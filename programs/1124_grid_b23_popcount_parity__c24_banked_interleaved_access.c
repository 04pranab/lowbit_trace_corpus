/*
 * LowBit -- 1124_grid_b23_popcount_parity__c24_banked_interleaved_access.c
 * Branch: popcount_parity | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1124_grid_b23_popcount_parity__c24_banked_interleaved_access.c\n");
