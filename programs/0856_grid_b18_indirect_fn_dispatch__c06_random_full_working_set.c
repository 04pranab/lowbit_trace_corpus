/*
 * LowBit -- 0856_grid_b18_indirect_fn_dispatch__c06_random_full_working_set.c
 * Branch: indirect_fn_dispatch | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0856_grid_b18_indirect_fn_dispatch__c06_random_full_working_set.c\n");
