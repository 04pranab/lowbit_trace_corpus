/*
 * LowBit -- 2582_base_cache_c32_hilbert_curve_traversal.c
 * Branch: synthetic_always_taken | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=2582_base_cache_c32_hilbert_curve_traversal.c\n");
