/*
 * LowBit -- 2136_grid_b43_moving_average_threshold__c36_im2col_overlapping_patch_gather.c
 * Branch: moving_average_threshold | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2136_grid_b43_moving_average_threshold__c36_im2col_overlapping_patch_gather.c\n");
