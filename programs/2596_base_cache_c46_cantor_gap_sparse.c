/*
 * LowBit -- 2596_base_cache_c46_cantor_gap_sparse.c
 * Branch: synthetic_always_taken | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=2596_base_cache_c46_cantor_gap_sparse.c\n");
