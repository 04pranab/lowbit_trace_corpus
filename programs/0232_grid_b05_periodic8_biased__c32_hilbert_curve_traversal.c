/*
 * LowBit -- 0232_grid_b05_periodic8_biased__c32_hilbert_curve_traversal.c
 * Branch: periodic8_biased | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0232_grid_b05_periodic8_biased__c32_hilbert_curve_traversal.c\n");
