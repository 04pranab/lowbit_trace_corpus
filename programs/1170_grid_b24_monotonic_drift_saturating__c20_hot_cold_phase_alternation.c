/*
 * LowBit -- 1170_grid_b24_monotonic_drift_saturating__c20_hot_cold_phase_alternation.c
 * Branch: monotonic_drift_saturating | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1170_grid_b24_monotonic_drift_saturating__c20_hot_cold_phase_alternation.c\n");
