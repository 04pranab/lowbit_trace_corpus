/*
 * LowBit -- 1152_grid_b24_monotonic_drift_saturating__c02_sequential_wraparound_large.c
 * Branch: monotonic_drift_saturating | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1152_grid_b24_monotonic_drift_saturating__c02_sequential_wraparound_large.c\n");
