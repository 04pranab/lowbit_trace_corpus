/*
 * LowBit -- 1788_grid_b36_traffic_light_fsm__c38_cuckoo_double_hash_probe.c
 * Branch: traffic_light_fsm | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1788_grid_b36_traffic_light_fsm__c38_cuckoo_double_hash_probe.c\n");
