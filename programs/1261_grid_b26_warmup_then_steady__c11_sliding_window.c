/*
 * LowBit -- 1261_grid_b26_warmup_then_steady__c11_sliding_window.c
 * Branch: warmup_then_steady | Cache: sliding_window
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1261_grid_b26_warmup_then_steady__c11_sliding_window.c\n");
