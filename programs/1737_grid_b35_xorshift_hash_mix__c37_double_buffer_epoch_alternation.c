/*
 * LowBit -- 1737_grid_b35_xorshift_hash_mix__c37_double_buffer_epoch_alternation.c
 * Branch: xorshift_hash_mix | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1737_grid_b35_xorshift_hash_mix__c37_double_buffer_epoch_alternation.c\n");
