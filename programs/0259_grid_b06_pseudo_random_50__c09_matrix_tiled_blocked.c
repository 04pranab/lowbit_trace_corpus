/*
 * LowBit -- 0259_grid_b06_pseudo_random_50__c09_matrix_tiled_blocked.c
 * Branch: pseudo_random_50 | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0259_grid_b06_pseudo_random_50__c09_matrix_tiled_blocked.c\n");
