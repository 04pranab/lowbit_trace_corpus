/*
 * LowBit -- 1506_grid_b31_prime_period13__c06_random_full_working_set.c
 * Branch: prime_period13 | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=1506_grid_b31_prime_period13__c06_random_full_working_set.c\n");
