/*
 * LowBit -- 0250_grid_b05_periodic8_biased__c50_streaming_with_periodic_flush.c
 * Branch: periodic8_biased | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0250_grid_b05_periodic8_biased__c50_streaming_with_periodic_flush.c\n");
