/*
 * LowBit -- 1801_grid_b37_value_driven_unswitch_run__c01_sequential_unit_stride.c
 * Branch: value_driven_unswitch_run | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1801_grid_b37_value_driven_unswitch_run__c01_sequential_unit_stride.c\n");
