/*
 * LowBit -- 0140_grid_b03_alternating__c40_causal_attention_triangular.c
 * Branch: alternating | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0140_grid_b03_alternating__c40_causal_attention_triangular.c\n");
