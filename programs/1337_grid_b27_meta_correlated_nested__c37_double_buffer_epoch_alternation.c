/*
 * LowBit -- 1337_grid_b27_meta_correlated_nested__c37_double_buffer_epoch_alternation.c
 * Branch: meta_correlated_nested | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1337_grid_b27_meta_correlated_nested__c37_double_buffer_epoch_alternation.c\n");
