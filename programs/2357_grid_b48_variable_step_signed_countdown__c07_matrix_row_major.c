/*
 * LowBit -- 2357_grid_b48_variable_step_signed_countdown__c07_matrix_row_major.c
 * Branch: variable_step_signed_countdown | Cache: matrix_row_major
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2357_grid_b48_variable_step_signed_countdown__c07_matrix_row_major.c\n");
