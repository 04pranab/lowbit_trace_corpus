/*
 * LowBit -- 0023_grid_b01_always_taken__c23_struct_of_array_field_burst.c
 * Branch: always_taken | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0023_grid_b01_always_taken__c23_struct_of_array_field_burst.c\n");
