/*
 * LowBit -- 0644_grid_b13_single_phase_change__c44_naive_gemm_row_col_alternation.c
 * Branch: single_phase_change | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0644_grid_b13_single_phase_change__c44_naive_gemm_row_col_alternation.c\n");
