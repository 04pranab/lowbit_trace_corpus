/*
 * LowBit -- 0863_grid_b18_indirect_fn_dispatch__c13_two_stream_interleaved.c
 * Branch: indirect_fn_dispatch | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0863_grid_b18_indirect_fn_dispatch__c13_two_stream_interleaved.c\n");
