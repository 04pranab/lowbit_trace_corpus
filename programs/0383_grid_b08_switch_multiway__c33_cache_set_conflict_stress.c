/*
 * LowBit -- 0383_grid_b08_switch_multiway__c33_cache_set_conflict_stress.c
 * Branch: switch_multiway | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0383_grid_b08_switch_multiway__c33_cache_set_conflict_stress.c\n");
