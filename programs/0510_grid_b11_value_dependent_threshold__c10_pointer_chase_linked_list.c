/*
 * LowBit -- 0510_grid_b11_value_dependent_threshold__c10_pointer_chase_linked_list.c
 * Branch: value_dependent_threshold | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0510_grid_b11_value_dependent_threshold__c10_pointer_chase_linked_list.c\n");
