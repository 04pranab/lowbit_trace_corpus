/*
 * LowBit -- 0844_grid_b17_correlated_two_branch_xor__c44_naive_gemm_row_col_alternation.c
 * Branch: correlated_two_branch_xor | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0844_grid_b17_correlated_two_branch_xor__c44_naive_gemm_row_col_alternation.c\n");
