/*
 * LowBit -- 2226_grid_b45_two_counters_race__c26_geometric_stride_growth.c
 * Branch: two_counters_race | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2226_grid_b45_two_counters_race__c26_geometric_stride_growth.c\n");
