/*
 * LowBit -- 1567_grid_b32_emulated_2bit_saturating_counter__c17_zipf_like_hot_buckets.c
 * Branch: emulated_2bit_saturating_counter | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1567_grid_b32_emulated_2bit_saturating_counter__c17_zipf_like_hot_buckets.c\n");
