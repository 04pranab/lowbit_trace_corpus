/*
 * LowBit -- 1717_grid_b35_xorshift_hash_mix__c17_zipf_like_hot_buckets.c
 * Branch: xorshift_hash_mix | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1717_grid_b35_xorshift_hash_mix__c17_zipf_like_hot_buckets.c\n");
