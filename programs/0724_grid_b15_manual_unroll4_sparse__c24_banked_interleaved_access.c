/*
 * LowBit -- 0724_grid_b15_manual_unroll4_sparse__c24_banked_interleaved_access.c
 * Branch: manual_unroll4_sparse | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0724_grid_b15_manual_unroll4_sparse__c24_banked_interleaved_access.c\n");
