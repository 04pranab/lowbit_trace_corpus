/*
 * LowBit -- 1795_grid_b36_traffic_light_fsm__c45_read_hot_write_cold_split.c
 * Branch: traffic_light_fsm | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1795_grid_b36_traffic_light_fsm__c45_read_hot_write_cold_split.c\n");
