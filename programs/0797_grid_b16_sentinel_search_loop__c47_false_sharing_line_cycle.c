/*
 * LowBit -- 0797_grid_b16_sentinel_search_loop__c47_false_sharing_line_cycle.c
 * Branch: sentinel_search_loop | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0797_grid_b16_sentinel_search_loop__c47_false_sharing_line_cycle.c\n");
