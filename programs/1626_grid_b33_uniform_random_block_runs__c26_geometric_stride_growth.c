/*
 * LowBit -- 1626_grid_b33_uniform_random_block_runs__c26_geometric_stride_growth.c
 * Branch: uniform_random_block_runs | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1626_grid_b33_uniform_random_block_runs__c26_geometric_stride_growth.c\n");
