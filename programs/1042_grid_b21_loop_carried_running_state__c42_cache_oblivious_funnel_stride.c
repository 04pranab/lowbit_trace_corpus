/*
 * LowBit -- 1042_grid_b21_loop_carried_running_state__c42_cache_oblivious_funnel_stride.c
 * Branch: loop_carried_running_state | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=1042_grid_b21_loop_carried_running_state__c42_cache_oblivious_funnel_stride.c\n");
