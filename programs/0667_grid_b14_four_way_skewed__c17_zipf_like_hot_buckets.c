/*
 * LowBit -- 0667_grid_b14_four_way_skewed__c17_zipf_like_hot_buckets.c
 * Branch: four_way_skewed | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0667_grid_b14_four_way_skewed__c17_zipf_like_hot_buckets.c\n");
