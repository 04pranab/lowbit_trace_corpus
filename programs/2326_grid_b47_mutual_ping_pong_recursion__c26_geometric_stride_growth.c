/*
 * LowBit -- 2326_grid_b47_mutual_ping_pong_recursion__c26_geometric_stride_growth.c
 * Branch: mutual_ping_pong_recursion | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2326_grid_b47_mutual_ping_pong_recursion__c26_geometric_stride_growth.c\n");
