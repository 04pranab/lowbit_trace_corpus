/*
 * LowBit -- 1195_grid_b24_monotonic_drift_saturating__c45_read_hot_write_cold_split.c
 * Branch: monotonic_drift_saturating | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1195_grid_b24_monotonic_drift_saturating__c45_read_hot_write_cold_split.c\n");
