/*
 * LowBit -- 1937_grid_b39_dual_lcg_xor_chaos__c37_double_buffer_epoch_alternation.c
 * Branch: dual_lcg_xor_chaos | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1937_grid_b39_dual_lcg_xor_chaos__c37_double_buffer_epoch_alternation.c\n");
