/*
 * LowBit -- 0422_grid_b09_recursive_calls__c22_tensor_3d_slice_poor_locality.c
 * Branch: recursive_calls | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0422_grid_b09_recursive_calls__c22_tensor_3d_slice_poor_locality.c\n");
