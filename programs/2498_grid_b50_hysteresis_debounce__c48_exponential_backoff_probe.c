/*
 * LowBit -- 2498_grid_b50_hysteresis_debounce__c48_exponential_backoff_probe.c
 * Branch: hysteresis_debounce | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2498_grid_b50_hysteresis_debounce__c48_exponential_backoff_probe.c\n");
