/*
 * LowBit -- 0527_grid_b11_value_dependent_threshold__c27_reduction_broadcast_pattern.c
 * Branch: value_dependent_threshold | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0527_grid_b11_value_dependent_threshold__c27_reduction_broadcast_pattern.c\n");
