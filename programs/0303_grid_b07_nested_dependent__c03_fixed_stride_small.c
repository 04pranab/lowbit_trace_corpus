/*
 * LowBit -- 0303_grid_b07_nested_dependent__c03_fixed_stride_small.c
 * Branch: nested_dependent | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0303_grid_b07_nested_dependent__c03_fixed_stride_small.c\n");
