/*
 * LowBit -- 1034_grid_b21_loop_carried_running_state__c34_variable_length_burst_reuse.c
 * Branch: loop_carried_running_state | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=1034_grid_b21_loop_carried_running_state__c34_variable_length_burst_reuse.c\n");
