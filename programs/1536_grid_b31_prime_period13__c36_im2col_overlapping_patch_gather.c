/*
 * LowBit -- 1536_grid_b31_prime_period13__c36_im2col_overlapping_patch_gather.c
 * Branch: prime_period13 | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=1536_grid_b31_prime_period13__c36_im2col_overlapping_patch_gather.c\n");
