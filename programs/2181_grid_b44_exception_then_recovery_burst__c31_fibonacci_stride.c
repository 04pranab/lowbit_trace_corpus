/*
 * LowBit -- 2181_grid_b44_exception_then_recovery_burst__c31_fibonacci_stride.c
 * Branch: exception_then_recovery_burst | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2181_grid_b44_exception_then_recovery_burst__c31_fibonacci_stride.c\n");
