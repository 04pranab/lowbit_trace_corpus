/*
 * LowBit -- 0076_grid_b02_always_not_taken__c26_geometric_stride_growth.c
 * Branch: always_not_taken | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0076_grid_b02_always_not_taken__c26_geometric_stride_growth.c\n");
