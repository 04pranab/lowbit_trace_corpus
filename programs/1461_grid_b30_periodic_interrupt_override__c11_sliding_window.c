/*
 * LowBit -- 1461_grid_b30_periodic_interrupt_override__c11_sliding_window.c
 * Branch: periodic_interrupt_override | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=1461_grid_b30_periodic_interrupt_override__c11_sliding_window.c\n");
