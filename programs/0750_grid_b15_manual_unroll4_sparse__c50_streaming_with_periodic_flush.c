/*
 * LowBit -- 0750_grid_b15_manual_unroll4_sparse__c50_streaming_with_periodic_flush.c
 * Branch: manual_unroll4_sparse | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0750_grid_b15_manual_unroll4_sparse__c50_streaming_with_periodic_flush.c\n");
