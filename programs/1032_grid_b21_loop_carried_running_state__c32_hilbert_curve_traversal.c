/*
 * LowBit -- 1032_grid_b21_loop_carried_running_state__c32_hilbert_curve_traversal.c
 * Branch: loop_carried_running_state | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=1032_grid_b21_loop_carried_running_state__c32_hilbert_curve_traversal.c\n");
