/*
 * LowBit -- 1559_grid_b32_emulated_2bit_saturating_counter__c09_matrix_tiled_blocked.c
 * Branch: emulated_2bit_saturating_counter | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1559_grid_b32_emulated_2bit_saturating_counter__c09_matrix_tiled_blocked.c\n");
