/*
 * LowBit -- 1946_grid_b39_dual_lcg_xor_chaos__c46_cantor_gap_sparse.c
 * Branch: dual_lcg_xor_chaos | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1946_grid_b39_dual_lcg_xor_chaos__c46_cantor_gap_sparse.c\n");
