/*
 * LowBit -- 1888_grid_b38_decaying_hazard_probability__c38_cuckoo_double_hash_probe.c
 * Branch: decaying_hazard_probability | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1888_grid_b38_decaying_hazard_probability__c38_cuckoo_double_hash_probe.c\n");
