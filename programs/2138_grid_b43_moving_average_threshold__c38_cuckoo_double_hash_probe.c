/*
 * LowBit -- 2138_grid_b43_moving_average_threshold__c38_cuckoo_double_hash_probe.c
 * Branch: moving_average_threshold | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2138_grid_b43_moving_average_threshold__c38_cuckoo_double_hash_probe.c\n");
