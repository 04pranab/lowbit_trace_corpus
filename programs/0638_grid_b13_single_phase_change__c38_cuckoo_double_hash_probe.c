/*
 * LowBit -- 0638_grid_b13_single_phase_change__c38_cuckoo_double_hash_probe.c
 * Branch: single_phase_change | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0638_grid_b13_single_phase_change__c38_cuckoo_double_hash_probe.c\n");
