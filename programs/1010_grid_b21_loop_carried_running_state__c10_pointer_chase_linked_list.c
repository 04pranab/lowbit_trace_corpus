/*
 * LowBit -- 1010_grid_b21_loop_carried_running_state__c10_pointer_chase_linked_list.c
 * Branch: loop_carried_running_state | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=1010_grid_b21_loop_carried_running_state__c10_pointer_chase_linked_list.c\n");
