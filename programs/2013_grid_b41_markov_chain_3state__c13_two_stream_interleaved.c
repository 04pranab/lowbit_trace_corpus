/*
 * LowBit -- 2013_grid_b41_markov_chain_3state__c13_two_stream_interleaved.c
 * Branch: markov_chain_3state | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2013_grid_b41_markov_chain_3state__c13_two_stream_interleaved.c\n");
