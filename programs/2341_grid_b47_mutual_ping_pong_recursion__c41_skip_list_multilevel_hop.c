/*
 * LowBit -- 2341_grid_b47_mutual_ping_pong_recursion__c41_skip_list_multilevel_hop.c
 * Branch: mutual_ping_pong_recursion | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2341_grid_b47_mutual_ping_pong_recursion__c41_skip_list_multilevel_hop.c\n");
