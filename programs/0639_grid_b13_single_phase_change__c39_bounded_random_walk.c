/*
 * LowBit -- 0639_grid_b13_single_phase_change__c39_bounded_random_walk.c
 * Branch: single_phase_change | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0639_grid_b13_single_phase_change__c39_bounded_random_walk.c\n");
