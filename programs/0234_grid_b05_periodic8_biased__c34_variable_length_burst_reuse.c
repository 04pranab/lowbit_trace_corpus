/*
 * LowBit -- 0234_grid_b05_periodic8_biased__c34_variable_length_burst_reuse.c
 * Branch: periodic8_biased | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0234_grid_b05_periodic8_biased__c34_variable_length_burst_reuse.c\n");
