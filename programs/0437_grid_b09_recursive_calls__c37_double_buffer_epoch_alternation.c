/*
 * LowBit -- 0437_grid_b09_recursive_calls__c37_double_buffer_epoch_alternation.c
 * Branch: recursive_calls | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0437_grid_b09_recursive_calls__c37_double_buffer_epoch_alternation.c\n");
