/*
 * LowBit -- 2206_grid_b45_two_counters_race__c06_random_full_working_set.c
 * Branch: two_counters_race | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2206_grid_b45_two_counters_race__c06_random_full_working_set.c\n");
