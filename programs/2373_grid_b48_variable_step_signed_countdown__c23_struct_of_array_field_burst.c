/*
 * LowBit -- 2373_grid_b48_variable_step_signed_countdown__c23_struct_of_array_field_burst.c
 * Branch: variable_step_signed_countdown | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2373_grid_b48_variable_step_signed_countdown__c23_struct_of_array_field_burst.c\n");
