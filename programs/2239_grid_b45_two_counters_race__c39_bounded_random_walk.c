/*
 * LowBit -- 2239_grid_b45_two_counters_race__c39_bounded_random_walk.c
 * Branch: two_counters_race | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2239_grid_b45_two_counters_race__c39_bounded_random_walk.c\n");
