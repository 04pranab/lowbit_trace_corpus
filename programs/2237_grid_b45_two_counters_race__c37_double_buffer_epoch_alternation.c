/*
 * LowBit -- 2237_grid_b45_two_counters_race__c37_double_buffer_epoch_alternation.c
 * Branch: two_counters_race | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2237_grid_b45_two_counters_race__c37_double_buffer_epoch_alternation.c\n");
