/*
 * LowBit -- 0624_grid_b13_single_phase_change__c24_banked_interleaved_access.c
 * Branch: single_phase_change | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0624_grid_b13_single_phase_change__c24_banked_interleaved_access.c\n");
