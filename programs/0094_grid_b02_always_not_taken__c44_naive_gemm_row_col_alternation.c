/*
 * LowBit -- 0094_grid_b02_always_not_taken__c44_naive_gemm_row_col_alternation.c
 * Branch: always_not_taken | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0094_grid_b02_always_not_taken__c44_naive_gemm_row_col_alternation.c\n");
