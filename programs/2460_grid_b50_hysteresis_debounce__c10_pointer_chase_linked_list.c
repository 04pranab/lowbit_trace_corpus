/*
 * LowBit -- 2460_grid_b50_hysteresis_debounce__c10_pointer_chase_linked_list.c
 * Branch: hysteresis_debounce | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2460_grid_b50_hysteresis_debounce__c10_pointer_chase_linked_list.c\n");
