/*
 * LowBit -- 1298_grid_b26_warmup_then_steady__c48_exponential_backoff_probe.c
 * Branch: warmup_then_steady | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1298_grid_b26_warmup_then_steady__c48_exponential_backoff_probe.c\n");
