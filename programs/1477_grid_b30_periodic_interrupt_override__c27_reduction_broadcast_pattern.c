/*
 * LowBit -- 1477_grid_b30_periodic_interrupt_override__c27_reduction_broadcast_pattern.c
 * Branch: periodic_interrupt_override | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=1477_grid_b30_periodic_interrupt_override__c27_reduction_broadcast_pattern.c\n");
