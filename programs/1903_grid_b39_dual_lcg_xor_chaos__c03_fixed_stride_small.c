/*
 * LowBit -- 1903_grid_b39_dual_lcg_xor_chaos__c03_fixed_stride_small.c
 * Branch: dual_lcg_xor_chaos | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1903_grid_b39_dual_lcg_xor_chaos__c03_fixed_stride_small.c\n");
