/*
 * LowBit -- 2383_grid_b48_variable_step_signed_countdown__c33_cache_set_conflict_stress.c
 * Branch: variable_step_signed_countdown | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2383_grid_b48_variable_step_signed_countdown__c33_cache_set_conflict_stress.c\n");
