/*
 * LowBit -- 2571_base_cache_c21_pyramid_multiresolution_stride.c
 * Branch: synthetic_always_taken | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=2571_base_cache_c21_pyramid_multiresolution_stride.c\n");
