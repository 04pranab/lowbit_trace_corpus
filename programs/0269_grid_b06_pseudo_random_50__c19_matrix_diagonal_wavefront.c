/*
 * LowBit -- 0269_grid_b06_pseudo_random_50__c19_matrix_diagonal_wavefront.c
 * Branch: pseudo_random_50 | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        taken = (int)((lcg_next(bseed) >> 16) & 1u);
    ...
    printf("program=0269_grid_b06_pseudo_random_50__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=pseudo_random_50\n");
