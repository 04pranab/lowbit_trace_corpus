/*
 * LowBit -- 2506_base_branch_b06_pseudo_random_50.c
 * Branch: pseudo_random_50 | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2506_base_branch_b06_pseudo_random_50.c\n");
