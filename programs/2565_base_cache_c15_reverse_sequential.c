/*
 * LowBit -- 2565_base_cache_c15_reverse_sequential.c
 * Branch: synthetic_always_taken | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=2565_base_cache_c15_reverse_sequential.c\n");
