/*
 * LowBit -- 0242_grid_b05_periodic8_biased__c42_cache_oblivious_funnel_stride.c
 * Branch: periodic8_biased | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0242_grid_b05_periodic8_biased__c42_cache_oblivious_funnel_stride.c\n");
