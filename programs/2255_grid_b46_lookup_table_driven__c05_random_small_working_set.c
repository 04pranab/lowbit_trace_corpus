/*
 * LowBit -- 2255_grid_b46_lookup_table_driven__c05_random_small_working_set.c
 * Branch: lookup_table_driven | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2255_grid_b46_lookup_table_driven__c05_random_small_working_set.c\n");
