/*
 * LowBit -- 0635_grid_b13_single_phase_change__c35_checkerboard_red_black.c
 * Branch: single_phase_change | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0635_grid_b13_single_phase_change__c35_checkerboard_red_black.c\n");
