/*
 * LowBit -- 1288_grid_b26_warmup_then_steady__c38_cuckoo_double_hash_probe.c
 * Branch: warmup_then_steady | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1288_grid_b26_warmup_then_steady__c38_cuckoo_double_hash_probe.c\n");
