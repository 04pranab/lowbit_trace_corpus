/*
 * LowBit -- 1068_grid_b22_drifting_threshold_periodic_reset__c18_producer_consumer_two_pointer.c
 * Branch: drifting_threshold_periodic_reset | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1068_grid_b22_drifting_threshold_periodic_reset__c18_producer_consumer_two_pointer.c\n");
