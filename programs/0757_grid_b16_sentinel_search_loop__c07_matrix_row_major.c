/*
 * LowBit -- 0757_grid_b16_sentinel_search_loop__c07_matrix_row_major.c
 * Branch: sentinel_search_loop | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0757_grid_b16_sentinel_search_loop__c07_matrix_row_major.c\n");
