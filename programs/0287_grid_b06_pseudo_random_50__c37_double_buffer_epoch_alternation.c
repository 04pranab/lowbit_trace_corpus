/*
 * LowBit -- 0287_grid_b06_pseudo_random_50__c37_double_buffer_epoch_alternation.c
 * Branch: pseudo_random_50 | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0287_grid_b06_pseudo_random_50__c37_double_buffer_epoch_alternation.c\n");
