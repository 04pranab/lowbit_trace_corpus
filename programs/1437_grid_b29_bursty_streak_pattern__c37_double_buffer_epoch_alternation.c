/*
 * LowBit -- 1437_grid_b29_bursty_streak_pattern__c37_double_buffer_epoch_alternation.c
 * Branch: bursty_streak_pattern | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1437_grid_b29_bursty_streak_pattern__c37_double_buffer_epoch_alternation.c\n");
