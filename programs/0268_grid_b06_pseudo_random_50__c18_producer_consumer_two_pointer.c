/*
 * LowBit -- 0268_grid_b06_pseudo_random_50__c18_producer_consumer_two_pointer.c
 * Branch: pseudo_random_50 | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0268_grid_b06_pseudo_random_50__c18_producer_consumer_two_pointer.c\n");
