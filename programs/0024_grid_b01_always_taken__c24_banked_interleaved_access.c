/*
 * LowBit -- 0024_grid_b01_always_taken__c24_banked_interleaved_access.c
 * Branch: always_taken | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0024_grid_b01_always_taken__c24_banked_interleaved_access.c\n");
