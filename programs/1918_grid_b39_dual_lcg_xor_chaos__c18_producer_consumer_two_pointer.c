/*
 * LowBit -- 1918_grid_b39_dual_lcg_xor_chaos__c18_producer_consumer_two_pointer.c
 * Branch: dual_lcg_xor_chaos | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1918_grid_b39_dual_lcg_xor_chaos__c18_producer_consumer_two_pointer.c\n");
