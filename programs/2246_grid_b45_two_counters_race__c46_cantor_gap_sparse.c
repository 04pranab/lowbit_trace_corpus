/*
 * LowBit -- 2246_grid_b45_two_counters_race__c46_cantor_gap_sparse.c
 * Branch: two_counters_race | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2246_grid_b45_two_counters_race__c46_cantor_gap_sparse.c\n");
