/*
 * LowBit -- 0014_grid_b01_always_taken__c14_temporal_burst_reuse.c
 * Branch: always_taken | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0014_grid_b01_always_taken__c14_temporal_burst_reuse.c\n");
