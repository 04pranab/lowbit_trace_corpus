/*
 * LowBit -- 2156_grid_b44_exception_then_recovery_burst__c06_random_full_working_set.c
 * Branch: exception_then_recovery_burst | Cache: random_full_working_set
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2156_grid_b44_exception_then_recovery_burst__c06_random_full_working_set.c\n");
