/*
 * LowBit -- 1911_grid_b39_dual_lcg_xor_chaos__c11_sliding_window.c
 * Branch: dual_lcg_xor_chaos | Cache: sliding_window
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1911_grid_b39_dual_lcg_xor_chaos__c11_sliding_window.c\n");
