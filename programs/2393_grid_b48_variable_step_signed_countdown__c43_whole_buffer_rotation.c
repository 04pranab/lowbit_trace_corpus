/*
 * LowBit -- 2393_grid_b48_variable_step_signed_countdown__c43_whole_buffer_rotation.c
 * Branch: variable_step_signed_countdown | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2393_grid_b48_variable_step_signed_countdown__c43_whole_buffer_rotation.c\n");
