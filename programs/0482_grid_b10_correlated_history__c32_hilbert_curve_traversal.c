/*
 * LowBit -- 0482_grid_b10_correlated_history__c32_hilbert_curve_traversal.c
 * Branch: correlated_history | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0482_grid_b10_correlated_history__c32_hilbert_curve_traversal.c\n");
