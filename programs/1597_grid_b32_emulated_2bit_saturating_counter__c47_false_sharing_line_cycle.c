/*
 * LowBit -- 1597_grid_b32_emulated_2bit_saturating_counter__c47_false_sharing_line_cycle.c
 * Branch: emulated_2bit_saturating_counter | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1597_grid_b32_emulated_2bit_saturating_counter__c47_false_sharing_line_cycle.c\n");
