/*
 * LowBit -- 1381_grid_b28_data_driven_stack_machine__c31_fibonacci_stride.c
 * Branch: data_driven_stack_machine | Cache: fibonacci_stride
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1381_grid_b28_data_driven_stack_machine__c31_fibonacci_stride.c\n");
