/*
 * LowBit -- 1550_grid_b31_prime_period13__c50_streaming_with_periodic_flush.c
 * Branch: prime_period13 | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=1550_grid_b31_prime_period13__c50_streaming_with_periodic_flush.c\n");
