/*
 * LowBit -- 1718_grid_b35_xorshift_hash_mix__c18_producer_consumer_two_pointer.c
 * Branch: xorshift_hash_mix | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1718_grid_b35_xorshift_hash_mix__c18_producer_consumer_two_pointer.c\n");
