/*
 * LowBit -- 2212_grid_b45_two_counters_race__c12_prime_stride_anti_alias.c
 * Branch: two_counters_race | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2212_grid_b45_two_counters_race__c12_prime_stride_anti_alias.c\n");
