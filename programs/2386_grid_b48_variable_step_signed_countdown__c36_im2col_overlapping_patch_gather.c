/*
 * LowBit -- 2386_grid_b48_variable_step_signed_countdown__c36_im2col_overlapping_patch_gather.c
 * Branch: variable_step_signed_countdown | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2386_grid_b48_variable_step_signed_countdown__c36_im2col_overlapping_patch_gather.c\n");
