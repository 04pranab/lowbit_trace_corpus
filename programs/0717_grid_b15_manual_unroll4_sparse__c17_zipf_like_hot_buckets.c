/*
 * LowBit -- 0717_grid_b15_manual_unroll4_sparse__c17_zipf_like_hot_buckets.c
 * Branch: manual_unroll4_sparse | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0717_grid_b15_manual_unroll4_sparse__c17_zipf_like_hot_buckets.c\n");
