/*
 * LowBit -- 0301_grid_b07_nested_dependent__c01_sequential_unit_stride.c
 * Branch: nested_dependent | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0301_grid_b07_nested_dependent__c01_sequential_unit_stride.c\n");
