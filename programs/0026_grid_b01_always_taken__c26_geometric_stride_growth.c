/*
 * LowBit -- 0026_grid_b01_always_taken__c26_geometric_stride_growth.c
 * Branch: always_taken | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0026_grid_b01_always_taken__c26_geometric_stride_growth.c\n");
