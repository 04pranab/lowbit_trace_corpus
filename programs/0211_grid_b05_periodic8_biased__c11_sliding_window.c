/*
 * LowBit -- 0211_grid_b05_periodic8_biased__c11_sliding_window.c
 * Branch: periodic8_biased | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0211_grid_b05_periodic8_biased__c11_sliding_window.c\n");
