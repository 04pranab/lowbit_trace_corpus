/*
 * LowBit -- 0892_grid_b18_indirect_fn_dispatch__c42_cache_oblivious_funnel_stride.c
 * Branch: indirect_fn_dispatch | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0892_grid_b18_indirect_fn_dispatch__c42_cache_oblivious_funnel_stride.c\n");
