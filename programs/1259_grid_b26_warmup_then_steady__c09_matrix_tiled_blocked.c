/*
 * LowBit -- 1259_grid_b26_warmup_then_steady__c09_matrix_tiled_blocked.c
 * Branch: warmup_then_steady | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1259_grid_b26_warmup_then_steady__c09_matrix_tiled_blocked.c\n");
