/*
 * LowBit -- 0781_grid_b16_sentinel_search_loop__c31_fibonacci_stride.c
 * Branch: sentinel_search_loop | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0781_grid_b16_sentinel_search_loop__c31_fibonacci_stride.c\n");
