/*
 * LowBit -- 2557_base_cache_c07_matrix_row_major.c
 * Branch: synthetic_always_taken | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=2557_base_cache_c07_matrix_row_major.c\n");
