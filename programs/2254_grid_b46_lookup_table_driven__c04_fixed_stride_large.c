/*
 * LowBit -- 2254_grid_b46_lookup_table_driven__c04_fixed_stride_large.c
 * Branch: lookup_table_driven | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2254_grid_b46_lookup_table_driven__c04_fixed_stride_large.c\n");
