/*
 * LowBit -- 0072_grid_b02_always_not_taken__c22_tensor_3d_slice_poor_locality.c
 * Branch: always_not_taken | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0072_grid_b02_always_not_taken__c22_tensor_3d_slice_poor_locality.c\n");
