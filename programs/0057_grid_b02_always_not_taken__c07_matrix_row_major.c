/*
 * LowBit -- 0057_grid_b02_always_not_taken__c07_matrix_row_major.c
 * Branch: always_not_taken | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0057_grid_b02_always_not_taken__c07_matrix_row_major.c\n");
