/*
 * LowBit -- 1216_grid_b25_rare_exception_1_in_1024__c16_block_sparse.c
 * Branch: rare_exception_1_in_1024 | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=1216_grid_b25_rare_exception_1_in_1024__c16_block_sparse.c\n");
