/*
 * LowBit -- 0320_grid_b07_nested_dependent__c20_hot_cold_phase_alternation.c
 * Branch: nested_dependent | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0320_grid_b07_nested_dependent__c20_hot_cold_phase_alternation.c\n");
