/*
 * LowBit -- 1051_grid_b22_drifting_threshold_periodic_reset__c01_sequential_unit_stride.c
 * Branch: drifting_threshold_periodic_reset | Cache: sequential_unit_stride
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1051_grid_b22_drifting_threshold_periodic_reset__c01_sequential_unit_stride.c\n");
