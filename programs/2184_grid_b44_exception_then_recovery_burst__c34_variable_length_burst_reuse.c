/*
 * LowBit -- 2184_grid_b44_exception_then_recovery_burst__c34_variable_length_burst_reuse.c
 * Branch: exception_then_recovery_burst | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2184_grid_b44_exception_then_recovery_burst__c34_variable_length_burst_reuse.c\n");
