/*
 * LowBit -- 0514_grid_b11_value_dependent_threshold__c14_temporal_burst_reuse.c
 * Branch: value_dependent_threshold | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0514_grid_b11_value_dependent_threshold__c14_temporal_burst_reuse.c\n");
