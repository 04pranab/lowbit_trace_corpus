/*
 * LowBit -- 0138_grid_b03_alternating__c38_cuckoo_double_hash_probe.c
 * Branch: alternating | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0138_grid_b03_alternating__c38_cuckoo_double_hash_probe.c\n");
