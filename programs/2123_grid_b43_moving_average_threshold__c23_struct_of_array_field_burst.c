/*
 * LowBit -- 2123_grid_b43_moving_average_threshold__c23_struct_of_array_field_burst.c
 * Branch: moving_average_threshold | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2123_grid_b43_moving_average_threshold__c23_struct_of_array_field_burst.c\n");
