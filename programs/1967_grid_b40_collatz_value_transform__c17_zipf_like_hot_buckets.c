/*
 * LowBit -- 1967_grid_b40_collatz_value_transform__c17_zipf_like_hot_buckets.c
 * Branch: collatz_value_transform | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1967_grid_b40_collatz_value_transform__c17_zipf_like_hot_buckets.c\n");
