/*
 * LowBit -- 0468_grid_b10_correlated_history__c18_producer_consumer_two_pointer.c
 * Branch: correlated_history | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0468_grid_b10_correlated_history__c18_producer_consumer_two_pointer.c\n");
