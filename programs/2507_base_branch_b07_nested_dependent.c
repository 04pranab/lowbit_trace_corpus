/*
 * LowBit -- 2507_base_branch_b07_nested_dependent.c
 * Branch: nested_dependent | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=2507_base_branch_b07_nested_dependent.c\n");
