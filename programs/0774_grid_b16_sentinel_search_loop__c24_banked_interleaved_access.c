/*
 * LowBit -- 0774_grid_b16_sentinel_search_loop__c24_banked_interleaved_access.c
 * Branch: sentinel_search_loop | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0774_grid_b16_sentinel_search_loop__c24_banked_interleaved_access.c\n");
