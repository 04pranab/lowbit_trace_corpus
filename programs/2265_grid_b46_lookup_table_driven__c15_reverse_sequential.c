/*
 * LowBit -- 2265_grid_b46_lookup_table_driven__c15_reverse_sequential.c
 * Branch: lookup_table_driven | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2265_grid_b46_lookup_table_driven__c15_reverse_sequential.c\n");
