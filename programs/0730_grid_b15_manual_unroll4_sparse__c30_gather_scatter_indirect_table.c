/*
 * LowBit -- 0730_grid_b15_manual_unroll4_sparse__c30_gather_scatter_indirect_table.c
 * Branch: manual_unroll4_sparse | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=0730_grid_b15_manual_unroll4_sparse__c30_gather_scatter_indirect_table.c\n");
