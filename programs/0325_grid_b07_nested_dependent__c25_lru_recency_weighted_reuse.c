/*
 * LowBit -- 0325_grid_b07_nested_dependent__c25_lru_recency_weighted_reuse.c
 * Branch: nested_dependent | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0325_grid_b07_nested_dependent__c25_lru_recency_weighted_reuse.c\n");
