/*
 * LowBit -- 1335_grid_b27_meta_correlated_nested__c35_checkerboard_red_black.c
 * Branch: meta_correlated_nested | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1335_grid_b27_meta_correlated_nested__c35_checkerboard_red_black.c\n");
