/*
 * LowBit -- 0796_grid_b16_sentinel_search_loop__c46_cantor_gap_sparse.c
 * Branch: sentinel_search_loop | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0796_grid_b16_sentinel_search_loop__c46_cantor_gap_sparse.c\n");
