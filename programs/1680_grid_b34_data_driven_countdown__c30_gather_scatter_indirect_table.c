/*
 * LowBit -- 1680_grid_b34_data_driven_countdown__c30_gather_scatter_indirect_table.c
 * Branch: data_driven_countdown | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1680_grid_b34_data_driven_countdown__c30_gather_scatter_indirect_table.c\n");
