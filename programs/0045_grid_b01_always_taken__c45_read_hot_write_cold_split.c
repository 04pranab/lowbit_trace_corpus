/*
 * LowBit -- 0045_grid_b01_always_taken__c45_read_hot_write_cold_split.c
 * Branch: always_taken | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0045_grid_b01_always_taken__c45_read_hot_write_cold_split.c\n");
