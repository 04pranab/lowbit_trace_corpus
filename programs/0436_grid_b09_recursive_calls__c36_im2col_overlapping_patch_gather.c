/*
 * LowBit -- 0436_grid_b09_recursive_calls__c36_im2col_overlapping_patch_gather.c
 * Branch: recursive_calls | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0436_grid_b09_recursive_calls__c36_im2col_overlapping_patch_gather.c\n");
