/*
 * LowBit -- 1317_grid_b27_meta_correlated_nested__c17_zipf_like_hot_buckets.c
 * Branch: meta_correlated_nested | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1317_grid_b27_meta_correlated_nested__c17_zipf_like_hot_buckets.c\n");
