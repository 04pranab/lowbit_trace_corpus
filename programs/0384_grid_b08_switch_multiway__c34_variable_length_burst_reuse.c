/*
 * LowBit -- 0384_grid_b08_switch_multiway__c34_variable_length_burst_reuse.c
 * Branch: switch_multiway | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0384_grid_b08_switch_multiway__c34_variable_length_burst_reuse.c\n");
