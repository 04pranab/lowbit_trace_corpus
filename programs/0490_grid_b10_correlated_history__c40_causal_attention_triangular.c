/*
 * LowBit -- 0490_grid_b10_correlated_history__c40_causal_attention_triangular.c
 * Branch: correlated_history | Cache: causal_attention_triangular
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0490_grid_b10_correlated_history__c40_causal_attention_triangular.c\n");
