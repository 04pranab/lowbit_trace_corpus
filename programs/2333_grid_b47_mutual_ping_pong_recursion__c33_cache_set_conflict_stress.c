/*
 * LowBit -- 2333_grid_b47_mutual_ping_pong_recursion__c33_cache_set_conflict_stress.c
 * Branch: mutual_ping_pong_recursion | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2333_grid_b47_mutual_ping_pong_recursion__c33_cache_set_conflict_stress.c\n");
