/*
 * LowBit -- 2185_grid_b44_exception_then_recovery_burst__c35_checkerboard_red_black.c
 * Branch: exception_then_recovery_burst | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2185_grid_b44_exception_then_recovery_burst__c35_checkerboard_red_black.c\n");
