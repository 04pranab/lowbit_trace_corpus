/*
 * LowBit -- 1563_grid_b32_emulated_2bit_saturating_counter__c13_two_stream_interleaved.c
 * Branch: emulated_2bit_saturating_counter | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1563_grid_b32_emulated_2bit_saturating_counter__c13_two_stream_interleaved.c\n");
