/*
 * LowBit -- 1470_grid_b30_periodic_interrupt_override__c20_hot_cold_phase_alternation.c
 * Branch: periodic_interrupt_override | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=1470_grid_b30_periodic_interrupt_override__c20_hot_cold_phase_alternation.c\n");
