/*
 * LowBit -- 0583_grid_b12_doubling_run_lengths__c33_cache_set_conflict_stress.c
 * Branch: doubling_run_lengths | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0583_grid_b12_doubling_run_lengths__c33_cache_set_conflict_stress.c\n");
