/*
 * LowBit -- 1280_grid_b26_warmup_then_steady__c30_gather_scatter_indirect_table.c
 * Branch: warmup_then_steady | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1280_grid_b26_warmup_then_steady__c30_gather_scatter_indirect_table.c\n");
