/*
 * LowBit -- 1069_grid_b22_drifting_threshold_periodic_reset__c19_matrix_diagonal_wavefront.c
 * Branch: drifting_threshold_periodic_reset | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1069_grid_b22_drifting_threshold_periodic_reset__c19_matrix_diagonal_wavefront.c\n");
