/*
 * LowBit -- 1123_grid_b23_popcount_parity__c23_struct_of_array_field_burst.c
 * Branch: popcount_parity | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1123_grid_b23_popcount_parity__c23_struct_of_array_field_burst.c\n");
