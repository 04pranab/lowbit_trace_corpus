/*
 * LowBit -- 0561_grid_b12_doubling_run_lengths__c11_sliding_window.c
 * Branch: doubling_run_lengths | Cache: sliding_window
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0561_grid_b12_doubling_run_lengths__c11_sliding_window.c\n");
