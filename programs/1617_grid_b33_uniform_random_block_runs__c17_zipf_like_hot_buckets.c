/*
 * LowBit -- 1617_grid_b33_uniform_random_block_runs__c17_zipf_like_hot_buckets.c
 * Branch: uniform_random_block_runs | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1617_grid_b33_uniform_random_block_runs__c17_zipf_like_hot_buckets.c\n");
