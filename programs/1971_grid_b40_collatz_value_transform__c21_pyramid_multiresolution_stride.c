/*
 * LowBit -- 1971_grid_b40_collatz_value_transform__c21_pyramid_multiresolution_stride.c
 * Branch: collatz_value_transform | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1971_grid_b40_collatz_value_transform__c21_pyramid_multiresolution_stride.c\n");
