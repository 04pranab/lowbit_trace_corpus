/*
 * LowBit -- 1421_grid_b29_bursty_streak_pattern__c21_pyramid_multiresolution_stride.c
 * Branch: bursty_streak_pattern | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1421_grid_b29_bursty_streak_pattern__c21_pyramid_multiresolution_stride.c\n");
