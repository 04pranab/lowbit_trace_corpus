/*
 * LowBit -- 1934_grid_b39_dual_lcg_xor_chaos__c34_variable_length_burst_reuse.c
 * Branch: dual_lcg_xor_chaos | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1934_grid_b39_dual_lcg_xor_chaos__c34_variable_length_burst_reuse.c\n");
