/*
 * LowBit -- 2317_grid_b47_mutual_ping_pong_recursion__c17_zipf_like_hot_buckets.c
 * Branch: mutual_ping_pong_recursion | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2317_grid_b47_mutual_ping_pong_recursion__c17_zipf_like_hot_buckets.c\n");
