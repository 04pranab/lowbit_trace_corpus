/*
 * LowBit -- 1874_grid_b38_decaying_hazard_probability__c24_banked_interleaved_access.c
 * Branch: decaying_hazard_probability | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1874_grid_b38_decaying_hazard_probability__c24_banked_interleaved_access.c\n");
