/*
 * LowBit -- 0850_grid_b17_correlated_two_branch_xor__c50_streaming_with_periodic_flush.c
 * Branch: correlated_two_branch_xor | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0850_grid_b17_correlated_two_branch_xor__c50_streaming_with_periodic_flush.c\n");
