/*
 * LowBit -- 1411_grid_b29_bursty_streak_pattern__c11_sliding_window.c
 * Branch: bursty_streak_pattern | Cache: sliding_window
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1411_grid_b29_bursty_streak_pattern__c11_sliding_window.c\n");
