/*
 * LowBit -- 0083_grid_b02_always_not_taken__c33_cache_set_conflict_stress.c
 * Branch: always_not_taken | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0083_grid_b02_always_not_taken__c33_cache_set_conflict_stress.c\n");
