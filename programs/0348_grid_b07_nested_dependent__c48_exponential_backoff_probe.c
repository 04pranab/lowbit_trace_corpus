/*
 * LowBit -- 0348_grid_b07_nested_dependent__c48_exponential_backoff_probe.c
 * Branch: nested_dependent | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0348_grid_b07_nested_dependent__c48_exponential_backoff_probe.c\n");
