/*
 * LowBit -- 2285_grid_b46_lookup_table_driven__c35_checkerboard_red_black.c
 * Branch: lookup_table_driven | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2285_grid_b46_lookup_table_driven__c35_checkerboard_red_black.c\n");
