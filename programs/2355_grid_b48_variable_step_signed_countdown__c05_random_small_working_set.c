/*
 * LowBit -- 2355_grid_b48_variable_step_signed_countdown__c05_random_small_working_set.c
 * Branch: variable_step_signed_countdown | Cache: random_small_working_set
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2355_grid_b48_variable_step_signed_countdown__c05_random_small_working_set.c\n");
