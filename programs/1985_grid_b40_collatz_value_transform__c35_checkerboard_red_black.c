/*
 * LowBit -- 1985_grid_b40_collatz_value_transform__c35_checkerboard_red_black.c
 * Branch: collatz_value_transform | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1985_grid_b40_collatz_value_transform__c35_checkerboard_red_black.c\n");
