/*
 * LowBit -- 1314_grid_b27_meta_correlated_nested__c14_temporal_burst_reuse.c
 * Branch: meta_correlated_nested | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1314_grid_b27_meta_correlated_nested__c14_temporal_burst_reuse.c\n");
