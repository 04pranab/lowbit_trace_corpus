/*
 * LowBit -- 2445_grid_b49_interleaved_two_pattern_multiplex__c45_read_hot_write_cold_split.c
 * Branch: interleaved_two_pattern_multiplex | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=2445_grid_b49_interleaved_two_pattern_multiplex__c45_read_hot_write_cold_split.c\n");
