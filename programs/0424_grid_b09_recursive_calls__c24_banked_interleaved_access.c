/*
 * LowBit -- 0424_grid_b09_recursive_calls__c24_banked_interleaved_access.c
 * Branch: recursive_calls | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0424_grid_b09_recursive_calls__c24_banked_interleaved_access.c\n");
