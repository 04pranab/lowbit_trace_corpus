/*
 * LowBit -- 0167_grid_b04_periodic3__c17_zipf_like_hot_buckets.c
 * Branch: periodic3 | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0167_grid_b04_periodic3__c17_zipf_like_hot_buckets.c\n");
