/*
 * LowBit -- 0131_grid_b03_alternating__c31_fibonacci_stride.c
 * Branch: alternating | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0131_grid_b03_alternating__c31_fibonacci_stride.c\n");
