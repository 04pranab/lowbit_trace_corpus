/*
 * LowBit -- 2331_grid_b47_mutual_ping_pong_recursion__c31_fibonacci_stride.c
 * Branch: mutual_ping_pong_recursion | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2331_grid_b47_mutual_ping_pong_recursion__c31_fibonacci_stride.c\n");
