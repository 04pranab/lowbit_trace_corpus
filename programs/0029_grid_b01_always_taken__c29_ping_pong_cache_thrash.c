/*
 * LowBit -- 0029_grid_b01_always_taken__c29_ping_pong_cache_thrash.c
 * Branch: always_taken | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0029_grid_b01_always_taken__c29_ping_pong_cache_thrash.c\n");
