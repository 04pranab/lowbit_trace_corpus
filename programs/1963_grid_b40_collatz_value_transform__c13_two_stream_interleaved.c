/*
 * LowBit -- 1963_grid_b40_collatz_value_transform__c13_two_stream_interleaved.c
 * Branch: collatz_value_transform | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1963_grid_b40_collatz_value_transform__c13_two_stream_interleaved.c\n");
