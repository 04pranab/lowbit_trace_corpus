/*
 * LowBit -- 2537_base_branch_b37_value_driven_unswitch_run.c
 * Branch: value_driven_unswitch_run | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=2537_base_branch_b37_value_driven_unswitch_run.c\n");
