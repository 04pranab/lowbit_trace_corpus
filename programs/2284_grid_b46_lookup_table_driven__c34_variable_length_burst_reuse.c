/*
 * LowBit -- 2284_grid_b46_lookup_table_driven__c34_variable_length_burst_reuse.c
 * Branch: lookup_table_driven | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t cseed34_ = SEED0 ^ 0x34343434u; uint32_t base34_ = 0u; uint32_t burst_remaining34_ = 0u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ if (burst_remaining34_ == 0u) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2284_grid_b46_lookup_table_driven__c34_variable_length_burst_reuse.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=variable_length_burst_reuse\n");
