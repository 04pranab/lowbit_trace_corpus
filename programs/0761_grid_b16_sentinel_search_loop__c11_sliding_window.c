/*
 * LowBit -- 0761_grid_b16_sentinel_search_loop__c11_sliding_window.c
 * Branch: sentinel_search_loop | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0761_grid_b16_sentinel_search_loop__c11_sliding_window.c\n");
