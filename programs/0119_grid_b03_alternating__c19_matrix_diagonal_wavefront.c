/*
 * LowBit -- 0119_grid_b03_alternating__c19_matrix_diagonal_wavefront.c
 * Branch: alternating | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0119_grid_b03_alternating__c19_matrix_diagonal_wavefront.c\n");
