/*
 * LowBit -- 1926_grid_b39_dual_lcg_xor_chaos__c26_geometric_stride_growth.c
 * Branch: dual_lcg_xor_chaos | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1926_grid_b39_dual_lcg_xor_chaos__c26_geometric_stride_growth.c\n");
