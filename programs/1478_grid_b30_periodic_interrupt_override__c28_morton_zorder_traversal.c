/*
 * LowBit -- 1478_grid_b30_periodic_interrupt_override__c28_morton_zorder_traversal.c
 * Branch: periodic_interrupt_override | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=1478_grid_b30_periodic_interrupt_override__c28_morton_zorder_traversal.c\n");
