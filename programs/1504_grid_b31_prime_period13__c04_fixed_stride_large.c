/*
 * LowBit -- 1504_grid_b31_prime_period13__c04_fixed_stride_large.c
 * Branch: prime_period13 | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=1504_grid_b31_prime_period13__c04_fixed_stride_large.c\n");
