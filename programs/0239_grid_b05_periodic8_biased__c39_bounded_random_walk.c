/*
 * LowBit -- 0239_grid_b05_periodic8_biased__c39_bounded_random_walk.c
 * Branch: periodic8_biased | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0239_grid_b05_periodic8_biased__c39_bounded_random_walk.c\n");
