/*
 * LowBit -- 0358_grid_b08_switch_multiway__c08_matrix_col_major.c
 * Branch: switch_multiway | Cache: matrix_col_major
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0358_grid_b08_switch_multiway__c08_matrix_col_major.c\n");
