/*
 * LowBit -- 2519_base_branch_b19_data_dependent_break_trip.c
 * Branch: data_dependent_break_trip | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=2519_base_branch_b19_data_dependent_break_trip.c\n");
