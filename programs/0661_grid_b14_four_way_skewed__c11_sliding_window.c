/*
 * LowBit -- 0661_grid_b14_four_way_skewed__c11_sliding_window.c
 * Branch: four_way_skewed | Cache: sliding_window
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0661_grid_b14_four_way_skewed__c11_sliding_window.c\n");
