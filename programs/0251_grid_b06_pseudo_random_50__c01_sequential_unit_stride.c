/*
 * LowBit -- 0251_grid_b06_pseudo_random_50__c01_sequential_unit_stride.c
 * Branch: pseudo_random_50 | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0251_grid_b06_pseudo_random_50__c01_sequential_unit_stride.c\n");
