/*
 * LowBit -- 2420_grid_b49_interleaved_two_pattern_multiplex__c20_hot_cold_phase_alternation.c
 * Branch: interleaved_two_pattern_multiplex | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=2420_grid_b49_interleaved_two_pattern_multiplex__c20_hot_cold_phase_alternation.c\n");
