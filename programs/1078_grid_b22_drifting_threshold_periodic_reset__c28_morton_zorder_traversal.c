/*
 * LowBit -- 1078_grid_b22_drifting_threshold_periodic_reset__c28_morton_zorder_traversal.c
 * Branch: drifting_threshold_periodic_reset | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1078_grid_b22_drifting_threshold_periodic_reset__c28_morton_zorder_traversal.c\n");
