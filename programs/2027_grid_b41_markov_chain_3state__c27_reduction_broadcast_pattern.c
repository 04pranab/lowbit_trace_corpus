/*
 * LowBit -- 2027_grid_b41_markov_chain_3state__c27_reduction_broadcast_pattern.c
 * Branch: markov_chain_3state | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2027_grid_b41_markov_chain_3state__c27_reduction_broadcast_pattern.c\n");
