/*
 * LowBit -- 2251_grid_b46_lookup_table_driven__c01_sequential_unit_stride.c
 * Branch: lookup_table_driven | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2251_grid_b46_lookup_table_driven__c01_sequential_unit_stride.c\n");
