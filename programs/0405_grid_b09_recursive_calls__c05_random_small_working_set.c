/*
 * LowBit -- 0405_grid_b09_recursive_calls__c05_random_small_working_set.c
 * Branch: recursive_calls | Cache: random_small_working_set
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0405_grid_b09_recursive_calls__c05_random_small_working_set.c\n");
