/*
 * LowBit -- 2392_grid_b48_variable_step_signed_countdown__c42_cache_oblivious_funnel_stride.c
 * Branch: variable_step_signed_countdown | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2392_grid_b48_variable_step_signed_countdown__c42_cache_oblivious_funnel_stride.c\n");
