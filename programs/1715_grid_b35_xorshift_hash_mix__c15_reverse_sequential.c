/*
 * LowBit -- 1715_grid_b35_xorshift_hash_mix__c15_reverse_sequential.c
 * Branch: xorshift_hash_mix | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1715_grid_b35_xorshift_hash_mix__c15_reverse_sequential.c\n");
