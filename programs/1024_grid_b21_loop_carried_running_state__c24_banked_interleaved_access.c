/*
 * LowBit -- 1024_grid_b21_loop_carried_running_state__c24_banked_interleaved_access.c
 * Branch: loop_carried_running_state | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=1024_grid_b21_loop_carried_running_state__c24_banked_interleaved_access.c\n");
