/*
 * LowBit -- 0764_grid_b16_sentinel_search_loop__c14_temporal_burst_reuse.c
 * Branch: sentinel_search_loop | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0764_grid_b16_sentinel_search_loop__c14_temporal_burst_reuse.c\n");
