/*
 * LowBit -- 1094_grid_b22_drifting_threshold_periodic_reset__c44_naive_gemm_row_col_alternation.c
 * Branch: drifting_threshold_periodic_reset | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1094_grid_b22_drifting_threshold_periodic_reset__c44_naive_gemm_row_col_alternation.c\n");
