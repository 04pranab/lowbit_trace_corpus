/*
 * LowBit -- 0295_grid_b06_pseudo_random_50__c45_read_hot_write_cold_split.c
 * Branch: pseudo_random_50 | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0295_grid_b06_pseudo_random_50__c45_read_hot_write_cold_split.c\n");
