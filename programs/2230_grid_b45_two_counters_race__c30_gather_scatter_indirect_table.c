/*
 * LowBit -- 2230_grid_b45_two_counters_race__c30_gather_scatter_indirect_table.c
 * Branch: two_counters_race | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2230_grid_b45_two_counters_race__c30_gather_scatter_indirect_table.c\n");
