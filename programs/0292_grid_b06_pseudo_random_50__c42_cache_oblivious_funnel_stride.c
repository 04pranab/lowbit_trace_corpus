/*
 * LowBit -- 0292_grid_b06_pseudo_random_50__c42_cache_oblivious_funnel_stride.c
 * Branch: pseudo_random_50 | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0292_grid_b06_pseudo_random_50__c42_cache_oblivious_funnel_stride.c\n");
