/*
 * LowBit -- 2024_grid_b41_markov_chain_3state__c24_banked_interleaved_access.c
 * Branch: markov_chain_3state | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2024_grid_b41_markov_chain_3state__c24_banked_interleaved_access.c\n");
