/*
 * LowBit -- 2368_grid_b48_variable_step_signed_countdown__c18_producer_consumer_two_pointer.c
 * Branch: variable_step_signed_countdown | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2368_grid_b48_variable_step_signed_countdown__c18_producer_consumer_two_pointer.c\n");
