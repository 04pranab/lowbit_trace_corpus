/*
 * LowBit -- 1347_grid_b27_meta_correlated_nested__c47_false_sharing_line_cycle.c
 * Branch: meta_correlated_nested | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1347_grid_b27_meta_correlated_nested__c47_false_sharing_line_cycle.c\n");
