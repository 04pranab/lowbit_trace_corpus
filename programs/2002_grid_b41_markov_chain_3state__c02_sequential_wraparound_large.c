/*
 * LowBit -- 2002_grid_b41_markov_chain_3state__c02_sequential_wraparound_large.c
 * Branch: markov_chain_3state | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2002_grid_b41_markov_chain_3state__c02_sequential_wraparound_large.c\n");
