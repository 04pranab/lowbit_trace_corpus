/*
 * LowBit -- 0329_grid_b07_nested_dependent__c29_ping_pong_cache_thrash.c
 * Branch: nested_dependent | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0329_grid_b07_nested_dependent__c29_ping_pong_cache_thrash.c\n");
