/*
 * LowBit -- 1019_grid_b21_loop_carried_running_state__c19_matrix_diagonal_wavefront.c
 * Branch: loop_carried_running_state | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static uint32_t acc21_ = 0u; acc21_ += v; taken = (acc21_ & 1u) == 0u; }
    ...
    printf("program=1019_grid_b21_loop_carried_running_state__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=loop_carried_running_state\n");
