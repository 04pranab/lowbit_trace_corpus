/*
 * LowBit -- 2348_grid_b47_mutual_ping_pong_recursion__c48_exponential_backoff_probe.c
 * Branch: mutual_ping_pong_recursion | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2348_grid_b47_mutual_ping_pong_recursion__c48_exponential_backoff_probe.c\n");
