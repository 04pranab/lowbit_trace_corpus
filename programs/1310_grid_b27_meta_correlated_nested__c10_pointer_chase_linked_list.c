/*
 * LowBit -- 1310_grid_b27_meta_correlated_nested__c10_pointer_chase_linked_list.c
 * Branch: meta_correlated_nested | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1310_grid_b27_meta_correlated_nested__c10_pointer_chase_linked_list.c\n");
