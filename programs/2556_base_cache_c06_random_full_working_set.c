/*
 * LowBit -- 2556_base_cache_c06_random_full_working_set.c
 * Branch: synthetic_always_taken | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=2556_base_cache_c06_random_full_working_set.c\n");
