/*
 * LowBit -- 1485_grid_b30_periodic_interrupt_override__c35_checkerboard_red_black.c
 * Branch: periodic_interrupt_override | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=1485_grid_b30_periodic_interrupt_override__c35_checkerboard_red_black.c\n");
