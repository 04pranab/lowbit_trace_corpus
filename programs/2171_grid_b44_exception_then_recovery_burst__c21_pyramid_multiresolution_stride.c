/*
 * LowBit -- 2171_grid_b44_exception_then_recovery_burst__c21_pyramid_multiresolution_stride.c
 * Branch: exception_then_recovery_burst | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2171_grid_b44_exception_then_recovery_burst__c21_pyramid_multiresolution_stride.c\n");
