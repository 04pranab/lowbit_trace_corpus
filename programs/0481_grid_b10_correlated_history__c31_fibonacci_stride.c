/*
 * LowBit -- 0481_grid_b10_correlated_history__c31_fibonacci_stride.c
 * Branch: correlated_history | Cache: fibonacci_stride
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0481_grid_b10_correlated_history__c31_fibonacci_stride.c\n");
