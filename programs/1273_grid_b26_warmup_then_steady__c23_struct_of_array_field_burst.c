/*
 * LowBit -- 1273_grid_b26_warmup_then_steady__c23_struct_of_array_field_burst.c
 * Branch: warmup_then_steady | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1273_grid_b26_warmup_then_steady__c23_struct_of_array_field_burst.c\n");
