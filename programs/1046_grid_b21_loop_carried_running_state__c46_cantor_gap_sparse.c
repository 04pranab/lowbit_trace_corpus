/*
 * LowBit -- 1046_grid_b21_loop_carried_running_state__c46_cantor_gap_sparse.c
 * Branch: loop_carried_running_state | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=1046_grid_b21_loop_carried_running_state__c46_cantor_gap_sparse.c\n");
