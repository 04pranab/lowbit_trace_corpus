/*
 * LowBit -- 1750_grid_b35_xorshift_hash_mix__c50_streaming_with_periodic_flush.c
 * Branch: xorshift_hash_mix | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1750_grid_b35_xorshift_hash_mix__c50_streaming_with_periodic_flush.c\n");
