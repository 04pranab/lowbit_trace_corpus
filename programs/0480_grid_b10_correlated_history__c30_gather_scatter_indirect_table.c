/*
 * LowBit -- 0480_grid_b10_correlated_history__c30_gather_scatter_indirect_table.c
 * Branch: correlated_history | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0480_grid_b10_correlated_history__c30_gather_scatter_indirect_table.c\n");
