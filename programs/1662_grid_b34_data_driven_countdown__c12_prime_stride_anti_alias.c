/*
 * LowBit -- 1662_grid_b34_data_driven_countdown__c12_prime_stride_anti_alias.c
 * Branch: data_driven_countdown | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1662_grid_b34_data_driven_countdown__c12_prime_stride_anti_alias.c\n");
