/*
 * LowBit -- 2502_base_branch_b02_always_not_taken.c
 * Branch: always_not_taken | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2502_base_branch_b02_always_not_taken.c\n");
