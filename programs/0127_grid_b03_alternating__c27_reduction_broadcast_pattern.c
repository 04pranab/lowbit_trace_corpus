/*
 * LowBit -- 0127_grid_b03_alternating__c27_reduction_broadcast_pattern.c
 * Branch: alternating | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=0127_grid_b03_alternating__c27_reduction_broadcast_pattern.c\n");
