/*
 * LowBit -- 2276_grid_b46_lookup_table_driven__c26_geometric_stride_growth.c
 * Branch: lookup_table_driven | Cache: geometric_stride_growth
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t base26_ = 0u; uint32_t stride26_ = 1u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ base26_ = (base26_ + stride26_) % SIZE;
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2276_grid_b46_lookup_table_driven__c26_geometric_stride_growth.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=geometric_stride_growth\n");
