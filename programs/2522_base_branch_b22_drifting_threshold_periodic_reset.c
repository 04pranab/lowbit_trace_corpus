/*
 * LowBit -- 2522_base_branch_b22_drifting_threshold_periodic_reset.c
 * Branch: drifting_threshold_periodic_reset | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=2522_base_branch_b22_drifting_threshold_periodic_reset.c\n");
