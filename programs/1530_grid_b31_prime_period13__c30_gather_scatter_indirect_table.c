/*
 * LowBit -- 1530_grid_b31_prime_period13__c30_gather_scatter_indirect_table.c
 * Branch: prime_period13 | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=1530_grid_b31_prime_period13__c30_gather_scatter_indirect_table.c\n");
