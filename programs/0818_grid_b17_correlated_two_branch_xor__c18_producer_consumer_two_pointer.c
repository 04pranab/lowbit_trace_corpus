/*
 * LowBit -- 0818_grid_b17_correlated_two_branch_xor__c18_producer_consumer_two_pointer.c
 * Branch: correlated_two_branch_xor | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0818_grid_b17_correlated_two_branch_xor__c18_producer_consumer_two_pointer.c\n");
