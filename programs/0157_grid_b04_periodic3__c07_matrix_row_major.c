/*
 * LowBit -- 0157_grid_b04_periodic3__c07_matrix_row_major.c
 * Branch: periodic3 | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0157_grid_b04_periodic3__c07_matrix_row_major.c\n");
