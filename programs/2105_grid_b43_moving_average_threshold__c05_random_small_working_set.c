/*
 * LowBit -- 2105_grid_b43_moving_average_threshold__c05_random_small_working_set.c
 * Branch: moving_average_threshold | Cache: random_small_working_set
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2105_grid_b43_moving_average_threshold__c05_random_small_working_set.c\n");
