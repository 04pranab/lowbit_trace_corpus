/*
 * LowBit -- 1978_grid_b40_collatz_value_transform__c28_morton_zorder_traversal.c
 * Branch: collatz_value_transform | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1978_grid_b40_collatz_value_transform__c28_morton_zorder_traversal.c\n");
