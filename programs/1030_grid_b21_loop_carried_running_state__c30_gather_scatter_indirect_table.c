/*
 * LowBit -- 1030_grid_b21_loop_carried_running_state__c30_gather_scatter_indirect_table.c
 * Branch: loop_carried_running_state | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=1030_grid_b21_loop_carried_running_state__c30_gather_scatter_indirect_table.c\n");
