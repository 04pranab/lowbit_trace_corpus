/*
 * LowBit -- 0560_grid_b12_doubling_run_lengths__c10_pointer_chase_linked_list.c
 * Branch: doubling_run_lengths | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0560_grid_b12_doubling_run_lengths__c10_pointer_chase_linked_list.c\n");
