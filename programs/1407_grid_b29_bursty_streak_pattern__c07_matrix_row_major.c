/*
 * LowBit -- 1407_grid_b29_bursty_streak_pattern__c07_matrix_row_major.c
 * Branch: bursty_streak_pattern | Cache: matrix_row_major
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1407_grid_b29_bursty_streak_pattern__c07_matrix_row_major.c\n");
