/*
 * LowBit -- 0476_grid_b10_correlated_history__c26_geometric_stride_growth.c
 * Branch: correlated_history | Cache: geometric_stride_growth
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0476_grid_b10_correlated_history__c26_geometric_stride_growth.c\n");
