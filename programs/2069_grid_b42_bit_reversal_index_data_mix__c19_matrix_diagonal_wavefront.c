/*
 * LowBit -- 2069_grid_b42_bit_reversal_index_data_mix__c19_matrix_diagonal_wavefront.c
 * Branch: bit_reversal_index_data_mix | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2069_grid_b42_bit_reversal_index_data_mix__c19_matrix_diagonal_wavefront.c\n");
