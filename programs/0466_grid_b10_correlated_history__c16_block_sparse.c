/*
 * LowBit -- 0466_grid_b10_correlated_history__c16_block_sparse.c
 * Branch: correlated_history | Cache: block_sparse
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0466_grid_b10_correlated_history__c16_block_sparse.c\n");
