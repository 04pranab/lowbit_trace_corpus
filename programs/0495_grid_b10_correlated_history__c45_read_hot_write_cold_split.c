/*
 * LowBit -- 0495_grid_b10_correlated_history__c45_read_hot_write_cold_split.c
 * Branch: correlated_history | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0495_grid_b10_correlated_history__c45_read_hot_write_cold_split.c\n");
