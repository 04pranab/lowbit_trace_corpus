/*
 * LowBit -- 0313_grid_b07_nested_dependent__c13_two_stream_interleaved.c
 * Branch: nested_dependent | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0313_grid_b07_nested_dependent__c13_two_stream_interleaved.c\n");
