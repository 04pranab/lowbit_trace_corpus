/*
 * LowBit -- 2495_grid_b50_hysteresis_debounce__c45_read_hot_write_cold_split.c
 * Branch: hysteresis_debounce | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2495_grid_b50_hysteresis_debounce__c45_read_hot_write_cold_split.c\n");
