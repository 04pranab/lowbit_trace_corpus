/*
 * LowBit -- 1837_grid_b37_value_driven_unswitch_run__c37_double_buffer_epoch_alternation.c
 * Branch: value_driven_unswitch_run | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1837_grid_b37_value_driven_unswitch_run__c37_double_buffer_epoch_alternation.c\n");
