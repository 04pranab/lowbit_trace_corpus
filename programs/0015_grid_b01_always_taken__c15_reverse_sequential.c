/*
 * LowBit -- 0015_grid_b01_always_taken__c15_reverse_sequential.c
 * Branch: always_taken | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0015_grid_b01_always_taken__c15_reverse_sequential.c\n");
