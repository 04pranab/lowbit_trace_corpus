/*
 * LowBit -- 0912_grid_b19_data_dependent_break_trip__c12_prime_stride_anti_alias.c
 * Branch: data_dependent_break_trip | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0912_grid_b19_data_dependent_break_trip__c12_prime_stride_anti_alias.c\n");
