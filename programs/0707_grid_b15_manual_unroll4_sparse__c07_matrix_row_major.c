/*
 * LowBit -- 0707_grid_b15_manual_unroll4_sparse__c07_matrix_row_major.c
 * Branch: manual_unroll4_sparse | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0707_grid_b15_manual_unroll4_sparse__c07_matrix_row_major.c\n");
