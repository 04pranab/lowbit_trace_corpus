/*
 * LowBit -- 1654_grid_b34_data_driven_countdown__c04_fixed_stride_large.c
 * Branch: data_driven_countdown | Cache: fixed_stride_large
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1654_grid_b34_data_driven_countdown__c04_fixed_stride_large.c\n");
