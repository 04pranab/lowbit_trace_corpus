/*
 * LowBit -- 0606_grid_b13_single_phase_change__c06_random_full_working_set.c
 * Branch: single_phase_change | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0606_grid_b13_single_phase_change__c06_random_full_working_set.c\n");
