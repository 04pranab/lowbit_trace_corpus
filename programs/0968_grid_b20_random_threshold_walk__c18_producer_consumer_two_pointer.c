/*
 * LowBit -- 0968_grid_b20_random_threshold_walk__c18_producer_consumer_two_pointer.c
 * Branch: random_threshold_walk | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0968_grid_b20_random_threshold_walk__c18_producer_consumer_two_pointer.c\n");
