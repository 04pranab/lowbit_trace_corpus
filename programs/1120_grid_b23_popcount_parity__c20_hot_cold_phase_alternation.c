/*
 * LowBit -- 1120_grid_b23_popcount_parity__c20_hot_cold_phase_alternation.c
 * Branch: popcount_parity | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1120_grid_b23_popcount_parity__c20_hot_cold_phase_alternation.c\n");
