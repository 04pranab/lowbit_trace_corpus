/*
 * LowBit -- 0139_grid_b03_alternating__c39_bounded_random_walk.c
 * Branch: alternating | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0139_grid_b03_alternating__c39_bounded_random_walk.c\n");
