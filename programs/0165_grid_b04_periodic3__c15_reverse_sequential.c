/*
 * LowBit -- 0165_grid_b04_periodic3__c15_reverse_sequential.c
 * Branch: periodic3 | Cache: reverse_sequential
...
int main(void) {
    ...
    printf("program=0165_grid_b04_periodic3__c15_reverse_sequential.c\n");
