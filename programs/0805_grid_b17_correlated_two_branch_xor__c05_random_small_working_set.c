/*
 * LowBit -- 0805_grid_b17_correlated_two_branch_xor__c05_random_small_working_set.c
 * Branch: correlated_two_branch_xor | Cache: random_small_working_set
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0805_grid_b17_correlated_two_branch_xor__c05_random_small_working_set.c\n");
