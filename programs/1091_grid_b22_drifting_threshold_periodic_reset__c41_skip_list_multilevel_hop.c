/*
 * LowBit -- 1091_grid_b22_drifting_threshold_periodic_reset__c41_skip_list_multilevel_hop.c
 * Branch: drifting_threshold_periodic_reset | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1091_grid_b22_drifting_threshold_periodic_reset__c41_skip_list_multilevel_hop.c\n");
