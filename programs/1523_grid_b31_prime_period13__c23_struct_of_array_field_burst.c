/*
 * LowBit -- 1523_grid_b31_prime_period13__c23_struct_of_array_field_burst.c
 * Branch: prime_period13 | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=1523_grid_b31_prime_period13__c23_struct_of_array_field_burst.c\n");
