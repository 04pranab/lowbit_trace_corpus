/*
 * LowBit -- 0031_grid_b01_always_taken__c31_fibonacci_stride.c
 * Branch: always_taken | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0031_grid_b01_always_taken__c31_fibonacci_stride.c\n");
