/*
 * LowBit -- 0573_grid_b12_doubling_run_lengths__c23_struct_of_array_field_burst.c
 * Branch: doubling_run_lengths | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0573_grid_b12_doubling_run_lengths__c23_struct_of_array_field_burst.c\n");
