/*
 * LowBit -- 0551_grid_b12_doubling_run_lengths__c01_sequential_unit_stride.c
 * Branch: doubling_run_lengths | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0551_grid_b12_doubling_run_lengths__c01_sequential_unit_stride.c\n");
    printf("branch_pattern=doubling_run_lengths\n");
    printf("cache_pattern=sequential_unit_stride\n");
