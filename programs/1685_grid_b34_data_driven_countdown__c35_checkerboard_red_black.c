/*
 * LowBit -- 1685_grid_b34_data_driven_countdown__c35_checkerboard_red_black.c
 * Branch: data_driven_countdown | Cache: checkerboard_red_black
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1685_grid_b34_data_driven_countdown__c35_checkerboard_red_black.c\n");
