/*
 * LowBit -- 0386_grid_b08_switch_multiway__c36_im2col_overlapping_patch_gather.c
 * Branch: switch_multiway | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0386_grid_b08_switch_multiway__c36_im2col_overlapping_patch_gather.c\n");
