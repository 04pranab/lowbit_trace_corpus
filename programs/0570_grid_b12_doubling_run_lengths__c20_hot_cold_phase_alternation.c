/*
 * LowBit -- 0570_grid_b12_doubling_run_lengths__c20_hot_cold_phase_alternation.c
 * Branch: doubling_run_lengths | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0570_grid_b12_doubling_run_lengths__c20_hot_cold_phase_alternation.c\n");
