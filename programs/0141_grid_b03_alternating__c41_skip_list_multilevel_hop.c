/*
 * LowBit -- 0141_grid_b03_alternating__c41_skip_list_multilevel_hop.c
 * Branch: alternating | Cache: skip_list_multilevel_hop
...
int main(void) {
    ...
    printf("program=0141_grid_b03_alternating__c41_skip_list_multilevel_hop.c\n");
