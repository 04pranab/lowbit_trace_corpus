/*
 * LowBit -- 1292_grid_b26_warmup_then_steady__c42_cache_oblivious_funnel_stride.c
 * Branch: warmup_then_steady | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1292_grid_b26_warmup_then_steady__c42_cache_oblivious_funnel_stride.c\n");
