/*
 * LowBit -- 1838_grid_b37_value_driven_unswitch_run__c38_cuckoo_double_hash_probe.c
 * Branch: value_driven_unswitch_run | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1838_grid_b37_value_driven_unswitch_run__c38_cuckoo_double_hash_probe.c\n");
