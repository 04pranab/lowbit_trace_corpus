/*
 * LowBit -- 1131_grid_b23_popcount_parity__c31_fibonacci_stride.c
 * Branch: popcount_parity | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1131_grid_b23_popcount_parity__c31_fibonacci_stride.c\n");
