/*
 * LowBit -- 0504_grid_b11_value_dependent_threshold__c04_fixed_stride_large.c
 * Branch: value_dependent_threshold | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0504_grid_b11_value_dependent_threshold__c04_fixed_stride_large.c\n");
