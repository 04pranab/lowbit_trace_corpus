/*
 * LowBit -- 2271_grid_b46_lookup_table_driven__c21_pyramid_multiresolution_stride.c
 * Branch: lookup_table_driven | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2271_grid_b46_lookup_table_driven__c21_pyramid_multiresolution_stride.c\n");
