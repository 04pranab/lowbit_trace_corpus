/*
 * LowBit -- 1910_grid_b39_dual_lcg_xor_chaos__c10_pointer_chase_linked_list.c
 * Branch: dual_lcg_xor_chaos | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1910_grid_b39_dual_lcg_xor_chaos__c10_pointer_chase_linked_list.c\n");
