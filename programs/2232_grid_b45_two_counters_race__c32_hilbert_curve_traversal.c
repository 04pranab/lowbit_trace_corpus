/*
 * LowBit -- 2232_grid_b45_two_counters_race__c32_hilbert_curve_traversal.c
 * Branch: two_counters_race | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2232_grid_b45_two_counters_race__c32_hilbert_curve_traversal.c\n");
