/*
 * LowBit -- 2409_grid_b49_interleaved_two_pattern_multiplex__c09_matrix_tiled_blocked.c
 * Branch: interleaved_two_pattern_multiplex | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=2409_grid_b49_interleaved_two_pattern_multiplex__c09_matrix_tiled_blocked.c\n");
