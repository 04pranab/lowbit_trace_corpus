/*
 * LowBit -- 0174_grid_b04_periodic3__c24_banked_interleaved_access.c
 * Branch: periodic3 | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0174_grid_b04_periodic3__c24_banked_interleaved_access.c\n");
