/*
 * LowBit -- 0309_grid_b07_nested_dependent__c09_matrix_tiled_blocked.c
 * Branch: nested_dependent | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0309_grid_b07_nested_dependent__c09_matrix_tiled_blocked.c\n");
