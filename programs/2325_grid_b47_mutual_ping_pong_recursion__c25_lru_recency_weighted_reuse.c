/*
 * LowBit -- 2325_grid_b47_mutual_ping_pong_recursion__c25_lru_recency_weighted_reuse.c
 * Branch: mutual_ping_pong_recursion | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2325_grid_b47_mutual_ping_pong_recursion__c25_lru_recency_weighted_reuse.c\n");
