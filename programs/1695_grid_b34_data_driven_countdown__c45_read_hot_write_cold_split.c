/*
 * LowBit -- 1695_grid_b34_data_driven_countdown__c45_read_hot_write_cold_split.c
 * Branch: data_driven_countdown | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1695_grid_b34_data_driven_countdown__c45_read_hot_write_cold_split.c\n");
