/*
 * LowBit -- 0607_grid_b13_single_phase_change__c07_matrix_row_major.c
 * Branch: single_phase_change | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0607_grid_b13_single_phase_change__c07_matrix_row_major.c\n");
