/*
 * LowBit -- 0245_grid_b05_periodic8_biased__c45_read_hot_write_cold_split.c
 * Branch: periodic8_biased | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0245_grid_b05_periodic8_biased__c45_read_hot_write_cold_split.c\n");
