/*
 * LowBit -- 0935_grid_b19_data_dependent_break_trip__c35_checkerboard_red_black.c
 * Branch: data_dependent_break_trip | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0935_grid_b19_data_dependent_break_trip__c35_checkerboard_red_black.c\n");
