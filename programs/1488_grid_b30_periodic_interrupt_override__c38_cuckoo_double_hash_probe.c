/*
 * LowBit -- 1488_grid_b30_periodic_interrupt_override__c38_cuckoo_double_hash_probe.c
 * Branch: periodic_interrupt_override | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=1488_grid_b30_periodic_interrupt_override__c38_cuckoo_double_hash_probe.c\n");
