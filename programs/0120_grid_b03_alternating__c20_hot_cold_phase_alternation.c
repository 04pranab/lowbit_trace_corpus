/*
 * LowBit -- 0120_grid_b03_alternating__c20_hot_cold_phase_alternation.c
 * Branch: alternating | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0120_grid_b03_alternating__c20_hot_cold_phase_alternation.c\n");
