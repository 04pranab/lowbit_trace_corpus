/*
 * LowBit -- 1296_grid_b26_warmup_then_steady__c46_cantor_gap_sparse.c
 * Branch: warmup_then_steady | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1296_grid_b26_warmup_then_steady__c46_cantor_gap_sparse.c\n");
