/*
 * LowBit -- 1511_grid_b31_prime_period13__c11_sliding_window.c
 * Branch: prime_period13 | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=1511_grid_b31_prime_period13__c11_sliding_window.c\n");
