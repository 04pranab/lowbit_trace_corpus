/*
 * LowBit -- 1732_grid_b35_xorshift_hash_mix__c32_hilbert_curve_traversal.c
 * Branch: xorshift_hash_mix | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1732_grid_b35_xorshift_hash_mix__c32_hilbert_curve_traversal.c\n");
