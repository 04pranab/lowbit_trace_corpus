/*
 * LowBit -- 1486_grid_b30_periodic_interrupt_override__c36_im2col_overlapping_patch_gather.c
 * Branch: periodic_interrupt_override | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=1486_grid_b30_periodic_interrupt_override__c36_im2col_overlapping_patch_gather.c\n");
