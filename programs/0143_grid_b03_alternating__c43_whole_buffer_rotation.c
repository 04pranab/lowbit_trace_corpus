/*
 * LowBit -- 0143_grid_b03_alternating__c43_whole_buffer_rotation.c
 * Branch: alternating | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0143_grid_b03_alternating__c43_whole_buffer_rotation.c\n");
