/*
 * LowBit -- 1109_grid_b23_popcount_parity__c09_matrix_tiled_blocked.c
 * Branch: popcount_parity | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1109_grid_b23_popcount_parity__c09_matrix_tiled_blocked.c\n");
