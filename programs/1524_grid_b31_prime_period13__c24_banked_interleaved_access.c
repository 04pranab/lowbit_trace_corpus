/*
 * LowBit -- 1524_grid_b31_prime_period13__c24_banked_interleaved_access.c
 * Branch: prime_period13 | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=1524_grid_b31_prime_period13__c24_banked_interleaved_access.c\n");
