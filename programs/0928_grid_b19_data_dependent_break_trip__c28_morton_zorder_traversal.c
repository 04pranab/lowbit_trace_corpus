/*
 * LowBit -- 0928_grid_b19_data_dependent_break_trip__c28_morton_zorder_traversal.c
 * Branch: data_dependent_break_trip | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0928_grid_b19_data_dependent_break_trip__c28_morton_zorder_traversal.c\n");
