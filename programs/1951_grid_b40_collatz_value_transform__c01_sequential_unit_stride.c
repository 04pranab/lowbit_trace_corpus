/*
 * LowBit -- 1951_grid_b40_collatz_value_transform__c01_sequential_unit_stride.c
 * Branch: collatz_value_transform | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1951_grid_b40_collatz_value_transform__c01_sequential_unit_stride.c\n");
