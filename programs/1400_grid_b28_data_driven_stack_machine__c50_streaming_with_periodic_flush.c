/*
 * LowBit -- 1400_grid_b28_data_driven_stack_machine__c50_streaming_with_periodic_flush.c
 * Branch: data_driven_stack_machine | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1400_grid_b28_data_driven_stack_machine__c50_streaming_with_periodic_flush.c\n");
