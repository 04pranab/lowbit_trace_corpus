/*
 * LowBit -- 0328_grid_b07_nested_dependent__c28_morton_zorder_traversal.c
 * Branch: nested_dependent | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0328_grid_b07_nested_dependent__c28_morton_zorder_traversal.c\n");
