/*
 * LowBit -- 0996_grid_b20_random_threshold_walk__c46_cantor_gap_sparse.c
 * Branch: random_threshold_walk | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0996_grid_b20_random_threshold_walk__c46_cantor_gap_sparse.c\n");
