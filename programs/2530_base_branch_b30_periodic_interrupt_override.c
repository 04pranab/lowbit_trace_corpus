/*
 * LowBit -- 2530_base_branch_b30_periodic_interrupt_override.c
 * Branch: periodic_interrupt_override | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2530_base_branch_b30_periodic_interrupt_override.c\n");
