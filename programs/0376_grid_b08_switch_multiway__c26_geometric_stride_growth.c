/*
 * LowBit -- 0376_grid_b08_switch_multiway__c26_geometric_stride_growth.c
 * Branch: switch_multiway | Cache: geometric_stride_growth
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0376_grid_b08_switch_multiway__c26_geometric_stride_growth.c\n");
