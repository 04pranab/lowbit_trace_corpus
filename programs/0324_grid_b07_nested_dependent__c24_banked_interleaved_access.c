/*
 * LowBit -- 0324_grid_b07_nested_dependent__c24_banked_interleaved_access.c
 * Branch: nested_dependent | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0324_grid_b07_nested_dependent__c24_banked_interleaved_access.c\n");
