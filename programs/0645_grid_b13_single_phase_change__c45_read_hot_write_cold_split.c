/*
 * LowBit -- 0645_grid_b13_single_phase_change__c45_read_hot_write_cold_split.c
 * Branch: single_phase_change | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0645_grid_b13_single_phase_change__c45_read_hot_write_cold_split.c\n");
