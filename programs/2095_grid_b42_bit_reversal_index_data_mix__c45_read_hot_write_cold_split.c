/*
 * LowBit -- 2095_grid_b42_bit_reversal_index_data_mix__c45_read_hot_write_cold_split.c
 * Branch: bit_reversal_index_data_mix | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2095_grid_b42_bit_reversal_index_data_mix__c45_read_hot_write_cold_split.c\n");
