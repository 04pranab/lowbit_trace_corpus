/*
 * LowBit -- 0696_grid_b14_four_way_skewed__c46_cantor_gap_sparse.c
 * Branch: four_way_skewed | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0696_grid_b14_four_way_skewed__c46_cantor_gap_sparse.c\n");
