/*
 * LowBit -- 0381_grid_b08_switch_multiway__c31_fibonacci_stride.c
 * Branch: switch_multiway | Cache: fibonacci_stride
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0381_grid_b08_switch_multiway__c31_fibonacci_stride.c\n");
