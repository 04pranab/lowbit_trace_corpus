/*
 * LowBit -- 0103_grid_b03_alternating__c03_fixed_stride_small.c
 * Branch: alternating | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0103_grid_b03_alternating__c03_fixed_stride_small.c\n");
