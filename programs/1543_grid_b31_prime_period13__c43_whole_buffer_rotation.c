/*
 * LowBit -- 1543_grid_b31_prime_period13__c43_whole_buffer_rotation.c
 * Branch: prime_period13 | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=1543_grid_b31_prime_period13__c43_whole_buffer_rotation.c\n");
