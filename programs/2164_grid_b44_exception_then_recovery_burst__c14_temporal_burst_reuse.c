/*
 * LowBit -- 2164_grid_b44_exception_then_recovery_burst__c14_temporal_burst_reuse.c
 * Branch: exception_then_recovery_burst | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2164_grid_b44_exception_then_recovery_burst__c14_temporal_burst_reuse.c\n");
