/*
 * LowBit -- 2099_grid_b42_bit_reversal_index_data_mix__c49_binary_heap_parent_child.c
 * Branch: bit_reversal_index_data_mix | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2099_grid_b42_bit_reversal_index_data_mix__c49_binary_heap_parent_child.c\n");
