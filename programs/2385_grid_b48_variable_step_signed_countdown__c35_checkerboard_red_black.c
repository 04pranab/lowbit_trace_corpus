/*
 * LowBit -- 2385_grid_b48_variable_step_signed_countdown__c35_checkerboard_red_black.c
 * Branch: variable_step_signed_countdown | Cache: checkerboard_red_black
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2385_grid_b48_variable_step_signed_countdown__c35_checkerboard_red_black.c\n");
