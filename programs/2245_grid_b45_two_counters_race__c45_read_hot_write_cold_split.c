/*
 * LowBit -- 2245_grid_b45_two_counters_race__c45_read_hot_write_cold_split.c
 * Branch: two_counters_race | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2245_grid_b45_two_counters_race__c45_read_hot_write_cold_split.c\n");
