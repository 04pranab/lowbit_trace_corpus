/*
 * LowBit -- 2332_grid_b47_mutual_ping_pong_recursion__c32_hilbert_curve_traversal.c
 * Branch: mutual_ping_pong_recursion | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2332_grid_b47_mutual_ping_pong_recursion__c32_hilbert_curve_traversal.c\n");
