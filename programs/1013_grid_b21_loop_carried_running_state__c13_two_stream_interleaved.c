/*
 * LowBit -- 1013_grid_b21_loop_carried_running_state__c13_two_stream_interleaved.c
 * Branch: loop_carried_running_state | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=1013_grid_b21_loop_carried_running_state__c13_two_stream_interleaved.c\n");
