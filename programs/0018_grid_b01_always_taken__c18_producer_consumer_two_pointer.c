/*
 * LowBit -- 0018_grid_b01_always_taken__c18_producer_consumer_two_pointer.c
 * Branch: always_taken | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0018_grid_b01_always_taken__c18_producer_consumer_two_pointer.c\n");
