/*
 * LowBit -- 0433_grid_b09_recursive_calls__c33_cache_set_conflict_stress.c
 * Branch: recursive_calls | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0433_grid_b09_recursive_calls__c33_cache_set_conflict_stress.c\n");
