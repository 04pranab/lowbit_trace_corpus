/*
 * LowBit -- 0714_grid_b15_manual_unroll4_sparse__c14_temporal_burst_reuse.c
 * Branch: manual_unroll4_sparse | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0714_grid_b15_manual_unroll4_sparse__c14_temporal_burst_reuse.c\n");
