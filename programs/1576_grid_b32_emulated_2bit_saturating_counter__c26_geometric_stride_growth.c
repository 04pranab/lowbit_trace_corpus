/*
 * LowBit -- 1576_grid_b32_emulated_2bit_saturating_counter__c26_geometric_stride_growth.c
 * Branch: emulated_2bit_saturating_counter | Cache: geometric_stride_growth
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1576_grid_b32_emulated_2bit_saturating_counter__c26_geometric_stride_growth.c\n");
