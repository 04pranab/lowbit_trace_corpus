/*
 * LowBit -- 0917_grid_b19_data_dependent_break_trip__c17_zipf_like_hot_buckets.c
 * Branch: data_dependent_break_trip | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0917_grid_b19_data_dependent_break_trip__c17_zipf_like_hot_buckets.c\n");
