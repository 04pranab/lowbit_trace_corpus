/*
 * LowBit -- 0987_grid_b20_random_threshold_walk__c37_double_buffer_epoch_alternation.c
 * Branch: random_threshold_walk | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0987_grid_b20_random_threshold_walk__c37_double_buffer_epoch_alternation.c\n");
