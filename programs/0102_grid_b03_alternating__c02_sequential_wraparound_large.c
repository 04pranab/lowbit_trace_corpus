/*
 * LowBit -- 0102_grid_b03_alternating__c02_sequential_wraparound_large.c
 * Branch: alternating | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0102_grid_b03_alternating__c02_sequential_wraparound_large.c\n");
