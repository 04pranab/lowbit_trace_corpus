/*
 * LowBit -- 0288_grid_b06_pseudo_random_50__c38_cuckoo_double_hash_probe.c
 * Branch: pseudo_random_50 | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0288_grid_b06_pseudo_random_50__c38_cuckoo_double_hash_probe.c\n");
