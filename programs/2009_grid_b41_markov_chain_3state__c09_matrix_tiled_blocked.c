/*
 * LowBit -- 2009_grid_b41_markov_chain_3state__c09_matrix_tiled_blocked.c
 * Branch: markov_chain_3state | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2009_grid_b41_markov_chain_3state__c09_matrix_tiled_blocked.c\n");
