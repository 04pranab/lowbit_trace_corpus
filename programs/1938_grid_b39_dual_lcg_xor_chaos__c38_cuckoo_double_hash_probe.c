/*
 * LowBit -- 1938_grid_b39_dual_lcg_xor_chaos__c38_cuckoo_double_hash_probe.c
 * Branch: dual_lcg_xor_chaos | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1938_grid_b39_dual_lcg_xor_chaos__c38_cuckoo_double_hash_probe.c\n");
