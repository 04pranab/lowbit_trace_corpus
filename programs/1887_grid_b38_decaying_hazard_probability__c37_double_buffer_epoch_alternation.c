/*
 * LowBit -- 1887_grid_b38_decaying_hazard_probability__c37_double_buffer_epoch_alternation.c
 * Branch: decaying_hazard_probability | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1887_grid_b38_decaying_hazard_probability__c37_double_buffer_epoch_alternation.c\n");
