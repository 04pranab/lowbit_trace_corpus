/*
 * LowBit -- 0862_grid_b18_indirect_fn_dispatch__c12_prime_stride_anti_alias.c
 * Branch: indirect_fn_dispatch | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0862_grid_b18_indirect_fn_dispatch__c12_prime_stride_anti_alias.c\n");
