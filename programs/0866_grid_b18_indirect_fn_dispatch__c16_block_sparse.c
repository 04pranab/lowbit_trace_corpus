/*
 * LowBit -- 0866_grid_b18_indirect_fn_dispatch__c16_block_sparse.c
 * Branch: indirect_fn_dispatch | Cache: block_sparse
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0866_grid_b18_indirect_fn_dispatch__c16_block_sparse.c\n");
