/*
 * LowBit -- 0006_grid_b01_always_taken__c06_random_full_working_set.c
 * Branch: always_taken | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0006_grid_b01_always_taken__c06_random_full_working_set.c\n");
