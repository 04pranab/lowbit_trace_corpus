/*
 * LowBit -- 0150_grid_b03_alternating__c50_streaming_with_periodic_flush.c
 * Branch: alternating | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0150_grid_b03_alternating__c50_streaming_with_periodic_flush.c\n");
