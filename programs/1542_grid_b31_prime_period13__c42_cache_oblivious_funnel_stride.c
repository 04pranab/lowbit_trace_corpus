/*
 * LowBit -- 1542_grid_b31_prime_period13__c42_cache_oblivious_funnel_stride.c
 * Branch: prime_period13 | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=1542_grid_b31_prime_period13__c42_cache_oblivious_funnel_stride.c\n");
