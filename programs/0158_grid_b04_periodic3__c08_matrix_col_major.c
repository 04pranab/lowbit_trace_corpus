/*
 * LowBit -- 0158_grid_b04_periodic3__c08_matrix_col_major.c
 * Branch: periodic3 | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0158_grid_b04_periodic3__c08_matrix_col_major.c\n");
