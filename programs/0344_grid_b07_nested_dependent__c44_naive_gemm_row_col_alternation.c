/*
 * LowBit -- 0344_grid_b07_nested_dependent__c44_naive_gemm_row_col_alternation.c
 * Branch: nested_dependent | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0344_grid_b07_nested_dependent__c44_naive_gemm_row_col_alternation.c\n");
