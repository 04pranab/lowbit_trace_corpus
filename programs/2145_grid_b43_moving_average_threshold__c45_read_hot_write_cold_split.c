/*
 * LowBit -- 2145_grid_b43_moving_average_threshold__c45_read_hot_write_cold_split.c
 * Branch: moving_average_threshold | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2145_grid_b43_moving_average_threshold__c45_read_hot_write_cold_split.c\n");
