/*
 * LowBit -- 1385_grid_b28_data_driven_stack_machine__c35_checkerboard_red_black.c
 * Branch: data_driven_stack_machine | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1385_grid_b28_data_driven_stack_machine__c35_checkerboard_red_black.c\n");
