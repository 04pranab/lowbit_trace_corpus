/*
 * LowBit -- 1605_grid_b33_uniform_random_block_runs__c05_random_small_working_set.c
 * Branch: uniform_random_block_runs | Cache: random_small_working_set
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1605_grid_b33_uniform_random_block_runs__c05_random_small_working_set.c\n");
