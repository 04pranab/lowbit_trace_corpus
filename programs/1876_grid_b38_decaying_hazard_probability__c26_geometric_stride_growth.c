/*
 * LowBit -- 1876_grid_b38_decaying_hazard_probability__c26_geometric_stride_growth.c
 * Branch: decaying_hazard_probability | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1876_grid_b38_decaying_hazard_probability__c26_geometric_stride_growth.c\n");
