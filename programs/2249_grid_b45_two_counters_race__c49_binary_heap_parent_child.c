/*
 * LowBit -- 2249_grid_b45_two_counters_race__c49_binary_heap_parent_child.c
 * Branch: two_counters_race | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2249_grid_b45_two_counters_race__c49_binary_heap_parent_child.c\n");
