/*
 * LowBit -- 0600_grid_b12_doubling_run_lengths__c50_streaming_with_periodic_flush.c
 * Branch: doubling_run_lengths | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0600_grid_b12_doubling_run_lengths__c50_streaming_with_periodic_flush.c\n");
