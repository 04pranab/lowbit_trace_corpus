/*
 * LowBit -- 1687_grid_b34_data_driven_countdown__c37_double_buffer_epoch_alternation.c
 * Branch: data_driven_countdown | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1687_grid_b34_data_driven_countdown__c37_double_buffer_epoch_alternation.c\n");
