/*
 * LowBit -- 1014_grid_b21_loop_carried_running_state__c14_temporal_burst_reuse.c
 * Branch: loop_carried_running_state | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=1014_grid_b21_loop_carried_running_state__c14_temporal_burst_reuse.c\n");
