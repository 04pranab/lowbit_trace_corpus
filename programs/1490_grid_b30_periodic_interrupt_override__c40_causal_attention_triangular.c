/*
 * LowBit -- 1490_grid_b30_periodic_interrupt_override__c40_causal_attention_triangular.c
 * Branch: periodic_interrupt_override | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=1490_grid_b30_periodic_interrupt_override__c40_causal_attention_triangular.c\n");
