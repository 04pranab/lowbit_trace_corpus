/*
 * LowBit -- 1177_grid_b24_monotonic_drift_saturating__c27_reduction_broadcast_pattern.c
 * Branch: monotonic_drift_saturating | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1177_grid_b24_monotonic_drift_saturating__c27_reduction_broadcast_pattern.c\n");
