/*
 * LowBit -- 1271_grid_b26_warmup_then_steady__c21_pyramid_multiresolution_stride.c
 * Branch: warmup_then_steady | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1271_grid_b26_warmup_then_steady__c21_pyramid_multiresolution_stride.c\n");
