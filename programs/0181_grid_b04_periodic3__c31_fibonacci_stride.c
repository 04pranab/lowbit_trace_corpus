/*
 * LowBit -- 0181_grid_b04_periodic3__c31_fibonacci_stride.c
 * Branch: periodic3 | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0181_grid_b04_periodic3__c31_fibonacci_stride.c\n");
