/*
 * LowBit -- 0170_grid_b04_periodic3__c20_hot_cold_phase_alternation.c
 * Branch: periodic3 | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0170_grid_b04_periodic3__c20_hot_cold_phase_alternation.c\n");
