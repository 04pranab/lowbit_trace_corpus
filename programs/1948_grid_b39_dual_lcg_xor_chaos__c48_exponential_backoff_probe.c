/*
 * LowBit -- 1948_grid_b39_dual_lcg_xor_chaos__c48_exponential_backoff_probe.c
 * Branch: dual_lcg_xor_chaos | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1948_grid_b39_dual_lcg_xor_chaos__c48_exponential_backoff_probe.c\n");
