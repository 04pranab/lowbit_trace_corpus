/*
 * LowBit -- 2082_grid_b42_bit_reversal_index_data_mix__c32_hilbert_curve_traversal.c
 * Branch: bit_reversal_index_data_mix | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2082_grid_b42_bit_reversal_index_data_mix__c32_hilbert_curve_traversal.c\n");
