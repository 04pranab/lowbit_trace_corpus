/*
 * LowBit -- 2197_grid_b44_exception_then_recovery_burst__c47_false_sharing_line_cycle.c
 * Branch: exception_then_recovery_burst | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2197_grid_b44_exception_then_recovery_burst__c47_false_sharing_line_cycle.c\n");
