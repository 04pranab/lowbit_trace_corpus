/*
 * LowBit -- 2108_grid_b43_moving_average_threshold__c08_matrix_col_major.c
 * Branch: moving_average_threshold | Cache: matrix_col_major
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2108_grid_b43_moving_average_threshold__c08_matrix_col_major.c\n");
