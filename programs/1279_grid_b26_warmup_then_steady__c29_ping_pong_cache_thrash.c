/*
 * LowBit -- 1279_grid_b26_warmup_then_steady__c29_ping_pong_cache_thrash.c
 * Branch: warmup_then_steady | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1279_grid_b26_warmup_then_steady__c29_ping_pong_cache_thrash.c\n");
