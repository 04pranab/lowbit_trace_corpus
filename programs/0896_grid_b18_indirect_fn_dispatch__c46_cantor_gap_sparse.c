/*
 * LowBit -- 0896_grid_b18_indirect_fn_dispatch__c46_cantor_gap_sparse.c
 * Branch: indirect_fn_dispatch | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0896_grid_b18_indirect_fn_dispatch__c46_cantor_gap_sparse.c\n");
