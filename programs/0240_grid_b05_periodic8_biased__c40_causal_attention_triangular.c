/*
 * LowBit -- 0240_grid_b05_periodic8_biased__c40_causal_attention_triangular.c
 * Branch: periodic8_biased | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0240_grid_b05_periodic8_biased__c40_causal_attention_triangular.c\n");
