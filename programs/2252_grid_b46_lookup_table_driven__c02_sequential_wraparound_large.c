/*
 * LowBit -- 2252_grid_b46_lookup_table_driven__c02_sequential_wraparound_large.c
 * Branch: lookup_table_driven | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2252_grid_b46_lookup_table_driven__c02_sequential_wraparound_large.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=sequential_wraparound_large\n");
