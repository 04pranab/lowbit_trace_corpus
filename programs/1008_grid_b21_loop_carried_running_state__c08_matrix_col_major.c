/*
 * LowBit -- 1008_grid_b21_loop_carried_running_state__c08_matrix_col_major.c
 * Branch: loop_carried_running_state | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=1008_grid_b21_loop_carried_running_state__c08_matrix_col_major.c\n");
