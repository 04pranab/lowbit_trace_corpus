/*
 * LowBit -- 1076_grid_b22_drifting_threshold_periodic_reset__c26_geometric_stride_growth.c
 * Branch: drifting_threshold_periodic_reset | Cache: geometric_stride_growth
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1076_grid_b22_drifting_threshold_periodic_reset__c26_geometric_stride_growth.c\n");
