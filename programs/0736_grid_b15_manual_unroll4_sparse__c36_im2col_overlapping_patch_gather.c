/*
 * LowBit -- 0736_grid_b15_manual_unroll4_sparse__c36_im2col_overlapping_patch_gather.c
 * Branch: manual_unroll4_sparse | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0736_grid_b15_manual_unroll4_sparse__c36_im2col_overlapping_patch_gather.c\n");
