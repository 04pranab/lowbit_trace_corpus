/*
 * LowBit -- 1551_grid_b32_emulated_2bit_saturating_counter__c01_sequential_unit_stride.c
 * Branch: emulated_2bit_saturating_counter | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1551_grid_b32_emulated_2bit_saturating_counter__c01_sequential_unit_stride.c\n");
