/*
 * LowBit -- 0967_grid_b20_random_threshold_walk__c17_zipf_like_hot_buckets.c
 * Branch: random_threshold_walk | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0967_grid_b20_random_threshold_walk__c17_zipf_like_hot_buckets.c\n");
