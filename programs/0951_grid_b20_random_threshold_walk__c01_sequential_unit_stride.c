/*
 * LowBit -- 0951_grid_b20_random_threshold_walk__c01_sequential_unit_stride.c
 * Branch: random_threshold_walk | Cache: sequential_unit_stride
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0951_grid_b20_random_threshold_walk__c01_sequential_unit_stride.c\n");
