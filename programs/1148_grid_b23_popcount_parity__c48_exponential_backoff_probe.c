/*
 * LowBit -- 1148_grid_b23_popcount_parity__c48_exponential_backoff_probe.c
 * Branch: popcount_parity | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1148_grid_b23_popcount_parity__c48_exponential_backoff_probe.c\n");
