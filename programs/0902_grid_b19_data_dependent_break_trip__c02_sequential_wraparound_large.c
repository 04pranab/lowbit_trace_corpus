/*
 * LowBit -- 0902_grid_b19_data_dependent_break_trip__c02_sequential_wraparound_large.c
 * Branch: data_dependent_break_trip | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0902_grid_b19_data_dependent_break_trip__c02_sequential_wraparound_large.c\n");
