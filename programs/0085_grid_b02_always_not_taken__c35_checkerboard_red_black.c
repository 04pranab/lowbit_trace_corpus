/*
 * LowBit -- 0085_grid_b02_always_not_taken__c35_checkerboard_red_black.c
 * Branch: always_not_taken | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0085_grid_b02_always_not_taken__c35_checkerboard_red_black.c\n");
