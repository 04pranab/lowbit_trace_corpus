/*
 * LowBit -- 2250_grid_b45_two_counters_race__c50_streaming_with_periodic_flush.c
 * Branch: two_counters_race | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2250_grid_b45_two_counters_race__c50_streaming_with_periodic_flush.c\n");
