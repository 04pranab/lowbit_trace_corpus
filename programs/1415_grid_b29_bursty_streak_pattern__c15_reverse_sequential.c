/*
 * LowBit -- 1415_grid_b29_bursty_streak_pattern__c15_reverse_sequential.c
 * Branch: bursty_streak_pattern | Cache: reverse_sequential
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1415_grid_b29_bursty_streak_pattern__c15_reverse_sequential.c\n");
