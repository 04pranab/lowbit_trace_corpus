/*
 * LowBit -- 1646_grid_b33_uniform_random_block_runs__c46_cantor_gap_sparse.c
 * Branch: uniform_random_block_runs | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1646_grid_b33_uniform_random_block_runs__c46_cantor_gap_sparse.c\n");
