/*
 * LowBit -- 1824_grid_b37_value_driven_unswitch_run__c24_banked_interleaved_access.c
 * Branch: value_driven_unswitch_run | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1824_grid_b37_value_driven_unswitch_run__c24_banked_interleaved_access.c\n");
