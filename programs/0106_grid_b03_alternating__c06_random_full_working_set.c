/*
 * LowBit -- 0106_grid_b03_alternating__c06_random_full_working_set.c
 * Branch: alternating | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0106_grid_b03_alternating__c06_random_full_working_set.c\n");
