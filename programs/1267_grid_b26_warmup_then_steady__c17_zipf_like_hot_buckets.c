/*
 * LowBit -- 1267_grid_b26_warmup_then_steady__c17_zipf_like_hot_buckets.c
 * Branch: warmup_then_steady | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1267_grid_b26_warmup_then_steady__c17_zipf_like_hot_buckets.c\n");
