/*
 * LowBit -- 0193_grid_b04_periodic3__c43_whole_buffer_rotation.c
 * Branch: periodic3 | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0193_grid_b04_periodic3__c43_whole_buffer_rotation.c\n");
