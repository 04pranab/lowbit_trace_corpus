/*
 * LowBit -- 0276_grid_b06_pseudo_random_50__c26_geometric_stride_growth.c
 * Branch: pseudo_random_50 | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0276_grid_b06_pseudo_random_50__c26_geometric_stride_growth.c\n");
