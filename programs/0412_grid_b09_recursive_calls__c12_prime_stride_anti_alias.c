/*
 * LowBit -- 0412_grid_b09_recursive_calls__c12_prime_stride_anti_alias.c
 * Branch: recursive_calls | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0412_grid_b09_recursive_calls__c12_prime_stride_anti_alias.c\n");
