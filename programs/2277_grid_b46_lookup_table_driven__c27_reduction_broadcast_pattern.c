/*
 * LowBit -- 2277_grid_b46_lookup_table_driven__c27_reduction_broadcast_pattern.c
 * Branch: lookup_table_driven | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2277_grid_b46_lookup_table_driven__c27_reduction_broadcast_pattern.c\n");
