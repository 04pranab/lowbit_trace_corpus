/*
 * LowBit -- 2139_grid_b43_moving_average_threshold__c39_bounded_random_walk.c
 * Branch: moving_average_threshold | Cache: bounded_random_walk
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2139_grid_b43_moving_average_threshold__c39_bounded_random_walk.c\n");
