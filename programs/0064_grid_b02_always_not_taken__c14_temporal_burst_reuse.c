/*
 * LowBit -- 0064_grid_b02_always_not_taken__c14_temporal_burst_reuse.c
 * Branch: always_not_taken | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0064_grid_b02_always_not_taken__c14_temporal_burst_reuse.c\n");
