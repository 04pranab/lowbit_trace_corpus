/*
 * LowBit -- 1323_grid_b27_meta_correlated_nested__c23_struct_of_array_field_burst.c
 * Branch: meta_correlated_nested | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1323_grid_b27_meta_correlated_nested__c23_struct_of_array_field_burst.c\n");
