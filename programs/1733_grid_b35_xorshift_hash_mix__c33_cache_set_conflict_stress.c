/*
 * LowBit -- 1733_grid_b35_xorshift_hash_mix__c33_cache_set_conflict_stress.c
 * Branch: xorshift_hash_mix | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1733_grid_b35_xorshift_hash_mix__c33_cache_set_conflict_stress.c\n");
