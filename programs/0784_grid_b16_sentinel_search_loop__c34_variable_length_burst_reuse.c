/*
 * LowBit -- 0784_grid_b16_sentinel_search_loop__c34_variable_length_burst_reuse.c
 * Branch: sentinel_search_loop | Cache: variable_length_burst_reuse
...
int main(void) {
    ...
    printf("program=0784_grid_b16_sentinel_search_loop__c34_variable_length_burst_reuse.c\n");
