/*
 * LowBit -- 2581_base_cache_c31_fibonacci_stride.c
 * Branch: synthetic_always_taken | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=2581_base_cache_c31_fibonacci_stride.c\n");
