/*
 * LowBit -- 1618_grid_b33_uniform_random_block_runs__c18_producer_consumer_two_pointer.c
 * Branch: uniform_random_block_runs | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1618_grid_b33_uniform_random_block_runs__c18_producer_consumer_two_pointer.c\n");
