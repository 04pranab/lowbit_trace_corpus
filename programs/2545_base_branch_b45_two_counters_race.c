/*
 * LowBit -- 2545_base_branch_b45_two_counters_race.c
 * Branch: two_counters_race | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2545_base_branch_b45_two_counters_race.c\n");
