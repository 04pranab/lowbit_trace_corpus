/*
 * LowBit -- 2440_grid_b49_interleaved_two_pattern_multiplex__c40_causal_attention_triangular.c
 * Branch: interleaved_two_pattern_multiplex | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=2440_grid_b49_interleaved_two_pattern_multiplex__c40_causal_attention_triangular.c\n");
