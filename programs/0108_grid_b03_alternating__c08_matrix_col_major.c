/*
 * LowBit -- 0108_grid_b03_alternating__c08_matrix_col_major.c
 * Branch: alternating | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0108_grid_b03_alternating__c08_matrix_col_major.c\n");
