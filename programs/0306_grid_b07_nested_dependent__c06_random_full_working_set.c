/*
 * LowBit -- 0306_grid_b07_nested_dependent__c06_random_full_working_set.c
 * Branch: nested_dependent | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0306_grid_b07_nested_dependent__c06_random_full_working_set.c\n");
