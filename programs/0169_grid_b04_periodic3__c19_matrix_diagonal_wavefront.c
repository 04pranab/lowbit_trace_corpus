/*
 * LowBit -- 0169_grid_b04_periodic3__c19_matrix_diagonal_wavefront.c
 * Branch: periodic3 | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0169_grid_b04_periodic3__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=periodic3\n");
