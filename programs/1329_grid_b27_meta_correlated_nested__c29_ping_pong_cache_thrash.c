/*
 * LowBit -- 1329_grid_b27_meta_correlated_nested__c29_ping_pong_cache_thrash.c
 * Branch: meta_correlated_nested | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1329_grid_b27_meta_correlated_nested__c29_ping_pong_cache_thrash.c\n");
