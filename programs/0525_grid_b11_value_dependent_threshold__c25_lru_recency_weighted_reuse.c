/*
 * LowBit -- 0525_grid_b11_value_dependent_threshold__c25_lru_recency_weighted_reuse.c
 * Branch: value_dependent_threshold | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0525_grid_b11_value_dependent_threshold__c25_lru_recency_weighted_reuse.c\n");
