/*
 * LowBit -- 1394_grid_b28_data_driven_stack_machine__c44_naive_gemm_row_col_alternation.c
 * Branch: data_driven_stack_machine | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1394_grid_b28_data_driven_stack_machine__c44_naive_gemm_row_col_alternation.c\n");
