/*
 * LowBit -- 2427_grid_b49_interleaved_two_pattern_multiplex__c27_reduction_broadcast_pattern.c
 * Branch: interleaved_two_pattern_multiplex | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=2427_grid_b49_interleaved_two_pattern_multiplex__c27_reduction_broadcast_pattern.c\n");
