/*
 * LowBit -- 2301_grid_b47_mutual_ping_pong_recursion__c01_sequential_unit_stride.c
 * Branch: mutual_ping_pong_recursion | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2301_grid_b47_mutual_ping_pong_recursion__c01_sequential_unit_stride.c\n");
