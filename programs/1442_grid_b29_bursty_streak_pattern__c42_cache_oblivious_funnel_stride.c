/*
 * LowBit -- 1442_grid_b29_bursty_streak_pattern__c42_cache_oblivious_funnel_stride.c
 * Branch: bursty_streak_pattern | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1442_grid_b29_bursty_streak_pattern__c42_cache_oblivious_funnel_stride.c\n");
