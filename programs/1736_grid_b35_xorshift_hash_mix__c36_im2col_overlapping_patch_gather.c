/*
 * LowBit -- 1736_grid_b35_xorshift_hash_mix__c36_im2col_overlapping_patch_gather.c
 * Branch: xorshift_hash_mix | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1736_grid_b35_xorshift_hash_mix__c36_im2col_overlapping_patch_gather.c\n");
