/*
 * LowBit -- 1792_grid_b36_traffic_light_fsm__c42_cache_oblivious_funnel_stride.c
 * Branch: traffic_light_fsm | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1792_grid_b36_traffic_light_fsm__c42_cache_oblivious_funnel_stride.c\n");
