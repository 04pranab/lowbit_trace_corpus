/*
 * LowBit -- 2321_grid_b47_mutual_ping_pong_recursion__c21_pyramid_multiresolution_stride.c
 * Branch: mutual_ping_pong_recursion | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2321_grid_b47_mutual_ping_pong_recursion__c21_pyramid_multiresolution_stride.c\n");
