/*
 * LowBit -- 0202_grid_b05_periodic8_biased__c02_sequential_wraparound_large.c
 * Branch: periodic8_biased | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0202_grid_b05_periodic8_biased__c02_sequential_wraparound_large.c\n");
