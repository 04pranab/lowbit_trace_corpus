/*
 * LowBit -- 1660_grid_b34_data_driven_countdown__c10_pointer_chase_linked_list.c
 * Branch: data_driven_countdown | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1660_grid_b34_data_driven_countdown__c10_pointer_chase_linked_list.c\n");
