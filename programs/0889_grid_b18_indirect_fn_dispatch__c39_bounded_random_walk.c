/*
 * LowBit -- 0889_grid_b18_indirect_fn_dispatch__c39_bounded_random_walk.c
 * Branch: indirect_fn_dispatch | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0889_grid_b18_indirect_fn_dispatch__c39_bounded_random_walk.c\n");
