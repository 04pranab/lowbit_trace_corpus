/*
 * LowBit -- 0927_grid_b19_data_dependent_break_trip__c27_reduction_broadcast_pattern.c
 * Branch: data_dependent_break_trip | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0927_grid_b19_data_dependent_break_trip__c27_reduction_broadcast_pattern.c\n");
