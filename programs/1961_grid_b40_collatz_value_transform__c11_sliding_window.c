/*
 * LowBit -- 1961_grid_b40_collatz_value_transform__c11_sliding_window.c
 * Branch: collatz_value_transform | Cache: sliding_window
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1961_grid_b40_collatz_value_transform__c11_sliding_window.c\n");
