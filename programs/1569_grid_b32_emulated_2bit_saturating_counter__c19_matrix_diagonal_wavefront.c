/*
 * LowBit -- 1569_grid_b32_emulated_2bit_saturating_counter__c19_matrix_diagonal_wavefront.c
 * Branch: emulated_2bit_saturating_counter | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1569_grid_b32_emulated_2bit_saturating_counter__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=emulated_2bit_saturating_counter\n");
