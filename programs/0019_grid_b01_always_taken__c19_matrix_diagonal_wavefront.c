/*
 * LowBit -- 0019_grid_b01_always_taken__c19_matrix_diagonal_wavefront.c
 * Branch: always_taken | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0019_grid_b01_always_taken__c19_matrix_diagonal_wavefront.c\n");
