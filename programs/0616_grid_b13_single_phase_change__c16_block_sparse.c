/*
 * LowBit -- 0616_grid_b13_single_phase_change__c16_block_sparse.c
 * Branch: single_phase_change | Cache: block_sparse
...
int main(void) {
    ...
    printf("program=0616_grid_b13_single_phase_change__c16_block_sparse.c\n");
