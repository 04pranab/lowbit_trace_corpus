/*
 * LowBit -- 0087_grid_b02_always_not_taken__c37_double_buffer_epoch_alternation.c
 * Branch: always_not_taken | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0087_grid_b02_always_not_taken__c37_double_buffer_epoch_alternation.c\n");
