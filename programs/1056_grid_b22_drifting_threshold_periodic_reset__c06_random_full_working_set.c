/*
 * LowBit -- 1056_grid_b22_drifting_threshold_periodic_reset__c06_random_full_working_set.c
 * Branch: drifting_threshold_periodic_reset | Cache: random_full_working_set
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1056_grid_b22_drifting_threshold_periodic_reset__c06_random_full_working_set.c\n");
