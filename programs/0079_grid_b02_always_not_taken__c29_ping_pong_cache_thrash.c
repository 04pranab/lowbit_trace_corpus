/*
 * LowBit -- 0079_grid_b02_always_not_taken__c29_ping_pong_cache_thrash.c
 * Branch: always_not_taken | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0079_grid_b02_always_not_taken__c29_ping_pong_cache_thrash.c\n");
