/*
 * LowBit -- 0793_grid_b16_sentinel_search_loop__c43_whole_buffer_rotation.c
 * Branch: sentinel_search_loop | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0793_grid_b16_sentinel_search_loop__c43_whole_buffer_rotation.c\n");
