/*
 * LowBit -- 2366_grid_b48_variable_step_signed_countdown__c16_block_sparse.c
 * Branch: variable_step_signed_countdown | Cache: block_sparse
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2366_grid_b48_variable_step_signed_countdown__c16_block_sparse.c\n");
