/*
 * LowBit -- 2104_grid_b43_moving_average_threshold__c04_fixed_stride_large.c
 * Branch: moving_average_threshold | Cache: fixed_stride_large
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2104_grid_b43_moving_average_threshold__c04_fixed_stride_large.c\n");
