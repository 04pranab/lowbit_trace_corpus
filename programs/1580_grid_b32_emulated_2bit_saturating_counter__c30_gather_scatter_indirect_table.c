/*
 * LowBit -- 1580_grid_b32_emulated_2bit_saturating_counter__c30_gather_scatter_indirect_table.c
 * Branch: emulated_2bit_saturating_counter | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1580_grid_b32_emulated_2bit_saturating_counter__c30_gather_scatter_indirect_table.c\n");
