/*
 * LowBit -- 1793_grid_b36_traffic_light_fsm__c43_whole_buffer_rotation.c
 * Branch: traffic_light_fsm | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1793_grid_b36_traffic_light_fsm__c43_whole_buffer_rotation.c\n");
