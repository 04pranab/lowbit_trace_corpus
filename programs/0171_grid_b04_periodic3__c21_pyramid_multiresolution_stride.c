/*
 * LowBit -- 0171_grid_b04_periodic3__c21_pyramid_multiresolution_stride.c
 * Branch: periodic3 | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0171_grid_b04_periodic3__c21_pyramid_multiresolution_stride.c\n");
