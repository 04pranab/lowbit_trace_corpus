/*
 * LowBit -- 1341_grid_b27_meta_correlated_nested__c41_skip_list_multilevel_hop.c
 * Branch: meta_correlated_nested | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1341_grid_b27_meta_correlated_nested__c41_skip_list_multilevel_hop.c\n");
