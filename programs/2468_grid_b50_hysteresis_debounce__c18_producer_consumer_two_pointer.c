/*
 * LowBit -- 2468_grid_b50_hysteresis_debounce__c18_producer_consumer_two_pointer.c
 * Branch: hysteresis_debounce | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2468_grid_b50_hysteresis_debounce__c18_producer_consumer_two_pointer.c\n");
