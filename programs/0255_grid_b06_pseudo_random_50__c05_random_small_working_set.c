/*
 * LowBit -- 0255_grid_b06_pseudo_random_50__c05_random_small_working_set.c
 * Branch: pseudo_random_50 | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0255_grid_b06_pseudo_random_50__c05_random_small_working_set.c\n");
