/*
 * LowBit -- 2150_grid_b43_moving_average_threshold__c50_streaming_with_periodic_flush.c
 * Branch: moving_average_threshold | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2150_grid_b43_moving_average_threshold__c50_streaming_with_periodic_flush.c\n");
