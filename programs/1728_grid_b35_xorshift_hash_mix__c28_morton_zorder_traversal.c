/*
 * LowBit -- 1728_grid_b35_xorshift_hash_mix__c28_morton_zorder_traversal.c
 * Branch: xorshift_hash_mix | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1728_grid_b35_xorshift_hash_mix__c28_morton_zorder_traversal.c\n");
