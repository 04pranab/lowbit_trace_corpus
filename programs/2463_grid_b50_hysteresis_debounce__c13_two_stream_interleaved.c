/*
 * LowBit -- 2463_grid_b50_hysteresis_debounce__c13_two_stream_interleaved.c
 * Branch: hysteresis_debounce | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2463_grid_b50_hysteresis_debounce__c13_two_stream_interleaved.c\n");
