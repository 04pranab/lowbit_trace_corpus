/*
 * LowBit -- 0792_grid_b16_sentinel_search_loop__c42_cache_oblivious_funnel_stride.c
 * Branch: sentinel_search_loop | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0792_grid_b16_sentinel_search_loop__c42_cache_oblivious_funnel_stride.c\n");
