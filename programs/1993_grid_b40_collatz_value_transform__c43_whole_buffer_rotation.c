/*
 * LowBit -- 1993_grid_b40_collatz_value_transform__c43_whole_buffer_rotation.c
 * Branch: collatz_value_transform | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1993_grid_b40_collatz_value_transform__c43_whole_buffer_rotation.c\n");
