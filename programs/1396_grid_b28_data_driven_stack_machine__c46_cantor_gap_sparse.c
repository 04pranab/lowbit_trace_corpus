/*
 * LowBit -- 1396_grid_b28_data_driven_stack_machine__c46_cantor_gap_sparse.c
 * Branch: data_driven_stack_machine | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1396_grid_b28_data_driven_stack_machine__c46_cantor_gap_sparse.c\n");
