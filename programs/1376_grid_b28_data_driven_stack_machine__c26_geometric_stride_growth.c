/*
 * LowBit -- 1376_grid_b28_data_driven_stack_machine__c26_geometric_stride_growth.c
 * Branch: data_driven_stack_machine | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1376_grid_b28_data_driven_stack_machine__c26_geometric_stride_growth.c\n");
