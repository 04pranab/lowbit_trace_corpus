/*
 * LowBit -- 0281_grid_b06_pseudo_random_50__c31_fibonacci_stride.c
 * Branch: pseudo_random_50 | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0281_grid_b06_pseudo_random_50__c31_fibonacci_stride.c\n");
