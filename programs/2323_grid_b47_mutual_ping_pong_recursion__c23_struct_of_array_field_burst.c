/*
 * LowBit -- 2323_grid_b47_mutual_ping_pong_recursion__c23_struct_of_array_field_burst.c
 * Branch: mutual_ping_pong_recursion | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2323_grid_b47_mutual_ping_pong_recursion__c23_struct_of_array_field_burst.c\n");
