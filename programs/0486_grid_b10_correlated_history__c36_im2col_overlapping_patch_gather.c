/*
 * LowBit -- 0486_grid_b10_correlated_history__c36_im2col_overlapping_patch_gather.c
 * Branch: correlated_history | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0486_grid_b10_correlated_history__c36_im2col_overlapping_patch_gather.c\n");
