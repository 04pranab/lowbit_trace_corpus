/*
 * LowBit -- 1575_grid_b32_emulated_2bit_saturating_counter__c25_lru_recency_weighted_reuse.c
 * Branch: emulated_2bit_saturating_counter | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1575_grid_b32_emulated_2bit_saturating_counter__c25_lru_recency_weighted_reuse.c\n");
