/*
 * LowBit -- 0756_grid_b16_sentinel_search_loop__c06_random_full_working_set.c
 * Branch: sentinel_search_loop | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0756_grid_b16_sentinel_search_loop__c06_random_full_working_set.c\n");
