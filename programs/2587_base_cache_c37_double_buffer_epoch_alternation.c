/*
 * LowBit -- 2587_base_cache_c37_double_buffer_epoch_alternation.c
 * Branch: synthetic_always_taken | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=2587_base_cache_c37_double_buffer_epoch_alternation.c\n");
