/*
 * LowBit -- 0366_grid_b08_switch_multiway__c16_block_sparse.c
 * Branch: switch_multiway | Cache: block_sparse
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0366_grid_b08_switch_multiway__c16_block_sparse.c\n");
