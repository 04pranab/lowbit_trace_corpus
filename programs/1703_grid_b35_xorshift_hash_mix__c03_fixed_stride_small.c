/*
 * LowBit -- 1703_grid_b35_xorshift_hash_mix__c03_fixed_stride_small.c
 * Branch: xorshift_hash_mix | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1703_grid_b35_xorshift_hash_mix__c03_fixed_stride_small.c\n");
