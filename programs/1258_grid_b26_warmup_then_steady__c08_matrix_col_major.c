/*
 * LowBit -- 1258_grid_b26_warmup_then_steady__c08_matrix_col_major.c
 * Branch: warmup_then_steady | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1258_grid_b26_warmup_then_steady__c08_matrix_col_major.c\n");
