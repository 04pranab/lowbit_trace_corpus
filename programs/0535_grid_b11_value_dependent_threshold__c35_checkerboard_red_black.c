/*
 * LowBit -- 0535_grid_b11_value_dependent_threshold__c35_checkerboard_red_black.c
 * Branch: value_dependent_threshold | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0535_grid_b11_value_dependent_threshold__c35_checkerboard_red_black.c\n");
