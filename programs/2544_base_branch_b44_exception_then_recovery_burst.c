/*
 * LowBit -- 2544_base_branch_b44_exception_then_recovery_burst.c
 * Branch: exception_then_recovery_burst | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2544_base_branch_b44_exception_then_recovery_burst.c\n");
