/*
 * LowBit -- 0093_grid_b02_always_not_taken__c43_whole_buffer_rotation.c
 * Branch: always_not_taken | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0093_grid_b02_always_not_taken__c43_whole_buffer_rotation.c\n");
