/*
 * LowBit -- 0664_grid_b14_four_way_skewed__c14_temporal_burst_reuse.c
 * Branch: four_way_skewed | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0664_grid_b14_four_way_skewed__c14_temporal_burst_reuse.c\n");
