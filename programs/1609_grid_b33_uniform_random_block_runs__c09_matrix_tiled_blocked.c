/*
 * LowBit -- 1609_grid_b33_uniform_random_block_runs__c09_matrix_tiled_blocked.c
 * Branch: uniform_random_block_runs | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1609_grid_b33_uniform_random_block_runs__c09_matrix_tiled_blocked.c\n");
