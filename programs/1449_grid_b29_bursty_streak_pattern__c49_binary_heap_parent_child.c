/*
 * LowBit -- 1449_grid_b29_bursty_streak_pattern__c49_binary_heap_parent_child.c
 * Branch: bursty_streak_pattern | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1449_grid_b29_bursty_streak_pattern__c49_binary_heap_parent_child.c\n");
