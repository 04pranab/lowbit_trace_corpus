/*
 * LowBit -- 0298_grid_b06_pseudo_random_50__c48_exponential_backoff_probe.c
 * Branch: pseudo_random_50 | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0298_grid_b06_pseudo_random_50__c48_exponential_backoff_probe.c\n");
