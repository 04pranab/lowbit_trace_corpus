/*
 * LowBit -- 1102_grid_b23_popcount_parity__c02_sequential_wraparound_large.c
 * Branch: popcount_parity | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1102_grid_b23_popcount_parity__c02_sequential_wraparound_large.c\n");
