/*
 * LowBit -- 0807_grid_b17_correlated_two_branch_xor__c07_matrix_row_major.c
 * Branch: correlated_two_branch_xor | Cache: matrix_row_major
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0807_grid_b17_correlated_two_branch_xor__c07_matrix_row_major.c\n");
