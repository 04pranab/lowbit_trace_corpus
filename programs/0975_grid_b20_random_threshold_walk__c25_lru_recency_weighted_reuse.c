/*
 * LowBit -- 0975_grid_b20_random_threshold_walk__c25_lru_recency_weighted_reuse.c
 * Branch: random_threshold_walk | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0975_grid_b20_random_threshold_walk__c25_lru_recency_weighted_reuse.c\n");
