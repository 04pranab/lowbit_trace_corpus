/*
 * LowBit -- 1723_grid_b35_xorshift_hash_mix__c23_struct_of_array_field_burst.c
 * Branch: xorshift_hash_mix | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1723_grid_b35_xorshift_hash_mix__c23_struct_of_array_field_burst.c\n");
