/*
 * LowBit -- 2439_grid_b49_interleaved_two_pattern_multiplex__c39_bounded_random_walk.c
 * Branch: interleaved_two_pattern_multiplex | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=2439_grid_b49_interleaved_two_pattern_multiplex__c39_bounded_random_walk.c\n");
