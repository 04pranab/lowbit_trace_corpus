/*
 * LowBit -- 0523_grid_b11_value_dependent_threshold__c23_struct_of_array_field_burst.c
 * Branch: value_dependent_threshold | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0523_grid_b11_value_dependent_threshold__c23_struct_of_array_field_burst.c\n");
