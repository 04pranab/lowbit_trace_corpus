/*
 * LowBit -- 2222_grid_b45_two_counters_race__c22_tensor_3d_slice_poor_locality.c
 * Branch: two_counters_race | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2222_grid_b45_two_counters_race__c22_tensor_3d_slice_poor_locality.c\n");
