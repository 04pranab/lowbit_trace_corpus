/*
 * LowBit -- 1739_grid_b35_xorshift_hash_mix__c39_bounded_random_walk.c
 * Branch: xorshift_hash_mix | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1739_grid_b35_xorshift_hash_mix__c39_bounded_random_walk.c\n");
