/*
 * LowBit -- 1505_grid_b31_prime_period13__c05_random_small_working_set.c
 * Branch: prime_period13 | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=1505_grid_b31_prime_period13__c05_random_small_working_set.c\n");
