/*
 * LowBit -- 1150_grid_b23_popcount_parity__c50_streaming_with_periodic_flush.c
 * Branch: popcount_parity | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1150_grid_b23_popcount_parity__c50_streaming_with_periodic_flush.c\n");
