/*
 * LowBit -- 0121_grid_b03_alternating__c21_pyramid_multiresolution_stride.c
 * Branch: alternating | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0121_grid_b03_alternating__c21_pyramid_multiresolution_stride.c\n");
