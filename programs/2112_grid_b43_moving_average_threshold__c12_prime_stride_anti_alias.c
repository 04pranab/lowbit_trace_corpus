/*
 * LowBit -- 2112_grid_b43_moving_average_threshold__c12_prime_stride_anti_alias.c
 * Branch: moving_average_threshold | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2112_grid_b43_moving_average_threshold__c12_prime_stride_anti_alias.c\n");
