/*
 * LowBit -- 1475_grid_b30_periodic_interrupt_override__c25_lru_recency_weighted_reuse.c
 * Branch: periodic_interrupt_override | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=1475_grid_b30_periodic_interrupt_override__c25_lru_recency_weighted_reuse.c\n");
