/*
 * LowBit -- 2163_grid_b44_exception_then_recovery_burst__c13_two_stream_interleaved.c
 * Branch: exception_then_recovery_burst | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2163_grid_b44_exception_then_recovery_burst__c13_two_stream_interleaved.c\n");
