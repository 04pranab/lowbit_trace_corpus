/*
 * LowBit -- 2405_grid_b49_interleaved_two_pattern_multiplex__c05_random_small_working_set.c
 * Branch: interleaved_two_pattern_multiplex | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=2405_grid_b49_interleaved_two_pattern_multiplex__c05_random_small_working_set.c\n");
