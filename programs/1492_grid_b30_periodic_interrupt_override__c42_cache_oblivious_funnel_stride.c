/*
 * LowBit -- 1492_grid_b30_periodic_interrupt_override__c42_cache_oblivious_funnel_stride.c
 * Branch: periodic_interrupt_override | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=1492_grid_b30_periodic_interrupt_override__c42_cache_oblivious_funnel_stride.c\n");
