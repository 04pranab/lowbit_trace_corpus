/*
 * LowBit -- 2166_grid_b44_exception_then_recovery_burst__c16_block_sparse.c
 * Branch: exception_then_recovery_burst | Cache: block_sparse
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2166_grid_b44_exception_then_recovery_burst__c16_block_sparse.c\n");
