/*
 * LowBit -- 0946_grid_b19_data_dependent_break_trip__c46_cantor_gap_sparse.c
 * Branch: data_dependent_break_trip | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0946_grid_b19_data_dependent_break_trip__c46_cantor_gap_sparse.c\n");
