/*
 * LowBit -- 1104_grid_b23_popcount_parity__c04_fixed_stride_large.c
 * Branch: popcount_parity | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1104_grid_b23_popcount_parity__c04_fixed_stride_large.c\n");
