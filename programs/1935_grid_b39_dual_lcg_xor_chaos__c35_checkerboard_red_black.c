/*
 * LowBit -- 1935_grid_b39_dual_lcg_xor_chaos__c35_checkerboard_red_black.c
 * Branch: dual_lcg_xor_chaos | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1935_grid_b39_dual_lcg_xor_chaos__c35_checkerboard_red_black.c\n");
