/*
 * LowBit -- 1835_grid_b37_value_driven_unswitch_run__c35_checkerboard_red_black.c
 * Branch: value_driven_unswitch_run | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1835_grid_b37_value_driven_unswitch_run__c35_checkerboard_red_black.c\n");
