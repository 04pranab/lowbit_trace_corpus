/*
 * LowBit -- 1182_grid_b24_monotonic_drift_saturating__c32_hilbert_curve_traversal.c
 * Branch: monotonic_drift_saturating | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1182_grid_b24_monotonic_drift_saturating__c32_hilbert_curve_traversal.c\n");
