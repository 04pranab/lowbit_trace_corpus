/*
 * LowBit -- 2153_grid_b44_exception_then_recovery_burst__c03_fixed_stride_small.c
 * Branch: exception_then_recovery_burst | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2153_grid_b44_exception_then_recovery_burst__c03_fixed_stride_small.c\n");
