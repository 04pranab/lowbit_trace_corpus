/*
 * LowBit -- 0954_grid_b20_random_threshold_walk__c04_fixed_stride_large.c
 * Branch: random_threshold_walk | Cache: fixed_stride_large
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0954_grid_b20_random_threshold_walk__c04_fixed_stride_large.c\n");
