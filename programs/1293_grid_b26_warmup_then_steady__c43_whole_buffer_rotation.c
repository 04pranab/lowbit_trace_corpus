/*
 * LowBit -- 1293_grid_b26_warmup_then_steady__c43_whole_buffer_rotation.c
 * Branch: warmup_then_steady | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1293_grid_b26_warmup_then_steady__c43_whole_buffer_rotation.c\n");
