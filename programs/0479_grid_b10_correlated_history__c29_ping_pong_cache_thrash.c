/*
 * LowBit -- 0479_grid_b10_correlated_history__c29_ping_pong_cache_thrash.c
 * Branch: correlated_history | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0479_grid_b10_correlated_history__c29_ping_pong_cache_thrash.c\n");
