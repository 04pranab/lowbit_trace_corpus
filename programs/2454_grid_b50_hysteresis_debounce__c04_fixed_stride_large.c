/*
 * LowBit -- 2454_grid_b50_hysteresis_debounce__c04_fixed_stride_large.c
 * Branch: hysteresis_debounce | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2454_grid_b50_hysteresis_debounce__c04_fixed_stride_large.c\n");
