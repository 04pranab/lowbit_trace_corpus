/*
 * LowBit -- 1895_grid_b38_decaying_hazard_probability__c45_read_hot_write_cold_split.c
 * Branch: decaying_hazard_probability | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1895_grid_b38_decaying_hazard_probability__c45_read_hot_write_cold_split.c\n");
