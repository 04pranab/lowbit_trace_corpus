/*
 * LowBit -- 0913_grid_b19_data_dependent_break_trip__c13_two_stream_interleaved.c
 * Branch: data_dependent_break_trip | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0913_grid_b19_data_dependent_break_trip__c13_two_stream_interleaved.c\n");
