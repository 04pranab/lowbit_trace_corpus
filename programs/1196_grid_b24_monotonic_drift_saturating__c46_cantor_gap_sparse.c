/*
 * LowBit -- 1196_grid_b24_monotonic_drift_saturating__c46_cantor_gap_sparse.c
 * Branch: monotonic_drift_saturating | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1196_grid_b24_monotonic_drift_saturating__c46_cantor_gap_sparse.c\n");
