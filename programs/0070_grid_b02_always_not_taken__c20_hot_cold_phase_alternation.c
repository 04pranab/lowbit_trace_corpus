/*
 * LowBit -- 0070_grid_b02_always_not_taken__c20_hot_cold_phase_alternation.c
 * Branch: always_not_taken | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0070_grid_b02_always_not_taken__c20_hot_cold_phase_alternation.c\n");
