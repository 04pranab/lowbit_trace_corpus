/*
 * LowBit -- 2492_grid_b50_hysteresis_debounce__c42_cache_oblivious_funnel_stride.c
 * Branch: hysteresis_debounce | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2492_grid_b50_hysteresis_debounce__c42_cache_oblivious_funnel_stride.c\n");
