/*
 * LowBit -- 1061_grid_b22_drifting_threshold_periodic_reset__c11_sliding_window.c
 * Branch: drifting_threshold_periodic_reset | Cache: sliding_window
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1061_grid_b22_drifting_threshold_periodic_reset__c11_sliding_window.c\n");
