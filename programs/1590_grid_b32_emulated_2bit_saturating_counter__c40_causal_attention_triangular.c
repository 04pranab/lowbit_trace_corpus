/*
 * LowBit -- 1590_grid_b32_emulated_2bit_saturating_counter__c40_causal_attention_triangular.c
 * Branch: emulated_2bit_saturating_counter | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1590_grid_b32_emulated_2bit_saturating_counter__c40_causal_attention_triangular.c\n");
