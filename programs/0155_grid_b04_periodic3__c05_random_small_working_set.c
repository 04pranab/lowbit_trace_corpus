/*
 * LowBit -- 0155_grid_b04_periodic3__c05_random_small_working_set.c
 * Branch: periodic3 | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0155_grid_b04_periodic3__c05_random_small_working_set.c\n");
