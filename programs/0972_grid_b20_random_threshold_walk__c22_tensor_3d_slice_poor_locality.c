/*
 * LowBit -- 0972_grid_b20_random_threshold_walk__c22_tensor_3d_slice_poor_locality.c
 * Branch: random_threshold_walk | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0972_grid_b20_random_threshold_walk__c22_tensor_3d_slice_poor_locality.c\n");
