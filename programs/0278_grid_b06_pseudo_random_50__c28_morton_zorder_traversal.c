/*
 * LowBit -- 0278_grid_b06_pseudo_random_50__c28_morton_zorder_traversal.c
 * Branch: pseudo_random_50 | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0278_grid_b06_pseudo_random_50__c28_morton_zorder_traversal.c\n");
