/*
 * LowBit -- 2336_grid_b47_mutual_ping_pong_recursion__c36_im2col_overlapping_patch_gather.c
 * Branch: mutual_ping_pong_recursion | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2336_grid_b47_mutual_ping_pong_recursion__c36_im2col_overlapping_patch_gather.c\n");
