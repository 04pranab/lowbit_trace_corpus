/*
 * LowBit -- 1748_grid_b35_xorshift_hash_mix__c48_exponential_backoff_probe.c
 * Branch: xorshift_hash_mix | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1748_grid_b35_xorshift_hash_mix__c48_exponential_backoff_probe.c\n");
