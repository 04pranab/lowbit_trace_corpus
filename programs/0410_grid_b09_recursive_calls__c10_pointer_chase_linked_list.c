/*
 * LowBit -- 0410_grid_b09_recursive_calls__c10_pointer_chase_linked_list.c
 * Branch: recursive_calls | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0410_grid_b09_recursive_calls__c10_pointer_chase_linked_list.c\n");
