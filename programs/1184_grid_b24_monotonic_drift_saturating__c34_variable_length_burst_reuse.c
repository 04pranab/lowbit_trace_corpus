/*
 * LowBit -- 1184_grid_b24_monotonic_drift_saturating__c34_variable_length_burst_reuse.c
 * Branch: monotonic_drift_saturating | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1184_grid_b24_monotonic_drift_saturating__c34_variable_length_burst_reuse.c\n");
