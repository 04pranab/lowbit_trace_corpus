/*
 * LowBit -- 0343_grid_b07_nested_dependent__c43_whole_buffer_rotation.c
 * Branch: nested_dependent | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0343_grid_b07_nested_dependent__c43_whole_buffer_rotation.c\n");
