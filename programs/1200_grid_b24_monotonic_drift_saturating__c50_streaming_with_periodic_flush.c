/*
 * LowBit -- 1200_grid_b24_monotonic_drift_saturating__c50_streaming_with_periodic_flush.c
 * Branch: monotonic_drift_saturating | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1200_grid_b24_monotonic_drift_saturating__c50_streaming_with_periodic_flush.c\n");
