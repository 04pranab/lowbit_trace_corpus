/*
 * LowBit -- 0323_grid_b07_nested_dependent__c23_struct_of_array_field_burst.c
 * Branch: nested_dependent | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0323_grid_b07_nested_dependent__c23_struct_of_array_field_burst.c\n");
