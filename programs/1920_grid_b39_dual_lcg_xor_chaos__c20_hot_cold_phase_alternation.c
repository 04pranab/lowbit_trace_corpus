/*
 * LowBit -- 1920_grid_b39_dual_lcg_xor_chaos__c20_hot_cold_phase_alternation.c
 * Branch: dual_lcg_xor_chaos | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1920_grid_b39_dual_lcg_xor_chaos__c20_hot_cold_phase_alternation.c\n");
