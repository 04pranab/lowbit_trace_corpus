/*
 * LowBit -- 1915_grid_b39_dual_lcg_xor_chaos__c15_reverse_sequential.c
 * Branch: dual_lcg_xor_chaos | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1915_grid_b39_dual_lcg_xor_chaos__c15_reverse_sequential.c\n");
