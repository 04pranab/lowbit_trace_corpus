/*
 * LowBit -- 0683_grid_b14_four_way_skewed__c33_cache_set_conflict_stress.c
 * Branch: four_way_skewed | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0683_grid_b14_four_way_skewed__c33_cache_set_conflict_stress.c\n");
