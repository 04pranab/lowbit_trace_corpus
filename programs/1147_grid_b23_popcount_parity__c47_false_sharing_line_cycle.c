/*
 * LowBit -- 1147_grid_b23_popcount_parity__c47_false_sharing_line_cycle.c
 * Branch: popcount_parity | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1147_grid_b23_popcount_parity__c47_false_sharing_line_cycle.c\n");
