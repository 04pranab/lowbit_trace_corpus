/*
 * LowBit -- 1357_grid_b28_data_driven_stack_machine__c07_matrix_row_major.c
 * Branch: data_driven_stack_machine | Cache: matrix_row_major
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1357_grid_b28_data_driven_stack_machine__c07_matrix_row_major.c\n");
