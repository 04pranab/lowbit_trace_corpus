/*
 * LowBit -- 2296_grid_b46_lookup_table_driven__c46_cantor_gap_sparse.c
 * Branch: lookup_table_driven | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ uint32_t n46_ = (uint32_t)(i % SIZE); uint32_t t46_ = n46_; int valid46_ = 1;
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2296_grid_b46_lookup_table_driven__c46_cantor_gap_sparse.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=cantor_gap_sparse\n");
    printf("predictor_stress_type=stochastic\n");
    printf("expected_dominant_miss_type=compulsory (sparse, low reuse)\n");
