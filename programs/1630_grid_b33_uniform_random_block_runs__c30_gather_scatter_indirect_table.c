/*
 * LowBit -- 1630_grid_b33_uniform_random_block_runs__c30_gather_scatter_indirect_table.c
 * Branch: uniform_random_block_runs | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1630_grid_b33_uniform_random_block_runs__c30_gather_scatter_indirect_table.c\n");
