/*
 * LowBit -- 0411_grid_b09_recursive_calls__c11_sliding_window.c
 * Branch: recursive_calls | Cache: sliding_window
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0411_grid_b09_recursive_calls__c11_sliding_window.c\n");
