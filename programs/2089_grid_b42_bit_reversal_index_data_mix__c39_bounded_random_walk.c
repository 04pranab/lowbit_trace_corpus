/*
 * LowBit -- 2089_grid_b42_bit_reversal_index_data_mix__c39_bounded_random_walk.c
 * Branch: bit_reversal_index_data_mix | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2089_grid_b42_bit_reversal_index_data_mix__c39_bounded_random_walk.c\n");
