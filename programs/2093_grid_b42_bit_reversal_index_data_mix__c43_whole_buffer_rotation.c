/*
 * LowBit -- 2093_grid_b42_bit_reversal_index_data_mix__c43_whole_buffer_rotation.c
 * Branch: bit_reversal_index_data_mix | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2093_grid_b42_bit_reversal_index_data_mix__c43_whole_buffer_rotation.c\n");
