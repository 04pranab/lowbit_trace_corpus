/*
 * LowBit -- 1819_grid_b37_value_driven_unswitch_run__c19_matrix_diagonal_wavefront.c
 * Branch: value_driven_unswitch_run | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1819_grid_b37_value_driven_unswitch_run__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=value_driven_unswitch_run\n");
    printf("cache_pattern=matrix_diagonal_wavefront\n");
    printf("predictor_stress_type=indirect-branch\n");
