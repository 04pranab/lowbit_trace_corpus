/*
 * LowBit -- 1745_grid_b35_xorshift_hash_mix__c45_read_hot_write_cold_split.c
 * Branch: xorshift_hash_mix | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1745_grid_b35_xorshift_hash_mix__c45_read_hot_write_cold_split.c\n");
