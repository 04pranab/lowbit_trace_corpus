/*
 * LowBit -- 2180_grid_b44_exception_then_recovery_burst__c30_gather_scatter_indirect_table.c
 * Branch: exception_then_recovery_burst | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2180_grid_b44_exception_then_recovery_burst__c30_gather_scatter_indirect_table.c\n");
