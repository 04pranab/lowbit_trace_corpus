/*
 * LowBit -- 0608_grid_b13_single_phase_change__c08_matrix_col_major.c
 * Branch: single_phase_change | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0608_grid_b13_single_phase_change__c08_matrix_col_major.c\n");
