/*
 * LowBit -- 0691_grid_b14_four_way_skewed__c41_skip_list_multilevel_hop.c
 * Branch: four_way_skewed | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0691_grid_b14_four_way_skewed__c41_skip_list_multilevel_hop.c\n");
