/*
 * LowBit -- 2548_base_branch_b48_variable_step_signed_countdown.c
 * Branch: variable_step_signed_countdown | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2548_base_branch_b48_variable_step_signed_countdown.c\n");
