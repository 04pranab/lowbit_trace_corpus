/*
 * LowBit -- 2378_grid_b48_variable_step_signed_countdown__c28_morton_zorder_traversal.c
 * Branch: variable_step_signed_countdown | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2378_grid_b48_variable_step_signed_countdown__c28_morton_zorder_traversal.c\n");
