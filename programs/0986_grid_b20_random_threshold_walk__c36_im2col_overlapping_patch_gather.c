/*
 * LowBit -- 0986_grid_b20_random_threshold_walk__c36_im2col_overlapping_patch_gather.c
 * Branch: random_threshold_walk | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0986_grid_b20_random_threshold_walk__c36_im2col_overlapping_patch_gather.c\n");
