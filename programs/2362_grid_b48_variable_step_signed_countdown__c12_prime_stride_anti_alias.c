/*
 * LowBit -- 2362_grid_b48_variable_step_signed_countdown__c12_prime_stride_anti_alias.c
 * Branch: variable_step_signed_countdown | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2362_grid_b48_variable_step_signed_countdown__c12_prime_stride_anti_alias.c\n");
