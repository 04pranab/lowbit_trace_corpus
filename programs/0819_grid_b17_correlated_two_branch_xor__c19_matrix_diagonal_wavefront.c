/*
 * LowBit -- 0819_grid_b17_correlated_two_branch_xor__c19_matrix_diagonal_wavefront.c
 * Branch: correlated_two_branch_xor | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0819_grid_b17_correlated_two_branch_xor__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=correlated_two_branch_xor\n");
