/*
 * LowBit -- 2318_grid_b47_mutual_ping_pong_recursion__c18_producer_consumer_two_pointer.c
 * Branch: mutual_ping_pong_recursion | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2318_grid_b47_mutual_ping_pong_recursion__c18_producer_consumer_two_pointer.c\n");
