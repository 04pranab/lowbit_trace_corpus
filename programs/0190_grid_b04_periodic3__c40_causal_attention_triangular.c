/*
 * LowBit -- 0190_grid_b04_periodic3__c40_causal_attention_triangular.c
 * Branch: periodic3 | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0190_grid_b04_periodic3__c40_causal_attention_triangular.c\n");
