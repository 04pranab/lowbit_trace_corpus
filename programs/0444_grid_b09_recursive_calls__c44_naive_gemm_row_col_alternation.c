/*
 * LowBit -- 0444_grid_b09_recursive_calls__c44_naive_gemm_row_col_alternation.c
 * Branch: recursive_calls | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0444_grid_b09_recursive_calls__c44_naive_gemm_row_col_alternation.c\n");
