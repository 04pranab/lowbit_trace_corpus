/*
 * LowBit -- 1408_grid_b29_bursty_streak_pattern__c08_matrix_col_major.c
 * Branch: bursty_streak_pattern | Cache: matrix_col_major
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1408_grid_b29_bursty_streak_pattern__c08_matrix_col_major.c\n");
