/*
 * LowBit -- 1185_grid_b24_monotonic_drift_saturating__c35_checkerboard_red_black.c
 * Branch: monotonic_drift_saturating | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1185_grid_b24_monotonic_drift_saturating__c35_checkerboard_red_black.c\n");
