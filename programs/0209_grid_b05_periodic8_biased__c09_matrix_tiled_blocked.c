/*
 * LowBit -- 0209_grid_b05_periodic8_biased__c09_matrix_tiled_blocked.c
 * Branch: periodic8_biased | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0209_grid_b05_periodic8_biased__c09_matrix_tiled_blocked.c\n");
