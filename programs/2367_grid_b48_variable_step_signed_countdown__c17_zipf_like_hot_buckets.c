/*
 * LowBit -- 2367_grid_b48_variable_step_signed_countdown__c17_zipf_like_hot_buckets.c
 * Branch: variable_step_signed_countdown | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2367_grid_b48_variable_step_signed_countdown__c17_zipf_like_hot_buckets.c\n");
