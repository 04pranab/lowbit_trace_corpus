/*
 * LowBit -- 0147_grid_b03_alternating__c47_false_sharing_line_cycle.c
 * Branch: alternating | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0147_grid_b03_alternating__c47_false_sharing_line_cycle.c\n");
