/*
 * LowBit -- 0746_grid_b15_manual_unroll4_sparse__c46_cantor_gap_sparse.c
 * Branch: manual_unroll4_sparse | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0746_grid_b15_manual_unroll4_sparse__c46_cantor_gap_sparse.c\n");
