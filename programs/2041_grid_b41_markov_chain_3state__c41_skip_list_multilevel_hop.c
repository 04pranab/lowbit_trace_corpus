/*
 * LowBit -- 2041_grid_b41_markov_chain_3state__c41_skip_list_multilevel_hop.c
 * Branch: markov_chain_3state | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2041_grid_b41_markov_chain_3state__c41_skip_list_multilevel_hop.c\n");
