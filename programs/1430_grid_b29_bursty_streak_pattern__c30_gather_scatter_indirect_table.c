/*
 * LowBit -- 1430_grid_b29_bursty_streak_pattern__c30_gather_scatter_indirect_table.c
 * Branch: bursty_streak_pattern | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1430_grid_b29_bursty_streak_pattern__c30_gather_scatter_indirect_table.c\n");
