/*
 * LowBit -- 0002_grid_b01_always_taken__c02_sequential_wraparound_large.c
 * Branch: always_taken | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0002_grid_b01_always_taken__c02_sequential_wraparound_large.c\n");
