/*
 * LowBit -- 0906_grid_b19_data_dependent_break_trip__c06_random_full_working_set.c
 * Branch: data_dependent_break_trip | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0906_grid_b19_data_dependent_break_trip__c06_random_full_working_set.c\n");
