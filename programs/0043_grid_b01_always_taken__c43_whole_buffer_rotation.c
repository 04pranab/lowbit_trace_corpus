/*
 * LowBit -- 0043_grid_b01_always_taken__c43_whole_buffer_rotation.c
 * Branch: always_taken | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0043_grid_b01_always_taken__c43_whole_buffer_rotation.c\n");
