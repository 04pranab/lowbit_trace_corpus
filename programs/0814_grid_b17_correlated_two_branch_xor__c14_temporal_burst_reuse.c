/*
 * LowBit -- 0814_grid_b17_correlated_two_branch_xor__c14_temporal_burst_reuse.c
 * Branch: correlated_two_branch_xor | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0814_grid_b17_correlated_two_branch_xor__c14_temporal_burst_reuse.c\n");
