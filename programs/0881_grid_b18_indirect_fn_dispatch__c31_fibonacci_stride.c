/*
 * LowBit -- 0881_grid_b18_indirect_fn_dispatch__c31_fibonacci_stride.c
 * Branch: indirect_fn_dispatch | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0881_grid_b18_indirect_fn_dispatch__c31_fibonacci_stride.c\n");
