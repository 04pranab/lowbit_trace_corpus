/*
 * LowBit -- 1594_grid_b32_emulated_2bit_saturating_counter__c44_naive_gemm_row_col_alternation.c
 * Branch: emulated_2bit_saturating_counter | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1594_grid_b32_emulated_2bit_saturating_counter__c44_naive_gemm_row_col_alternation.c\n");
