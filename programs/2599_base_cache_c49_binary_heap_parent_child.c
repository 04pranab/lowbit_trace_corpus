/*
 * LowBit -- 2599_base_cache_c49_binary_heap_parent_child.c
 * Branch: synthetic_always_taken | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=2599_base_cache_c49_binary_heap_parent_child.c\n");
