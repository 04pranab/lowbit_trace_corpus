/*
 * LowBit -- 0053_grid_b02_always_not_taken__c03_fixed_stride_small.c
 * Branch: always_not_taken | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0053_grid_b02_always_not_taken__c03_fixed_stride_small.c\n");
