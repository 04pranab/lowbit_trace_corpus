/*
 * LowBit -- 0257_grid_b06_pseudo_random_50__c07_matrix_row_major.c
 * Branch: pseudo_random_50 | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0257_grid_b06_pseudo_random_50__c07_matrix_row_major.c\n");
