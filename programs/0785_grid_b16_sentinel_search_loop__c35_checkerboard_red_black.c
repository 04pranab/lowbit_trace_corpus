/*
 * LowBit -- 0785_grid_b16_sentinel_search_loop__c35_checkerboard_red_black.c
 * Branch: sentinel_search_loop | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0785_grid_b16_sentinel_search_loop__c35_checkerboard_red_black.c\n");
