/*
 * LowBit -- 0207_grid_b05_periodic8_biased__c07_matrix_row_major.c
 * Branch: periodic8_biased | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0207_grid_b05_periodic8_biased__c07_matrix_row_major.c\n");
