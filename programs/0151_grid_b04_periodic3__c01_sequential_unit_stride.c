/*
 * LowBit -- 0151_grid_b04_periodic3__c01_sequential_unit_stride.c
 * Branch: periodic3 | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0151_grid_b04_periodic3__c01_sequential_unit_stride.c\n");
