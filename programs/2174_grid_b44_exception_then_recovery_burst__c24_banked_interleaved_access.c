/*
 * LowBit -- 2174_grid_b44_exception_then_recovery_burst__c24_banked_interleaved_access.c
 * Branch: exception_then_recovery_burst | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2174_grid_b44_exception_then_recovery_burst__c24_banked_interleaved_access.c\n");
