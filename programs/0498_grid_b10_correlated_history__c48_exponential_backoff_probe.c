/*
 * LowBit -- 0498_grid_b10_correlated_history__c48_exponential_backoff_probe.c
 * Branch: correlated_history | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0498_grid_b10_correlated_history__c48_exponential_backoff_probe.c\n");
