/*
 * LowBit -- 2390_grid_b48_variable_step_signed_countdown__c40_causal_attention_triangular.c
 * Branch: variable_step_signed_countdown | Cache: causal_attention_triangular
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2390_grid_b48_variable_step_signed_countdown__c40_causal_attention_triangular.c\n");
