/*
 * LowBit -- 1482_grid_b30_periodic_interrupt_override__c32_hilbert_curve_traversal.c
 * Branch: periodic_interrupt_override | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=1482_grid_b30_periodic_interrupt_override__c32_hilbert_curve_traversal.c\n");
