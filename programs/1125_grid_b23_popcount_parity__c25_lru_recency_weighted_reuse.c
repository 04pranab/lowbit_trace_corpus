/*
 * LowBit -- 1125_grid_b23_popcount_parity__c25_lru_recency_weighted_reuse.c
 * Branch: popcount_parity | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1125_grid_b23_popcount_parity__c25_lru_recency_weighted_reuse.c\n");
