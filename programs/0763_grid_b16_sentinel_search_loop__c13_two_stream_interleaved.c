/*
 * LowBit -- 0763_grid_b16_sentinel_search_loop__c13_two_stream_interleaved.c
 * Branch: sentinel_search_loop | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0763_grid_b16_sentinel_search_loop__c13_two_stream_interleaved.c\n");
