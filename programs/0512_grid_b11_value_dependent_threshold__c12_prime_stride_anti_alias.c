/*
 * LowBit -- 0512_grid_b11_value_dependent_threshold__c12_prime_stride_anti_alias.c
 * Branch: value_dependent_threshold | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=0512_grid_b11_value_dependent_threshold__c12_prime_stride_anti_alias.c\n");
