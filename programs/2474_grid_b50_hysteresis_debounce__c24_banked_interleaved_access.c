/*
 * LowBit -- 2474_grid_b50_hysteresis_debounce__c24_banked_interleaved_access.c
 * Branch: hysteresis_debounce | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2474_grid_b50_hysteresis_debounce__c24_banked_interleaved_access.c\n");
