/*
 * LowBit -- 0956_grid_b20_random_threshold_walk__c06_random_full_working_set.c
 * Branch: random_threshold_walk | Cache: random_full_working_set
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0956_grid_b20_random_threshold_walk__c06_random_full_working_set.c\n");
