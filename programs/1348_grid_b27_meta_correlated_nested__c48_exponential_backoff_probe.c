/*
 * LowBit -- 1348_grid_b27_meta_correlated_nested__c48_exponential_backoff_probe.c
 * Branch: meta_correlated_nested | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1348_grid_b27_meta_correlated_nested__c48_exponential_backoff_probe.c\n");
