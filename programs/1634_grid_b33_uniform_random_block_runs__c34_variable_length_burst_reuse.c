/*
 * LowBit -- 1634_grid_b33_uniform_random_block_runs__c34_variable_length_burst_reuse.c
 * Branch: uniform_random_block_runs | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1634_grid_b33_uniform_random_block_runs__c34_variable_length_burst_reuse.c\n");
