/*
 * LowBit -- 1055_grid_b22_drifting_threshold_periodic_reset__c05_random_small_working_set.c
 * Branch: drifting_threshold_periodic_reset | Cache: random_small_working_set
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1055_grid_b22_drifting_threshold_periodic_reset__c05_random_small_working_set.c\n");
