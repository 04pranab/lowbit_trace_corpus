/*
 * LowBit -- 0932_grid_b19_data_dependent_break_trip__c32_hilbert_curve_traversal.c
 * Branch: data_dependent_break_trip | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0932_grid_b19_data_dependent_break_trip__c32_hilbert_curve_traversal.c\n");
