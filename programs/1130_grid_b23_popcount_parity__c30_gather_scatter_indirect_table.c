/*
 * LowBit -- 1130_grid_b23_popcount_parity__c30_gather_scatter_indirect_table.c
 * Branch: popcount_parity | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1130_grid_b23_popcount_parity__c30_gather_scatter_indirect_table.c\n");
