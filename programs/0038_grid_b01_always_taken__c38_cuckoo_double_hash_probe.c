/*
 * LowBit -- 0038_grid_b01_always_taken__c38_cuckoo_double_hash_probe.c
 * Branch: always_taken | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0038_grid_b01_always_taken__c38_cuckoo_double_hash_probe.c\n");
