/*
 * LowBit -- 1883_grid_b38_decaying_hazard_probability__c33_cache_set_conflict_stress.c
 * Branch: decaying_hazard_probability | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1883_grid_b38_decaying_hazard_probability__c33_cache_set_conflict_stress.c\n");
