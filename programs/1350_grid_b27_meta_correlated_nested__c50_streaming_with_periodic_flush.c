/*
 * LowBit -- 1350_grid_b27_meta_correlated_nested__c50_streaming_with_periodic_flush.c
 * Branch: meta_correlated_nested | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1350_grid_b27_meta_correlated_nested__c50_streaming_with_periodic_flush.c\n");
