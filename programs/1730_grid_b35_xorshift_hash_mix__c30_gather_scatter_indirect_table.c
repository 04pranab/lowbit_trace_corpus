/*
 * LowBit -- 1730_grid_b35_xorshift_hash_mix__c30_gather_scatter_indirect_table.c
 * Branch: xorshift_hash_mix | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1730_grid_b35_xorshift_hash_mix__c30_gather_scatter_indirect_table.c\n");
