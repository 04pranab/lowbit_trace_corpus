/*
 * LowBit -- 0740_grid_b15_manual_unroll4_sparse__c40_causal_attention_triangular.c
 * Branch: manual_unroll4_sparse | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0740_grid_b15_manual_unroll4_sparse__c40_causal_attention_triangular.c\n");
