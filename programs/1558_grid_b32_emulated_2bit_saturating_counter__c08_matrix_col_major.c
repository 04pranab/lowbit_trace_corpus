/*
 * LowBit -- 1558_grid_b32_emulated_2bit_saturating_counter__c08_matrix_col_major.c
 * Branch: emulated_2bit_saturating_counter | Cache: matrix_col_major
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1558_grid_b32_emulated_2bit_saturating_counter__c08_matrix_col_major.c\n");
