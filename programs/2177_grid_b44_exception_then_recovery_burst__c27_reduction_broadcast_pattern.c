/*
 * LowBit -- 2177_grid_b44_exception_then_recovery_burst__c27_reduction_broadcast_pattern.c
 * Branch: exception_then_recovery_burst | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2177_grid_b44_exception_then_recovery_burst__c27_reduction_broadcast_pattern.c\n");
