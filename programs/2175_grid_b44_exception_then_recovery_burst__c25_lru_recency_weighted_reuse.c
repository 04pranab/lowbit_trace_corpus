/*
 * LowBit -- 2175_grid_b44_exception_then_recovery_burst__c25_lru_recency_weighted_reuse.c
 * Branch: exception_then_recovery_burst | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2175_grid_b44_exception_then_recovery_burst__c25_lru_recency_weighted_reuse.c\n");
