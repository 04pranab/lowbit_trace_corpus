/*
 * LowBit -- 2194_grid_b44_exception_then_recovery_burst__c44_naive_gemm_row_col_alternation.c
 * Branch: exception_then_recovery_burst | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2194_grid_b44_exception_then_recovery_burst__c44_naive_gemm_row_col_alternation.c\n");
