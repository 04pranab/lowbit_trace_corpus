/*
 * LowBit -- 2286_grid_b46_lookup_table_driven__c36_im2col_overlapping_patch_gather.c
 * Branch: lookup_table_driven | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2286_grid_b46_lookup_table_driven__c36_im2col_overlapping_patch_gather.c\n");
