/*
 * LowBit -- 0226_grid_b05_periodic8_biased__c26_geometric_stride_growth.c
 * Branch: periodic8_biased | Cache: geometric_stride_growth
...
int main(void) {
    ...
    printf("program=0226_grid_b05_periodic8_biased__c26_geometric_stride_growth.c\n");
