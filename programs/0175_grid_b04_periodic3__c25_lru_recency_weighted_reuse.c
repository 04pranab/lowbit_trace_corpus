/*
 * LowBit -- 0175_grid_b04_periodic3__c25_lru_recency_weighted_reuse.c
 * Branch: periodic3 | Cache: lru_recency_weighted_reuse
...
int main(void) {
    ...
    printf("program=0175_grid_b04_periodic3__c25_lru_recency_weighted_reuse.c\n");
