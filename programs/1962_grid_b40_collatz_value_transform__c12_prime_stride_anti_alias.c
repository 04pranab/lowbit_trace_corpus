/*
 * LowBit -- 1962_grid_b40_collatz_value_transform__c12_prime_stride_anti_alias.c
 * Branch: collatz_value_transform | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1962_grid_b40_collatz_value_transform__c12_prime_stride_anti_alias.c\n");
