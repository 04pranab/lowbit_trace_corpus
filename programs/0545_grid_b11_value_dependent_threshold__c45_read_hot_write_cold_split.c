/*
 * LowBit -- 0545_grid_b11_value_dependent_threshold__c45_read_hot_write_cold_split.c
 * Branch: value_dependent_threshold | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0545_grid_b11_value_dependent_threshold__c45_read_hot_write_cold_split.c\n");
