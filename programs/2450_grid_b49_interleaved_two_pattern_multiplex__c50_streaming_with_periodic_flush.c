/*
 * LowBit -- 2450_grid_b49_interleaved_two_pattern_multiplex__c50_streaming_with_periodic_flush.c
 * Branch: interleaved_two_pattern_multiplex | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=2450_grid_b49_interleaved_two_pattern_multiplex__c50_streaming_with_periodic_flush.c\n");
