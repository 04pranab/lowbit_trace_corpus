/*
 * LowBit -- 0041_grid_b01_always_taken__c41_skip_list_multilevel_hop.c
 * Branch: always_taken | Cache: skip_list_multilevel_hop
...
int main(void) {
    ...
    printf("program=0041_grid_b01_always_taken__c41_skip_list_multilevel_hop.c\n");
