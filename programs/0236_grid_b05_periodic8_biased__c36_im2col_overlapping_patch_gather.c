/*
 * LowBit -- 0236_grid_b05_periodic8_biased__c36_im2col_overlapping_patch_gather.c
 * Branch: periodic8_biased | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0236_grid_b05_periodic8_biased__c36_im2col_overlapping_patch_gather.c\n");
