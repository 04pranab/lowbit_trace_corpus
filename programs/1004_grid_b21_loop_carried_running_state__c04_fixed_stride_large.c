/*
 * LowBit -- 1004_grid_b21_loop_carried_running_state__c04_fixed_stride_large.c
 * Branch: loop_carried_running_state | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=1004_grid_b21_loop_carried_running_state__c04_fixed_stride_large.c\n");
