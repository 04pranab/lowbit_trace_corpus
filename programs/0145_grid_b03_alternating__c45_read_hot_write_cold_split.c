/*
 * LowBit -- 0145_grid_b03_alternating__c45_read_hot_write_cold_split.c
 * Branch: alternating | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=0145_grid_b03_alternating__c45_read_hot_write_cold_split.c\n");
