/*
 * LowBit -- 0864_grid_b18_indirect_fn_dispatch__c14_temporal_burst_reuse.c
 * Branch: indirect_fn_dispatch | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0864_grid_b18_indirect_fn_dispatch__c14_temporal_burst_reuse.c\n");
