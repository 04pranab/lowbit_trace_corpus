/*
 * LowBit -- 0183_grid_b04_periodic3__c33_cache_set_conflict_stress.c
 * Branch: periodic3 | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0183_grid_b04_periodic3__c33_cache_set_conflict_stress.c\n");
