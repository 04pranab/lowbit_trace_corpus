/*
 * LowBit -- 0547_grid_b11_value_dependent_threshold__c47_false_sharing_line_cycle.c
 * Branch: value_dependent_threshold | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0547_grid_b11_value_dependent_threshold__c47_false_sharing_line_cycle.c\n");
