/*
 * LowBit -- 2128_grid_b43_moving_average_threshold__c28_morton_zorder_traversal.c
 * Branch: moving_average_threshold | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2128_grid_b43_moving_average_threshold__c28_morton_zorder_traversal.c\n");
