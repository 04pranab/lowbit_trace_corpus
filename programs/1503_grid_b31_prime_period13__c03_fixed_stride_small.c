/*
 * LowBit -- 1503_grid_b31_prime_period13__c03_fixed_stride_small.c
 * Branch: prime_period13 | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=1503_grid_b31_prime_period13__c03_fixed_stride_small.c\n");
