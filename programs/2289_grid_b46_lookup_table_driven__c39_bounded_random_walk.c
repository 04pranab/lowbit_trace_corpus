/*
 * LowBit -- 2289_grid_b46_lookup_table_driven__c39_bounded_random_walk.c
 * Branch: lookup_table_driven | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2289_grid_b46_lookup_table_driven__c39_bounded_random_walk.c\n");
