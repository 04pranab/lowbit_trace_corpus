/*
 * LowBit -- 2447_grid_b49_interleaved_two_pattern_multiplex__c47_false_sharing_line_cycle.c
 * Branch: interleaved_two_pattern_multiplex | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=2447_grid_b49_interleaved_two_pattern_multiplex__c47_false_sharing_line_cycle.c\n");
