/*
 * LowBit -- 0879_grid_b18_indirect_fn_dispatch__c29_ping_pong_cache_thrash.c
 * Branch: indirect_fn_dispatch | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0879_grid_b18_indirect_fn_dispatch__c29_ping_pong_cache_thrash.c\n");
