/*
 * LowBit -- 0142_grid_b03_alternating__c42_cache_oblivious_funnel_stride.c
 * Branch: alternating | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0142_grid_b03_alternating__c42_cache_oblivious_funnel_stride.c\n");
