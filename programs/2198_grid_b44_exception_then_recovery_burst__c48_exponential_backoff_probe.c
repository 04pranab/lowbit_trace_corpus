/*
 * LowBit -- 2198_grid_b44_exception_then_recovery_burst__c48_exponential_backoff_probe.c
 * Branch: exception_then_recovery_burst | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2198_grid_b44_exception_then_recovery_burst__c48_exponential_backoff_probe.c\n");
