/*
 * LowBit -- 2568_base_cache_c18_producer_consumer_two_pointer.c
 * Branch: synthetic_always_taken | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=2568_base_cache_c18_producer_consumer_two_pointer.c\n");
