/*
 * LowBit -- 2324_grid_b47_mutual_ping_pong_recursion__c24_banked_interleaved_access.c
 * Branch: mutual_ping_pong_recursion | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2324_grid_b47_mutual_ping_pong_recursion__c24_banked_interleaved_access.c\n");
