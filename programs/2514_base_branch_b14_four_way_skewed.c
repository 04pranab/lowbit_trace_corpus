/*
 * LowBit -- 2514_base_branch_b14_four_way_skewed.c
 * Branch: four_way_skewed | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=2514_base_branch_b14_four_way_skewed.c\n");
