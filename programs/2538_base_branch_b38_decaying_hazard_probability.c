/*
 * LowBit -- 2538_base_branch_b38_decaying_hazard_probability.c
 * Branch: decaying_hazard_probability | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=2538_base_branch_b38_decaying_hazard_probability.c\n");
