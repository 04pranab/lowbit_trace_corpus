/*
 * LowBit -- 2117_grid_b43_moving_average_threshold__c17_zipf_like_hot_buckets.c
 * Branch: moving_average_threshold | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2117_grid_b43_moving_average_threshold__c17_zipf_like_hot_buckets.c\n");
