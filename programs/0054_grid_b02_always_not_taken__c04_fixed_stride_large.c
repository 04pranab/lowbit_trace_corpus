/*
 * LowBit -- 0054_grid_b02_always_not_taken__c04_fixed_stride_large.c
 * Branch: always_not_taken | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0054_grid_b02_always_not_taken__c04_fixed_stride_large.c\n");
