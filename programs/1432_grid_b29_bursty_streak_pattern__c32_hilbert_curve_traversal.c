/*
 * LowBit -- 1432_grid_b29_bursty_streak_pattern__c32_hilbert_curve_traversal.c
 * Branch: bursty_streak_pattern | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1432_grid_b29_bursty_streak_pattern__c32_hilbert_curve_traversal.c\n");
