/*
 * LowBit -- 1785_grid_b36_traffic_light_fsm__c35_checkerboard_red_black.c
 * Branch: traffic_light_fsm | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1785_grid_b36_traffic_light_fsm__c35_checkerboard_red_black.c\n");
