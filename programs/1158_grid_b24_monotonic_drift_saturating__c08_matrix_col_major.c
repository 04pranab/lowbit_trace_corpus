/*
 * LowBit -- 1158_grid_b24_monotonic_drift_saturating__c08_matrix_col_major.c
 * Branch: monotonic_drift_saturating | Cache: matrix_col_major
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1158_grid_b24_monotonic_drift_saturating__c08_matrix_col_major.c\n");
