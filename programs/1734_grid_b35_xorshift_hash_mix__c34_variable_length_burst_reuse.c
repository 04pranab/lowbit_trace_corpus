/*
 * LowBit -- 1734_grid_b35_xorshift_hash_mix__c34_variable_length_burst_reuse.c
 * Branch: xorshift_hash_mix | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1734_grid_b35_xorshift_hash_mix__c34_variable_length_burst_reuse.c\n");
