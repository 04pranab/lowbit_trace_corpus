/*
 * LowBit -- 1700_grid_b34_data_driven_countdown__c50_streaming_with_periodic_flush.c
 * Branch: data_driven_countdown | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1700_grid_b34_data_driven_countdown__c50_streaming_with_periodic_flush.c\n");
