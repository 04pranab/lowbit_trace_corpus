/*
 * LowBit -- 2299_grid_b46_lookup_table_driven__c49_binary_heap_parent_child.c
 * Branch: lookup_table_driven | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2299_grid_b46_lookup_table_driven__c49_binary_heap_parent_child.c\n");
