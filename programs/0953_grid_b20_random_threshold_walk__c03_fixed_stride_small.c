/*
 * LowBit -- 0953_grid_b20_random_threshold_walk__c03_fixed_stride_small.c
 * Branch: random_threshold_walk | Cache: fixed_stride_small
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0953_grid_b20_random_threshold_walk__c03_fixed_stride_small.c\n");
