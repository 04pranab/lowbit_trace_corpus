/*
 * LowBit -- 0857_grid_b18_indirect_fn_dispatch__c07_matrix_row_major.c
 * Branch: indirect_fn_dispatch | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0857_grid_b18_indirect_fn_dispatch__c07_matrix_row_major.c\n");
