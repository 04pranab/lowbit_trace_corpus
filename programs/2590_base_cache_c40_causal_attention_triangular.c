/*
 * LowBit -- 2590_base_cache_c40_causal_attention_triangular.c
 * Branch: synthetic_always_taken | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=2590_base_cache_c40_causal_attention_triangular.c\n");
