/*
 * LowBit -- 0502_grid_b11_value_dependent_threshold__c02_sequential_wraparound_large.c
 * Branch: value_dependent_threshold | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0502_grid_b11_value_dependent_threshold__c02_sequential_wraparound_large.c\n");
