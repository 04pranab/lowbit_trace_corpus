/*
 * LowBit -- 1885_grid_b38_decaying_hazard_probability__c35_checkerboard_red_black.c
 * Branch: decaying_hazard_probability | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1885_grid_b38_decaying_hazard_probability__c35_checkerboard_red_black.c\n");
