/*
 * LowBit -- 0020_grid_b01_always_taken__c20_hot_cold_phase_alternation.c
 * Branch: always_taken | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0020_grid_b01_always_taken__c20_hot_cold_phase_alternation.c\n");
