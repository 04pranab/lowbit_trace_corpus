/*
 * LowBit -- 1093_grid_b22_drifting_threshold_periodic_reset__c43_whole_buffer_rotation.c
 * Branch: drifting_threshold_periodic_reset | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1093_grid_b22_drifting_threshold_periodic_reset__c43_whole_buffer_rotation.c\n");
