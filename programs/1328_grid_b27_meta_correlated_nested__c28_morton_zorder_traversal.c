/*
 * LowBit -- 1328_grid_b27_meta_correlated_nested__c28_morton_zorder_traversal.c
 * Branch: meta_correlated_nested | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1328_grid_b27_meta_correlated_nested__c28_morton_zorder_traversal.c\n");
