/*
 * LowBit -- 0235_grid_b05_periodic8_biased__c35_checkerboard_red_black.c
 * Branch: periodic8_biased | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0235_grid_b05_periodic8_biased__c35_checkerboard_red_black.c\n");
