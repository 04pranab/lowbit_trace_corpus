/*
 * LowBit -- 1366_grid_b28_data_driven_stack_machine__c16_block_sparse.c
 * Branch: data_driven_stack_machine | Cache: block_sparse
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1366_grid_b28_data_driven_stack_machine__c16_block_sparse.c\n");
