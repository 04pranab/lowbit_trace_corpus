/*
 * LowBit -- 1906_grid_b39_dual_lcg_xor_chaos__c06_random_full_working_set.c
 * Branch: dual_lcg_xor_chaos | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1906_grid_b39_dual_lcg_xor_chaos__c06_random_full_working_set.c\n");
