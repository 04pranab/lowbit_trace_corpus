/*
 * LowBit -- 0701_grid_b15_manual_unroll4_sparse__c01_sequential_unit_stride.c
 * Branch: manual_unroll4_sparse | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=0701_grid_b15_manual_unroll4_sparse__c01_sequential_unit_stride.c\n");
