/*
 * LowBit -- 2360_grid_b48_variable_step_signed_countdown__c10_pointer_chase_linked_list.c
 * Branch: variable_step_signed_countdown | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2360_grid_b48_variable_step_signed_countdown__c10_pointer_chase_linked_list.c\n");
