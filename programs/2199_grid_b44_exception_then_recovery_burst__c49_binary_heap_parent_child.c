/*
 * LowBit -- 2199_grid_b44_exception_then_recovery_burst__c49_binary_heap_parent_child.c
 * Branch: exception_then_recovery_burst | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2199_grid_b44_exception_then_recovery_burst__c49_binary_heap_parent_child.c\n");
