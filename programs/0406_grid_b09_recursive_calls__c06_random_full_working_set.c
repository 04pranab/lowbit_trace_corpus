/*
 * LowBit -- 0406_grid_b09_recursive_calls__c06_random_full_working_set.c
 * Branch: recursive_calls | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0406_grid_b09_recursive_calls__c06_random_full_working_set.c\n");
