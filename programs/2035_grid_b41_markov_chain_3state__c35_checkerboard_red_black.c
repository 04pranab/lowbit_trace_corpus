/*
 * LowBit -- 2035_grid_b41_markov_chain_3state__c35_checkerboard_red_black.c
 * Branch: markov_chain_3state | Cache: checkerboard_red_black
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2035_grid_b41_markov_chain_3state__c35_checkerboard_red_black.c\n");
