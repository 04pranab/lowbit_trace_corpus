/*
 * LowBit -- 0345_grid_b07_nested_dependent__c45_read_hot_write_cold_split.c
 * Branch: nested_dependent | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0345_grid_b07_nested_dependent__c45_read_hot_write_cold_split.c\n");
