/*
 * LowBit -- 0450_grid_b09_recursive_calls__c50_streaming_with_periodic_flush.c
 * Branch: recursive_calls | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0450_grid_b09_recursive_calls__c50_streaming_with_periodic_flush.c\n");
