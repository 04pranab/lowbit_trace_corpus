/*
 * LowBit -- 0543_grid_b11_value_dependent_threshold__c43_whole_buffer_rotation.c
 * Branch: value_dependent_threshold | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0543_grid_b11_value_dependent_threshold__c43_whole_buffer_rotation.c\n");
