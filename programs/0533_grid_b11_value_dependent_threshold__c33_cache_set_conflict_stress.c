/*
 * LowBit -- 0533_grid_b11_value_dependent_threshold__c33_cache_set_conflict_stress.c
 * Branch: value_dependent_threshold | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0533_grid_b11_value_dependent_threshold__c33_cache_set_conflict_stress.c\n");
