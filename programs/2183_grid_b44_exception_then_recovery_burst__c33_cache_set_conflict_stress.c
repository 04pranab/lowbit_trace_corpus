/*
 * LowBit -- 2183_grid_b44_exception_then_recovery_burst__c33_cache_set_conflict_stress.c
 * Branch: exception_then_recovery_burst | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2183_grid_b44_exception_then_recovery_burst__c33_cache_set_conflict_stress.c\n");
