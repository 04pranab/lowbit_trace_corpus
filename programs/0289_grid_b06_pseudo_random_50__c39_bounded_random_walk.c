/*
 * LowBit -- 0289_grid_b06_pseudo_random_50__c39_bounded_random_walk.c
 * Branch: pseudo_random_50 | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0289_grid_b06_pseudo_random_50__c39_bounded_random_walk.c\n");
