/*
 * LowBit -- 1192_grid_b24_monotonic_drift_saturating__c42_cache_oblivious_funnel_stride.c
 * Branch: monotonic_drift_saturating | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1192_grid_b24_monotonic_drift_saturating__c42_cache_oblivious_funnel_stride.c\n");
