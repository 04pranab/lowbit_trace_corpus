/*
 * LowBit -- 0354_grid_b08_switch_multiway__c04_fixed_stride_large.c
 * Branch: switch_multiway | Cache: fixed_stride_large
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0354_grid_b08_switch_multiway__c04_fixed_stride_large.c\n");
