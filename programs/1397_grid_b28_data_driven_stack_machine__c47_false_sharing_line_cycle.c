/*
 * LowBit -- 1397_grid_b28_data_driven_stack_machine__c47_false_sharing_line_cycle.c
 * Branch: data_driven_stack_machine | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1397_grid_b28_data_driven_stack_machine__c47_false_sharing_line_cycle.c\n");
