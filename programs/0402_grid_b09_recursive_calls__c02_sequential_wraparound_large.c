/*
 * LowBit -- 0402_grid_b09_recursive_calls__c02_sequential_wraparound_large.c
 * Branch: recursive_calls | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0402_grid_b09_recursive_calls__c02_sequential_wraparound_large.c\n");
