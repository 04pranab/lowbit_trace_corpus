/*
 * LowBit -- 2353_grid_b48_variable_step_signed_countdown__c03_fixed_stride_small.c
 * Branch: variable_step_signed_countdown | Cache: fixed_stride_small
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2353_grid_b48_variable_step_signed_countdown__c03_fixed_stride_small.c\n");
