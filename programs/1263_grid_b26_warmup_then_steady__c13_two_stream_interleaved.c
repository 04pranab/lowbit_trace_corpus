/*
 * LowBit -- 1263_grid_b26_warmup_then_steady__c13_two_stream_interleaved.c
 * Branch: warmup_then_steady | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1263_grid_b26_warmup_then_steady__c13_two_stream_interleaved.c\n");
