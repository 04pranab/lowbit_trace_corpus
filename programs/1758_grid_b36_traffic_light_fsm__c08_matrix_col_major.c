/*
 * LowBit -- 1758_grid_b36_traffic_light_fsm__c08_matrix_col_major.c
 * Branch: traffic_light_fsm | Cache: matrix_col_major
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1758_grid_b36_traffic_light_fsm__c08_matrix_col_major.c\n");
