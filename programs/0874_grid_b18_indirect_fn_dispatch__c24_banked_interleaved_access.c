/*
 * LowBit -- 0874_grid_b18_indirect_fn_dispatch__c24_banked_interleaved_access.c
 * Branch: indirect_fn_dispatch | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0874_grid_b18_indirect_fn_dispatch__c24_banked_interleaved_access.c\n");
