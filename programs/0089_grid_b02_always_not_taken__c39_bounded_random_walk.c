/*
 * LowBit -- 0089_grid_b02_always_not_taken__c39_bounded_random_walk.c
 * Branch: always_not_taken | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0089_grid_b02_always_not_taken__c39_bounded_random_walk.c\n");
