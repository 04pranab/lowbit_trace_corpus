/*
 * LowBit -- 1735_grid_b35_xorshift_hash_mix__c35_checkerboard_red_black.c
 * Branch: xorshift_hash_mix | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1735_grid_b35_xorshift_hash_mix__c35_checkerboard_red_black.c\n");
