/*
 * LowBit -- 2111_grid_b43_moving_average_threshold__c11_sliding_window.c
 * Branch: moving_average_threshold | Cache: sliding_window
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2111_grid_b43_moving_average_threshold__c11_sliding_window.c\n");
