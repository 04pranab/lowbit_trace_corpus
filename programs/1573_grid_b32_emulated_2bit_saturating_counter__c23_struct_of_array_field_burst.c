/*
 * LowBit -- 1573_grid_b32_emulated_2bit_saturating_counter__c23_struct_of_array_field_burst.c
 * Branch: emulated_2bit_saturating_counter | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1573_grid_b32_emulated_2bit_saturating_counter__c23_struct_of_array_field_burst.c\n");
