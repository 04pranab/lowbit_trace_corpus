/*
 * LowBit -- 0754_grid_b16_sentinel_search_loop__c04_fixed_stride_large.c
 * Branch: sentinel_search_loop | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=0754_grid_b16_sentinel_search_loop__c04_fixed_stride_large.c\n");
