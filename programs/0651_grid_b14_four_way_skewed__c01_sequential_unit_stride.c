/*
 * LowBit -- 0651_grid_b14_four_way_skewed__c01_sequential_unit_stride.c
 * Branch: four_way_skewed | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0651_grid_b14_four_way_skewed__c01_sequential_unit_stride.c\n");
