/*
 * LowBit -- 1330_grid_b27_meta_correlated_nested__c30_gather_scatter_indirect_table.c
 * Branch: meta_correlated_nested | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1330_grid_b27_meta_correlated_nested__c30_gather_scatter_indirect_table.c\n");
