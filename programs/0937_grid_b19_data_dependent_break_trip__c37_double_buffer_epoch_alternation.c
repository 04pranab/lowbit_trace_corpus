/*
 * LowBit -- 0937_grid_b19_data_dependent_break_trip__c37_double_buffer_epoch_alternation.c
 * Branch: data_dependent_break_trip | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0937_grid_b19_data_dependent_break_trip__c37_double_buffer_epoch_alternation.c\n");
