/*
 * LowBit -- 2337_grid_b47_mutual_ping_pong_recursion__c37_double_buffer_epoch_alternation.c
 * Branch: mutual_ping_pong_recursion | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2337_grid_b47_mutual_ping_pong_recursion__c37_double_buffer_epoch_alternation.c\n");
