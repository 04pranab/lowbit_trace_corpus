/*
 * LowBit -- 0133_grid_b03_alternating__c33_cache_set_conflict_stress.c
 * Branch: alternating | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0133_grid_b03_alternating__c33_cache_set_conflict_stress.c\n");
