/*
 * LowBit -- 0327_grid_b07_nested_dependent__c27_reduction_broadcast_pattern.c
 * Branch: nested_dependent | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0327_grid_b07_nested_dependent__c27_reduction_broadcast_pattern.c\n");
