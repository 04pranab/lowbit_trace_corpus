/*
 * LowBit -- 1099_grid_b22_drifting_threshold_periodic_reset__c49_binary_heap_parent_child.c
 * Branch: drifting_threshold_periodic_reset | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1099_grid_b22_drifting_threshold_periodic_reset__c49_binary_heap_parent_child.c\n");
