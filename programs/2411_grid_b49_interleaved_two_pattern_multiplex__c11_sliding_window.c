/*
 * LowBit -- 2411_grid_b49_interleaved_two_pattern_multiplex__c11_sliding_window.c
 * Branch: interleaved_two_pattern_multiplex | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=2411_grid_b49_interleaved_two_pattern_multiplex__c11_sliding_window.c\n");
