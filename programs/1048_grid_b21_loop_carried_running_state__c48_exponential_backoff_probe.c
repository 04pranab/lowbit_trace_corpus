/*
 * LowBit -- 1048_grid_b21_loop_carried_running_state__c48_exponential_backoff_probe.c
 * Branch: loop_carried_running_state | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=1048_grid_b21_loop_carried_running_state__c48_exponential_backoff_probe.c\n");
