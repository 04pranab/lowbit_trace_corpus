/*
 * LowBit -- 0453_grid_b10_correlated_history__c03_fixed_stride_small.c
 * Branch: correlated_history | Cache: fixed_stride_small
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0453_grid_b10_correlated_history__c03_fixed_stride_small.c\n");
