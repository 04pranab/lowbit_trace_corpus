/*
 * LowBit -- 0217_grid_b05_periodic8_biased__c17_zipf_like_hot_buckets.c
 * Branch: periodic8_biased | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0217_grid_b05_periodic8_biased__c17_zipf_like_hot_buckets.c\n");
