/*
 * LowBit -- 0798_grid_b16_sentinel_search_loop__c48_exponential_backoff_probe.c
 * Branch: sentinel_search_loop | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0798_grid_b16_sentinel_search_loop__c48_exponential_backoff_probe.c\n");
