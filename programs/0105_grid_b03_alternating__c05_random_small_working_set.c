/*
 * LowBit -- 0105_grid_b03_alternating__c05_random_small_working_set.c
 * Branch: alternating | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=0105_grid_b03_alternating__c05_random_small_working_set.c\n");
