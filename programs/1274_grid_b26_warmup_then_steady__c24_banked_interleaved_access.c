/*
 * LowBit -- 1274_grid_b26_warmup_then_steady__c24_banked_interleaved_access.c
 * Branch: warmup_then_steady | Cache: banked_interleaved_access
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1274_grid_b26_warmup_then_steady__c24_banked_interleaved_access.c\n");
