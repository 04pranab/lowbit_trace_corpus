/*
 * LowBit -- 0379_grid_b08_switch_multiway__c29_ping_pong_cache_thrash.c
 * Branch: switch_multiway | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0379_grid_b08_switch_multiway__c29_ping_pong_cache_thrash.c\n");
