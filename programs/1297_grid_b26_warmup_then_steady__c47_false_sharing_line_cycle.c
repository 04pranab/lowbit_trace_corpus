/*
 * LowBit -- 1297_grid_b26_warmup_then_steady__c47_false_sharing_line_cycle.c
 * Branch: warmup_then_steady | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1297_grid_b26_warmup_then_steady__c47_false_sharing_line_cycle.c\n");
