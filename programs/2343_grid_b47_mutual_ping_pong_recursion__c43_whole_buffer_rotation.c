/*
 * LowBit -- 2343_grid_b47_mutual_ping_pong_recursion__c43_whole_buffer_rotation.c
 * Branch: mutual_ping_pong_recursion | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2343_grid_b47_mutual_ping_pong_recursion__c43_whole_buffer_rotation.c\n");
