/*
 * LowBit -- 1021_grid_b21_loop_carried_running_state__c21_pyramid_multiresolution_stride.c
 * Branch: loop_carried_running_state | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=1021_grid_b21_loop_carried_running_state__c21_pyramid_multiresolution_stride.c\n");
