/*
 * LowBit -- 1175_grid_b24_monotonic_drift_saturating__c25_lru_recency_weighted_reuse.c
 * Branch: monotonic_drift_saturating | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1175_grid_b24_monotonic_drift_saturating__c25_lru_recency_weighted_reuse.c\n");
