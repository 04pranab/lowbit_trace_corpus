/*
 * LowBit -- 2075_grid_b42_bit_reversal_index_data_mix__c25_lru_recency_weighted_reuse.c
 * Branch: bit_reversal_index_data_mix | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2075_grid_b42_bit_reversal_index_data_mix__c25_lru_recency_weighted_reuse.c\n");
