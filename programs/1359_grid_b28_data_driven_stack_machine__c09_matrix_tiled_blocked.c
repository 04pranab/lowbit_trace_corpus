/*
 * LowBit -- 1359_grid_b28_data_driven_stack_machine__c09_matrix_tiled_blocked.c
 * Branch: data_driven_stack_machine | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1359_grid_b28_data_driven_stack_machine__c09_matrix_tiled_blocked.c\n");
