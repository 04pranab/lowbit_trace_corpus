/*
 * LowBit -- 0925_grid_b19_data_dependent_break_trip__c25_lru_recency_weighted_reuse.c
 * Branch: data_dependent_break_trip | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0925_grid_b19_data_dependent_break_trip__c25_lru_recency_weighted_reuse.c\n");
