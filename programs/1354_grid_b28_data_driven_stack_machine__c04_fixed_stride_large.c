/*
 * LowBit -- 1354_grid_b28_data_driven_stack_machine__c04_fixed_stride_large.c
 * Branch: data_driven_stack_machine | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1354_grid_b28_data_driven_stack_machine__c04_fixed_stride_large.c\n");
