/*
 * LowBit -- 1731_grid_b35_xorshift_hash_mix__c31_fibonacci_stride.c
 * Branch: xorshift_hash_mix | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1731_grid_b35_xorshift_hash_mix__c31_fibonacci_stride.c\n");
