/*
 * LowBit -- 1500_grid_b30_periodic_interrupt_override__c50_streaming_with_periodic_flush.c
 * Branch: periodic_interrupt_override | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=1500_grid_b30_periodic_interrupt_override__c50_streaming_with_periodic_flush.c\n");
