/*
 * LowBit -- 0732_grid_b15_manual_unroll4_sparse__c32_hilbert_curve_traversal.c
 * Branch: manual_unroll4_sparse | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0732_grid_b15_manual_unroll4_sparse__c32_hilbert_curve_traversal.c\n");
