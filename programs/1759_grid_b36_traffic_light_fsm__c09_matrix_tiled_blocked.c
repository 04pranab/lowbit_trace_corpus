/*
 * LowBit -- 1759_grid_b36_traffic_light_fsm__c09_matrix_tiled_blocked.c
 * Branch: traffic_light_fsm | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1759_grid_b36_traffic_light_fsm__c09_matrix_tiled_blocked.c\n");
