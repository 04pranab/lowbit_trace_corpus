/*
 * LowBit -- 1897_grid_b38_decaying_hazard_probability__c47_false_sharing_line_cycle.c
 * Branch: decaying_hazard_probability | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1897_grid_b38_decaying_hazard_probability__c47_false_sharing_line_cycle.c\n");
