/*
 * LowBit -- 1976_grid_b40_collatz_value_transform__c26_geometric_stride_growth.c
 * Branch: collatz_value_transform | Cache: geometric_stride_growth
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1976_grid_b40_collatz_value_transform__c26_geometric_stride_growth.c\n");
