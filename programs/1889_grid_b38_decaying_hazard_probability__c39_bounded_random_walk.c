/*
 * LowBit -- 1889_grid_b38_decaying_hazard_probability__c39_bounded_random_walk.c
 * Branch: decaying_hazard_probability | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1889_grid_b38_decaying_hazard_probability__c39_bounded_random_walk.c\n");
