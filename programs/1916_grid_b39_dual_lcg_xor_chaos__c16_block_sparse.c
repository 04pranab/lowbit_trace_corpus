/*
 * LowBit -- 1916_grid_b39_dual_lcg_xor_chaos__c16_block_sparse.c
 * Branch: dual_lcg_xor_chaos | Cache: block_sparse
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1916_grid_b39_dual_lcg_xor_chaos__c16_block_sparse.c\n");
