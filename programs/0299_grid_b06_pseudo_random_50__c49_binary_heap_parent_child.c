/*
 * LowBit -- 0299_grid_b06_pseudo_random_50__c49_binary_heap_parent_child.c
 * Branch: pseudo_random_50 | Cache: binary_heap_parent_child
...
int main(void) {
    ...
    printf("program=0299_grid_b06_pseudo_random_50__c49_binary_heap_parent_child.c\n");
