/*
 * LowBit -- 0663_grid_b14_four_way_skewed__c13_two_stream_interleaved.c
 * Branch: four_way_skewed | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0663_grid_b14_four_way_skewed__c13_two_stream_interleaved.c\n");
