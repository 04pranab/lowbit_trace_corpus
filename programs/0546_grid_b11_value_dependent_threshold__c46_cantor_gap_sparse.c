/*
 * LowBit -- 0546_grid_b11_value_dependent_threshold__c46_cantor_gap_sparse.c
 * Branch: value_dependent_threshold | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0546_grid_b11_value_dependent_threshold__c46_cantor_gap_sparse.c\n");
