/*
 * LowBit -- 0314_grid_b07_nested_dependent__c14_temporal_burst_reuse.c
 * Branch: nested_dependent | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0314_grid_b07_nested_dependent__c14_temporal_burst_reuse.c\n");
