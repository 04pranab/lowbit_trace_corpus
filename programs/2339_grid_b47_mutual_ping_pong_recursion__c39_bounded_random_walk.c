/*
 * LowBit -- 2339_grid_b47_mutual_ping_pong_recursion__c39_bounded_random_walk.c
 * Branch: mutual_ping_pong_recursion | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2339_grid_b47_mutual_ping_pong_recursion__c39_bounded_random_walk.c\n");
