/*
 * LowBit -- 0758_grid_b16_sentinel_search_loop__c08_matrix_col_major.c
 * Branch: sentinel_search_loop | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0758_grid_b16_sentinel_search_loop__c08_matrix_col_major.c\n");
