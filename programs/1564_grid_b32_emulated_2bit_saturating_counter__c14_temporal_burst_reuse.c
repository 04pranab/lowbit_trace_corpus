/*
 * LowBit -- 1564_grid_b32_emulated_2bit_saturating_counter__c14_temporal_burst_reuse.c
 * Branch: emulated_2bit_saturating_counter | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1564_grid_b32_emulated_2bit_saturating_counter__c14_temporal_burst_reuse.c\n");
