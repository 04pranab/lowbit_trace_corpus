/*
 * LowBit -- 0632_grid_b13_single_phase_change__c32_hilbert_curve_traversal.c
 * Branch: single_phase_change | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=0632_grid_b13_single_phase_change__c32_hilbert_curve_traversal.c\n");
