/*
 * LowBit -- 2003_grid_b41_markov_chain_3state__c03_fixed_stride_small.c
 * Branch: markov_chain_3state | Cache: fixed_stride_small
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2003_grid_b41_markov_chain_3state__c03_fixed_stride_small.c\n");
