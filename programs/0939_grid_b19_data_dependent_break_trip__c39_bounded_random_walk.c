/*
 * LowBit -- 0939_grid_b19_data_dependent_break_trip__c39_bounded_random_walk.c
 * Branch: data_dependent_break_trip | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0939_grid_b19_data_dependent_break_trip__c39_bounded_random_walk.c\n");
