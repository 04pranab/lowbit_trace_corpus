/*
 * LowBit -- 1995_grid_b40_collatz_value_transform__c45_read_hot_write_cold_split.c
 * Branch: collatz_value_transform | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1995_grid_b40_collatz_value_transform__c45_read_hot_write_cold_split.c\n");
