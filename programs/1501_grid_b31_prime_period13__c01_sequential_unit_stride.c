/*
 * LowBit -- 1501_grid_b31_prime_period13__c01_sequential_unit_stride.c
 * Branch: prime_period13 | Cache: sequential_unit_stride
...
int main(void) {
    ...
    printf("program=1501_grid_b31_prime_period13__c01_sequential_unit_stride.c\n");
