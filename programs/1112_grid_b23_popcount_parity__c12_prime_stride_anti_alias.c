/*
 * LowBit -- 1112_grid_b23_popcount_parity__c12_prime_stride_anti_alias.c
 * Branch: popcount_parity | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1112_grid_b23_popcount_parity__c12_prime_stride_anti_alias.c\n");
