/*
 * LowBit -- 1813_grid_b37_value_driven_unswitch_run__c13_two_stream_interleaved.c
 * Branch: value_driven_unswitch_run | Cache: two_stream_interleaved
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1813_grid_b37_value_driven_unswitch_run__c13_two_stream_interleaved.c\n");
