/*
 * LowBit -- 0446_grid_b09_recursive_calls__c46_cantor_gap_sparse.c
 * Branch: recursive_calls | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0446_grid_b09_recursive_calls__c46_cantor_gap_sparse.c\n");
