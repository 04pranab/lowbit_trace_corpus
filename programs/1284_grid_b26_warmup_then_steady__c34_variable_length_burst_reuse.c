/*
 * LowBit -- 1284_grid_b26_warmup_then_steady__c34_variable_length_burst_reuse.c
 * Branch: warmup_then_steady | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1284_grid_b26_warmup_then_steady__c34_variable_length_burst_reuse.c\n");
