/*
 * LowBit -- 0642_grid_b13_single_phase_change__c42_cache_oblivious_funnel_stride.c
 * Branch: single_phase_change | Cache: cache_oblivious_funnel_stride
...
int main(void) {
    ...
    printf("program=0642_grid_b13_single_phase_change__c42_cache_oblivious_funnel_stride.c\n");
