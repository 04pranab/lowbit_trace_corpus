/*
 * LowBit -- 2001_grid_b41_markov_chain_3state__c01_sequential_unit_stride.c
 * Branch: markov_chain_3state | Cache: sequential_unit_stride
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2001_grid_b41_markov_chain_3state__c01_sequential_unit_stride.c\n");
