/*
 * LowBit -- 0196_grid_b04_periodic3__c46_cantor_gap_sparse.c
 * Branch: periodic3 | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0196_grid_b04_periodic3__c46_cantor_gap_sparse.c\n");
