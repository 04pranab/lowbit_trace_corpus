/*
 * LowBit -- 0445_grid_b09_recursive_calls__c45_read_hot_write_cold_split.c
 * Branch: recursive_calls | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0445_grid_b09_recursive_calls__c45_read_hot_write_cold_split.c\n");
