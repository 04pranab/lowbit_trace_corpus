/*
 * LowBit -- 2238_grid_b45_two_counters_race__c38_cuckoo_double_hash_probe.c
 * Branch: two_counters_race | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2238_grid_b45_two_counters_race__c38_cuckoo_double_hash_probe.c\n");
