/*
 * LowBit -- 0316_grid_b07_nested_dependent__c16_block_sparse.c
 * Branch: nested_dependent | Cache: block_sparse
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0316_grid_b07_nested_dependent__c16_block_sparse.c\n");
