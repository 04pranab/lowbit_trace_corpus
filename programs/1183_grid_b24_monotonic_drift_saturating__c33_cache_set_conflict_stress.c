/*
 * LowBit -- 1183_grid_b24_monotonic_drift_saturating__c33_cache_set_conflict_stress.c
 * Branch: monotonic_drift_saturating | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1183_grid_b24_monotonic_drift_saturating__c33_cache_set_conflict_stress.c\n");
