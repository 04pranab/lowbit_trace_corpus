/*
 * LowBit -- 1806_grid_b37_value_driven_unswitch_run__c06_random_full_working_set.c
 * Branch: value_driven_unswitch_run | Cache: random_full_working_set
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1806_grid_b37_value_driven_unswitch_run__c06_random_full_working_set.c\n");
