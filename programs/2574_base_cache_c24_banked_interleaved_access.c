/*
 * LowBit -- 2574_base_cache_c24_banked_interleaved_access.c
 * Branch: synthetic_always_taken | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=2574_base_cache_c24_banked_interleaved_access.c\n");
