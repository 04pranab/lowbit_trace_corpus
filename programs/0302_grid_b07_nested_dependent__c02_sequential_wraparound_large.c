/*
 * LowBit -- 0302_grid_b07_nested_dependent__c02_sequential_wraparound_large.c
 * Branch: nested_dependent | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0302_grid_b07_nested_dependent__c02_sequential_wraparound_large.c\n");
