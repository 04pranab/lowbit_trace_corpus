/*
 * LowBit -- 2036_grid_b41_markov_chain_3state__c36_im2col_overlapping_patch_gather.c
 * Branch: markov_chain_3state | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2036_grid_b41_markov_chain_3state__c36_im2col_overlapping_patch_gather.c\n");
