/*
 * LowBit -- 0179_grid_b04_periodic3__c29_ping_pong_cache_thrash.c
 * Branch: periodic3 | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0179_grid_b04_periodic3__c29_ping_pong_cache_thrash.c\n");
