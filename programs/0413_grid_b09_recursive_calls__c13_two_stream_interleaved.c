/*
 * LowBit -- 0413_grid_b09_recursive_calls__c13_two_stream_interleaved.c
 * Branch: recursive_calls | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0413_grid_b09_recursive_calls__c13_two_stream_interleaved.c\n");
