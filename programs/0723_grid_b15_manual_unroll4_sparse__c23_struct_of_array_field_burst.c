/*
 * LowBit -- 0723_grid_b15_manual_unroll4_sparse__c23_struct_of_array_field_burst.c
 * Branch: manual_unroll4_sparse | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0723_grid_b15_manual_unroll4_sparse__c23_struct_of_array_field_burst.c\n");
