/*
 * LowBit -- 2527_base_branch_b27_meta_correlated_nested.c
 * Branch: meta_correlated_nested | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=2527_base_branch_b27_meta_correlated_nested.c\n");
