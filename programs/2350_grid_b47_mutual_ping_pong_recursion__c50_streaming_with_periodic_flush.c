/*
 * LowBit -- 2350_grid_b47_mutual_ping_pong_recursion__c50_streaming_with_periodic_flush.c
 * Branch: mutual_ping_pong_recursion | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2350_grid_b47_mutual_ping_pong_recursion__c50_streaming_with_periodic_flush.c\n");
