/*
 * LowBit -- 0713_grid_b15_manual_unroll4_sparse__c13_two_stream_interleaved.c
 * Branch: manual_unroll4_sparse | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0713_grid_b15_manual_unroll4_sparse__c13_two_stream_interleaved.c\n");
