/*
 * LowBit -- 0978_grid_b20_random_threshold_walk__c28_morton_zorder_traversal.c
 * Branch: random_threshold_walk | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0978_grid_b20_random_threshold_walk__c28_morton_zorder_traversal.c\n");
