/*
 * LowBit -- 1507_grid_b31_prime_period13__c07_matrix_row_major.c
 * Branch: prime_period13 | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=1507_grid_b31_prime_period13__c07_matrix_row_major.c\n");
