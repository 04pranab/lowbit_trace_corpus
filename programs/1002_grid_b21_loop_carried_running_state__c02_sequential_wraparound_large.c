/*
 * LowBit -- 1002_grid_b21_loop_carried_running_state__c02_sequential_wraparound_large.c
 * Branch: loop_carried_running_state | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=1002_grid_b21_loop_carried_running_state__c02_sequential_wraparound_large.c\n");
