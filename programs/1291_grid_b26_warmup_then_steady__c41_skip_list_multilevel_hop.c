/*
 * LowBit -- 1291_grid_b26_warmup_then_steady__c41_skip_list_multilevel_hop.c
 * Branch: warmup_then_steady | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1291_grid_b26_warmup_then_steady__c41_skip_list_multilevel_hop.c\n");
