/*
 * LowBit -- 0931_grid_b19_data_dependent_break_trip__c31_fibonacci_stride.c
 * Branch: data_dependent_break_trip | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0931_grid_b19_data_dependent_break_trip__c31_fibonacci_stride.c\n");
