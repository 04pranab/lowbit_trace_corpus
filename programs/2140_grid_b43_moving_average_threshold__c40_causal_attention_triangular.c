/*
 * LowBit -- 2140_grid_b43_moving_average_threshold__c40_causal_attention_triangular.c
 * Branch: moving_average_threshold | Cache: causal_attention_triangular
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2140_grid_b43_moving_average_threshold__c40_causal_attention_triangular.c\n");
