/*
 * LowBit -- 0513_grid_b11_value_dependent_threshold__c13_two_stream_interleaved.c
 * Branch: value_dependent_threshold | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0513_grid_b11_value_dependent_threshold__c13_two_stream_interleaved.c\n");
