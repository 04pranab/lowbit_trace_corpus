/*
 * LowBit -- 0465_grid_b10_correlated_history__c15_reverse_sequential.c
 * Branch: correlated_history | Cache: reverse_sequential
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0465_grid_b10_correlated_history__c15_reverse_sequential.c\n");
