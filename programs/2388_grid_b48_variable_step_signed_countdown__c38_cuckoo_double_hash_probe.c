/*
 * LowBit -- 2388_grid_b48_variable_step_signed_countdown__c38_cuckoo_double_hash_probe.c
 * Branch: variable_step_signed_countdown | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2388_grid_b48_variable_step_signed_countdown__c38_cuckoo_double_hash_probe.c\n");
