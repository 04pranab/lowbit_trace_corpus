/*
 * LowBit -- 1518_grid_b31_prime_period13__c18_producer_consumer_two_pointer.c
 * Branch: prime_period13 | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=1518_grid_b31_prime_period13__c18_producer_consumer_two_pointer.c\n");
