/*
 * LowBit -- 2433_grid_b49_interleaved_two_pattern_multiplex__c33_cache_set_conflict_stress.c
 * Branch: interleaved_two_pattern_multiplex | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=2433_grid_b49_interleaved_two_pattern_multiplex__c33_cache_set_conflict_stress.c\n");
