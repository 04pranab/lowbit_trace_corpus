/*
 * LowBit -- 1856_grid_b38_decaying_hazard_probability__c06_random_full_working_set.c
 * Branch: decaying_hazard_probability | Cache: random_full_working_set
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1856_grid_b38_decaying_hazard_probability__c06_random_full_working_set.c\n");
