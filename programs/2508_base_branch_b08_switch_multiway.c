/*
 * LowBit -- 2508_base_branch_b08_switch_multiway.c
 * Branch: switch_multiway | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=2508_base_branch_b08_switch_multiway.c\n");
