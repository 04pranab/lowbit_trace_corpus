/*
 * LowBit -- 2293_grid_b46_lookup_table_driven__c43_whole_buffer_rotation.c
 * Branch: lookup_table_driven | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2293_grid_b46_lookup_table_driven__c43_whole_buffer_rotation.c\n");
