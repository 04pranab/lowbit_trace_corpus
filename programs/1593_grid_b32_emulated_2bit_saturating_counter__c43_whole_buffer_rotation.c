/*
 * LowBit -- 1593_grid_b32_emulated_2bit_saturating_counter__c43_whole_buffer_rotation.c
 * Branch: emulated_2bit_saturating_counter | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1593_grid_b32_emulated_2bit_saturating_counter__c43_whole_buffer_rotation.c\n");
