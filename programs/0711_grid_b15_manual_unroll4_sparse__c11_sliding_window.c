/*
 * LowBit -- 0711_grid_b15_manual_unroll4_sparse__c11_sliding_window.c
 * Branch: manual_unroll4_sparse | Cache: sliding_window
...
int main(void) {
    ...
    printf("program=0711_grid_b15_manual_unroll4_sparse__c11_sliding_window.c\n");
