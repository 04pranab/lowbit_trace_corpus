/*
 * LowBit -- 0471_grid_b10_correlated_history__c21_pyramid_multiresolution_stride.c
 * Branch: correlated_history | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0471_grid_b10_correlated_history__c21_pyramid_multiresolution_stride.c\n");
