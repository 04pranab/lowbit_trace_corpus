/*
 * LowBit -- 1053_grid_b22_drifting_threshold_periodic_reset__c03_fixed_stride_small.c
 * Branch: drifting_threshold_periodic_reset | Cache: fixed_stride_small
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1053_grid_b22_drifting_threshold_periodic_reset__c03_fixed_stride_small.c\n");
