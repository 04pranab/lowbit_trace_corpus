/*
 * LowBit -- 0223_grid_b05_periodic8_biased__c23_struct_of_array_field_burst.c
 * Branch: periodic8_biased | Cache: struct_of_array_field_burst
...
int main(void) {
    ...
    printf("program=0223_grid_b05_periodic8_biased__c23_struct_of_array_field_burst.c\n");
