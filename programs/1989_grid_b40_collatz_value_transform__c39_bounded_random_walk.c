/*
 * LowBit -- 1989_grid_b40_collatz_value_transform__c39_bounded_random_walk.c
 * Branch: collatz_value_transform | Cache: bounded_random_walk
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1989_grid_b40_collatz_value_transform__c39_bounded_random_walk.c\n");
