/*
 * LowBit -- 1193_grid_b24_monotonic_drift_saturating__c43_whole_buffer_rotation.c
 * Branch: monotonic_drift_saturating | Cache: whole_buffer_rotation
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1193_grid_b24_monotonic_drift_saturating__c43_whole_buffer_rotation.c\n");
