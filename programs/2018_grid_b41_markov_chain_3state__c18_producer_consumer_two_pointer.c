/*
 * LowBit -- 2018_grid_b41_markov_chain_3state__c18_producer_consumer_two_pointer.c
 * Branch: markov_chain_3state | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2018_grid_b41_markov_chain_3state__c18_producer_consumer_two_pointer.c\n");
