/*
 * LowBit -- 1299_grid_b26_warmup_then_steady__c49_binary_heap_parent_child.c
 * Branch: warmup_then_steady | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1299_grid_b26_warmup_then_steady__c49_binary_heap_parent_child.c\n");
