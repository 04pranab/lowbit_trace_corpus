/*
 * LowBit -- 0039_grid_b01_always_taken__c39_bounded_random_walk.c
 * Branch: always_taken | Cache: bounded_random_walk
...
int main(void) {
    ...
    printf("program=0039_grid_b01_always_taken__c39_bounded_random_walk.c\n");
