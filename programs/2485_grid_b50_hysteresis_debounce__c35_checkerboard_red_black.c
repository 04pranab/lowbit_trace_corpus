/*
 * LowBit -- 2485_grid_b50_hysteresis_debounce__c35_checkerboard_red_black.c
 * Branch: hysteresis_debounce | Cache: checkerboard_red_black
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2485_grid_b50_hysteresis_debounce__c35_checkerboard_red_black.c\n");
