/*
 * LowBit -- 1850_grid_b37_value_driven_unswitch_run__c50_streaming_with_periodic_flush.c
 * Branch: value_driven_unswitch_run | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1850_grid_b37_value_driven_unswitch_run__c50_streaming_with_periodic_flush.c\n");
