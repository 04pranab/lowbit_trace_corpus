/*
 * LowBit -- 1454_grid_b30_periodic_interrupt_override__c04_fixed_stride_large.c
 * Branch: periodic_interrupt_override | Cache: fixed_stride_large
...
int main(void) {
    ...
    printf("program=1454_grid_b30_periodic_interrupt_override__c04_fixed_stride_large.c\n");
