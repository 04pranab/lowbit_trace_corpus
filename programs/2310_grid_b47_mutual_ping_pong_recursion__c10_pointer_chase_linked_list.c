/*
 * LowBit -- 2310_grid_b47_mutual_ping_pong_recursion__c10_pointer_chase_linked_list.c
 * Branch: mutual_ping_pong_recursion | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2310_grid_b47_mutual_ping_pong_recursion__c10_pointer_chase_linked_list.c\n");
