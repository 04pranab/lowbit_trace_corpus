/*
 * LowBit -- 1790_grid_b36_traffic_light_fsm__c40_causal_attention_triangular.c
 * Branch: traffic_light_fsm | Cache: causal_attention_triangular
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1790_grid_b36_traffic_light_fsm__c40_causal_attention_triangular.c\n");
