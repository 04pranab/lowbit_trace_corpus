/*
 * LowBit -- 0238_grid_b05_periodic8_biased__c38_cuckoo_double_hash_probe.c
 * Branch: periodic8_biased | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0238_grid_b05_periodic8_biased__c38_cuckoo_double_hash_probe.c\n");
