/*
 * LowBit -- 0786_grid_b16_sentinel_search_loop__c36_im2col_overlapping_patch_gather.c
 * Branch: sentinel_search_loop | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0786_grid_b16_sentinel_search_loop__c36_im2col_overlapping_patch_gather.c\n");
