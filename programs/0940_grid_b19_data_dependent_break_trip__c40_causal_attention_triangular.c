/*
 * LowBit -- 0940_grid_b19_data_dependent_break_trip__c40_causal_attention_triangular.c
 * Branch: data_dependent_break_trip | Cache: causal_attention_triangular
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0940_grid_b19_data_dependent_break_trip__c40_causal_attention_triangular.c\n");
