/*
 * LowBit -- 2126_grid_b43_moving_average_threshold__c26_geometric_stride_growth.c
 * Branch: moving_average_threshold | Cache: geometric_stride_growth
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2126_grid_b43_moving_average_threshold__c26_geometric_stride_growth.c\n");
