/*
 * LowBit -- 1557_grid_b32_emulated_2bit_saturating_counter__c07_matrix_row_major.c
 * Branch: emulated_2bit_saturating_counter | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1557_grid_b32_emulated_2bit_saturating_counter__c07_matrix_row_major.c\n");
