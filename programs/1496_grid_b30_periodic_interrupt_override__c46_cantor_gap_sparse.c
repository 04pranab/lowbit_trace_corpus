/*
 * LowBit -- 1496_grid_b30_periodic_interrupt_override__c46_cantor_gap_sparse.c
 * Branch: periodic_interrupt_override | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=1496_grid_b30_periodic_interrupt_override__c46_cantor_gap_sparse.c\n");
