/*
 * LowBit -- 0821_grid_b17_correlated_two_branch_xor__c21_pyramid_multiresolution_stride.c
 * Branch: correlated_two_branch_xor | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0821_grid_b17_correlated_two_branch_xor__c21_pyramid_multiresolution_stride.c\n");
