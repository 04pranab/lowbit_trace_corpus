/*
 * LowBit -- 2578_base_cache_c28_morton_zorder_traversal.c
 * Branch: synthetic_always_taken | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=2578_base_cache_c28_morton_zorder_traversal.c\n");
