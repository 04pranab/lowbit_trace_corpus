/*
 * LowBit -- 0454_grid_b10_correlated_history__c04_fixed_stride_large.c
 * Branch: correlated_history | Cache: fixed_stride_large
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0454_grid_b10_correlated_history__c04_fixed_stride_large.c\n");
