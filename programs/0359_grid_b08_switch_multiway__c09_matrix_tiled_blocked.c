/*
 * LowBit -- 0359_grid_b08_switch_multiway__c09_matrix_tiled_blocked.c
 * Branch: switch_multiway | Cache: matrix_tiled_blocked
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0359_grid_b08_switch_multiway__c09_matrix_tiled_blocked.c\n");
