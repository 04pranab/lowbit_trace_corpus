/*
 * LowBit -- 0752_grid_b16_sentinel_search_loop__c02_sequential_wraparound_large.c
 * Branch: sentinel_search_loop | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0752_grid_b16_sentinel_search_loop__c02_sequential_wraparound_large.c\n");
