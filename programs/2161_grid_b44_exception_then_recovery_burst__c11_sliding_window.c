/*
 * LowBit -- 2161_grid_b44_exception_then_recovery_burst__c11_sliding_window.c
 * Branch: exception_then_recovery_burst | Cache: sliding_window
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2161_grid_b44_exception_then_recovery_burst__c11_sliding_window.c\n");
