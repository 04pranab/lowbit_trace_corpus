/*
 * LowBit -- 1673_grid_b34_data_driven_countdown__c23_struct_of_array_field_burst.c
 * Branch: data_driven_countdown | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1673_grid_b34_data_driven_countdown__c23_struct_of_array_field_burst.c\n");
