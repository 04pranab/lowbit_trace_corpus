/*
 * LowBit -- 0114_grid_b03_alternating__c14_temporal_burst_reuse.c
 * Branch: alternating | Cache: temporal_burst_reuse
...
int main(void) {
    ...
    printf("program=0114_grid_b03_alternating__c14_temporal_burst_reuse.c\n");
