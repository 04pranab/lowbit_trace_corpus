/*
 * LowBit -- 0274_grid_b06_pseudo_random_50__c24_banked_interleaved_access.c
 * Branch: pseudo_random_50 | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0274_grid_b06_pseudo_random_50__c24_banked_interleaved_access.c\n");
