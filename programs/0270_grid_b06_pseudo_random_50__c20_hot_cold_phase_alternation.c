/*
 * LowBit -- 0270_grid_b06_pseudo_random_50__c20_hot_cold_phase_alternation.c
 * Branch: pseudo_random_50 | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=0270_grid_b06_pseudo_random_50__c20_hot_cold_phase_alternation.c\n");
