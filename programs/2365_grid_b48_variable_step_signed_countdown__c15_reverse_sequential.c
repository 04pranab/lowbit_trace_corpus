/*
 * LowBit -- 2365_grid_b48_variable_step_signed_countdown__c15_reverse_sequential.c
 * Branch: variable_step_signed_countdown | Cache: reverse_sequential
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2365_grid_b48_variable_step_signed_countdown__c15_reverse_sequential.c\n");
