/*
 * LowBit -- 2107_grid_b43_moving_average_threshold__c07_matrix_row_major.c
 * Branch: moving_average_threshold | Cache: matrix_row_major
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2107_grid_b43_moving_average_threshold__c07_matrix_row_major.c\n");
