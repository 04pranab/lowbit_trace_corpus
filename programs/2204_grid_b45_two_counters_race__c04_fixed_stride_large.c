/*
 * LowBit -- 2204_grid_b45_two_counters_race__c04_fixed_stride_large.c
 * Branch: two_counters_race | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2204_grid_b45_two_counters_race__c04_fixed_stride_large.c\n");
