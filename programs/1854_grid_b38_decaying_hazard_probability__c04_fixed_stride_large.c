/*
 * LowBit -- 1854_grid_b38_decaying_hazard_probability__c04_fixed_stride_large.c
 * Branch: decaying_hazard_probability | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1854_grid_b38_decaying_hazard_probability__c04_fixed_stride_large.c\n");
