/*
 * LowBit -- 1521_grid_b31_prime_period13__c21_pyramid_multiresolution_stride.c
 * Branch: prime_period13 | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=1521_grid_b31_prime_period13__c21_pyramid_multiresolution_stride.c\n");
