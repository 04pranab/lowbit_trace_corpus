/*
 * LowBit -- 1483_grid_b30_periodic_interrupt_override__c33_cache_set_conflict_stress.c
 * Branch: periodic_interrupt_override | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=1483_grid_b30_periodic_interrupt_override__c33_cache_set_conflict_stress.c\n");
