/*
 * LowBit -- 1950_grid_b39_dual_lcg_xor_chaos__c50_streaming_with_periodic_flush.c
 * Branch: dual_lcg_xor_chaos | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1950_grid_b39_dual_lcg_xor_chaos__c50_streaming_with_periodic_flush.c\n");
