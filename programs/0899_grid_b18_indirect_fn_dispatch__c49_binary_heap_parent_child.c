/*
 * LowBit -- 0899_grid_b18_indirect_fn_dispatch__c49_binary_heap_parent_child.c
 * Branch: indirect_fn_dispatch | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0899_grid_b18_indirect_fn_dispatch__c49_binary_heap_parent_child.c\n");
