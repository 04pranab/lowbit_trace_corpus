/*
 * LowBit -- 0487_grid_b10_correlated_history__c37_double_buffer_epoch_alternation.c
 * Branch: correlated_history | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0487_grid_b10_correlated_history__c37_double_buffer_epoch_alternation.c\n");
