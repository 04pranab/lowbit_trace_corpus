/*
 * LowBit -- 0118_grid_b03_alternating__c18_producer_consumer_two_pointer.c
 * Branch: alternating | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0118_grid_b03_alternating__c18_producer_consumer_two_pointer.c\n");
