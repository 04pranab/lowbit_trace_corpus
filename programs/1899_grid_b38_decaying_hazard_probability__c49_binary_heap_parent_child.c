/*
 * LowBit -- 1899_grid_b38_decaying_hazard_probability__c49_binary_heap_parent_child.c
 * Branch: decaying_hazard_probability | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1899_grid_b38_decaying_hazard_probability__c49_binary_heap_parent_child.c\n");
