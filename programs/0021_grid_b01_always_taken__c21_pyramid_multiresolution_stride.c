/*
 * LowBit -- 0021_grid_b01_always_taken__c21_pyramid_multiresolution_stride.c
 * Branch: always_taken | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0021_grid_b01_always_taken__c21_pyramid_multiresolution_stride.c\n");
