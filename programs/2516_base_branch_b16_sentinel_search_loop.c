/*
 * LowBit -- 2516_base_branch_b16_sentinel_search_loop.c
 * Branch: sentinel_search_loop | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2516_base_branch_b16_sentinel_search_loop.c\n");
