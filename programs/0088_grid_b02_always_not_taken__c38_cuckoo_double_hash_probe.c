/*
 * LowBit -- 0088_grid_b02_always_not_taken__c38_cuckoo_double_hash_probe.c
 * Branch: always_not_taken | Cache: cuckoo_double_hash_probe
...
int main(void) {
    ...
    printf("program=0088_grid_b02_always_not_taken__c38_cuckoo_double_hash_probe.c\n");
