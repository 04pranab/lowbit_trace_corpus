/*
 * LowBit -- 0362_grid_b08_switch_multiway__c12_prime_stride_anti_alias.c
 * Branch: switch_multiway | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0362_grid_b08_switch_multiway__c12_prime_stride_anti_alias.c\n");
