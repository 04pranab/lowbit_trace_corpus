/*
 * LowBit -- 1018_grid_b21_loop_carried_running_state__c18_producer_consumer_two_pointer.c
 * Branch: loop_carried_running_state | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=1018_grid_b21_loop_carried_running_state__c18_producer_consumer_two_pointer.c\n");
