/*
 * LowBit -- 1933_grid_b39_dual_lcg_xor_chaos__c33_cache_set_conflict_stress.c
 * Branch: dual_lcg_xor_chaos | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1933_grid_b39_dual_lcg_xor_chaos__c33_cache_set_conflict_stress.c\n");
