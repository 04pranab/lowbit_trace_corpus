/*
 * LowBit -- 1088_grid_b22_drifting_threshold_periodic_reset__c38_cuckoo_double_hash_probe.c
 * Branch: drifting_threshold_periodic_reset | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1088_grid_b22_drifting_threshold_periodic_reset__c38_cuckoo_double_hash_probe.c\n");
