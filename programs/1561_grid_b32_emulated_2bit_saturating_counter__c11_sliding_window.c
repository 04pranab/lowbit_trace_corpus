/*
 * LowBit -- 1561_grid_b32_emulated_2bit_saturating_counter__c11_sliding_window.c
 * Branch: emulated_2bit_saturating_counter | Cache: sliding_window
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1561_grid_b32_emulated_2bit_saturating_counter__c11_sliding_window.c\n");
