/*
 * LowBit -- 0744_grid_b15_manual_unroll4_sparse__c44_naive_gemm_row_col_alternation.c
 * Branch: manual_unroll4_sparse | Cache: naive_gemm_row_col_alternation
...
int main(void) {
    ...
    printf("program=0744_grid_b15_manual_unroll4_sparse__c44_naive_gemm_row_col_alternation.c\n");
