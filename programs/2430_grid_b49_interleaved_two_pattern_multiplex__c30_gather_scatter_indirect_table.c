/*
 * LowBit -- 2430_grid_b49_interleaved_two_pattern_multiplex__c30_gather_scatter_indirect_table.c
 * Branch: interleaved_two_pattern_multiplex | Cache: gather_scatter_indirect_table
...
int main(void) {
    ...
    printf("program=2430_grid_b49_interleaved_two_pattern_multiplex__c30_gather_scatter_indirect_table.c\n");
