/*
 * LowBit -- 1173_grid_b24_monotonic_drift_saturating__c23_struct_of_array_field_burst.c
 * Branch: monotonic_drift_saturating | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1173_grid_b24_monotonic_drift_saturating__c23_struct_of_array_field_burst.c\n");
