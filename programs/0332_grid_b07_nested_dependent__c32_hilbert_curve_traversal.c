/*
 * LowBit -- 0332_grid_b07_nested_dependent__c32_hilbert_curve_traversal.c
 * Branch: nested_dependent | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0332_grid_b07_nested_dependent__c32_hilbert_curve_traversal.c\n");
