/*
 * LowBit -- 1307_grid_b27_meta_correlated_nested__c07_matrix_row_major.c
 * Branch: meta_correlated_nested | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1307_grid_b27_meta_correlated_nested__c07_matrix_row_major.c\n");
