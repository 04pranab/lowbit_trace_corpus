/*
 * LowBit -- 0982_grid_b20_random_threshold_walk__c32_hilbert_curve_traversal.c
 * Branch: random_threshold_walk | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0982_grid_b20_random_threshold_walk__c32_hilbert_curve_traversal.c\n");
