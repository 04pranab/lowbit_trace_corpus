/*
 * LowBit -- 2307_grid_b47_mutual_ping_pong_recursion__c07_matrix_row_major.c
 * Branch: mutual_ping_pong_recursion | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2307_grid_b47_mutual_ping_pong_recursion__c07_matrix_row_major.c\n");
