/*
 * LowBit -- 1553_grid_b32_emulated_2bit_saturating_counter__c03_fixed_stride_small.c
 * Branch: emulated_2bit_saturating_counter | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1553_grid_b32_emulated_2bit_saturating_counter__c03_fixed_stride_small.c\n");
