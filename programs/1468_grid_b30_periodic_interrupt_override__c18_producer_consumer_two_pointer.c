/*
 * LowBit -- 1468_grid_b30_periodic_interrupt_override__c18_producer_consumer_two_pointer.c
 * Branch: periodic_interrupt_override | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=1468_grid_b30_periodic_interrupt_override__c18_producer_consumer_two_pointer.c\n");
