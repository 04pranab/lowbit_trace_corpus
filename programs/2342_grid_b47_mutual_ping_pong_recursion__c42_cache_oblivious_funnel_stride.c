/*
 * LowBit -- 2342_grid_b47_mutual_ping_pong_recursion__c42_cache_oblivious_funnel_stride.c
 * Branch: mutual_ping_pong_recursion | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2342_grid_b47_mutual_ping_pong_recursion__c42_cache_oblivious_funnel_stride.c\n");
