/*
 * LowBit -- 2380_grid_b48_variable_step_signed_countdown__c30_gather_scatter_indirect_table.c
 * Branch: variable_step_signed_countdown | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2380_grid_b48_variable_step_signed_countdown__c30_gather_scatter_indirect_table.c\n");
