/*
 * LowBit -- 0952_grid_b20_random_threshold_walk__c02_sequential_wraparound_large.c
 * Branch: random_threshold_walk | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0952_grid_b20_random_threshold_walk__c02_sequential_wraparound_large.c\n");
