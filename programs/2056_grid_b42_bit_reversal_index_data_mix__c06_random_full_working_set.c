/*
 * LowBit -- 2056_grid_b42_bit_reversal_index_data_mix__c06_random_full_working_set.c
 * Branch: bit_reversal_index_data_mix | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2056_grid_b42_bit_reversal_index_data_mix__c06_random_full_working_set.c\n");
