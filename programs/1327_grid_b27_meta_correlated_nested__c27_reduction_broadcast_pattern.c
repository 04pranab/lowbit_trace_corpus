/*
 * LowBit -- 1327_grid_b27_meta_correlated_nested__c27_reduction_broadcast_pattern.c
 * Branch: meta_correlated_nested | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1327_grid_b27_meta_correlated_nested__c27_reduction_broadcast_pattern.c\n");
