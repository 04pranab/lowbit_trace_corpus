/*
 * LowBit -- 0779_grid_b16_sentinel_search_loop__c29_ping_pong_cache_thrash.c
 * Branch: sentinel_search_loop | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0779_grid_b16_sentinel_search_loop__c29_ping_pong_cache_thrash.c\n");
