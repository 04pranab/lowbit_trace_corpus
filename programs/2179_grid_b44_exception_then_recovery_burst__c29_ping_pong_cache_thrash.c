/*
 * LowBit -- 2179_grid_b44_exception_then_recovery_burst__c29_ping_pong_cache_thrash.c
 * Branch: exception_then_recovery_burst | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2179_grid_b44_exception_then_recovery_burst__c29_ping_pong_cache_thrash.c\n");
