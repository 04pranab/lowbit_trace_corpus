/*
 * LowBit -- 0990_grid_b20_random_threshold_walk__c40_causal_attention_triangular.c
 * Branch: random_threshold_walk | Cache: causal_attention_triangular
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0990_grid_b20_random_threshold_walk__c40_causal_attention_triangular.c\n");
