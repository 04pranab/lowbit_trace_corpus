/*
 * LowBit -- 1336_grid_b27_meta_correlated_nested__c36_im2col_overlapping_patch_gather.c
 * Branch: meta_correlated_nested | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1336_grid_b27_meta_correlated_nested__c36_im2col_overlapping_patch_gather.c\n");
