/*
 * LowBit -- 0888_grid_b18_indirect_fn_dispatch__c38_cuckoo_double_hash_probe.c
 * Branch: indirect_fn_dispatch | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0888_grid_b18_indirect_fn_dispatch__c38_cuckoo_double_hash_probe.c\n");
