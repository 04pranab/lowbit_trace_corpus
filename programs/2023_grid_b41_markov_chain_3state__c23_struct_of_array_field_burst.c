/*
 * LowBit -- 2023_grid_b41_markov_chain_3state__c23_struct_of_array_field_burst.c
 * Branch: markov_chain_3state | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2023_grid_b41_markov_chain_3state__c23_struct_of_array_field_burst.c\n");
