/*
 * LowBit -- 2412_grid_b49_interleaved_two_pattern_multiplex__c12_prime_stride_anti_alias.c
 * Branch: interleaved_two_pattern_multiplex | Cache: prime_stride_anti_alias
...
int main(void) {
    ...
    printf("program=2412_grid_b49_interleaved_two_pattern_multiplex__c12_prime_stride_anti_alias.c\n");
