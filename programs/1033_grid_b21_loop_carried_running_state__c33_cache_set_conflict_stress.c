/*
 * LowBit -- 1033_grid_b21_loop_carried_running_state__c33_cache_set_conflict_stress.c
 * Branch: loop_carried_running_state | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=1033_grid_b21_loop_carried_running_state__c33_cache_set_conflict_stress.c\n");
