/*
 * LowBit -- 1389_grid_b28_data_driven_stack_machine__c39_bounded_random_walk.c
 * Branch: data_driven_stack_machine | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1389_grid_b28_data_driven_stack_machine__c39_bounded_random_walk.c\n");
