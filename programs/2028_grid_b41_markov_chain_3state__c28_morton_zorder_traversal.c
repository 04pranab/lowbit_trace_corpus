/*
 * LowBit -- 2028_grid_b41_markov_chain_3state__c28_morton_zorder_traversal.c
 * Branch: markov_chain_3state | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2028_grid_b41_markov_chain_3state__c28_morton_zorder_traversal.c\n");
