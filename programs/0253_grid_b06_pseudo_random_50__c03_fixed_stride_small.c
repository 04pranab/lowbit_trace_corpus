/*
 * LowBit -- 0253_grid_b06_pseudo_random_50__c03_fixed_stride_small.c
 * Branch: pseudo_random_50 | Cache: fixed_stride_small
...
int main(void) {
    ...
    printf("program=0253_grid_b06_pseudo_random_50__c03_fixed_stride_small.c\n");
