/*
 * LowBit -- 0961_grid_b20_random_threshold_walk__c11_sliding_window.c
 * Branch: random_threshold_walk | Cache: sliding_window
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0961_grid_b20_random_threshold_walk__c11_sliding_window.c\n");
