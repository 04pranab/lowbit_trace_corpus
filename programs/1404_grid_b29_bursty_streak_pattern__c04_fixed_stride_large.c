/*
 * LowBit -- 1404_grid_b29_bursty_streak_pattern__c04_fixed_stride_large.c
 * Branch: bursty_streak_pattern | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1404_grid_b29_bursty_streak_pattern__c04_fixed_stride_large.c\n");
