/*
 * LowBit -- 2462_grid_b50_hysteresis_debounce__c12_prime_stride_anti_alias.c
 * Branch: hysteresis_debounce | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2462_grid_b50_hysteresis_debounce__c12_prime_stride_anti_alias.c\n");
