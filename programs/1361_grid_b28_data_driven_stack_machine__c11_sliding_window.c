/*
 * LowBit -- 1361_grid_b28_data_driven_stack_machine__c11_sliding_window.c
 * Branch: data_driven_stack_machine | Cache: sliding_window
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1361_grid_b28_data_driven_stack_machine__c11_sliding_window.c\n");
