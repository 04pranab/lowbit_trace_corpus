/*
 * LowBit -- 2483_grid_b50_hysteresis_debounce__c33_cache_set_conflict_stress.c
 * Branch: hysteresis_debounce | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2483_grid_b50_hysteresis_debounce__c33_cache_set_conflict_stress.c\n");
