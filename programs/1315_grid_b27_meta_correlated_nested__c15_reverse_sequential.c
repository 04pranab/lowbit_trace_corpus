/*
 * LowBit -- 1315_grid_b27_meta_correlated_nested__c15_reverse_sequential.c
 * Branch: meta_correlated_nested | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1315_grid_b27_meta_correlated_nested__c15_reverse_sequential.c\n");
