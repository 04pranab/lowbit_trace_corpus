/*
 * LowBit -- 1372_grid_b28_data_driven_stack_machine__c22_tensor_3d_slice_poor_locality.c
 * Branch: data_driven_stack_machine | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1372_grid_b28_data_driven_stack_machine__c22_tensor_3d_slice_poor_locality.c\n");
