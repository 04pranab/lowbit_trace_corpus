/*
 * LowBit -- 1375_grid_b28_data_driven_stack_machine__c25_lru_recency_weighted_reuse.c
 * Branch: data_driven_stack_machine | Cache: lru_recency_weighted_reuse
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1375_grid_b28_data_driven_stack_machine__c25_lru_recency_weighted_reuse.c\n");
