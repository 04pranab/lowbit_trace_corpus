/*
 * LowBit -- 1907_grid_b39_dual_lcg_xor_chaos__c07_matrix_row_major.c
 * Branch: dual_lcg_xor_chaos | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = (r39_ & 1u) == 0u; }
    ...
    printf("program=1907_grid_b39_dual_lcg_xor_chaos__c07_matrix_row_major.c\n");
