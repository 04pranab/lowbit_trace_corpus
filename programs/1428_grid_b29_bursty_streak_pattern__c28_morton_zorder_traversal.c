/*
 * LowBit -- 1428_grid_b29_bursty_streak_pattern__c28_morton_zorder_traversal.c
 * Branch: bursty_streak_pattern | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1428_grid_b29_bursty_streak_pattern__c28_morton_zorder_traversal.c\n");
