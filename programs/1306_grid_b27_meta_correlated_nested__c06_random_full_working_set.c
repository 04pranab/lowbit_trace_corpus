/*
 * LowBit -- 1306_grid_b27_meta_correlated_nested__c06_random_full_working_set.c
 * Branch: meta_correlated_nested | Cache: random_full_working_set
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1306_grid_b27_meta_correlated_nested__c06_random_full_working_set.c\n");
