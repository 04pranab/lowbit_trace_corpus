/*
 * LowBit -- 1545_grid_b31_prime_period13__c45_read_hot_write_cold_split.c
 * Branch: prime_period13 | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=1545_grid_b31_prime_period13__c45_read_hot_write_cold_split.c\n");
