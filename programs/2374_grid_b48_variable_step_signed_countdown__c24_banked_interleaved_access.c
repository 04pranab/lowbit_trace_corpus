/*
 * LowBit -- 2374_grid_b48_variable_step_signed_countdown__c24_banked_interleaved_access.c
 * Branch: variable_step_signed_countdown | Cache: banked_interleaved_access
...
int main(void) {
  ...
  val48_ -= (int32_t)((v & 7u) + 1u); }
    ...
    printf("program=2374_grid_b48_variable_step_signed_countdown__c24_banked_interleaved_access.c\n");
