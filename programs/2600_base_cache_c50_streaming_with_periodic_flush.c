/*
 * LowBit -- 2600_base_cache_c50_streaming_with_periodic_flush.c
 * Branch: synthetic_always_taken | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=2600_base_cache_c50_streaming_with_periodic_flush.c\n");
