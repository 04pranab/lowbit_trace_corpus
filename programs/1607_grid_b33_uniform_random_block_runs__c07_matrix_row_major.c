/*
 * LowBit -- 1607_grid_b33_uniform_random_block_runs__c07_matrix_row_major.c
 * Branch: uniform_random_block_runs | Cache: matrix_row_major
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = (uint32_t)(((i / mcols_) % mrows_) * mcols_ + (i % mcols_));
        uint32_t v = buf[idx];
        int taken;
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1607_grid_b33_uniform_random_block_runs__c07_matrix_row_major.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=matrix_row_major\n");
