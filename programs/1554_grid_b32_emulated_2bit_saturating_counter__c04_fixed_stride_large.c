/*
 * LowBit -- 1554_grid_b32_emulated_2bit_saturating_counter__c04_fixed_stride_large.c
 * Branch: emulated_2bit_saturating_counter | Cache: fixed_stride_large
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1554_grid_b32_emulated_2bit_saturating_counter__c04_fixed_stride_large.c\n");
