/*
 * LowBit -- 1169_grid_b24_monotonic_drift_saturating__c19_matrix_diagonal_wavefront.c
 * Branch: monotonic_drift_saturating | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1169_grid_b24_monotonic_drift_saturating__c19_matrix_diagonal_wavefront.c\n");
