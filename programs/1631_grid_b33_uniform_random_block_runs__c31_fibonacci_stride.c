/*
 * LowBit -- 1631_grid_b33_uniform_random_block_runs__c31_fibonacci_stride.c
 * Branch: uniform_random_block_runs | Cache: fibonacci_stride
...
int main(void) {
    ...
    int *prev_taken = &prev_taken_local;
        ...
        uint32_t fib_a31_ = 1u, fib_b31_ = 1u; uint32_t base31_ = 0u;
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
        uint32_t idx = ({ base31_ = (base31_ + fib_a31_) % SIZE;
  ...
  if (pos33_ >= len33_) { pos33_ = 0; len33_ = 1u + (lcg_next(&bseed33_) % 64u); dir33_ ^= 1; } }
    ...
    printf("program=1631_grid_b33_uniform_random_block_runs__c31_fibonacci_stride.c\n");
    printf("branch_pattern=uniform_random_block_runs\n");
    printf("cache_pattern=fibonacci_stride\n");
