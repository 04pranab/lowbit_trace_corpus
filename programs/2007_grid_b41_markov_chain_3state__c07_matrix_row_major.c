/*
 * LowBit -- 2007_grid_b41_markov_chain_3state__c07_matrix_row_major.c
 * Branch: markov_chain_3state | Cache: matrix_row_major
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2007_grid_b41_markov_chain_3state__c07_matrix_row_major.c\n");
