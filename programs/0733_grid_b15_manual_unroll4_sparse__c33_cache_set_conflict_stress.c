/*
 * LowBit -- 0733_grid_b15_manual_unroll4_sparse__c33_cache_set_conflict_stress.c
 * Branch: manual_unroll4_sparse | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0733_grid_b15_manual_unroll4_sparse__c33_cache_set_conflict_stress.c\n");
