/*
 * LowBit -- 0979_grid_b20_random_threshold_walk__c29_ping_pong_cache_thrash.c
 * Branch: random_threshold_walk | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0979_grid_b20_random_threshold_walk__c29_ping_pong_cache_thrash.c\n");
