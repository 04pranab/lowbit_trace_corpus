/*
 * LowBit -- 2319_grid_b47_mutual_ping_pong_recursion__c19_matrix_diagonal_wavefront.c
 * Branch: mutual_ping_pong_recursion | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2319_grid_b47_mutual_ping_pong_recursion__c19_matrix_diagonal_wavefront.c\n");
