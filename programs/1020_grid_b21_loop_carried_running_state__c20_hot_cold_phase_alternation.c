/*
 * LowBit -- 1020_grid_b21_loop_carried_running_state__c20_hot_cold_phase_alternation.c
 * Branch: loop_carried_running_state | Cache: hot_cold_phase_alternation
...
int main(void) {
    ...
    printf("program=1020_grid_b21_loop_carried_running_state__c20_hot_cold_phase_alternation.c\n");
