/*
 * LowBit -- 2268_grid_b46_lookup_table_driven__c18_producer_consumer_two_pointer.c
 * Branch: lookup_table_driven | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = tbl46_[v & 0xFFu]; }
    ...
    printf("program=2268_grid_b46_lookup_table_driven__c18_producer_consumer_two_pointer.c\n");
    printf("branch_pattern=lookup_table_driven\n");
    printf("cache_pattern=producer_consumer_two_pointer\n");
