/*
 * LowBit -- 1591_grid_b32_emulated_2bit_saturating_counter__c41_skip_list_multilevel_hop.c
 * Branch: emulated_2bit_saturating_counter | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1591_grid_b32_emulated_2bit_saturating_counter__c41_skip_list_multilevel_hop.c\n");
