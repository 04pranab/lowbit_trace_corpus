/*
 * LowBit -- 2010_grid_b41_markov_chain_3state__c10_pointer_chase_linked_list.c
 * Branch: markov_chain_3state | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2010_grid_b41_markov_chain_3state__c10_pointer_chase_linked_list.c\n");
