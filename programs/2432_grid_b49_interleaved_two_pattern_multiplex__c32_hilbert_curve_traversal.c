/*
 * LowBit -- 2432_grid_b49_interleaved_two_pattern_multiplex__c32_hilbert_curve_traversal.c
 * Branch: interleaved_two_pattern_multiplex | Cache: hilbert_curve_traversal
...
int main(void) {
    ...
    printf("program=2432_grid_b49_interleaved_two_pattern_multiplex__c32_hilbert_curve_traversal.c\n");
