/*
 * LowBit -- 0382_grid_b08_switch_multiway__c32_hilbert_curve_traversal.c
 * Branch: switch_multiway | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0382_grid_b08_switch_multiway__c32_hilbert_curve_traversal.c\n");
