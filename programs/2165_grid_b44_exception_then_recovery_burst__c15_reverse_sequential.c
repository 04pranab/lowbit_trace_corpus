/*
 * LowBit -- 2165_grid_b44_exception_then_recovery_burst__c15_reverse_sequential.c
 * Branch: exception_then_recovery_burst | Cache: reverse_sequential
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2165_grid_b44_exception_then_recovery_burst__c15_reverse_sequential.c\n");
