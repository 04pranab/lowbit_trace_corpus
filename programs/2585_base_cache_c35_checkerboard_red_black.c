/*
 * LowBit -- 2585_base_cache_c35_checkerboard_red_black.c
 * Branch: synthetic_always_taken | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=2585_base_cache_c35_checkerboard_red_black.c\n");
