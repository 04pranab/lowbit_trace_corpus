/*
 * LowBit -- 0365_grid_b08_switch_multiway__c15_reverse_sequential.c
 * Branch: switch_multiway | Cache: reverse_sequential
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0365_grid_b08_switch_multiway__c15_reverse_sequential.c\n");
