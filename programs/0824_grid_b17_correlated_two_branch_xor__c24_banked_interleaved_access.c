/*
 * LowBit -- 0824_grid_b17_correlated_two_branch_xor__c24_banked_interleaved_access.c
 * Branch: correlated_two_branch_xor | Cache: banked_interleaved_access
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0824_grid_b17_correlated_two_branch_xor__c24_banked_interleaved_access.c\n");
