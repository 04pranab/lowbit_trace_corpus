/*
 * LowBit -- 1344_grid_b27_meta_correlated_nested__c44_naive_gemm_row_col_alternation.c
 * Branch: meta_correlated_nested | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1344_grid_b27_meta_correlated_nested__c44_naive_gemm_row_col_alternation.c\n");
