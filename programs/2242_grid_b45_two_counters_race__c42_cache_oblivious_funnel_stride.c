/*
 * LowBit -- 2242_grid_b45_two_counters_race__c42_cache_oblivious_funnel_stride.c
 * Branch: two_counters_race | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = cA45_ >= cB45_; }
    ...
    printf("program=2242_grid_b45_two_counters_race__c42_cache_oblivious_funnel_stride.c\n");
