/*
 * LowBit -- 0322_grid_b07_nested_dependent__c22_tensor_3d_slice_poor_locality.c
 * Branch: nested_dependent | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0322_grid_b07_nested_dependent__c22_tensor_3d_slice_poor_locality.c\n");
