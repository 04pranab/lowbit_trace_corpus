/*
 * LowBit -- 1117_grid_b23_popcount_parity__c17_zipf_like_hot_buckets.c
 * Branch: popcount_parity | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1117_grid_b23_popcount_parity__c17_zipf_like_hot_buckets.c\n");
