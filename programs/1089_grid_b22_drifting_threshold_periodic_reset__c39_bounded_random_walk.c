/*
 * LowBit -- 1089_grid_b22_drifting_threshold_periodic_reset__c39_bounded_random_walk.c
 * Branch: drifting_threshold_periodic_reset | Cache: bounded_random_walk
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1089_grid_b22_drifting_threshold_periodic_reset__c39_bounded_random_walk.c\n");
