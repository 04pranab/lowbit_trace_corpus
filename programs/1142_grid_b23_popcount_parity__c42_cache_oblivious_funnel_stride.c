/*
 * LowBit -- 1142_grid_b23_popcount_parity__c42_cache_oblivious_funnel_stride.c
 * Branch: popcount_parity | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1142_grid_b23_popcount_parity__c42_cache_oblivious_funnel_stride.c\n");
