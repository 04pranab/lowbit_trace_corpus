/*
 * LowBit -- 1438_grid_b29_bursty_streak_pattern__c38_cuckoo_double_hash_probe.c
 * Branch: bursty_streak_pattern | Cache: cuckoo_double_hash_probe
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1438_grid_b29_bursty_streak_pattern__c38_cuckoo_double_hash_probe.c\n");
