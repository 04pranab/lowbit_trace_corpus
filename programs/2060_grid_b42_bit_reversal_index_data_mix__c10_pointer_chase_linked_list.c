/*
 * LowBit -- 2060_grid_b42_bit_reversal_index_data_mix__c10_pointer_chase_linked_list.c
 * Branch: bit_reversal_index_data_mix | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2060_grid_b42_bit_reversal_index_data_mix__c10_pointer_chase_linked_list.c\n");
