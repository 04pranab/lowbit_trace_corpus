/*
 * LowBit -- 0399_grid_b08_switch_multiway__c49_binary_heap_parent_child.c
 * Branch: switch_multiway | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0399_grid_b08_switch_multiway__c49_binary_heap_parent_child.c\n");
