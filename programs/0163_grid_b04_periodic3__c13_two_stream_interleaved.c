/*
 * LowBit -- 0163_grid_b04_periodic3__c13_two_stream_interleaved.c
 * Branch: periodic3 | Cache: two_stream_interleaved
...
int main(void) {
    ...
    printf("program=0163_grid_b04_periodic3__c13_two_stream_interleaved.c\n");
