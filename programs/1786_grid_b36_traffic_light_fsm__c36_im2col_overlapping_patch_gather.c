/*
 * LowBit -- 1786_grid_b36_traffic_light_fsm__c36_im2col_overlapping_patch_gather.c
 * Branch: traffic_light_fsm | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1786_grid_b36_traffic_light_fsm__c36_im2col_overlapping_patch_gather.c\n");
