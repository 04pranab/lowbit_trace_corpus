/*
 * LowBit -- 0364_grid_b08_switch_multiway__c14_temporal_burst_reuse.c
 * Branch: switch_multiway | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0364_grid_b08_switch_multiway__c14_temporal_burst_reuse.c\n");
