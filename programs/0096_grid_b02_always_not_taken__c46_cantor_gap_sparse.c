/*
 * LowBit -- 0096_grid_b02_always_not_taken__c46_cantor_gap_sparse.c
 * Branch: always_not_taken | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0096_grid_b02_always_not_taken__c46_cantor_gap_sparse.c\n");
