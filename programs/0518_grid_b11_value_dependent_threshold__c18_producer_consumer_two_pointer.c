/*
 * LowBit -- 0518_grid_b11_value_dependent_threshold__c18_producer_consumer_two_pointer.c
 * Branch: value_dependent_threshold | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0518_grid_b11_value_dependent_threshold__c18_producer_consumer_two_pointer.c\n");
