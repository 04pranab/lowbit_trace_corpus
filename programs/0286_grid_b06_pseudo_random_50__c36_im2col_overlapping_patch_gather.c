/*
 * LowBit -- 0286_grid_b06_pseudo_random_50__c36_im2col_overlapping_patch_gather.c
 * Branch: pseudo_random_50 | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0286_grid_b06_pseudo_random_50__c36_im2col_overlapping_patch_gather.c\n");
