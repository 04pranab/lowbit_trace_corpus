/*
 * LowBit -- 1029_grid_b21_loop_carried_running_state__c29_ping_pong_cache_thrash.c
 * Branch: loop_carried_running_state | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=1029_grid_b21_loop_carried_running_state__c29_ping_pong_cache_thrash.c\n");
