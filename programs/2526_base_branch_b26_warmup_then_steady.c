/*
 * LowBit -- 2526_base_branch_b26_warmup_then_steady.c
 * Branch: warmup_then_steady | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=2526_base_branch_b26_warmup_then_steady.c\n");
