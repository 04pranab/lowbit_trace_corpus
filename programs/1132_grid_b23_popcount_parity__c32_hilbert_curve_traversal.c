/*
 * LowBit -- 1132_grid_b23_popcount_parity__c32_hilbert_curve_traversal.c
 * Branch: popcount_parity | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1132_grid_b23_popcount_parity__c32_hilbert_curve_traversal.c\n");
