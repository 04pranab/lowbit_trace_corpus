/*
 * LowBit -- 0283_grid_b06_pseudo_random_50__c33_cache_set_conflict_stress.c
 * Branch: pseudo_random_50 | Cache: cache_set_conflict_stress
...
int main(void) {
    ...
    printf("program=0283_grid_b06_pseudo_random_50__c33_cache_set_conflict_stress.c\n");
