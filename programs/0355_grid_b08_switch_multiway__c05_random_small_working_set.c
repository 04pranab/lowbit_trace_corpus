/*
 * LowBit -- 0355_grid_b08_switch_multiway__c05_random_small_working_set.c
 * Branch: switch_multiway | Cache: random_small_working_set
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0355_grid_b08_switch_multiway__c05_random_small_working_set.c\n");
