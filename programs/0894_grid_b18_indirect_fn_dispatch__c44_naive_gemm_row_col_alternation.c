/*
 * LowBit -- 0894_grid_b18_indirect_fn_dispatch__c44_naive_gemm_row_col_alternation.c
 * Branch: indirect_fn_dispatch | Cache: naive_gemm_row_col_alternation
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0894_grid_b18_indirect_fn_dispatch__c44_naive_gemm_row_col_alternation.c\n");
