/*
 * LowBit -- 2167_grid_b44_exception_then_recovery_burst__c17_zipf_like_hot_buckets.c
 * Branch: exception_then_recovery_burst | Cache: zipf_like_hot_buckets
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2167_grid_b44_exception_then_recovery_burst__c17_zipf_like_hot_buckets.c\n");
