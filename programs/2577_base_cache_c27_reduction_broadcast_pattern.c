/*
 * LowBit -- 2577_base_cache_c27_reduction_broadcast_pattern.c
 * Branch: synthetic_always_taken | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=2577_base_cache_c27_reduction_broadcast_pattern.c\n");
