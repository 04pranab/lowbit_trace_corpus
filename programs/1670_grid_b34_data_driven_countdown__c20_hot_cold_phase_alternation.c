/*
 * LowBit -- 1670_grid_b34_data_driven_countdown__c20_hot_cold_phase_alternation.c
 * Branch: data_driven_countdown | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1670_grid_b34_data_driven_countdown__c20_hot_cold_phase_alternation.c\n");
