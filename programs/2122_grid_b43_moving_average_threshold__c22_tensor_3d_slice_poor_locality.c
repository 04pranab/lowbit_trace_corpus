/*
 * LowBit -- 2122_grid_b43_moving_average_threshold__c22_tensor_3d_slice_poor_locality.c
 * Branch: moving_average_threshold | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2122_grid_b43_moving_average_threshold__c22_tensor_3d_slice_poor_locality.c\n");
