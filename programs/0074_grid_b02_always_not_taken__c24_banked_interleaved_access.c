/*
 * LowBit -- 0074_grid_b02_always_not_taken__c24_banked_interleaved_access.c
 * Branch: always_not_taken | Cache: banked_interleaved_access
...
int main(void) {
    ...
    printf("program=0074_grid_b02_always_not_taken__c24_banked_interleaved_access.c\n");
