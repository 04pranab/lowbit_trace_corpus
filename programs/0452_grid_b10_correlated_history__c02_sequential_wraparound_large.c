/*
 * LowBit -- 0452_grid_b10_correlated_history__c02_sequential_wraparound_large.c
 * Branch: correlated_history | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  *prev_taken = ((*prev_taken) << 1) | taken; }
    ...
    printf("program=0452_grid_b10_correlated_history__c02_sequential_wraparound_large.c\n");
