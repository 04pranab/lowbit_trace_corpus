/*
 * LowBit -- 1527_grid_b31_prime_period13__c27_reduction_broadcast_pattern.c
 * Branch: prime_period13 | Cache: reduction_broadcast_pattern
...
int main(void) {
    ...
    printf("program=1527_grid_b31_prime_period13__c27_reduction_broadcast_pattern.c\n");
