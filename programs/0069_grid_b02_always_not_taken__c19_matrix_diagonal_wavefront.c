/*
 * LowBit -- 0069_grid_b02_always_not_taken__c19_matrix_diagonal_wavefront.c
 * Branch: always_not_taken | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    printf("program=0069_grid_b02_always_not_taken__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=always_not_taken\n");
