/*
 * LowBit -- 2435_grid_b49_interleaved_two_pattern_multiplex__c35_checkerboard_red_black.c
 * Branch: interleaved_two_pattern_multiplex | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=2435_grid_b49_interleaved_two_pattern_multiplex__c35_checkerboard_red_black.c\n");
