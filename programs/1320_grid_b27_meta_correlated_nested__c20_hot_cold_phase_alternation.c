/*
 * LowBit -- 1320_grid_b27_meta_correlated_nested__c20_hot_cold_phase_alternation.c
 * Branch: meta_correlated_nested | Cache: hot_cold_phase_alternation
...
int main(void) {
  ...
  taken = outer27_ ? (int)((inner27_ % 3u) != 0u) : (int)((inner27_ % 7u) < 4u); }
    ...
    printf("program=1320_grid_b27_meta_correlated_nested__c20_hot_cold_phase_alternation.c\n");
