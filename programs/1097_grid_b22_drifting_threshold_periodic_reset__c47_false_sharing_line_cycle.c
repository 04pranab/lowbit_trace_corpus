/*
 * LowBit -- 1097_grid_b22_drifting_threshold_periodic_reset__c47_false_sharing_line_cycle.c
 * Branch: drifting_threshold_periodic_reset | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1097_grid_b22_drifting_threshold_periodic_reset__c47_false_sharing_line_cycle.c\n");
