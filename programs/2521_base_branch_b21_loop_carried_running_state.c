/*
 * LowBit -- 2521_base_branch_b21_loop_carried_running_state.c
 * Branch: loop_carried_running_state | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2521_base_branch_b21_loop_carried_running_state.c\n");
