/*
 * LowBit -- 1141_grid_b23_popcount_parity__c41_skip_list_multilevel_hop.c
 * Branch: popcount_parity | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1141_grid_b23_popcount_parity__c41_skip_list_multilevel_hop.c\n");
