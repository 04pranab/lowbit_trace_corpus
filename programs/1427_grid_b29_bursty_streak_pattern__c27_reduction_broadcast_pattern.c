/*
 * LowBit -- 1427_grid_b29_bursty_streak_pattern__c27_reduction_broadcast_pattern.c
 * Branch: bursty_streak_pattern | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1427_grid_b29_bursty_streak_pattern__c27_reduction_broadcast_pattern.c\n");
