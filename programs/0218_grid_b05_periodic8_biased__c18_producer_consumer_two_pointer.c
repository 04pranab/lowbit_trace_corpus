/*
 * LowBit -- 0218_grid_b05_periodic8_biased__c18_producer_consumer_two_pointer.c
 * Branch: periodic8_biased | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0218_grid_b05_periodic8_biased__c18_producer_consumer_two_pointer.c\n");
