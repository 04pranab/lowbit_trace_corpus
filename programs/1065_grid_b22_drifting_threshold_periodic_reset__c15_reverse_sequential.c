/*
 * LowBit -- 1065_grid_b22_drifting_threshold_periodic_reset__c15_reverse_sequential.c
 * Branch: drifting_threshold_periodic_reset | Cache: reverse_sequential
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1065_grid_b22_drifting_threshold_periodic_reset__c15_reverse_sequential.c\n");
