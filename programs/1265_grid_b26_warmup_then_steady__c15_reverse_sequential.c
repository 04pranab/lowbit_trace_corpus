/*
 * LowBit -- 1265_grid_b26_warmup_then_steady__c15_reverse_sequential.c
 * Branch: warmup_then_steady | Cache: reverse_sequential
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1265_grid_b26_warmup_then_steady__c15_reverse_sequential.c\n");
