/*
 * LowBit -- 0349_grid_b07_nested_dependent__c49_binary_heap_parent_child.c
 * Branch: nested_dependent | Cache: binary_heap_parent_child
...
int main(void) {
  ...
  taken = inner_ < (outer_ ? 12u : 4u); }
    ...
    printf("program=0349_grid_b07_nested_dependent__c49_binary_heap_parent_child.c\n");
