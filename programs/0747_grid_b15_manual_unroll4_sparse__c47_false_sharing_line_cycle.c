/*
 * LowBit -- 0747_grid_b15_manual_unroll4_sparse__c47_false_sharing_line_cycle.c
 * Branch: manual_unroll4_sparse | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0747_grid_b15_manual_unroll4_sparse__c47_false_sharing_line_cycle.c\n");
