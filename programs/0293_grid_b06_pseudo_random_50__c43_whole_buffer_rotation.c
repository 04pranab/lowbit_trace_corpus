/*
 * LowBit -- 0293_grid_b06_pseudo_random_50__c43_whole_buffer_rotation.c
 * Branch: pseudo_random_50 | Cache: whole_buffer_rotation
...
int main(void) {
    ...
    printf("program=0293_grid_b06_pseudo_random_50__c43_whole_buffer_rotation.c\n");
