/*
 * LowBit -- 1727_grid_b35_xorshift_hash_mix__c27_reduction_broadcast_pattern.c
 * Branch: xorshift_hash_mix | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1727_grid_b35_xorshift_hash_mix__c27_reduction_broadcast_pattern.c\n");
