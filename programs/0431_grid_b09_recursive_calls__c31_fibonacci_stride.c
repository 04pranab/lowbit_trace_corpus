/*
 * LowBit -- 0431_grid_b09_recursive_calls__c31_fibonacci_stride.c
 * Branch: recursive_calls | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0431_grid_b09_recursive_calls__c31_fibonacci_stride.c\n");
