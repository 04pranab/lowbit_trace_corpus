/*
 * LowBit -- 0610_grid_b13_single_phase_change__c10_pointer_chase_linked_list.c
 * Branch: single_phase_change | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0610_grid_b13_single_phase_change__c10_pointer_chase_linked_list.c\n");
