/*
 * LowBit -- 1586_grid_b32_emulated_2bit_saturating_counter__c36_im2col_overlapping_patch_gather.c
 * Branch: emulated_2bit_saturating_counter | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1586_grid_b32_emulated_2bit_saturating_counter__c36_im2col_overlapping_patch_gather.c\n");
