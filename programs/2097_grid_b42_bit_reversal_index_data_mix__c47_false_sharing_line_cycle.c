/*
 * LowBit -- 2097_grid_b42_bit_reversal_index_data_mix__c47_false_sharing_line_cycle.c
 * Branch: bit_reversal_index_data_mix | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2097_grid_b42_bit_reversal_index_data_mix__c47_false_sharing_line_cycle.c\n");
