/*
 * LowBit -- 0873_grid_b18_indirect_fn_dispatch__c23_struct_of_array_field_burst.c
 * Branch: indirect_fn_dispatch | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0873_grid_b18_indirect_fn_dispatch__c23_struct_of_array_field_burst.c\n");
