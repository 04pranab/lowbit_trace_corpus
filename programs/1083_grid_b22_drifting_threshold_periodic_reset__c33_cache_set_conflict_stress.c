/*
 * LowBit -- 1083_grid_b22_drifting_threshold_periodic_reset__c33_cache_set_conflict_stress.c
 * Branch: drifting_threshold_periodic_reset | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1083_grid_b22_drifting_threshold_periodic_reset__c33_cache_set_conflict_stress.c\n");
