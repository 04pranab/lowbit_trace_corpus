/*
 * LowBit -- 0823_grid_b17_correlated_two_branch_xor__c23_struct_of_array_field_burst.c
 * Branch: correlated_two_branch_xor | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0823_grid_b17_correlated_two_branch_xor__c23_struct_of_array_field_burst.c\n");
