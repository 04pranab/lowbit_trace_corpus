/*
 * LowBit -- 2505_base_branch_b05_periodic8_biased.c
 * Branch: periodic8_biased | Cache: synthetic_sequential_scan
...
int main(void) {
    ...
    printf("program=2505_base_branch_b05_periodic8_biased.c\n");
