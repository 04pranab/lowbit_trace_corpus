/*
 * LowBit -- 1452_grid_b30_periodic_interrupt_override__c02_sequential_wraparound_large.c
 * Branch: periodic_interrupt_override | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=1452_grid_b30_periodic_interrupt_override__c02_sequential_wraparound_large.c\n");
