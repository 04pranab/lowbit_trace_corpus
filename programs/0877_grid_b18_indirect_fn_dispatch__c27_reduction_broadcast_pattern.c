/*
 * LowBit -- 0877_grid_b18_indirect_fn_dispatch__c27_reduction_broadcast_pattern.c
 * Branch: indirect_fn_dispatch | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0877_grid_b18_indirect_fn_dispatch__c27_reduction_broadcast_pattern.c\n");
