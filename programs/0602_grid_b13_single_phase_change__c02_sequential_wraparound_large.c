/*
 * LowBit -- 0602_grid_b13_single_phase_change__c02_sequential_wraparound_large.c
 * Branch: single_phase_change | Cache: sequential_wraparound_large
...
int main(void) {
    ...
    printf("program=0602_grid_b13_single_phase_change__c02_sequential_wraparound_large.c\n");
