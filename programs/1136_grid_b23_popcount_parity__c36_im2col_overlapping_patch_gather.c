/*
 * LowBit -- 1136_grid_b23_popcount_parity__c36_im2col_overlapping_patch_gather.c
 * Branch: popcount_parity | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1136_grid_b23_popcount_parity__c36_im2col_overlapping_patch_gather.c\n");
