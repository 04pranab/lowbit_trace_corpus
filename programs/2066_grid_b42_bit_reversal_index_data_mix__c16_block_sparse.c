/*
 * LowBit -- 2066_grid_b42_bit_reversal_index_data_mix__c16_block_sparse.c
 * Branch: bit_reversal_index_data_mix | Cache: block_sparse
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2066_grid_b42_bit_reversal_index_data_mix__c16_block_sparse.c\n");
