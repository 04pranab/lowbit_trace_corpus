/*
 * LowBit -- 0010_grid_b01_always_taken__c10_pointer_chase_linked_list.c
 * Branch: always_taken | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0010_grid_b01_always_taken__c10_pointer_chase_linked_list.c\n");
