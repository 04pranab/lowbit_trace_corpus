/*
 * LowBit -- 2542_base_branch_b42_bit_reversal_index_data_mix.c
 * Branch: bit_reversal_index_data_mix | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2542_base_branch_b42_bit_reversal_index_data_mix.c\n");
