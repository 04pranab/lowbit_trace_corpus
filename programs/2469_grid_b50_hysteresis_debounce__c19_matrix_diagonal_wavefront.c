/*
 * LowBit -- 2469_grid_b50_hysteresis_debounce__c19_matrix_diagonal_wavefront.c
 * Branch: hysteresis_debounce | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        uint32_t v = buf[idx];
        int taken;
        { static int state50_ = 0; static int counter50_ = 0;
  ...
  taken = state50_; }
    ...
    printf("program=2469_grid_b50_hysteresis_debounce__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=hysteresis_debounce\n");
