/*
 * LowBit -- 1178_grid_b24_monotonic_drift_saturating__c28_morton_zorder_traversal.c
 * Branch: monotonic_drift_saturating | Cache: morton_zorder_traversal
...
int main(void) {
  ...
  if (bias24_ < 9900u) bias24_ += 3u; }
    ...
    printf("program=1178_grid_b24_monotonic_drift_saturating__c28_morton_zorder_traversal.c\n");
