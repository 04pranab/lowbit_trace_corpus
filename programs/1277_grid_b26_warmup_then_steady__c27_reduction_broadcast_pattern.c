/*
 * LowBit -- 1277_grid_b26_warmup_then_steady__c27_reduction_broadcast_pattern.c
 * Branch: warmup_then_steady | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1277_grid_b26_warmup_then_steady__c27_reduction_broadcast_pattern.c\n");
