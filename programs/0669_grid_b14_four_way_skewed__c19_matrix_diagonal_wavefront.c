/*
 * LowBit -- 0669_grid_b14_four_way_skewed__c19_matrix_diagonal_wavefront.c
 * Branch: four_way_skewed | Cache: matrix_diagonal_wavefront
...
int main(void) {
    ...
    for (uint64_t i = 0; i < warmup_n; i++) {
     ...
     (r_ < mrows19_ && c_ < mcols19_) ? (r_ * mcols19_ + c_) : (uint32_t)(i % SIZE); });
        ...
        int taken;
        { uint32_t r_ = v % 10u;
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0669_grid_b14_four_way_skewed__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=four_way_skewed\n");
