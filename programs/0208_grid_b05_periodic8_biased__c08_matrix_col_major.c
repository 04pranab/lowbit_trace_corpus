/*
 * LowBit -- 0208_grid_b05_periodic8_biased__c08_matrix_col_major.c
 * Branch: periodic8_biased | Cache: matrix_col_major
...
int main(void) {
    ...
    printf("program=0208_grid_b05_periodic8_biased__c08_matrix_col_major.c\n");
