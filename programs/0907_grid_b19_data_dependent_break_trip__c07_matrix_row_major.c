/*
 * LowBit -- 0907_grid_b19_data_dependent_break_trip__c07_matrix_row_major.c
 * Branch: data_dependent_break_trip | Cache: matrix_row_major
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0907_grid_b19_data_dependent_break_trip__c07_matrix_row_major.c\n");
