/*
 * LowBit -- 0995_grid_b20_random_threshold_walk__c45_read_hot_write_cold_split.c
 * Branch: random_threshold_walk | Cache: read_hot_write_cold_split
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0995_grid_b20_random_threshold_walk__c45_read_hot_write_cold_split.c\n");
