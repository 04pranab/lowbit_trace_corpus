/*
 * LowBit -- 0671_grid_b14_four_way_skewed__c21_pyramid_multiresolution_stride.c
 * Branch: four_way_skewed | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0671_grid_b14_four_way_skewed__c21_pyramid_multiresolution_stride.c\n");
