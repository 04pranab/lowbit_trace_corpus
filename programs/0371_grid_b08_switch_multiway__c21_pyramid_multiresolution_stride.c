/*
 * LowBit -- 0371_grid_b08_switch_multiway__c21_pyramid_multiresolution_stride.c
 * Branch: switch_multiway | Cache: pyramid_multiresolution_stride
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0371_grid_b08_switch_multiway__c21_pyramid_multiresolution_stride.c\n");
