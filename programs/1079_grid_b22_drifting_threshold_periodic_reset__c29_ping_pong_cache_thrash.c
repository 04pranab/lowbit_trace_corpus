/*
 * LowBit -- 1079_grid_b22_drifting_threshold_periodic_reset__c29_ping_pong_cache_thrash.c
 * Branch: drifting_threshold_periodic_reset | Cache: ping_pong_cache_thrash
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1079_grid_b22_drifting_threshold_periodic_reset__c29_ping_pong_cache_thrash.c\n");
