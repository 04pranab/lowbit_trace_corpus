/*
 * LowBit -- 0910_grid_b19_data_dependent_break_trip__c10_pointer_chase_linked_list.c
 * Branch: data_dependent_break_trip | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0910_grid_b19_data_dependent_break_trip__c10_pointer_chase_linked_list.c\n");
