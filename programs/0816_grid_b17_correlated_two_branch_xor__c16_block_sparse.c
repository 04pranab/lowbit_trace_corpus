/*
 * LowBit -- 0816_grid_b17_correlated_two_branch_xor__c16_block_sparse.c
 * Branch: correlated_two_branch_xor | Cache: block_sparse
...
int main(void) {
  ...
  (void)b1_; }
    ...
    printf("program=0816_grid_b17_correlated_two_branch_xor__c16_block_sparse.c\n");
