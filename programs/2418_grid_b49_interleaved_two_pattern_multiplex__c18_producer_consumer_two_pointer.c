/*
 * LowBit -- 2418_grid_b49_interleaved_two_pattern_multiplex__c18_producer_consumer_two_pointer.c
 * Branch: interleaved_two_pattern_multiplex | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=2418_grid_b49_interleaved_two_pattern_multiplex__c18_producer_consumer_two_pointer.c\n");
