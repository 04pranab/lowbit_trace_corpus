/*
 * LowBit -- 1800_grid_b36_traffic_light_fsm__c50_streaming_with_periodic_flush.c
 * Branch: traffic_light_fsm | Cache: streaming_with_periodic_flush
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1800_grid_b36_traffic_light_fsm__c50_streaming_with_periodic_flush.c\n");
