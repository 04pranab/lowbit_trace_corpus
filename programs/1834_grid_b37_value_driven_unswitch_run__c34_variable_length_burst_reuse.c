/*
 * LowBit -- 1834_grid_b37_value_driven_unswitch_run__c34_variable_length_burst_reuse.c
 * Branch: value_driven_unswitch_run | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1834_grid_b37_value_driven_unswitch_run__c34_variable_length_burst_reuse.c\n");
