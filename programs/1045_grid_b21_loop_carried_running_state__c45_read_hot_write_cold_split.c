/*
 * LowBit -- 1045_grid_b21_loop_carried_running_state__c45_read_hot_write_cold_split.c
 * Branch: loop_carried_running_state | Cache: read_hot_write_cold_split
...
int main(void) {
    ...
    printf("program=1045_grid_b21_loop_carried_running_state__c45_read_hot_write_cold_split.c\n");
