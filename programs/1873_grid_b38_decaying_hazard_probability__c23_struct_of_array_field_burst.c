/*
 * LowBit -- 1873_grid_b38_decaying_hazard_probability__c23_struct_of_array_field_burst.c
 * Branch: decaying_hazard_probability | Cache: struct_of_array_field_burst
...
int main(void) {
  ...
  if (hazard38_ < 1000000u) hazard38_ = 4000000000u; }
    ...
    printf("program=1873_grid_b38_decaying_hazard_probability__c23_struct_of_array_field_burst.c\n");
