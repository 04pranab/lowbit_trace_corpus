/*
 * LowBit -- 1391_grid_b28_data_driven_stack_machine__c41_skip_list_multilevel_hop.c
 * Branch: data_driven_stack_machine | Cache: skip_list_multilevel_hop
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1391_grid_b28_data_driven_stack_machine__c41_skip_list_multilevel_hop.c\n");
