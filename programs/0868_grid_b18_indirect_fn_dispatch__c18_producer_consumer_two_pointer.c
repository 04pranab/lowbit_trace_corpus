/*
 * LowBit -- 0868_grid_b18_indirect_fn_dispatch__c18_producer_consumer_two_pointer.c
 * Branch: indirect_fn_dispatch | Cache: producer_consumer_two_pointer
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0868_grid_b18_indirect_fn_dispatch__c18_producer_consumer_two_pointer.c\n");
