/*
 * LowBit -- 1581_grid_b32_emulated_2bit_saturating_counter__c31_fibonacci_stride.c
 * Branch: emulated_2bit_saturating_counter | Cache: fibonacci_stride
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=1581_grid_b32_emulated_2bit_saturating_counter__c31_fibonacci_stride.c\n");
