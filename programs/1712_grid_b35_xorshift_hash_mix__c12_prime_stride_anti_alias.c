/*
 * LowBit -- 1712_grid_b35_xorshift_hash_mix__c12_prime_stride_anti_alias.c
 * Branch: xorshift_hash_mix | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1712_grid_b35_xorshift_hash_mix__c12_prime_stride_anti_alias.c\n");
