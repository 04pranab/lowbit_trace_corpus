/*
 * LowBit -- 0172_grid_b04_periodic3__c22_tensor_3d_slice_poor_locality.c
 * Branch: periodic3 | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
    ...
    printf("program=0172_grid_b04_periodic3__c22_tensor_3d_slice_poor_locality.c\n");
