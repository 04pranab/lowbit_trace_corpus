/*
 * LowBit -- 0109_grid_b03_alternating__c09_matrix_tiled_blocked.c
 * Branch: alternating | Cache: matrix_tiled_blocked
...
int main(void) {
    ...
    printf("program=0109_grid_b03_alternating__c09_matrix_tiled_blocked.c\n");
