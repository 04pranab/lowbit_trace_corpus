/*
 * LowBit -- 1974_grid_b40_collatz_value_transform__c24_banked_interleaved_access.c
 * Branch: collatz_value_transform | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1974_grid_b40_collatz_value_transform__c24_banked_interleaved_access.c\n");
