/*
 * LowBit -- 2052_grid_b42_bit_reversal_index_data_mix__c02_sequential_wraparound_large.c
 * Branch: bit_reversal_index_data_mix | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2052_grid_b42_bit_reversal_index_data_mix__c02_sequential_wraparound_large.c\n");
