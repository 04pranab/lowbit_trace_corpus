/*
 * LowBit -- 0430_grid_b09_recursive_calls__c30_gather_scatter_indirect_table.c
 * Branch: recursive_calls | Cache: gather_scatter_indirect_table
...
int main(void) {
  ...
  taken = (r_ & 1u) == 0u; v = r_; }
    ...
    printf("program=0430_grid_b09_recursive_calls__c30_gather_scatter_indirect_table.c\n");
