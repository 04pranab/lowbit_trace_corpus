/*
 * LowBit -- 1074_grid_b22_drifting_threshold_periodic_reset__c24_banked_interleaved_access.c
 * Branch: drifting_threshold_periodic_reset | Cache: banked_interleaved_access
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1074_grid_b22_drifting_threshold_periodic_reset__c24_banked_interleaved_access.c\n");
