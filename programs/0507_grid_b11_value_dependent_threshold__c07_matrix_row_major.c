/*
 * LowBit -- 0507_grid_b11_value_dependent_threshold__c07_matrix_row_major.c
 * Branch: value_dependent_threshold | Cache: matrix_row_major
...
int main(void) {
    ...
    printf("program=0507_grid_b11_value_dependent_threshold__c07_matrix_row_major.c\n");
