/*
 * LowBit -- 0360_grid_b08_switch_multiway__c10_pointer_chase_linked_list.c
 * Branch: switch_multiway | Cache: pointer_chase_linked_list
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0360_grid_b08_switch_multiway__c10_pointer_chase_linked_list.c\n");
