/*
 * LowBit -- 0721_grid_b15_manual_unroll4_sparse__c21_pyramid_multiresolution_stride.c
 * Branch: manual_unroll4_sparse | Cache: pyramid_multiresolution_stride
...
int main(void) {
    ...
    printf("program=0721_grid_b15_manual_unroll4_sparse__c21_pyramid_multiresolution_stride.c\n");
