/*
 * LowBit -- 2127_grid_b43_moving_average_threshold__c27_reduction_broadcast_pattern.c
 * Branch: moving_average_threshold | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2127_grid_b43_moving_average_threshold__c27_reduction_broadcast_pattern.c\n");
