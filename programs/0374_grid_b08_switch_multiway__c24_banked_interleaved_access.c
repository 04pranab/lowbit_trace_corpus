/*
 * LowBit -- 0374_grid_b08_switch_multiway__c24_banked_interleaved_access.c
 * Branch: switch_multiway | Cache: banked_interleaved_access
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0374_grid_b08_switch_multiway__c24_banked_interleaved_access.c\n");
