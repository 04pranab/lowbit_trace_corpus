/*
 * LowBit -- 2016_grid_b41_markov_chain_3state__c16_block_sparse.c
 * Branch: markov_chain_3state | Cache: block_sparse
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2016_grid_b41_markov_chain_3state__c16_block_sparse.c\n");
