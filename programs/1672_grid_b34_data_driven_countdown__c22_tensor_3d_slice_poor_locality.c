/*
 * LowBit -- 1672_grid_b34_data_driven_countdown__c22_tensor_3d_slice_poor_locality.c
 * Branch: data_driven_countdown | Cache: tensor_3d_slice_poor_locality
...
int main(void) {
  ...
  cnt34_--; }
    ...
    printf("program=1672_grid_b34_data_driven_countdown__c22_tensor_3d_slice_poor_locality.c\n");
