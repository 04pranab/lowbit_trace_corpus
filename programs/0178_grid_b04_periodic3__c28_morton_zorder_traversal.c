/*
 * LowBit -- 0178_grid_b04_periodic3__c28_morton_zorder_traversal.c
 * Branch: periodic3 | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0178_grid_b04_periodic3__c28_morton_zorder_traversal.c\n");
