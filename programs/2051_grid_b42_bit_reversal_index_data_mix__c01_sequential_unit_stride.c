/*
 * LowBit -- 2051_grid_b42_bit_reversal_index_data_mix__c01_sequential_unit_stride.c
 * Branch: bit_reversal_index_data_mix | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (r42_ & 1u) == 0u; }
    ...
    printf("program=2051_grid_b42_bit_reversal_index_data_mix__c01_sequential_unit_stride.c\n");
