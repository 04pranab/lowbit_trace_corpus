/*
 * LowBit -- 0256_grid_b06_pseudo_random_50__c06_random_full_working_set.c
 * Branch: pseudo_random_50 | Cache: random_full_working_set
...
int main(void) {
    ...
    printf("program=0256_grid_b06_pseudo_random_50__c06_random_full_working_set.c\n");
