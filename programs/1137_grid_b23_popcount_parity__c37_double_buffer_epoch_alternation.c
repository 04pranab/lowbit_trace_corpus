/*
 * LowBit -- 1137_grid_b23_popcount_parity__c37_double_buffer_epoch_alternation.c
 * Branch: popcount_parity | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1137_grid_b23_popcount_parity__c37_double_buffer_epoch_alternation.c\n");
