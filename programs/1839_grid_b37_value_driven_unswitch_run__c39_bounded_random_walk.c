/*
 * LowBit -- 1839_grid_b37_value_driven_unswitch_run__c39_bounded_random_walk.c
 * Branch: value_driven_unswitch_run | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1839_grid_b37_value_driven_unswitch_run__c39_bounded_random_walk.c\n");
