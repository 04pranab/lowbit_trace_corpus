/*
 * LowBit -- 2039_grid_b41_markov_chain_3state__c39_bounded_random_walk.c
 * Branch: markov_chain_3state | Cache: bounded_random_walk
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2039_grid_b41_markov_chain_3state__c39_bounded_random_walk.c\n");
