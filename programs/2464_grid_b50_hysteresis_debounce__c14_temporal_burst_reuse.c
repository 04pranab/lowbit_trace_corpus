/*
 * LowBit -- 2464_grid_b50_hysteresis_debounce__c14_temporal_burst_reuse.c
 * Branch: hysteresis_debounce | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2464_grid_b50_hysteresis_debounce__c14_temporal_burst_reuse.c\n");
