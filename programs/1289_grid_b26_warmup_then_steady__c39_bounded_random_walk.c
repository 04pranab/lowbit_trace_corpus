/*
 * LowBit -- 1289_grid_b26_warmup_then_steady__c39_bounded_random_walk.c
 * Branch: warmup_then_steady | Cache: bounded_random_walk
...
int main(void) {
  ...
  taken = (i < warm26_) ? (int)((i & 1u) == 0u) : 1; }
    ...
    printf("program=1289_grid_b26_warmup_then_steady__c39_bounded_random_walk.c\n");
