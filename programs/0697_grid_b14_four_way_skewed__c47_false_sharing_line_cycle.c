/*
 * LowBit -- 0697_grid_b14_four_way_skewed__c47_false_sharing_line_cycle.c
 * Branch: four_way_skewed | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  if (r_ < 7u) taken = 1; else if (r_ < 8u) taken = 0; else if (r_ < 9u) taken = 1; else taken = 0; }
    ...
    printf("program=0697_grid_b14_four_way_skewed__c47_false_sharing_line_cycle.c\n");
