/*
 * LowBit -- 2034_grid_b41_markov_chain_3state__c34_variable_length_burst_reuse.c
 * Branch: markov_chain_3state | Cache: variable_length_burst_reuse
...
int main(void) {
  ...
  if (r41_ >= trans41_[mstate41_]) { mstate41_ = (mstate41_ + 1) % 3; } }
    ...
    printf("program=2034_grid_b41_markov_chain_3state__c34_variable_length_burst_reuse.c\n");
