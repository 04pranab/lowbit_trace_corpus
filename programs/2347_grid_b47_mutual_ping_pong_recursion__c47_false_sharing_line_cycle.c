/*
 * LowBit -- 2347_grid_b47_mutual_ping_pong_recursion__c47_false_sharing_line_cycle.c
 * Branch: mutual_ping_pong_recursion | Cache: false_sharing_line_cycle
...
int main(void) {
  ...
  taken = (r47_ & 1u) == 0u; v = r47_; }
    ...
    printf("program=2347_grid_b47_mutual_ping_pong_recursion__c47_false_sharing_line_cycle.c\n");
