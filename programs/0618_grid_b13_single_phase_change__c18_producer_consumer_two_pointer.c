/*
 * LowBit -- 0618_grid_b13_single_phase_change__c18_producer_consumer_two_pointer.c
 * Branch: single_phase_change | Cache: producer_consumer_two_pointer
...
int main(void) {
    ...
    printf("program=0618_grid_b13_single_phase_change__c18_producer_consumer_two_pointer.c\n");
