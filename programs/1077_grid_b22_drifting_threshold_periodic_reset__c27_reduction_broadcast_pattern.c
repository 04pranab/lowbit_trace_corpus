/*
 * LowBit -- 1077_grid_b22_drifting_threshold_periodic_reset__c27_reduction_broadcast_pattern.c
 * Branch: drifting_threshold_periodic_reset | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  thresh22_ = (thresh22_ > 5u) ? thresh22_ - 5u : 500u; }
    ...
    printf("program=1077_grid_b22_drifting_threshold_periodic_reset__c27_reduction_broadcast_pattern.c\n");
