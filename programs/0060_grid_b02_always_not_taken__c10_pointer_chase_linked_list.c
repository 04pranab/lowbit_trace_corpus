/*
 * LowBit -- 0060_grid_b02_always_not_taken__c10_pointer_chase_linked_list.c
 * Branch: always_not_taken | Cache: pointer_chase_linked_list
...
int main(void) {
    ...
    printf("program=0060_grid_b02_always_not_taken__c10_pointer_chase_linked_list.c\n");
