/*
 * LowBit -- 2152_grid_b44_exception_then_recovery_burst__c02_sequential_wraparound_large.c
 * Branch: exception_then_recovery_burst | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2152_grid_b44_exception_then_recovery_burst__c02_sequential_wraparound_large.c\n");
