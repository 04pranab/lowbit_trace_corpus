/*
 * LowBit -- 1101_grid_b23_popcount_parity__c01_sequential_unit_stride.c
 * Branch: popcount_parity | Cache: sequential_unit_stride
...
int main(void) {
  ...
  taken = (pc_ & 1u) == 0u; }
    ...
    printf("program=1101_grid_b23_popcount_parity__c01_sequential_unit_stride.c\n");
