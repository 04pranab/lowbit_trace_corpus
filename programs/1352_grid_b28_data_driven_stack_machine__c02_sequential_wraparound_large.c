/*
 * LowBit -- 1352_grid_b28_data_driven_stack_machine__c02_sequential_wraparound_large.c
 * Branch: data_driven_stack_machine | Cache: sequential_wraparound_large
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1352_grid_b28_data_driven_stack_machine__c02_sequential_wraparound_large.c\n");
