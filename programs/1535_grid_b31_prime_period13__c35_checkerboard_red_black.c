/*
 * LowBit -- 1535_grid_b31_prime_period13__c35_checkerboard_red_black.c
 * Branch: prime_period13 | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=1535_grid_b31_prime_period13__c35_checkerboard_red_black.c\n");
