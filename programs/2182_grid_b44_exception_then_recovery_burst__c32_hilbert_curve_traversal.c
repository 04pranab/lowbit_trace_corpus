/*
 * LowBit -- 2182_grid_b44_exception_then_recovery_burst__c32_hilbert_curve_traversal.c
 * Branch: exception_then_recovery_burst | Cache: hilbert_curve_traversal
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2182_grid_b44_exception_then_recovery_burst__c32_hilbert_curve_traversal.c\n");
