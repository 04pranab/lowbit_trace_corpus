/*
 * LowBit -- 0646_grid_b13_single_phase_change__c46_cantor_gap_sparse.c
 * Branch: single_phase_change | Cache: cantor_gap_sparse
...
int main(void) {
    ...
    printf("program=0646_grid_b13_single_phase_change__c46_cantor_gap_sparse.c\n");
