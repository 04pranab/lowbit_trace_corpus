/*
 * LowBit -- 1433_grid_b29_bursty_streak_pattern__c33_cache_set_conflict_stress.c
 * Branch: bursty_streak_pattern | Cache: cache_set_conflict_stress
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1433_grid_b29_bursty_streak_pattern__c33_cache_set_conflict_stress.c\n");
