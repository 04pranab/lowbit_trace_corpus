/*
 * LowBit -- 0554_grid_b12_doubling_run_lengths__c04_fixed_stride_large.c
 * Branch: doubling_run_lengths | Cache: fixed_stride_large
...
int main(void) {
  ...
  if (run_pos_ >= run_len_) { run_pos_ = 0; run_len_ = (run_len_ < 4096u) ? run_len_ * 2u : 1u; dir_ ^= 1u; } }
    ...
    printf("program=0554_grid_b12_doubling_run_lengths__c04_fixed_stride_large.c\n");
