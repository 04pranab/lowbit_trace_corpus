/*
 * LowBit -- 1424_grid_b29_bursty_streak_pattern__c24_banked_interleaved_access.c
 * Branch: bursty_streak_pattern | Cache: banked_interleaved_access
...
int main(void) {
  ...
  if (burst29_remaining_ > 0) { taken = 0; burst29_remaining_--; }
    ...
    printf("program=1424_grid_b29_bursty_streak_pattern__c24_banked_interleaved_access.c\n");
