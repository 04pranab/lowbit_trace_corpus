/*
 * LowBit -- 0628_grid_b13_single_phase_change__c28_morton_zorder_traversal.c
 * Branch: single_phase_change | Cache: morton_zorder_traversal
...
int main(void) {
    ...
    printf("program=0628_grid_b13_single_phase_change__c28_morton_zorder_traversal.c\n");
