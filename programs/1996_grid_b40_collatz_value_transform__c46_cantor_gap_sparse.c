/*
 * LowBit -- 1996_grid_b40_collatz_value_transform__c46_cantor_gap_sparse.c
 * Branch: collatz_value_transform | Cache: cantor_gap_sparse
...
int main(void) {
  ...
  if ((cv40_ & 1u) == 0u) { taken = 1; v = cv40_ >> 1; }
    ...
    printf("program=1996_grid_b40_collatz_value_transform__c46_cantor_gap_sparse.c\n");
