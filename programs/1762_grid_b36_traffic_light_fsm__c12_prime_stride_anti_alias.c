/*
 * LowBit -- 1762_grid_b36_traffic_light_fsm__c12_prime_stride_anti_alias.c
 * Branch: traffic_light_fsm | Cache: prime_stride_anti_alias
...
int main(void) {
  ...
  if (dwell36_ >= dwell_times36_[state36_]) { dwell36_ = 0; state36_ = (state36_ + 1) % 3; } }
    ...
    printf("program=1762_grid_b36_traffic_light_fsm__c12_prime_stride_anti_alias.c\n");
