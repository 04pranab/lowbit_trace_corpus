/*
 * LowBit -- 0887_grid_b18_indirect_fn_dispatch__c37_double_buffer_epoch_alternation.c
 * Branch: indirect_fn_dispatch | Cache: double_buffer_epoch_alternation
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0887_grid_b18_indirect_fn_dispatch__c37_double_buffer_epoch_alternation.c\n");
