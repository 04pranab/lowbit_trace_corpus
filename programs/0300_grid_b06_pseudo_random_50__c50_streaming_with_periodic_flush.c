/*
 * LowBit -- 0300_grid_b06_pseudo_random_50__c50_streaming_with_periodic_flush.c
 * Branch: pseudo_random_50 | Cache: streaming_with_periodic_flush
...
int main(void) {
    ...
    printf("program=0300_grid_b06_pseudo_random_50__c50_streaming_with_periodic_flush.c\n");
