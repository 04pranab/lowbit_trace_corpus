/*
 * LowBit -- 0640_grid_b13_single_phase_change__c40_causal_attention_triangular.c
 * Branch: single_phase_change | Cache: causal_attention_triangular
...
int main(void) {
    ...
    printf("program=0640_grid_b13_single_phase_change__c40_causal_attention_triangular.c\n");
