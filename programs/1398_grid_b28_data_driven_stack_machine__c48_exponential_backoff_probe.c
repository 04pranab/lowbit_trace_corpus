/*
 * LowBit -- 1398_grid_b28_data_driven_stack_machine__c48_exponential_backoff_probe.c
 * Branch: data_driven_stack_machine | Cache: exponential_backoff_probe
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1398_grid_b28_data_driven_stack_machine__c48_exponential_backoff_probe.c\n");
