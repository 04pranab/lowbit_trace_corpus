/*
 * LowBit -- 0731_grid_b15_manual_unroll4_sparse__c31_fibonacci_stride.c
 * Branch: manual_unroll4_sparse | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0731_grid_b15_manual_unroll4_sparse__c31_fibonacci_stride.c\n");
