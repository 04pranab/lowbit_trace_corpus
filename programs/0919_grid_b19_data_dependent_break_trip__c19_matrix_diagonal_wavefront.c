/*
 * LowBit -- 0919_grid_b19_data_dependent_break_trip__c19_matrix_diagonal_wavefront.c
 * Branch: data_dependent_break_trip | Cache: matrix_diagonal_wavefront
...
int main(void) {
  ...
  taken = j_ < bound_; }
    ...
    printf("program=0919_grid_b19_data_dependent_break_trip__c19_matrix_diagonal_wavefront.c\n");
    printf("branch_pattern=data_dependent_break_trip\n");
