/*
 * LowBit -- 2158_grid_b44_exception_then_recovery_burst__c08_matrix_col_major.c
 * Branch: exception_then_recovery_burst | Cache: matrix_col_major
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2158_grid_b44_exception_then_recovery_burst__c08_matrix_col_major.c\n");
