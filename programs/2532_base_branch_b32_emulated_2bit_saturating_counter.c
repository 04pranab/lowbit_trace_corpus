/*
 * LowBit -- 2532_base_branch_b32_emulated_2bit_saturating_counter.c
 * Branch: emulated_2bit_saturating_counter | Cache: synthetic_sequential_scan
...
int main(void) {
  ...
  taken = sat32_ >= 2; }
    ...
    printf("program=2532_base_branch_b32_emulated_2bit_saturating_counter.c\n");
