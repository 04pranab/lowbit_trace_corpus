/*
 * LowBit -- 0958_grid_b20_random_threshold_walk__c08_matrix_col_major.c
 * Branch: random_threshold_walk | Cache: matrix_col_major
...
int main(void) {
  ...
  bias_ = 8u + ((bias_ + 7u) % 56u); }
    ...
    printf("program=0958_grid_b20_random_threshold_walk__c08_matrix_col_major.c\n");
