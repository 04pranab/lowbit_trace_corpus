/*
 * LowBit -- 0853_grid_b18_indirect_fn_dispatch__c03_fixed_stride_small.c
 * Branch: indirect_fn_dispatch | Cache: fixed_stride_small
...
int main(void) {
  ...
  taken = (v & 1u) == 0u; }
    ...
    printf("program=0853_grid_b18_indirect_fn_dispatch__c03_fixed_stride_small.c\n");
