/*
 * LowBit -- 0237_grid_b05_periodic8_biased__c37_double_buffer_epoch_alternation.c
 * Branch: periodic8_biased | Cache: double_buffer_epoch_alternation
...
int main(void) {
    ...
    printf("program=0237_grid_b05_periodic8_biased__c37_double_buffer_epoch_alternation.c\n");
