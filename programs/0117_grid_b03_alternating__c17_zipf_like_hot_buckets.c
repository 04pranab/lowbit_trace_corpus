/*
 * LowBit -- 0117_grid_b03_alternating__c17_zipf_like_hot_buckets.c
 * Branch: alternating | Cache: zipf_like_hot_buckets
...
int main(void) {
    ...
    printf("program=0117_grid_b03_alternating__c17_zipf_like_hot_buckets.c\n");
