/*
 * LowBit -- 0392_grid_b08_switch_multiway__c42_cache_oblivious_funnel_stride.c
 * Branch: switch_multiway | Cache: cache_oblivious_funnel_stride
...
int main(void) {
  ...
  switch (route_) {
    ...
    printf("program=0392_grid_b08_switch_multiway__c42_cache_oblivious_funnel_stride.c\n");
