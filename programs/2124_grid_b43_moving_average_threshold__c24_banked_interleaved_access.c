/*
 * LowBit -- 2124_grid_b43_moving_average_threshold__c24_banked_interleaved_access.c
 * Branch: moving_average_threshold | Cache: banked_interleaved_access
...
int main(void) {
  ...
  hist43_[pos43_] = v; pos43_ = (pos43_ + 1) & 3; }
    ...
    printf("program=2124_grid_b43_moving_average_threshold__c24_banked_interleaved_access.c\n");
