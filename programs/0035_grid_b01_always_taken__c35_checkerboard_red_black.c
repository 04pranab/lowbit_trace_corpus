/*
 * LowBit -- 0035_grid_b01_always_taken__c35_checkerboard_red_black.c
 * Branch: always_taken | Cache: checkerboard_red_black
...
int main(void) {
    ...
    printf("program=0035_grid_b01_always_taken__c35_checkerboard_red_black.c\n");
