/*
 * LowBit -- 0536_grid_b11_value_dependent_threshold__c36_im2col_overlapping_patch_gather.c
 * Branch: value_dependent_threshold | Cache: im2col_overlapping_patch_gather
...
int main(void) {
    ...
    printf("program=0536_grid_b11_value_dependent_threshold__c36_im2col_overlapping_patch_gather.c\n");
