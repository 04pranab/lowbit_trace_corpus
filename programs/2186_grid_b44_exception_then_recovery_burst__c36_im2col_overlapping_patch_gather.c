/*
 * LowBit -- 2186_grid_b44_exception_then_recovery_burst__c36_im2col_overlapping_patch_gather.c
 * Branch: exception_then_recovery_burst | Cache: im2col_overlapping_patch_gather
...
int main(void) {
  ...
  if (recover44_remaining_ > 0) { taken = 0; recover44_remaining_--; }
    ...
    printf("program=2186_grid_b44_exception_then_recovery_burst__c36_im2col_overlapping_patch_gather.c\n");
