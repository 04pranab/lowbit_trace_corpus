/*
 * LowBit -- 0248_grid_b05_periodic8_biased__c48_exponential_backoff_probe.c
 * Branch: periodic8_biased | Cache: exponential_backoff_probe
...
int main(void) {
    ...
    printf("program=0248_grid_b05_periodic8_biased__c48_exponential_backoff_probe.c\n");
