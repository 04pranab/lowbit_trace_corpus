/*
 * LowBit -- 0297_grid_b06_pseudo_random_50__c47_false_sharing_line_cycle.c
 * Branch: pseudo_random_50 | Cache: false_sharing_line_cycle
...
int main(void) {
    ...
    printf("program=0297_grid_b06_pseudo_random_50__c47_false_sharing_line_cycle.c\n");
