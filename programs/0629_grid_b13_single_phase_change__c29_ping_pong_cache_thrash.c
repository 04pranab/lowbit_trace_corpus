/*
 * LowBit -- 0629_grid_b13_single_phase_change__c29_ping_pong_cache_thrash.c
 * Branch: single_phase_change | Cache: ping_pong_cache_thrash
...
int main(void) {
    ...
    printf("program=0629_grid_b13_single_phase_change__c29_ping_pong_cache_thrash.c\n");
