/*
 * LowBit -- 1807_grid_b37_value_driven_unswitch_run__c07_matrix_row_major.c
 * Branch: value_driven_unswitch_run | Cache: matrix_row_major
...
int main(void) {
  ...
  if (rem37_ == 0u) { taken = 0; } }
    ...
    printf("program=1807_grid_b37_value_driven_unswitch_run__c07_matrix_row_major.c\n");
