/*
 * LowBit -- 2477_grid_b50_hysteresis_debounce__c27_reduction_broadcast_pattern.c
 * Branch: hysteresis_debounce | Cache: reduction_broadcast_pattern
...
int main(void) {
  ...
  taken = state50_; }
    ...
    printf("program=2477_grid_b50_hysteresis_debounce__c27_reduction_broadcast_pattern.c\n");
