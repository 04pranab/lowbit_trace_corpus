/*
 * LowBit -- 1713_grid_b35_xorshift_hash_mix__c13_two_stream_interleaved.c
 * Branch: xorshift_hash_mix | Cache: two_stream_interleaved
...
int main(void) {
  ...
  taken = (h35_ & 1u) == 0u; }
    ...
    printf("program=1713_grid_b35_xorshift_hash_mix__c13_two_stream_interleaved.c\n");
