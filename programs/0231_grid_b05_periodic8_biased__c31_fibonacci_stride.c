/*
 * LowBit -- 0231_grid_b05_periodic8_biased__c31_fibonacci_stride.c
 * Branch: periodic8_biased | Cache: fibonacci_stride
...
int main(void) {
    ...
    printf("program=0231_grid_b05_periodic8_biased__c31_fibonacci_stride.c\n");
