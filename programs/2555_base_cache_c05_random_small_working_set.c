/*
 * LowBit -- 2555_base_cache_c05_random_small_working_set.c
 * Branch: synthetic_always_taken | Cache: random_small_working_set
...
int main(void) {
    ...
    printf("program=2555_base_cache_c05_random_small_working_set.c\n");
