/*
 * LowBit -- 1364_grid_b28_data_driven_stack_machine__c14_temporal_burst_reuse.c
 * Branch: data_driven_stack_machine | Cache: temporal_burst_reuse
...
int main(void) {
  ...
  if (op28_ != 0u && depth28_ < 63) { stack28_[depth28_++] = (int)v; taken = 1; }
    ...
    printf("program=1364_grid_b28_data_driven_stack_machine__c14_temporal_burst_reuse.c\n");
